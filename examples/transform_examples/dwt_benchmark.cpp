...
template <typename T> std::vector<T> extract_energies_static(std::vector<T> x)
{
...
template <typename T> std::vector<T> extract_energies_static_3(std::vector<T> x)
{
...
int main()
{
	...
	std::cout //<< "\n\nresult1: " //<< result1
		<< "average time: " << sum / runs << " s" << std::endl;
	std::cout << "" << std::endl;
