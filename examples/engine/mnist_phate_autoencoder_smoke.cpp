...
struct Options {
	...
	std::filesystem::path export_dir{"docs/examples/assets/mnist-phate-ae-smoke"};
...
int main(int argc, char **argv)
{
	...
	std::cout << "mnist phate-ae smoke dataset = MNIST train IDX\n";
	std::cout << "mnist phate-ae smoke records = " << records.size() << "\n";
	std::cout << "mnist phate-ae smoke per class = " << options.per_class << "\n";
	std::cout << "mnist phate-ae smoke metric = Euclidean(normalized_pixels)\n";
	std::cout << "mnist phate-ae smoke dense evaluations = " << targets.dense_distance_evaluations << "\n";
	std::cout << "mnist phate-ae smoke epochs = " << options.epochs << "\n";
	std::cout << "mnist phate-ae smoke initial bottleneck mse = " << initial_bottleneck << "\n";
	std::cout << "mnist phate-ae smoke final bottleneck mse = " << final_bottleneck << "\n";
	if (options.export_files) {
		std::cout << "mnist phate-ae smoke export dir = " << options.export_dir.string() << "\n";
	}
}
