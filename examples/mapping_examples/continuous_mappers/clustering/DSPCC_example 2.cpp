...
int main()
{
	...
	float freq_time_balance = 1; // try values from 0 to 1 (e g 0, 0.5, 1) to get the following portions of freq-domain:
	0, 4/9, 8/9 auto bundle = mtrc::DSPCC1<RecType, void>(d, 2, 4, freq_time_balance, 0.5);
	...
	auto vDSPCC = mtrc::DSPCC<std::vector<double>, void>(vdata, 8, 8, 0.1, 0);
