 ...
 */
template <typename Pixel = uint8_t, typename Label = uint8_t> struct MNIST_dataset {
 ...
 */
template <typename Label = uint8_t> std::vector<Label> read_mnist_label_file(const std::string &path)
{
 ...
 */
template <typename Pixel = uint8_t> std::vector<std::vector<Pixel>> read_training_images()
{
 ...
 * \return Container filled with the images
 */
template <typename Pixel = uint8_t> std::vector<std::vector<Pixel>> read_test_images()
{
 ...
 */
template <typename Label = uint8_t> std::vector<Label> read_training_labels()
{
 ...
 * \return Container filled with the labels
 */
template <typename Label = uint8_t> std::vector<Label> read_test_labels()
{
 ...
 * \return The dataset
 */
template <typename Pixel = uint8_t, typename Label = uint8_t> MNIST_dataset<Pixel, Label> read_dataset()
{
