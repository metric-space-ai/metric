...
TEST_CASE("bfloat16_bfloat16_detail_fixed2bfloat16", "[float16]")
{
	...
	// tests for (0.10)
	val = bfloat16::detail::fixed2bfloat16<std::round_to_nearest, 31, false, false, true>(pointten.m, pointten.exp + 14,
																						  possign);
	REQUIRE(0x3DCC == val); // 0x3DCC = 0.099609375 bf16
	val = bfloat16::detail::fixed2bfloat16<std::round_toward_infinity, 31, false, false, true>(
		pointten.m, pointten.exp + 14, possign);
	REQUIRE(0x3DCC == val); // 0x3DCC = 0.099609375 bf16
	val = bfloat16::detail::fixed2bfloat16<std::round_toward_neg_infinity, 31, false, false, true>(
		pointten.m, pointten.exp + 14, possign);
	REQUIRE(0x3DCC == val); // 0x3DCC = 0.099609375 bf16

	// tests for (0.5)
	val = bfloat16::detail::fixed2bfloat16<std::round_to_nearest, 31, false, false, true>(pointfive.m,
																						  pointfive.exp + 14, possign);
	REQUIRE(0x3F00 == val); // 0x3F00 = 0.5 bf16
	val = bfloat16::detail::fixed2bfloat16<std::round_toward_infinity, 31, false, false, true>(
		pointfive.m, pointfive.exp + 14, possign);
	REQUIRE(0x3F00 == val); // 0x3F00 = 0.5 bf16
	val = bfloat16::detail::fixed2bfloat16<std::round_toward_neg_infinity, 31, false, false, true>(
		pointfive.m, pointfive.exp + 14, possign);
	REQUIRE(0x3F00 == val); // 0x3F00 = 0.5 bf16
	...
	REQUIRE(0x3F80 == val); // 0x3F80 = 1.0 bf16
	val = bfloat16::detail::fixed2bfloat16<std::round_toward_infinity, 31, false, false, true>(one.m, one.exp + 14,
																							   possign);
	REQUIRE(0x3F80 == val); // 0x3F80 = 1.0 bf16
	val = bfloat16::detail::fixed2bfloat16<std::round_toward_neg_infinity, 31, false, false, true>(one.m, one.exp + 14,
																								   possign);
	REQUIRE(0x3F80 == val); // 0x3F80 = 1.0 bf16

	// tests for (1.6)
	val = bfloat16::detail::fixed2bfloat16<std::round_to_nearest, 31, false, false, true>(
		onepointsix.m, onepointsix.exp + 14, possign);
	...
	// tests for (2.4)
	val = bfloat16::detail::fixed2bfloat16<std::round_to_nearest, 31, false, false, true>(
		twopointfour.m, twopointfour.exp + 14, possign);
	...
	// tests for (10.8)
	val = bfloat16::detail::fixed2bfloat16<std::round_to_nearest, 31, false, false, true>(
		tenpointeight.m, tenpointeight.exp + 14, possign);
	...
	// tests for (50.5)
	val = bfloat16::detail::fixed2bfloat16<std::round_to_nearest, 31, false, false, true>(
		fiftypointfive.m, fiftypointfive.exp + 14, possign);
	...
	// tests for (586.3)
	val = bfloat16::detail::fixed2bfloat16<std::round_to_nearest, 31, false, false, true>(
		fivehundred.m, fivehundred.exp + 14, possign);
	...
	// tests for (-0.10)
	val = bfloat16::detail::fixed2bfloat16<std::round_to_nearest, 31, true, false, true>(negpointten.m,
																						 negpointten.exp + 14, negsign);
	REQUIRE(0xBDCC == val); // 0xBDCC = -0.099609375 bf16
	val = bfloat16::detail::fixed2bfloat16<std::round_toward_infinity, 31, true, false, true>(
		negpointten.m, negpointten.exp + 14, negsign);
	REQUIRE(0xBDCC == val); // 0xBDCC = -0.099609375 bf16
	val = bfloat16::detail::fixed2bfloat16<std::round_toward_neg_infinity, 31, true, false, true>(
		negpointten.m, negpointten.exp + 14, negsign);
	REQUIRE(0xBDCC == val); // 0xBDCC = -0.099609375 bf16

	// tests for (-0.5)
	val = bfloat16::detail::fixed2bfloat16<std::round_to_nearest, 31, true, false, true>(
		negpointfive.m, negpointfive.exp + 14, negsign);
	REQUIRE(0xBF00 == val); // 0xBF00 = -0.5 bf16
	val = bfloat16::detail::fixed2bfloat16<std::round_toward_infinity, 31, true, false, true>(
		negpointfive.m, negpointfive.exp + 14, negsign);
	REQUIRE(0xBF00 == val); // 0xBF00 = -0.5 bf16
	...
	// tests for (-1.0)
	val = bfloat16::detail::fixed2bfloat16<std::round_to_nearest, 31, true, false, true>(negone.m, negone.exp + 14,
																						 negsign);
	REQUIRE(0xBF80 == val); // 0xBF80 = -1.0 bf16
	val = bfloat16::detail::fixed2bfloat16<std::round_toward_infinity, 31, true, false, true>(negone.m, negone.exp + 14,
																							  negsign);
	REQUIRE(0xBF80 == val); // 0xBF80 = -1.0 bf16
	val = bfloat16::detail::fixed2bfloat16<std::round_toward_neg_infinity, 31, true, false, true>(
		negone.m, negone.exp + 14, negsign);
	REQUIRE(0xBF80 == val); // 0xBF80 = -1.0 bf16

	// tests for (-1.6)
	val = bfloat16::detail::fixed2bfloat16<std::round_to_nearest, 31, true, false, true>(
		negonepointsix.m, negonepointsix.exp + 14, negsign);
	...
	// tests for (-2.4)
	val = bfloat16::detail::fixed2bfloat16<std::round_to_nearest, 31, true, false, true>(
		negtwopointfour.m, negtwopointfour.exp + 14, negsign);
	...
	// tests for (-10.8)
	val = bfloat16::detail::fixed2bfloat16<std::round_to_nearest, 31, true, false, true>(
		negtenpointeight.m, negtenpointeight.exp + 14, negsign);
	...
	// tests for (-50.5)
	val = bfloat16::detail::fixed2bfloat16<std::round_to_nearest, 31, true, false, true>(
		negfiftypointfive.m, negfiftypointfive.exp + 14, negsign);
	...
	// tests for (-586.3)
	val = bfloat16::detail::fixed2bfloat16<std::round_to_nearest, 31, true, false, true>(
		negfivehundred.m, negfivehundred.exp + 14, negsign);
...
TEST_CASE("bfloat16_bfloat16_detail_f31", "[float16]")
{
	...
	val = bfloat16::detail::fixed2bfloat16<std::round_to_nearest, 31, false, false, true>(result.m, result.exp + 14,
																						  possign);
	...
	// 0.1
	result = pointone * pointone;
	val = bfloat16::detail::fixed2bfloat16<std::round_to_nearest, 31, false, false, true>(result.m, result.exp - 98,
																						  possign);
	...
	// 0.1
	result = pointone / pointone;
	val = bfloat16::detail::fixed2bfloat16<std::round_to_nearest, 31, false, false, true>(result.m, result.exp + 126,
																						  possign);
	REQUIRE(0x3F80 == val); // 0x3F80 = 1.0 bf16
	result = pointfive / pointone;
	val = bfloat16::detail::fixed2bfloat16<std::round_to_nearest, 31, false, false, true>(result.m, result.exp + 126,
...
TEST_CASE("bfloat16_fma", "[float16]")
{
	...
	// ERRhandling / numeric Limits
	REQUIRE(isnan(bfloat16::fma(bfloat16::bfloat16(0), std::numeric_limits<bfloat16::bfloat16>::infinity(),
								bfloat16::bfloat16(2))));
	REQUIRE(isnan(bfloat16::fma(std::numeric_limits<bfloat16::bfloat16>::infinity(), bfloat16::bfloat16(0),
								bfloat16::bfloat16(2))));

	REQUIRE(isnan(bfloat16::fma(bfloat16::bfloat16(0), std::numeric_limits<bfloat16::bfloat16>::infinity(),
								std::numeric_limits<bfloat16::bfloat16>::quiet_NaN())));
	REQUIRE(isnan(bfloat16::fma(std::numeric_limits<bfloat16::bfloat16>::infinity(), bfloat16::bfloat16(0),
								std::numeric_limits<bfloat16::bfloat16>::quiet_NaN())));

	REQUIRE(isnan(bfloat16::fma(std::numeric_limits<bfloat16::bfloat16>::quiet_NaN(), bfloat16::bfloat16(2),
								bfloat16::bfloat16(2))));
	REQUIRE(isnan(bfloat16::fma(bfloat16::bfloat16(2), std::numeric_limits<bfloat16::bfloat16>::quiet_NaN(),
								bfloat16::bfloat16(2))));

	REQUIRE(isnan(bfloat16::fma(bfloat16::bfloat16(2), bfloat16::bfloat16(2),
								std::numeric_limits<bfloat16::bfloat16>::quiet_NaN())));
	REQUIRE(isnan(bfloat16::fma(bfloat16::bfloat16(2), bfloat16::bfloat16(2),
								std::numeric_limits<bfloat16::bfloat16>::quiet_NaN())));
	...
	REQUIRE(0x4250 ==
			bfloat16::fma(bfloat16::bfloat16(10), bfloat16::bfloat16(5), bfloat16::bfloat16(2))); // 0x4250 = 52.0 bf16
	REQUIRE(0x41C8 ==
			bfloat16::fma(bfloat16::bfloat16(10), bfloat16::bfloat16(2), bfloat16::bfloat16(5))); // 0x41C8 = 25.0 bf16
	REQUIRE(0x4250 ==
			bfloat16::fma(bfloat16::bfloat16(5), bfloat16::bfloat16(10), bfloat16::bfloat16(2))); // 0x4250 = 52.0 bf16
	REQUIRE(0x41A0 ==
			bfloat16::fma(bfloat16::bfloat16(5), bfloat16::bfloat16(2), bfloat16::bfloat16(10))); // 0x41A0 = 20.0 bf16
	REQUIRE(0x41C8 ==
			bfloat16::fma(bfloat16::bfloat16(2), bfloat16::bfloat16(10), bfloat16::bfloat16(5))); // 0x41C8 = 25.0 bf16
	REQUIRE(0x41A0 ==
			bfloat16::fma(bfloat16::bfloat16(2), bfloat16::bfloat16(5), bfloat16::bfloat16(10))); // 0x41A0 = 20.0 bf16

	// positive 2x negative 1x
	REQUIRE(0x4240 ==
			bfloat16::fma(bfloat16::bfloat16(10), bfloat16::bfloat16(5), bfloat16::bfloat16(-2))); // 0x4240 = 48.0 bf16
	REQUIRE(0x4170 ==
			bfloat16::fma(bfloat16::bfloat16(10), bfloat16::bfloat16(2), bfloat16::bfloat16(-5))); // 0x4170 = 15.0 bf16
	REQUIRE(0x4240 ==
			bfloat16::fma(bfloat16::bfloat16(5), bfloat16::bfloat16(10), bfloat16::bfloat16(-2))); // 0x4240 = 48.0 bf16
	REQUIRE(0x0 ==
			bfloat16::fma(bfloat16::bfloat16(5), bfloat16::bfloat16(2), bfloat16::bfloat16(-10))); // 0x0 = 0.0 bf16
	REQUIRE(0x4170 ==
			bfloat16::fma(bfloat16::bfloat16(2), bfloat16::bfloat16(10), bfloat16::bfloat16(-5))); // 0x4170 = 15.0 bf16
	REQUIRE(0x0 ==
			bfloat16::fma(bfloat16::bfloat16(2), bfloat16::bfloat16(5), bfloat16::bfloat16(-10))); // 0x0 = 0.0 bf16

	// positive 2x negative 1x
	REQUIRE(0xC240 == bfloat16::fma(bfloat16::bfloat16(10), bfloat16::bfloat16(-5),
									bfloat16::bfloat16(2))); // 0xC240 = -48.0 bf16
	REQUIRE(0xC170 == bfloat16::fma(bfloat16::bfloat16(10), bfloat16::bfloat16(-2),
									bfloat16::bfloat16(5))); // 0xC170 = -15.0 bf16
	REQUIRE(0xC240 == bfloat16::fma(bfloat16::bfloat16(5), bfloat16::bfloat16(-10),
									bfloat16::bfloat16(2))); // 0xC240 = -48.0 bf16
	REQUIRE(0x0 ==
			bfloat16::fma(bfloat16::bfloat16(5), bfloat16::bfloat16(-2), bfloat16::bfloat16(10))); // 0x0 = 0.0 bf16
	REQUIRE(0xC170 == bfloat16::fma(bfloat16::bfloat16(2), bfloat16::bfloat16(-10),
									bfloat16::bfloat16(5))); // 0xC170 = -15.0 bf16
	REQUIRE(0x0 ==
			bfloat16::fma(bfloat16::bfloat16(2), bfloat16::bfloat16(-5), bfloat16::bfloat16(10))); // 0x0 = 0.0 bf16
	...
	REQUIRE(0xC250 == bfloat16::fma(bfloat16::bfloat16(10), bfloat16::bfloat16(-5),
									bfloat16::bfloat16(-2))); // 0xC250 = -52.0 bf16
	REQUIRE(0xC1C8 == bfloat16::fma(bfloat16::bfloat16(10), bfloat16::bfloat16(-2),
									bfloat16::bfloat16(-5))); // 0xC1C8 = -25.0 bf16
	REQUIRE(0xC250 == bfloat16::fma(bfloat16::bfloat16(5), bfloat16::bfloat16(-10),
									bfloat16::bfloat16(-2))); // 0xC250 = -52.0 bf16
	REQUIRE(0xC1A0 == bfloat16::fma(bfloat16::bfloat16(5), bfloat16::bfloat16(-2),
									bfloat16::bfloat16(-10))); // 0xC1A0 = -20.0 bf16
	REQUIRE(0xC1C8 == bfloat16::fma(bfloat16::bfloat16(2), bfloat16::bfloat16(-10),
									bfloat16::bfloat16(-5))); // 0xC1C8 = -25.0 bf16
	REQUIRE(0xC1A0 == bfloat16::fma(bfloat16::bfloat16(2), bfloat16::bfloat16(-5),
									bfloat16::bfloat16(-10))); // 0xC1A0 = -20.0 bf16

	// positive 1x negative x2
	REQUIRE(0x4250 == bfloat16::fma(bfloat16::bfloat16(-10), bfloat16::bfloat16(-5),
									bfloat16::bfloat16(2))); // 0x4250 = 52.0 bf16
	REQUIRE(0x41C8 == bfloat16::fma(bfloat16::bfloat16(-10), bfloat16::bfloat16(-2),
									bfloat16::bfloat16(5))); // 0x41C8 = 25.0 bf16
	REQUIRE(0x4250 == bfloat16::fma(bfloat16::bfloat16(-5), bfloat16::bfloat16(-10),
									bfloat16::bfloat16(2))); // 0x4250 = 52.0 bf16
	REQUIRE(0x41A0 == bfloat16::fma(bfloat16::bfloat16(-5), bfloat16::bfloat16(-2),
									bfloat16::bfloat16(10))); // 0x41A0 = 20.0 bf16
	REQUIRE(0x41C8 == bfloat16::fma(bfloat16::bfloat16(-2), bfloat16::bfloat16(-10),
									bfloat16::bfloat16(5))); // 0x41C8 = 25.0 bf16
	REQUIRE(0x41A0 == bfloat16::fma(bfloat16::bfloat16(-2), bfloat16::bfloat16(-5),
									bfloat16::bfloat16(10))); // 0x41A0 = 20.0 bf16

	// positive 0x negative x3
	REQUIRE(0x4240 == bfloat16::fma(bfloat16::bfloat16(-10), bfloat16::bfloat16(-5),
									bfloat16::bfloat16(-2))); // 0x4240 = 48.0 bf16
	REQUIRE(0x4170 == bfloat16::fma(bfloat16::bfloat16(-10), bfloat16::bfloat16(-2),
									bfloat16::bfloat16(-5))); // 0x4170 = 15.0 bf16
	REQUIRE(0x4240 == bfloat16::fma(bfloat16::bfloat16(-5), bfloat16::bfloat16(-10),
									bfloat16::bfloat16(-2))); // 0x4240 = 48.0 bf16
	REQUIRE(0x0 ==
			bfloat16::fma(bfloat16::bfloat16(-5), bfloat16::bfloat16(-2), bfloat16::bfloat16(-10))); // 0x0 = 0.0 bf16
	REQUIRE(0x4170 == bfloat16::fma(bfloat16::bfloat16(-2), bfloat16::bfloat16(-10),
									bfloat16::bfloat16(-5))); // 0x4170 = 15.0 bf16
	REQUIRE(0x0 ==
			bfloat16::fma(bfloat16::bfloat16(-2), bfloat16::bfloat16(-5), bfloat16::bfloat16(-10))); // 0x0 = 0.0 bf16
}
...
TEST_CASE("bfloat16_fmax", "[float16]")
{
	...
	REQUIRE(isnan(bfloat16::fmax(std::numeric_limits<bfloat16::bfloat16>::quiet_NaN(),
								 std::numeric_limits<bfloat16::bfloat16>::quiet_NaN())));
...
TEST_CASE("bfloat16_fmin", "[float16]")
{
	...
	REQUIRE(isnan(bfloat16::fmin(std::numeric_limits<bfloat16::bfloat16>::quiet_NaN(),
								 std::numeric_limits<bfloat16::bfloat16>::quiet_NaN())));
...
TEST_CASE("bfloat16_hypot2", "[float16]")
{
	...
	REQUIRE(isnan(bfloat16::hypot(std::numeric_limits<bfloat16::bfloat16>::quiet_NaN(),
								  std::numeric_limits<bfloat16::bfloat16>::quiet_NaN())));
...
TEST_CASE("bfloat16_hypot3", "[float16]")
{
	...
	REQUIRE(isnan(bfloat16::hypot(bfloat16::bfloat16(2), std::numeric_limits<bfloat16::bfloat16>::quiet_NaN(),
								  bfloat16::bfloat16(2))));
	REQUIRE(isnan(bfloat16::hypot(bfloat16::bfloat16(2), bfloat16::bfloat16(2),
								  std::numeric_limits<bfloat16::bfloat16>::quiet_NaN())));
	REQUIRE(isnan(bfloat16::hypot(std::numeric_limits<bfloat16::bfloat16>::quiet_NaN(),
								  std::numeric_limits<bfloat16::bfloat16>::quiet_NaN(), bfloat16::bfloat16(2))));
	REQUIRE(isnan(bfloat16::hypot(std::numeric_limits<bfloat16::bfloat16>::quiet_NaN(), bfloat16::bfloat16(2),
								  std::numeric_limits<bfloat16::bfloat16>::quiet_NaN())));
	REQUIRE(isnan(bfloat16::hypot(bfloat16::bfloat16(2), std::numeric_limits<bfloat16::bfloat16>::quiet_NaN(),
								  std::numeric_limits<bfloat16::bfloat16>::quiet_NaN())));
	...
	// positive 3x
	REQUIRE(0x0 ==
			bfloat16::hypot(bfloat16::bfloat16(0), bfloat16::bfloat16(0), bfloat16::bfloat16(0))); // 0x0 = 0.0 bf16
	REQUIRE(0x40E2 == bfloat16::hypot(bfloat16::bfloat16(3), bfloat16::bfloat16(4),
									  bfloat16::bfloat16(5))); // 0x40E2 = 7.0625 bf16
	REQUIRE(0x40E2 == bfloat16::hypot(bfloat16::bfloat16(3), bfloat16::bfloat16(5),
									  bfloat16::bfloat16(4))); // 0x40E2 = 7.0625 bf16
	REQUIRE(0x40E2 == bfloat16::hypot(bfloat16::bfloat16(4), bfloat16::bfloat16(5),
									  bfloat16::bfloat16(3))); // 0x40E2 = 7.0625 bf16
	REQUIRE(0x40E2 == bfloat16::hypot(bfloat16::bfloat16(4), bfloat16::bfloat16(3),
									  bfloat16::bfloat16(5))); // 0x40E2 = 7.0625 bf16
	REQUIRE(0x40E2 == bfloat16::hypot(bfloat16::bfloat16(5), bfloat16::bfloat16(4),
									  bfloat16::bfloat16(3))); // 0x40E2 = 7.0625 bf16
	REQUIRE(0x40E2 == bfloat16::hypot(bfloat16::bfloat16(5), bfloat16::bfloat16(3),
									  bfloat16::bfloat16(4))); // 0x40E2 = 7.0625 bf16
...
TEST_CASE("bfloat16_pow", "[float16]")
{
	...
	REQUIRE(isnan(bfloat16::pow(std::numeric_limits<bfloat16::bfloat16>::quiet_NaN(),
								std::numeric_limits<bfloat16::bfloat16>::quiet_NaN())));
...
TEST_CASE("bfloat16_atan2", "[float16]")
{
	...
	REQUIRE(0x4016 == bfloat16::atan2(std::numeric_limits<bfloat16::bfloat16>::infinity(),
									  -std::numeric_limits<bfloat16::bfloat16>::infinity()));
	REQUIRE(0xC016 == bfloat16::atan2(-std::numeric_limits<bfloat16::bfloat16>::infinity(),
									  -std::numeric_limits<bfloat16::bfloat16>::infinity()));

	REQUIRE(0x3F49 == bfloat16::atan2(std::numeric_limits<bfloat16::bfloat16>::infinity(),
									  std::numeric_limits<bfloat16::bfloat16>::infinity()));
	REQUIRE(0xBF49 == bfloat16::atan2(-std::numeric_limits<bfloat16::bfloat16>::infinity(),
									  std::numeric_limits<bfloat16::bfloat16>::infinity()));
	...
	REQUIRE(isnan(bfloat16::atan2(std::numeric_limits<bfloat16::bfloat16>::quiet_NaN(),
								  std::numeric_limits<bfloat16::bfloat16>::quiet_NaN())));
	...
	// negative
	REQUIRE(0xBE49 ==
			bfloat16::atan2(bfloat16::bfloat16(-0.4), bfloat16::bfloat16(2.0))); // 0xBE49 = -0.1962890625 bf16
...
TEST_CASE("bfloat16_isunordered", "[float16]")
{
	...
	// ERRhandling / numeric Limits
	REQUIRE(true == bfloat16::isunordered(std::numeric_limits<bfloat16::bfloat16>::quiet_NaN(),
										  std::numeric_limits<bfloat16::bfloat16>::quiet_NaN()));
