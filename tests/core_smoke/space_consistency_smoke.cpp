...
int main()
{
    ...
    static_assert(std::is_same_v<metric::MatrixSpace<int, AbsoluteDistance>, metric::Matrix<int, AbsoluteDistance>>);
    static_assert(std::is_same_v<metric::TreeSpace<int, AbsoluteDistance>, metric::Tree<int, AbsoluteDistance>>);
    static_assert(std::is_same_v<metric::GraphSpace<int, AbsoluteDistance>, metric::KNNGraph<int, AbsoluteDistance>>);
