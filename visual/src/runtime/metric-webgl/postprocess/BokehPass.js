import {
	...
	UniformsUtils,
	WebGLRenderTarget
} from '../core/metric-webgl.module.js';
...
var BokehPass = function ( scene, camera, params ) {
	...
	if ( BokehShader === undefined ) {
		...
		console.error( 'MGL.BokehPass relies on BokehShader' );
...
BokehPass.prototype = Object.assign( Object.create( Pass.prototype ), {
	...
	render: function ( renderer, writeBuffer, readBuffer/*, deltaTime, maskActive*/ ) {
		...
		this.scene.traverse( function ( object ) {
			...
			if ( object.userData && object.userData.excludeFromDofDepth === true && object.visible === true ) {

				hiddenForDepth.push( object );
		...
		for ( var i = 0; i < hiddenForDepth.length; i ++ ) {

			hiddenForDepth[ i ].visible = true;
