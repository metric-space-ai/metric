...
- **WS-10 Hygiene:** [x] SOM/KOC/DSPCC `[[deprecated]]`-Konstruktoren · [~] KOC aus engine.hpp (Scope-Doku) · [x] Quarantäne `[[deprecated]]` (RandomEMD/CramervonMises/KolmogorovSmirnov) · [~] Python Nicht-Metriken/RandomEMD (dokumentiert; Guard = Rebuild) · [x] mapping.hpp-Banner · [x] Scope-Doku.
