 ...
 */
template <typename value_type> class DetSwitchDetector {
  ...
  public:
	 ...
	 */
	DetSwitchDetector(const size_t wnd_size_ = 15, const value_type update_rate_ = 0.0025, const value_type w_r = 2,
					  const value_type w_g = 2, const value_type w_b = 2, const value_type w_s = 15,
					  const value_type magn = 0.002, const value_type rgb_offs = -5, const value_type s_offs = 0,
					  const value_type rgb_wo = 1, const value_type s_wo = 2);
