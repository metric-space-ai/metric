...
#ifndef METRIC_NUMERIC_MATH_DIAGONALMATRIX_H
#define METRIC_NUMERIC_MATH_DIAGONALMATRIX_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class Rand<DiagonalMatrix<MT, SO, DF>> {
  public:
	...
	*/
	template <typename Arg> // Min/max argument type
	inline const DiagonalMatrix<MT, SO, DF> generate(size_t n, size_t nonzeros, const Arg &min, const Arg &max) const
	{
		METRIC_NUMERIC_CONSTRAINT_MUST_BE_RESIZABLE_TYPE(MT);
		METRIC_NUMERIC_CONSTRAINT_MUST_BE_SPARSE_MATRIX_TYPE(MT);
	...
	*/
	template <typename Arg> // Min/max argument type
	inline void randomize(DiagonalMatrix<MT, SO, DF> &matrix, size_t nonzeros, const Arg &min, const Arg &max) const
	{
		METRIC_NUMERIC_CONSTRAINT_MUST_BE_SPARSE_MATRIX_TYPE(MT);
