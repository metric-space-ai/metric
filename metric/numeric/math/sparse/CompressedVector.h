...
#ifndef METRIC_NUMERIC_MATH_SPARSE_COMPRESSEDVECTOR_H
#define METRIC_NUMERIC_MATH_SPARSE_COMPRESSEDVECTOR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
#include <metric/numeric/math/sparse/VectorAccessProxy.h>
...
//  - TF  : specifies whether the vector is a row vector (\a mtrc::numeric::rowVector) or a column
//          vector (\a mtrc::numeric::columnVector). The default value is \a mtrc::numeric::defaultTransposeFlag.
//  - Tag : optional type parameter to tag the vector. The default type is \a mtrc::numeric::Group0.
...
class CompressedVector : public SparseVector<CompressedVector<Type, TF, Tag>, TF> {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	template <typename Pred, typename = DisableIf_t<IsIntegral_v<Pred>>> inline void erase(Pred predicate);

	template <typename Pred> inline void erase(Iterator first, Iterator last, Pred predicate);
	//@}
	//**********************************************************************************************
...
// vector within a constructor call:
   ...
   \code
   mtrc::numeric::CompressedVector<double> v1{ 4.2, 6.3, -1.2 };
   \endcode
...
inline CompressedVector<Type, TF, Tag>::CompressedVector(initializer_list<Type> list)
	: CompressedVector(list.size(), mtrc::numeric::nonZeros(list))
{
	size_t i(0UL);
...
template <typename Type // Data type of the vector
		  ...
		  ,
		  typename Tag> // Type tag
template <typename VT>	// Type of the other dense vector
inline CompressedVector<Type, TF, Tag>::CompressedVector(const DenseVector<VT, TF> &dv) : CompressedVector((*dv).size())
{
...
template <typename Type // Data type of the vector
		  ...
		  ,
		  typename Tag> // Type tag
template <typename VT>	// Type of the other sparse vector
...
{
	METRIC_NUMERIC_USER_ASSERT(index < size_, "Invalid compressed vector access index");
...
template <typename Type // Data type of the vector
		  ...
		  ,
		  typename Tag> // Type tag
inline typename CompressedVector<Type, TF, Tag>::Reference CompressedVector<Type, TF, Tag>::at(size_t index)
{
	if (index >= size_) {
		METRIC_NUMERIC_THROW_OUT_OF_RANGE("Invalid compressed vector access index");
	}
	return (*this)[index];
}
//*************************************************************************************************
...
template <typename Type // Data type of the vector
		  ...
		  ,
		  typename Tag> // Type tag
inline typename CompressedVector<Type, TF, Tag>::ConstReference CompressedVector<Type, TF, Tag>::at(size_t index) const
{
	if (index >= size_) {
		METRIC_NUMERIC_THROW_OUT_OF_RANGE("Invalid compressed vector access index");
	}
...
template <typename Type // Data type of the vector
		  ...
		  ,
		  typename Tag> // Type tag
inline typename CompressedVector<Type, TF, Tag>::Iterator CompressedVector<Type, TF, Tag>::begin() noexcept
{
...
template <typename Type // Data type of the vector
		  ...
		  ,
		  typename Tag> // Type tag
inline typename CompressedVector<Type, TF, Tag>::ConstIterator CompressedVector<Type, TF, Tag>::begin() const noexcept
{
...
template <typename Type // Data type of the vector
		  ...
		  ,
		  typename Tag> // Type tag
inline typename CompressedVector<Type, TF, Tag>::ConstIterator CompressedVector<Type, TF, Tag>::cbegin() const noexcept
{
	return ConstIterator(begin_);
}
//*************************************************************************************************
...
template <typename Type // Data type of the vector
		  ...
		  ,
		  typename Tag> // Type tag
inline typename CompressedVector<Type, TF, Tag>::Iterator CompressedVector<Type, TF, Tag>::end() noexcept
{
...
template <typename Type // Data type of the vector
		  ...
		  ,
		  typename Tag> // Type tag
inline typename CompressedVector<Type, TF, Tag>::ConstIterator CompressedVector<Type, TF, Tag>::end() const noexcept
{
...
template <typename Type // Data type of the vector
		  ...
		  ,
		  typename Tag> // Type tag
inline typename CompressedVector<Type, TF, Tag>::ConstIterator CompressedVector<Type, TF, Tag>::cend() const noexcept
{
	return ConstIterator(end_);
}
//*************************************************************************************************
...
// by means of an initializer list:
   ...
   \code
   mtrc::numeric::CompressedVector<double> v;
   v = { 4.2, 6.3, -1.2 };
   \endcode
...
template <typename Type // Data type of the vector
		  ...
		  ,
		  typename Tag> // Type tag
inline CompressedVector<Type, TF, Tag> &CompressedVector<Type, TF, Tag>::operator=(initializer_list<Type> list) &
{
...
template <typename Type // Data type of the vector
		  ...
		  ,
		  typename Tag> // Type tag
inline CompressedVector<Type, TF, Tag> &CompressedVector<Type, TF, Tag>::operator=(const CompressedVector &rhs) &
{
	using std::swap;
...
template <typename Type // Data type of the vector
		  ...
		  ,
		  typename Tag> // Type tag
inline CompressedVector<Type, TF, Tag> &CompressedVector<Type, TF, Tag>::operator=(CompressedVector &&rhs) & noexcept
{
	deallocate(begin_);
...
inline CompressedVector<Type, TF, Tag> &CompressedVector<Type, TF, Tag>::operator=(const DenseVector<VT, TF> &rhs) &
{
	using mtrc::numeric::assign;
...
inline CompressedVector<Type, TF, Tag> &CompressedVector<Type, TF, Tag>::operator=(const SparseVector<VT, TF> &rhs) &
{
	using mtrc::numeric::assign;
...
inline CompressedVector<Type, TF, Tag> &CompressedVector<Type, TF, Tag>::operator+=(const Vector<VT, TF> &rhs) &
{
...
inline size_t CompressedVector<Type, TF, Tag>::extendCapacity() const noexcept
{
	...
	METRIC_NUMERIC_INTERNAL_ASSERT(nonzeros > capacity_, "Invalid capacity value");
...
template <typename Type // Data type of the vector
		  ...
		  ,
		  typename Tag> // Type tag
inline typename CompressedVector<Type, TF, Tag>::Iterator CompressedVector<Type, TF, Tag>::set(size_t index,
																							   const Type &value)
{
	METRIC_NUMERIC_USER_ASSERT(index < size_, "Invalid compressed vector access index");
...
template <typename Type // Data type of the vector
		  ...
		  ,
		  typename Tag> // Type tag
typename CompressedVector<Type, TF, Tag>::Iterator CompressedVector<Type, TF, Tag>::insert(size_t index,
																						   const Type &value)
{
	METRIC_NUMERIC_USER_ASSERT(index < size_, "Invalid compressed vector access index");
	...
	if (pos != end_ && pos->index_ == index) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Invalid compressed vector access index");
	}
...
template <typename Type // Data type of the vector
		  ...
		  ,
		  typename Tag> // Type tag
typename CompressedVector<Type, TF, Tag>::Iterator CompressedVector<Type, TF, Tag>::insert(Iterator pos, size_t index,
																						   const Type &value)
{
	using std::swap;
...
{
	METRIC_NUMERIC_USER_ASSERT(index < size_, "Invalid compressed vector access index");
	METRIC_NUMERIC_USER_ASSERT(nonZeros() < capacity(), "Not enough reserved capacity");
	METRIC_NUMERIC_USER_ASSERT(begin_ == end_ || (end_ - 1UL)->index_ < index, "Index is not strictly increasing");
...
template <typename Type // Data type of the vector
		  ...
		  ,
		  typename Tag> // Type tag
inline typename CompressedVector<Type, TF, Tag>::Iterator CompressedVector<Type, TF, Tag>::erase(Iterator pos)
{
	METRIC_NUMERIC_USER_ASSERT(pos >= begin_ && pos <= end_, "Invalid compressed vector iterator");
...
template <typename Type // Data type of the vector
		  ...
		  ,
		  typename Tag> // Type tag
inline typename CompressedVector<Type, TF, Tag>::Iterator CompressedVector<Type, TF, Tag>::erase(Iterator first,
																								 Iterator last)
{
	METRIC_NUMERIC_USER_ASSERT(first <= last, "Invalid iterator range");
	METRIC_NUMERIC_USER_ASSERT(first >= begin_ && first <= end_, "Invalid compressed vector iterator");
	METRIC_NUMERIC_USER_ASSERT(last >= begin_ && last <= end_, "Invalid compressed vector iterator");
...
{
	end_ = castDown(std::remove_if(castUp(begin_), castUp(end_), [predicate = predicate](const ElementBase &element) {
...
template <typename Type // Data type of the vector
		  ...
		  ,
		  typename Tag> // Type tag
inline typename CompressedVector<Type, TF, Tag>::Iterator CompressedVector<Type, TF, Tag>::find(size_t index)
{
...
template <typename Type // Data type of the vector
		  ...
		  ,
		  typename Tag> // Type tag
inline typename CompressedVector<Type, TF, Tag>::ConstIterator CompressedVector<Type, TF, Tag>::find(size_t index) const
{
	const ConstIterator pos(lowerBound(index));
	if (pos != end_ && pos->index_ == index)
		return pos;
...
template <typename Type // Data type of the vector
		  ...
		  ,
		  typename Tag> // Type tag
inline typename CompressedVector<Type, TF, Tag>::Iterator CompressedVector<Type, TF, Tag>::lowerBound(size_t index)
{
...
{
	return std::lower_bound(begin_, end_, index, [](const Element &element, size_t i) { return element.index() < i; });
}
//*************************************************************************************************
...
template <typename Type // Data type of the vector
		  ...
		  ,
		  typename Tag> // Type tag
inline typename CompressedVector<Type, TF, Tag>::Iterator CompressedVector<Type, TF, Tag>::upperBound(size_t index)
{
...
{
	return std::upper_bound(begin_, end_, index, [](size_t i, const Element &element) { return i < element.index(); });
}
//*************************************************************************************************
...
// multiplication assignment operator:
   ...
   \code
   mtrc::numeric::CompressedVector<int> a;
   // ... Resizing and initialization
...
inline void CompressedVector<Type, TF, Tag>::addAssign(const DenseVector<VT, TF> &rhs)
{
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_DENSE_VECTOR_TYPE(AddType);
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_VECTOR_WITH_TRANSPOSE_FLAG(AddType, TF);
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_REFERENCE_TYPE(CompositeType_t<AddType>);
...
inline void CompressedVector<Type, TF, Tag>::subAssign(const DenseVector<VT, TF> &rhs)
{
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_DENSE_VECTOR_TYPE(SubType);
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_VECTOR_WITH_TRANSPOSE_FLAG(SubType, TF);
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_REFERENCE_TYPE(CompositeType_t<SubType>);
...
template <typename Type, bool TF, typename Tag> bool isIntact(const CompressedVector<Type, TF, Tag> &v) noexcept;
...
struct AddTraitEval2<T1, T2, EnableIf_t<IsSparseVector_v<T1> && IsSparseVector_v<T2>>> {
	using Type = CompressedVector<AddTrait_t<ElementType_t<T1>, ElementType_t<T2>>, TransposeFlag_v<T1>,
...
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename T1, typename T2>
struct SubTraitEval2<T1, T2, EnableIf_t<IsSparseVector_v<T1> && IsSparseVector_v<T2>>> {
	using Type = CompressedVector<SubTrait_t<ElementType_t<T1>, ElementType_t<T2>>, TransposeFlag_v<T1>,
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename T1, typename T2> struct MultTraitEval2<T1, T2, EnableIf_t<IsSparseVector_v<T1> && IsScalar_v<T2>>> {
	using Type =
		CompressedVector<MultTrait_t<ElementType_t<T1>, T2>, TransposeFlag_v<T1>, MultTrait_t<TagType_t<T1>, T2>>;
};

template <typename T1, typename T2> struct MultTraitEval2<T1, T2, EnableIf_t<IsScalar_v<T1> && IsSparseVector_v<T2>>> {
	using Type =
		CompressedVector<MultTrait_t<T1, ElementType_t<T2>>, TransposeFlag_v<T2>, MultTrait_t<T1, TagType_t<T2>>>;
};
...
struct MultTraitEval2<
	...
	using Type = CompressedVector<MultTrait_t<ElementType_t<T1>, ElementType_t<T2>>, TransposeFlag_v<T1>,
								  MultTrait_t<TagType_t<T1>, TagType_t<T2>>>;
};

template <typename T1, typename T2>
struct MultTraitEval2<T1, T2, EnableIf_t<IsSparseMatrix_v<T1> && IsSparseVector_v<T2> && IsColumnVector_v<T2>>> {
	using MultType = MultTrait_t<ElementType_t<T1>, ElementType_t<T2>>;
	using MultTag = MultTrait_t<TagType_t<T1>, TagType_t<T2>>;

	using Type = CompressedVector<AddTrait_t<MultType, MultType>, false, AddTrait_t<MultTag, MultTag>>;
};

template <typename T1, typename T2>
struct MultTraitEval2<T1, T2, EnableIf_t<IsSparseVector_v<T1> && IsRowVector_v<T1> && IsSparseMatrix_v<T2>>> {
	using MultType = MultTrait_t<ElementType_t<T1>, ElementType_t<T2>>;
	using MultTag = MultTrait_t<TagType_t<T1>, TagType_t<T2>>;

	using Type = CompressedVector<AddTrait_t<MultType, MultType>, true, AddTrait_t<MultTag, MultTag>>;
};
/*! \endcond */
//*************************************************************************************************
...
struct KronTraitEval2<T1, T2,
					  EnableIf_t<IsVector_v<T1> && IsVector_v<T2> && (IsSparseVector_v<T1> || IsSparseVector_v<T2>)>> {
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename T1, typename T2> struct DivTraitEval2<T1, T2, EnableIf_t<IsSparseVector_v<T1> && IsScalar_v<T2>>> {
	using Type =
		CompressedVector<DivTrait_t<ElementType_t<T1>, T2>, TransposeFlag_v<T1>, DivTrait_t<TagType_t<T1>, T2>>;
};

template <typename T1, typename T2>
struct DivTraitEval2<T1, T2, EnableIf_t<IsSparseVector_v<T1> && IsDenseVector_v<T2>>> {
	using Type = CompressedVector<DivTrait_t<ElementType_t<T1>, ElementType_t<T2>>, TransposeFlag_v<T1>,
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename T, typename OP> struct UnaryMapTraitEval2<T, OP, EnableIf_t<IsSparseVector_v<T>>> {
	using ElementType = decltype(std::declval<OP>()(std::declval<ElementType_t<T>>()));

	using Type = CompressedVector<EvaluateTrait_t<ElementType>, TransposeFlag_v<T>, MapTrait_t<TagType_t<T>, OP>>;
};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename T, size_t R0> struct RepeatTraitEval2<T, R0, inf, inf, EnableIf_t<IsSparseVector_v<T>>> {
	using Type = CompressedVector<ElementType_t<T>, TransposeFlag_v<T>, TagType_t<T>>;
};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename VT, size_t I, size_t N> struct SubvectorTraitEval2<VT, I, N, EnableIf_t<IsSparseVector_v<VT>>> {
	using Type = CompressedVector<RemoveConst_t<ElementType_t<VT>>, TransposeFlag_v<VT>, TagType_t<VT>>;
};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename VT, size_t N> struct ElementsTraitEval2<VT, N, EnableIf_t<IsSparseVector_v<VT>>> {
	using Type = CompressedVector<RemoveConst_t<ElementType_t<VT>>, TransposeFlag_v<VT>, TagType_t<VT>>;
};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, size_t I> struct RowTraitEval2<MT, I, EnableIf_t<IsSparseMatrix_v<MT>>> {
	using Type = CompressedVector<RemoveConst_t<ElementType_t<MT>>, true, TagType_t<MT>>;
};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, size_t I> struct ColumnTraitEval2<MT, I, EnableIf_t<IsSparseMatrix_v<MT>>> {
	using Type = CompressedVector<RemoveConst_t<ElementType_t<MT>>, false, TagType_t<MT>>;
};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, ptrdiff_t I> struct BandTraitEval2<MT, I, EnableIf_t<IsSparseMatrix_v<MT>>> {
	using Type = CompressedVector<RemoveConst_t<ElementType_t<MT>>, defaultTransposeFlag, TagType_t<MT>>;
};
/*! \endcond */
//*************************************************************************************************
