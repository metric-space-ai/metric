...
#ifndef METRIC_NUMERIC_MATH_SPARSE_VALUEINDEXPAIR_H
#define METRIC_NUMERIC_MATH_SPARSE_VALUEINDEXPAIR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
#include <metric/numeric/util/mpl/Not.h>
...
class ValueIndexPair : private SparseElement {
  public:
	...
	constexpr auto operator=(Other &&rhs)
		-> EnableIf_t<IsSparseElement_v<RemoveReference_t<Other>> && IsRValueReference_v<Other &&>, ValueIndexPair &>;
...
*/
template <typename Type> // Type of the value element
constexpr typename ValueIndexPair<Type>::Reference ValueIndexPair<Type>::value() noexcept
{
	return value_;
}
//*************************************************************************************************
...
*/
template <typename Type> // Type of the value element
constexpr typename ValueIndexPair<Type>::ConstReference ValueIndexPair<Type>::value() const noexcept
{
	return value_;
}
//*************************************************************************************************
...
*/
template <typename Type> // Type of the value element
constexpr typename ValueIndexPair<Type>::IndexType ValueIndexPair<Type>::index() const noexcept
{
	return index_;
}
//*************************************************************************************************
