...
#ifndef METRIC_NUMERIC_MATH_SPARSE_VECTORACCESSPROXY_H
#define METRIC_NUMERIC_MATH_SPARSE_VECTORACCESSPROXY_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
// this with two examples by means of the CompressedVector class:
   ...
   \code
   mtrc::numeric::CompressedVector<double> a( 5 );
...
class VectorAccessProxy : public Proxy<VectorAccessProxy<VT>, ElementType_t<VT>> {
  public:
	//**Type definitions****************************************************************************
	...
	template <typename T> inline const VectorAccessProxy &operator=(initializer_list<T> list) const;

	template <typename T> inline const VectorAccessProxy &operator=(initializer_list<initializer_list<T>> list) const;
...
inline const VectorAccessProxy<VT> &VectorAccessProxy<VT>::operator=(initializer_list<T> list) const
{
	get() = list;
	return *this;
}
...
template <typename VT> // Type of the sparse vector
template <typename T>  // Type of the right-hand side elements
inline const VectorAccessProxy<VT> &VectorAccessProxy<VT>::operator=(initializer_list<initializer_list<T>> list) const
{
	get() = list;
	return *this;
}
...
inline typename VectorAccessProxy<VT>::RawReference VectorAccessProxy<VT>::get() const noexcept
{
	...
	METRIC_NUMERIC_INTERNAL_ASSERT(element != sv_.end(), "Missing vector element detected");
...
//@{
template <typename VT> void swap(const VectorAccessProxy<VT> &a, const VectorAccessProxy<VT> &b) noexcept;

template <typename VT, typename T> void swap(const VectorAccessProxy<VT> &a, T &b) noexcept;

template <typename T, typename VT> void swap(T &a, const VectorAccessProxy<VT> &v) noexcept;
//@}
//*************************************************************************************************
...
// \return void
*/
template <typename VT> inline void swap(const VectorAccessProxy<VT> &a, const VectorAccessProxy<VT> &b) noexcept
{
	using std::swap;
...
// \return void
*/
template <typename VT, typename T> inline void swap(const VectorAccessProxy<VT> &a, T &b) noexcept
{
	using std::swap;
...
// \return void
*/
template <typename T, typename VT> inline void swap(T &a, const VectorAccessProxy<VT> &b) noexcept
{
	using std::swap;
