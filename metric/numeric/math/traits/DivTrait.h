...
#ifndef METRIC_NUMERIC_MATH_TRAITS_DIVTRAIT_H
#define METRIC_NUMERIC_MATH_TRAITS_DIVTRAIT_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
struct DivTrait : public decltype(evalDivTrait(std::declval<T1 &>(), std::declval<T2 &>())){};
//*************************************************************************************************
...
// \ingroup math_traits
*/
template <typename T1, typename T2> struct DivTrait<T1, T2, EnableIf_t<IsNumeric_v<T1> && IsNumeric_v<T2>>> {
  public:
	//**********************************************************************************************
...
// two type definitions are identical:
   ...
   \code
   using Type1 = typename mtrc::numeric::DivTrait<T1,T2>::Type;
   using Type2 = mtrc::numeric::DivTrait_t<T1,T2>;
   \endcode
*/
template <typename T1, typename T2> using DivTrait_t = typename DivTrait<T1, T2>::Type;
//*************************************************************************************************
...
template <typename T1 // Type of the left-hand side operand
		  ...
		  ,
		  typename> // Restricting condition
struct DivTraitEval1 : public DivTraitEval2<T1, T2> {};
/*! \endcond */
//*************************************************************************************************
...
// \ingroup math_traits
*/
template <size_t ID> struct DivTraitEval1<GroupTag<ID>, GroupTag<ID>, void> {
  public:
	//**********************************************************************************************
...
// \ingroup math_traits
*/
template <size_t ID, typename T2> struct DivTraitEval1<GroupTag<ID>, T2> {
  public:
	//**********************************************************************************************
	using Type = GroupTag<ID>;
	//**********************************************************************************************
...
template <typename T1 // Type of the left-hand side operand
		  ...
		  ,
		  typename> // Restricting condition
struct DivTraitEval2 : public DivTraitEval3<T1, T2> {};
/*! \endcond */
//*************************************************************************************************
...
template <typename T1 // Type of the left-hand side operand
		  ,
		  typename T2> // Type of the right-hand side operand
struct DivTraitEval3<T1, T2, Void_t<decltype(std::declval<T1>() / std::declval<T2>())>> {
  public:
	//**********************************************************************************************
