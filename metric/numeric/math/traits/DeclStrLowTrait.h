...
#ifndef METRIC_NUMERIC_MATH_TRAITS_DECLSTRLOWTRAIT_H
#define METRIC_NUMERIC_MATH_TRAITS_DECLSTRLOWTRAIT_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename T> auto evalDeclStrLowTrait(const volatile T &) -> DeclStrLowTraitEval<T>;
/*! \endcond */
//*************************************************************************************************
...
//
// Per default, DeclStrLowTrait supports all matrix types of the Metric numeric library (including views
...
// on the given matrix type the resulting type is selected:
   ...
   using mtrc::numeric::DeclStrLowTrait;
...
struct DeclStrLowTrait : public decltype(evalDeclStrLowTrait(std::declval<MT &>())){};
//*************************************************************************************************
...
// following two type definitions are identical:
   ...
   \code
   using Type1 = typename mtrc::numeric::DeclStrLowTrait<MT>::Type;
   using Type2 = mtrc::numeric::DeclStrLowTrait_t<MT>;
   \endcode
*/
template <typename MT> // Type of the matrix
