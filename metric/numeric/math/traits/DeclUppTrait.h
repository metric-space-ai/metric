...
#ifndef METRIC_NUMERIC_MATH_TRAITS_DECLUPPTRAIT_H
#define METRIC_NUMERIC_MATH_TRAITS_DECLUPPTRAIT_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename T> auto evalDeclUppTrait(const volatile T &) -> DeclUppTraitEval<T>;
/*! \endcond */
//*************************************************************************************************
...
//
// Per default, DeclUppTrait supports all matrix types of the Metric numeric library (including views and
...
// the given matrix type the resulting type is selected:
   ...
   using mtrc::numeric::DeclUppTrait;
...
struct DeclUppTrait : public decltype(evalDeclUppTrait(std::declval<MT &>())){};
//*************************************************************************************************
...
// following two type definitions are identical:
   ...
   \code
   using Type1 = typename mtrc::numeric::DeclUppTrait<MT>::Type;
   using Type2 = mtrc::numeric::DeclUppTrait_t<MT>;
   \endcode
*/
template <typename MT> // Type of the matrix
