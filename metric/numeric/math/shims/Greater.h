...
#ifndef METRIC_NUMERIC_MATH_SHIMS_GREATER_H
#define METRIC_NUMERIC_MATH_SHIMS_GREATER_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
*/
template <typename T>
METRIC_NUMERIC_ALWAYS_INLINE constexpr bool greater_backend(const T &a, const T &b) noexcept(IsBuiltin_v<T>)
{
	return a > b;
}
/*! \endcond */
...
*/
METRIC_NUMERIC_ALWAYS_INLINE constexpr bool greater_backend(float a, float b) noexcept { return (b - a) > 1E-8F; }
/*! \endcond */
//*************************************************************************************************
...
// a certain accuracy margin.
*/
METRIC_NUMERIC_ALWAYS_INLINE constexpr bool greater_backend(double a, double b) noexcept { return (b - a) > 1E-8; }
/*! \endcond */
//*************************************************************************************************
...
*/
METRIC_NUMERIC_ALWAYS_INLINE constexpr bool greater_backend(long double a, long double b) noexcept
{
	return (b - a) > 1E-10L;
}
/*! \endcond */
...
METRIC_NUMERIC_ALWAYS_INLINE constexpr bool greater(const T1 &a,
													const T2 &b) noexcept(IsBuiltin_v<CommonType_t<T1, T2>>)
{
