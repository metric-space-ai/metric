...
#ifndef METRIC_NUMERIC_MATH_DENSE_DENSEITERATOR_H
#define METRIC_NUMERIC_MATH_DENSE_DENSEITERATOR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DenseIterator {
  public:
	...
	/*!\name Constructors */
	//@{
	explicit constexpr DenseIterator() noexcept;
	explicit constexpr DenseIterator(Type *ptr) noexcept;

	template <typename Other, AlignmentFlag AF2> constexpr DenseIterator(const DenseIterator<Other, AF2> &it) noexcept;
...
template <typename Type // Type of the elements
		  ,
		  AlignmentFlag AF>													// Alignment flag
constexpr DenseIterator<Type, AF>::DenseIterator() noexcept : ptr_(nullptr) // Pointer to the current element
{
}
//*************************************************************************************************
...
template <typename Type // Type of the elements
		  ,
		  AlignmentFlag AF>														 // Alignment flag
constexpr DenseIterator<Type, AF>::DenseIterator(Type *ptr) noexcept : ptr_(ptr) // Pointer to the current element
{
}
//*************************************************************************************************
...
//
// \param it The other DenseIterator instance to be copied.
*/
template <typename Type // Type of the elements
		  ,
		  AlignmentFlag AF> // Alignment flag
template <typename Other	// Type of the other elements
		  ,
		  AlignmentFlag AF2> // Alignment flag of the other iterator
constexpr DenseIterator<Type, AF>::DenseIterator(const DenseIterator<Other, AF2> &it) noexcept
...
template <typename Type // Type of the elements
		  ,
		  AlignmentFlag AF> // Alignment flag
constexpr DenseIterator<Type, AF> &DenseIterator<Type, AF>::operator+=(ptrdiff_t inc) noexcept
{
	ptr_ += inc;
	return *this;
}
...
template <typename Type // Type of the elements
		  ,
		  AlignmentFlag AF> // Alignment flag
constexpr DenseIterator<Type, AF> &DenseIterator<Type, AF>::operator-=(ptrdiff_t dec) noexcept
{
	ptr_ -= dec;
	return *this;
}
...
template <typename Type // Type of the elements
		  ,
		  AlignmentFlag AF> // Alignment flag
constexpr DenseIterator<Type, AF> &DenseIterator<Type, AF>::operator++() noexcept
{
	++ptr_;
	return *this;
}
...
template <typename Type // Type of the elements
		  ,
		  AlignmentFlag AF> // Alignment flag
constexpr const DenseIterator<Type, AF> DenseIterator<Type, AF>::operator++(int) noexcept
{
...
template <typename Type // Type of the elements
		  ...
		  AlignmentFlag AF> // Alignment flag
constexpr
	typename DenseIterator<Type, AF>::ReferenceType DenseIterator<Type, AF>::operator[](size_t index) const noexcept
{
	return ptr_[index];
}
//*************************************************************************************************
...
template <typename Type // Type of the elements
		  ,
		  AlignmentFlag AF> // Alignment flag
constexpr typename DenseIterator<Type, AF>::ReferenceType DenseIterator<Type, AF>::operator*() const noexcept
{
	return *ptr_;
}
//*************************************************************************************************
...
template <typename Type // Type of the elements
		  ,
		  AlignmentFlag AF> // Alignment flag
constexpr typename DenseIterator<Type, AF>::PointerType DenseIterator<Type, AF>::operator->() const noexcept
{
	return ptr_;
}
//*************************************************************************************************
...
template <typename Type // Type of the elements
		  ,
		  AlignmentFlag AF> // Alignment flag
constexpr typename DenseIterator<Type, AF>::PointerType DenseIterator<Type, AF>::base() const noexcept
{
	return ptr_;
}
//*************************************************************************************************
...
template <typename Type // Type of the elements
		  ,
		  AlignmentFlag AF> // Alignment flag
inline const typename DenseIterator<Type, AF>::SIMDType DenseIterator<Type, AF>::load() const noexcept
{
	if (AF)
		return loada();
	else
...
template <typename Type // Type of the elements
		  ,
		  AlignmentFlag AF> // Alignment flag
inline const typename DenseIterator<Type, AF>::SIMDType DenseIterator<Type, AF>::loada() const noexcept
{
	METRIC_NUMERIC_INTERNAL_ASSERT(checkAlignment(ptr_), "Invalid alignment detected");

	return mtrc::numeric::loada(ptr_);
}
//*************************************************************************************************
...
template <typename Type // Type of the elements
		  ,
		  AlignmentFlag AF> // Alignment flag
inline const typename DenseIterator<Type, AF>::SIMDType DenseIterator<Type, AF>::loadu() const noexcept
{
	return mtrc::numeric::loadu(ptr_);
}
//*************************************************************************************************
...
{
	mtrc::numeric::storea(ptr_, value);
}
//*************************************************************************************************
...
{
	mtrc::numeric::storeu(ptr_, value);
}
//*************************************************************************************************
...
{
	mtrc::numeric::stream(ptr_, value);
}
//*************************************************************************************************
