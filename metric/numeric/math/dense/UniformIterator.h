...
#ifndef METRIC_NUMERIC_MATH_DENSE_UNIFORMITERATOR_H
#define METRIC_NUMERIC_MATH_DENSE_UNIFORMITERATOR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
//
// \param it The other UniformIterator instance to be copied.
*/
template <typename Type // Type of the elements
		  ,
		  AlignmentFlag AF> // Alignment flag
...
template <typename Type // Type of the elements
		  ,
		  AlignmentFlag AF> // Alignment flag
constexpr UniformIterator<Type, AF> &UniformIterator<Type, AF>::operator+=(ptrdiff_t inc) noexcept
{
	index_ += inc;
	return *this;
}
...
template <typename Type // Type of the elements
		  ,
		  AlignmentFlag AF> // Alignment flag
constexpr UniformIterator<Type, AF> &UniformIterator<Type, AF>::operator-=(ptrdiff_t dec) noexcept
{
	index_ -= dec;
	return *this;
}
...
template <typename Type // Type of the elements
		  ,
		  AlignmentFlag AF> // Alignment flag
constexpr UniformIterator<Type, AF> &UniformIterator<Type, AF>::operator++() noexcept
{
	++index_;
	return *this;
}
...
template <typename Type // Type of the elements
		  ,
		  AlignmentFlag AF> // Alignment flag
constexpr const UniformIterator<Type, AF> UniformIterator<Type, AF>::operator++(int) noexcept
{
...
template <typename Type // Type of the elements
		  ...
		  AlignmentFlag AF> // Alignment flag
constexpr
	typename UniformIterator<Type, AF>::ReferenceType UniformIterator<Type, AF>::operator[](size_t index) const noexcept
{
	MAYBE_UNUSED(index);
...
template <typename Type // Type of the elements
		  ,
		  AlignmentFlag AF> // Alignment flag
constexpr typename UniformIterator<Type, AF>::ReferenceType UniformIterator<Type, AF>::operator*() const noexcept
{
	return *ptr_;
}
//*************************************************************************************************
...
template <typename Type // Type of the elements
		  ,
		  AlignmentFlag AF> // Alignment flag
constexpr typename UniformIterator<Type, AF>::PointerType UniformIterator<Type, AF>::operator->() const noexcept
{
	return ptr_;
}
//*************************************************************************************************
...
template <typename Type // Type of the elements
		  ,
		  AlignmentFlag AF> // Alignment flag
constexpr typename UniformIterator<Type, AF>::PointerType UniformIterator<Type, AF>::ptr() const noexcept
{
	return ptr_;
}
//*************************************************************************************************
...
template <typename Type // Type of the elements
		  ,
		  AlignmentFlag AF> // Alignment flag
constexpr size_t UniformIterator<Type, AF>::idx() const noexcept
{
	return index_;
}
//*************************************************************************************************
...
template <typename Type // Type of the elements
		  ,
		  AlignmentFlag AF> // Alignment flag
inline const typename UniformIterator<Type, AF>::SIMDType UniformIterator<Type, AF>::load() const noexcept
{
	if (AF)
		return loada();
	else
...
template <typename Type // Type of the elements
		  ,
		  AlignmentFlag AF> // Alignment flag
inline const typename UniformIterator<Type, AF>::SIMDType UniformIterator<Type, AF>::loada() const noexcept
{
	return mtrc::numeric::set(*ptr_);
}
//*************************************************************************************************
...
template <typename Type // Type of the elements
		  ,
		  AlignmentFlag AF> // Alignment flag
inline const typename UniformIterator<Type, AF>::SIMDType UniformIterator<Type, AF>::loadu() const noexcept
{
	return mtrc::numeric::set(*ptr_);
}
//*************************************************************************************************
