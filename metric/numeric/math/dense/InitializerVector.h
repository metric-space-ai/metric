...
#ifndef METRIC_NUMERIC_MATH_DENSE_INITIALIZERVECTOR_H
#define METRIC_NUMERIC_MATH_DENSE_INITIALIZERVECTOR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
// On construction, an InitializerVector is immediately bound to an initializer list:
   ...
   mtrc::numeric::InitializerVector<int> a( list );  // Representation of the initializer list as dense column vector
   \endcode
...
// size argument:
   ...
   mtrc::numeric::InitializerVector<int> b( list, 5UL );  // Representation of the original initializer list
   mtrc::numeric::InitializerVector<int> c( list, 8UL );  // Representing the initializer list { 2, 6, -1, 3, 5, 0, 0,
0 }
   \endcode
...
// access to the initializer list via an InitializerVector results in undefined behavior:
   ...
   \code
   mtrc::numeric::InitializerVector<int> d{ 1, 2, 3, 4, 5 };     // Undefined behavior!
   mtrc::numeric::InitializerVector<int> e( { 0, 3, 2 }, 3UL );  // Undefined behavior!
   \endcode
...
// InitializerVector:
   ...
   mtrc::numeric::InitializerVector<int> f( list );  // Representation of the initializer list as dense vector
   mtrc::numeric::DynamicVector<int> g;
...
class InitializerVector : public DenseVector<InitializerVector<Type, TF, Tag>, TF> {
  public:
	//**Type definitions****************************************************************************
...
template <typename Type // Data type of the vector
		  ...
		  typename Tag> // Type tag
inline
	typename InitializerVector<Type, TF, Tag>::ConstReference InitializerVector<Type, TF, Tag>::at(size_t index) const
{
	if (index >= size_) {
...
template <typename Type // Data type of the vector
		  ...
		  ,
		  typename Tag> // Type tag
inline typename InitializerVector<Type, TF, Tag>::ConstPointer InitializerVector<Type, TF, Tag>::data() const noexcept
{
	return list_.begin();
}
//*************************************************************************************************
...
template <typename Type // Data type of the vector
		  ...
		  ,
		  typename Tag> // Type tag
inline typename InitializerVector<Type, TF, Tag>::ConstIterator InitializerVector<Type, TF, Tag>::begin() const noexcept
{
...
template <typename Type // Data type of the vector
		  ...
		  typename Tag> // Type tag
inline
	typename InitializerVector<Type, TF, Tag>::ConstIterator InitializerVector<Type, TF, Tag>::cbegin() const noexcept
{
	return ConstIterator(0UL, list_);
}
//*************************************************************************************************
...
template <typename Type // Data type of the vector
		  ...
		  ,
		  typename Tag> // Type tag
inline typename InitializerVector<Type, TF, Tag>::ConstIterator InitializerVector<Type, TF, Tag>::end() const noexcept
{
...
template <typename Type // Data type of the vector
		  ...
		  ,
		  typename Tag> // Type tag
inline typename InitializerVector<Type, TF, Tag>::ConstIterator InitializerVector<Type, TF, Tag>::cend() const noexcept
{
	return ConstIterator(size_, list_);
}
//*************************************************************************************************
...
//@{
template <typename Type, bool TF, typename Tag> bool isIntact(const InitializerVector<Type, TF, Tag> &v) noexcept;
...
// function:
   ...
   \code
   mtrc::numeric::InitializerVector<int> a{ 1, 2, 0, 3 };
...
struct HasConstDataAccess<InitializerVector<T, TF, Tag>> : public TrueType {};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename T, bool TF, typename Tag> struct IsInitializer<InitializerVector<T, TF, Tag>> : public TrueType {};
/*! \endcond */
//*************************************************************************************************
