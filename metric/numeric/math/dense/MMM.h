...
#ifndef METRIC_NUMERIC_MATH_DENSE_MMM_H
#define METRIC_NUMERIC_MATH_DENSE_MMM_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
void mmm(DenseMatrix<MT1, false> &C, const MT2 &A, const MT3 &B, ST alpha, ST beta)
{
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_DENSE_MATRIX_TYPE(MT3);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_COMPUTATION_TYPE(MT3);

	METRIC_NUMERIC_CONSTRAINT_MUST_BE_SIMD_COMBINABLE_TYPES(ET1, ET2);
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_SIMD_COMBINABLE_TYPES(ET1, ET3);
	...
	METRIC_NUMERIC_STATIC_ASSERT(KBLOCK >= SIMDSIZE && KBLOCK % SIMDSIZE == 0UL);
	METRIC_NUMERIC_STATIC_ASSERT(JBLOCK >= SIMDSIZE && JBLOCK % SIMDSIZE == 0UL);

	const size_t M(A.rows());
	const size_t N(B.columns());
	const size_t K(A.columns());

	METRIC_NUMERIC_INTERNAL_ASSERT(A.columns() == B.rows(), "Invalid matrix sizes detected");
	...
	while (kk + (remainder ? SIMDSIZE - 1UL : 0UL) < K) {
		...
		while (jj < N) {
			...
			if ((IsLower_v<MT3> && kk + kblock <= jj) || (IsUpper_v<MT3> && jj + jblock <= kk)) {
				jj += jblock;
				continue;
			}
...
void mmm(DenseMatrix<MT1, true> &C, const MT2 &A, const MT3 &B, ST alpha, ST beta)
{
	...
	METRIC_NUMERIC_STATIC_ASSERT(KBLOCK >= SIMDSIZE && KBLOCK % SIMDSIZE == 0UL);
	METRIC_NUMERIC_STATIC_ASSERT(IBLOCK >= SIMDSIZE && IBLOCK % SIMDSIZE == 0UL);
	...
	while (kk + (remainder ? SIMDSIZE - 1UL : 0UL) < K) {
		...
		while (ii < M) {
			...
			if ((IsLower_v<MT2> && ii + iblock <= kk) || (IsUpper_v<MT2> && kk + kblock <= ii)) {
				ii += iblock;
				continue;
			}
...
*/
template <typename MT1, typename MT2, typename MT3> inline void mmm(MT1 &C, const MT2 &A, const MT3 &B)
{
	using ET1 = ElementType_t<MT1>;
	using ET2 = ElementType_t<MT2>;
	using ET3 = ElementType_t<MT3>;
...
void lmmm(DenseMatrix<MT1, false> &C, const MT2 &A, const MT3 &B, ST alpha, ST beta)
{
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_HERMITIAN_MATRIX_TYPE(MT1);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_UNILOWER_MATRIX_TYPE(MT1);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_STRICTLY_LOWER_MATRIX_TYPE(MT1);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_UPPER_MATRIX_TYPE(MT1);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_COMPUTATION_TYPE(MT1);
...
// provide a common SIMD interface.
*/
template <typename MT1, typename MT2, typename MT3> inline void lmmm(MT1 &C, const MT2 &A, const MT3 &B)
{
	using ET1 = ElementType_t<MT1>;
	using ET2 = ElementType_t<MT2>;
	using ET3 = ElementType_t<MT3>;
...
void ummm(DenseMatrix<MT1, false> &C, const MT2 &A, const MT3 &B, ST alpha, ST beta)
{
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_SYMMETRIC_MATRIX_TYPE(MT1);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_HERMITIAN_MATRIX_TYPE(MT1);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_LOWER_MATRIX_TYPE(MT1);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_UNIUPPER_MATRIX_TYPE(MT1);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_STRICTLY_UPPER_MATRIX_TYPE(MT1);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_COMPUTATION_TYPE(MT1);
...
// provide a common SIMD interface.
*/
template <typename MT1, typename MT2, typename MT3> inline void ummm(MT1 &C, const MT2 &A, const MT3 &B)
{
	using ET1 = ElementType_t<MT1>;
	using ET2 = ElementType_t<MT2>;
	using ET3 = ElementType_t<MT3>;
...
// provide a common SIMD interface.
*/
template <typename MT1, typename MT2, typename MT3> inline void smmm(MT1 &C, const MT2 &A, const MT3 &B)
{
	using ET1 = ElementType_t<MT1>;
	using ET2 = ElementType_t<MT2>;
	using ET3 = ElementType_t<MT3>;
...
// provide a common SIMD interface.
*/
template <typename MT1, typename MT2, typename MT3> inline void hmmm(MT1 &C, const MT2 &A, const MT3 &B)
{
	using ET1 = ElementType_t<MT1>;
	using ET2 = ElementType_t<MT2>;
	using ET3 = ElementType_t<MT3>;
