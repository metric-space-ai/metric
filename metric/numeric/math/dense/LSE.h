...
#ifndef METRIC_NUMERIC_MATH_DENSE_LSE_H
#define METRIC_NUMERIC_MATH_DENSE_LSE_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
#include <metric/numeric/math/lapack/gesv.h>
#include <metric/numeric/math/lapack/hesv.h>
#include <metric/numeric/math/lapack/sysv.h>
...
void solve0x0(const DenseMatrix<MT1, SO1> &A, DenseMatrix<MT2, SO2> &X, const DenseMatrix<MT3, SO3> &B)
{
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_UNIFORM_TYPE(MT1);
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_SAME_TYPE(ElementType_t<MT1>, ElementType_t<MT3>);

	METRIC_NUMERIC_INTERNAL_ASSERT((*A).rows() == 0UL, "Invalid number of rows detected");
	METRIC_NUMERIC_INTERNAL_ASSERT((*A).columns() == 0UL, "Invalid number of columns detected");
	METRIC_NUMERIC_INTERNAL_ASSERT((*B).rows() == 0UL, "Invalid number of rows detected");

	MAYBE_UNUSED(A);

	resize(*X, 0UL, (*B).columns());

	METRIC_NUMERIC_INTERNAL_ASSERT(isIntact(*X), "Broken invariant detected");
}
/*! \endcond */
//*************************************************************************************************
...
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_STRICTLY_TRIANGULAR_MATRIX_TYPE(MT);
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_SAME_TYPE(ElementType_t<MT>, ElementType_t<VT1>);
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_SAME_TYPE(ElementType_t<MT>, ElementType_t<VT2>);

	METRIC_NUMERIC_INTERNAL_ASSERT((*A).rows() == 1UL, "Invalid number of rows detected");
	METRIC_NUMERIC_INTERNAL_ASSERT((*A).columns() == 1UL, "Invalid number of columns detected");
	METRIC_NUMERIC_INTERNAL_ASSERT((*b).size() == 1UL, "Invalid vector size detected");
	...
	if (!isDivisor(Atmp(0, 0))) {
		METRIC_NUMERIC_THROW_DIVISION_BY_ZERO("Solving LSE with singular system matrix failed");
	}
...
void solve1x1(const DenseMatrix<MT1, SO1> &A, DenseMatrix<MT2, SO2> &X, const DenseMatrix<MT3, SO3> &B)
{
	...
	METRIC_NUMERIC_INTERNAL_ASSERT((*A).rows() == 1UL, "Invalid number of rows detected");
	METRIC_NUMERIC_INTERNAL_ASSERT((*A).columns() == 1UL, "Invalid number of columns detected");
	METRIC_NUMERIC_INTERNAL_ASSERT((*B).rows() == 1UL, "Invalid number of rows detected");
...
void solve2x2(const DenseMatrix<MT, SO> &A, DenseVector<VT1, TF1> &x, const DenseVector<VT2, TF2> &b)
{
	...
	METRIC_NUMERIC_INTERNAL_ASSERT((*A).rows() == 2UL, "Invalid number of rows detected");
	METRIC_NUMERIC_INTERNAL_ASSERT((*A).columns() == 2UL, "Invalid number of columns detected");
	METRIC_NUMERIC_INTERNAL_ASSERT((*b).size() == 2UL, "Invalid vector size detected");
...
void solve2x2(const DenseMatrix<MT1, SO1> &A, DenseMatrix<MT2, SO2> &X, const DenseMatrix<MT3, SO3> &B)
{
	...
	METRIC_NUMERIC_INTERNAL_ASSERT((*A).rows() == 2UL, "Invalid number of rows detected");
	METRIC_NUMERIC_INTERNAL_ASSERT((*A).columns() == 2UL, "Invalid number of columns detected");
	METRIC_NUMERIC_INTERNAL_ASSERT((*B).rows() == 2UL, "Invalid number of rows detected");
...
void solve3x3(const DenseMatrix<MT, SO> &A, DenseVector<VT1, TF1> &x, const DenseVector<VT2, TF2> &b)
{
	...
	METRIC_NUMERIC_INTERNAL_ASSERT((*A).rows() == 3UL, "Invalid number of rows detected");
	METRIC_NUMERIC_INTERNAL_ASSERT((*A).columns() == 3UL, "Invalid number of columns detected");
	METRIC_NUMERIC_INTERNAL_ASSERT((*b).size() == 3UL, "Invalid vector size detected");
...
void solve3x3(const DenseMatrix<MT1, SO1> &A, DenseMatrix<MT2, SO2> &X, const DenseMatrix<MT3, SO3> &B)
{
	...
	METRIC_NUMERIC_INTERNAL_ASSERT((*A).rows() == 3UL, "Invalid number of rows detected");
	METRIC_NUMERIC_INTERNAL_ASSERT((*A).columns() == 3UL, "Invalid number of columns detected");
	METRIC_NUMERIC_INTERNAL_ASSERT((*B).rows() == 3UL, "Invalid number of rows detected");
...
void solve4x4(const DenseMatrix<MT, SO> &A, DenseVector<VT1, TF1> &x, const DenseVector<VT2, TF2> &b)
{
	...
	METRIC_NUMERIC_INTERNAL_ASSERT((*A).rows() == 4UL, "Invalid number of rows detected");
	METRIC_NUMERIC_INTERNAL_ASSERT((*A).columns() == 4UL, "Invalid number of columns detected");
	METRIC_NUMERIC_INTERNAL_ASSERT((*b).size() == 4UL, "Invalid vector size detected");
...
void solve4x4(const DenseMatrix<MT1, SO1> &A, DenseMatrix<MT2, SO2> &X, const DenseMatrix<MT3, SO3> &B)
{
	...
	METRIC_NUMERIC_INTERNAL_ASSERT((*A).rows() == 4UL, "Invalid number of rows detected");
	METRIC_NUMERIC_INTERNAL_ASSERT((*A).columns() == 4UL, "Invalid number of columns detected");
	METRIC_NUMERIC_INTERNAL_ASSERT((*B).rows() == 4UL, "Invalid number of rows detected");
...
void solve5x5(const DenseMatrix<MT, SO> &A, DenseVector<VT1, TF1> &x, const DenseVector<VT2, TF2> &b)
{
	...
	METRIC_NUMERIC_INTERNAL_ASSERT((*A).rows() == 5UL, "Invalid number of rows detected");
	METRIC_NUMERIC_INTERNAL_ASSERT((*A).columns() == 5UL, "Invalid number of columns detected");
	METRIC_NUMERIC_INTERNAL_ASSERT((*b).size() == 5UL, "Invalid vector size detected");
...
void solve5x5(const DenseMatrix<MT1, SO1> &A, DenseMatrix<MT2, SO2> &X, const DenseMatrix<MT3, SO3> &B)
{
	...
	METRIC_NUMERIC_INTERNAL_ASSERT((*A).rows() == 5UL, "Invalid number of rows detected");
	METRIC_NUMERIC_INTERNAL_ASSERT((*A).columns() == 5UL, "Invalid number of columns detected");
	METRIC_NUMERIC_INTERNAL_ASSERT((*B).rows() == 5UL, "Invalid number of rows detected");
...
void solve5x5(const DenseMatrix<MT1, SO1> &A, DenseMatrix<MT2, SO2> &X, const DenseMatrix<MT3, SO3> &B)
{
	...
	for (size_t j = 0UL; j < N; ++j) {
		...
		X_(3, j) = (B_(3, j) - A_(3, 0) * X_(0, j) - A_(3, 1) * X_(1, j) - A_(3, 2) * X_(2, j)) * invD3;
		X_(4, j) =
			(B_(4, j) - A_(4, 0) * X_(0, j) - A_(4, 1) * X_(1, j) - A_(4, 2) * X_(2, j) - A_(4, 3) * X_(3, j)) * invD4;
	}
}
/*! \endcond */
//*************************************************************************************************
...
void solve5x5(const DenseMatrix<MT1, SO1> &A, DenseMatrix<MT2, SO2> &X, const DenseMatrix<MT3, SO3> &B)
{
	...
	for (size_t j = 0UL; j < N; ++j) {
		...
		X_(0, j) =
			(B_(0, j) - A_(0, 1) * X_(1, j) - A_(0, 2) * X_(2, j) - A_(0, 3) * X_(3, j) - A_(0, 4) * X_(4, j)) * invD0;
	}
}
/*! \endcond */
//*************************************************************************************************
...
void solve6x6(const DenseMatrix<MT, SO> &A, DenseVector<VT1, TF1> &x, const DenseVector<VT2, TF2> &b)
{
	...
	METRIC_NUMERIC_INTERNAL_ASSERT((*A).rows() == 6UL, "Invalid number of rows detected");
	METRIC_NUMERIC_INTERNAL_ASSERT((*A).columns() == 6UL, "Invalid number of columns detected");
	METRIC_NUMERIC_INTERNAL_ASSERT((*b).size() == 6UL, "Invalid vector size detected");
	...
	const ET D(tmp51 * A_(5, 5) - tmp52 * A_(5, 4) + tmp53 * A_(5, 3) - tmp54 * A_(5, 2) + tmp55 * A_(5, 1) -
			   tmp56 * A_(5, 0));
	...
	x_[0] = (tmp137 * A_(5, 5) - tmp138 * A_(5, 4) + tmp139 * A_(5, 3) - tmp140 * A_(5, 2) + tmp141 * A_(5, 1) -
			 tmp56 * b_[5]) *
			invD;
	x_[1] = (tmp142 * A_(5, 5) - tmp143 * A_(5, 4) + tmp144 * A_(5, 3) - tmp145 * A_(5, 2) + tmp55 * b_[5] -
			 tmp141 * A_(5, 0)) *
			invD;
	x_[2] = (tmp147 * A_(5, 5) - tmp148 * A_(5, 4) + tmp149 * A_(5, 3) - tmp54 * b_[5] + tmp145 * A_(5, 1) -
			 tmp146 * A_(5, 0)) *
			invD;
	x_[3] = (tmp152 * A_(5, 5) - tmp153 * A_(5, 4) + tmp53 * b_[5] - tmp149 * A_(5, 2) + tmp150 * A_(5, 1) -
			 tmp151 * A_(5, 0)) *
			invD;
	x_[4] = (tmp157 * A_(5, 5) - tmp52 * b_[5] + tmp153 * A_(5, 3) - tmp154 * A_(5, 2) + tmp155 * A_(5, 1) -
			 tmp156 * A_(5, 0)) *
			invD;
	x_[5] = (tmp51 * b_[5] - tmp157 * A_(5, 4) + tmp158 * A_(5, 3) - tmp159 * A_(5, 2) + tmp160 * A_(5, 1) -
			 tmp161 * A_(5, 0)) *
			invD;
}
/*! \endcond */
...
void solve6x6(const DenseMatrix<MT, SO> &A, DenseVector<VT1, TF1> &x, const DenseVector<VT2, TF2> &b)
{
	...
	const ET D(tmp51 * A_(5, 5) - tmp52 * A_(4, 5) + tmp53 * A_(3, 5) - tmp54 * A_(2, 5) + tmp55 * A_(1, 5) -
			   tmp56 * A_(0, 5));
	...
	x_[0] = (tmp137 * A_(5, 5) - tmp138 * A_(4, 5) + tmp139 * A_(3, 5) - tmp140 * A_(2, 5) + tmp141 * A_(1, 5) -
			 tmp56 * b_[5]) *
			invD;
	x_[1] = (tmp142 * A_(5, 5) - tmp143 * A_(4, 5) + tmp144 * A_(3, 5) - tmp145 * A_(2, 5) + tmp55 * b_[5] -
			 tmp141 * A_(0, 5)) *
			invD;
	x_[2] = (tmp147 * A_(5, 5) - tmp148 * A_(4, 5) + tmp149 * A_(3, 5) - tmp54 * b_[5] + tmp145 * A_(1, 5) -
			 tmp146 * A_(0, 5)) *
			invD;
	x_[3] = (tmp152 * A_(5, 5) - tmp153 * A_(4, 5) + tmp53 * b_[5] - tmp149 * A_(2, 5) + tmp150 * A_(1, 5) -
			 tmp151 * A_(0, 5)) *
			invD;
	x_[4] = (tmp157 * A_(5, 5) - tmp52 * b_[5] + tmp153 * A_(3, 5) - tmp154 * A_(2, 5) + tmp155 * A_(1, 5) -
			 tmp156 * A_(0, 5)) *
			invD;
	x_[5] = (tmp51 * b_[5] - tmp157 * A_(4, 5) + tmp158 * A_(3, 5) - tmp159 * A_(2, 5) + tmp160 * A_(1, 5) -
			 tmp161 * A_(0, 5)) *
			invD;
}
/*! \endcond */
...
void solve6x6(const DenseMatrix<MT1, SO1> &A, DenseMatrix<MT2, SO2> &X, const DenseMatrix<MT3, SO3> &B)
{
	...
	METRIC_NUMERIC_INTERNAL_ASSERT((*A).rows() == 6UL, "Invalid number of rows detected");
	METRIC_NUMERIC_INTERNAL_ASSERT((*A).columns() == 6UL, "Invalid number of columns detected");
	METRIC_NUMERIC_INTERNAL_ASSERT((*B).rows() == 6UL, "Invalid number of rows detected");
...
void solve6x6(const DenseMatrix<MT1, SO1> &A, DenseMatrix<MT2, SO2> &X, const DenseMatrix<MT3, SO3> &B)
{
	...
	for (size_t j = 0UL; j < N; ++j) {
		...
		X_(4, j) =
			(B_(4, j) - A_(4, 0) * X_(0, j) - A_(4, 1) * X_(1, j) - A_(4, 2) * X_(2, j) - A_(4, 3) * X_(3, j)) * invD4;
		X_(5, j) = (B_(5, j) - A_(5, 0) * X_(0, j) - A_(5, 1) * X_(1, j) - A_(5, 2) * X_(2, j) - A_(5, 3) * X_(3, j) -
					A_(5, 4) * X_(4, j)) *
				   invD5;
	}
}
...
void solve6x6(const DenseMatrix<MT1, SO1> &A, DenseMatrix<MT2, SO2> &X, const DenseMatrix<MT3, SO3> &B)
{
	...
	for (size_t j = 0UL; j < N; ++j) {
		...
		X_(1, j) =
			(B_(1, j) - A_(1, 2) * X_(2, j) - A_(1, 3) * X_(3, j) - A_(1, 4) * X_(4, j) - A_(1, 5) * X_(5, j)) * invD1;
		X_(0, j) = (B_(0, j) - A_(0, 1) * X_(1, j) - A_(0, 2) * X_(2, j) - A_(0, 3) * X_(3, j) - A_(0, 4) * X_(4, j) -
					A_(0, 5) * X_(5, j)) *
				   invD0;
	}
...
void solveNxN(const DenseMatrix<MT, SO> &A, DenseVector<VT1, TF1> &x, const DenseVector<VT2, TF2> &b)
{
	...
	METRIC_NUMERIC_INTERNAL_ASSERT((*A).rows() == (*b).size(), "Invalid matrix and vector sizes");
...
void solveNxN(const DenseMatrix<MT1, SO1> &A, DenseMatrix<MT2, SO2> &X, const DenseMatrix<MT3, SO3> &B)
{
	...
	METRIC_NUMERIC_INTERNAL_ASSERT(isSquare(*A), "Non-square matrix detected");
	METRIC_NUMERIC_INTERNAL_ASSERT((*A).rows() == (*B).rows(), "Invalid matrix and vector sizes");
	METRIC_NUMERIC_INTERNAL_ASSERT(IsResizable_v<MT2> || (*B).rows() == (*X).rows(), "Invalid number of rows detected");
	METRIC_NUMERIC_INTERNAL_ASSERT(IsResizable_v<MT2> || (*B).columns() == (*X).columns(),
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_COLUMN_MAJOR_MATRIX_TYPE(MT4);
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_COLUMN_MAJOR_MATRIX_TYPE(MT5);
...
// side vector.
   ...
   \code
   mtrc::numeric::DynamicMatrix<double> A;  // The square general system matrix
   mtrc::numeric::DynamicVector<double> b;  // The right-hand side vector
   // ... Resizing and initialization

   mtrc::numeric::DynamicVector<double> x;  // The solution vector
   solve( A, x, b );
   \endcode
...
// manually by means of declaration operations when calling the \c solve() function:
   ...
   \code
   mtrc::numeric::DynamicMatrix<double> A;  // The square lower system matrix
   mtrc::numeric::DynamicVector<double> b;  // The right-hand side vector
   // ... Resizing and initialization
...
void solve(const DenseMatrix<MT, SO> &A, DenseVector<VT1, TF1> &x, const DenseVector<VT2, TF2> &b)
{
	...
	if (!isSquare(*A)) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Invalid non-square system matrix provided");
...
// of \a B are the given right-hand side vectors.
   ...
   \code
   mtrc::numeric::DynamicMatrix<double> A;  // The square general system matrix
   mtrc::numeric::DynamicMatrix<double> B;  // The right-hand side matrix
   // ... Resizing and initialization

   mtrc::numeric::DynamicMatrix<double> X;  // The solution matrix
   solve( A, X, B );
   \endcode
