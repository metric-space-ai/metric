...
#ifndef METRIC_NUMERIC_MATH_DENSE_INITIALIZERITERATOR_H
#define METRIC_NUMERIC_MATH_DENSE_INITIALIZERITERATOR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
template <typename Type> // Type of the elements
inline
	typename InitializerIterator<Type>::ReferenceType InitializerIterator<Type>::operator[](size_t index) const noexcept
{
	if (index < list_.size())
...
*/
template <typename Type> // Type of the elements
inline typename InitializerIterator<Type>::ReferenceType InitializerIterator<Type>::operator*() const noexcept
{
...
*/
template <typename Type> // Type of the elements
inline typename InitializerIterator<Type>::PointerType InitializerIterator<Type>::operator->() const noexcept
{
	if (index_ < list_.size())
		return list_.begin() + index_;
	else
