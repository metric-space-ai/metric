...
#ifndef METRIC_NUMERIC_MATH_ALIASES_H
#define METRIC_NUMERIC_MATH_ALIASES_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
// both ways to access the nested type definition:
   ...
   METRIC_NUMERIC_CONSTRAINT_MUST_BE_STRICTLY_SAME_TYPE( Type1, Type2 );
   \endcode
*/
template <typename T> using AllocatorType_t = typename T::AllocatorType;
//*************************************************************************************************
...
// both ways to access the nested type definition:
   ...
   \endcode
*/
template <typename T> using BaseType_t = typename T::BaseType;
//*************************************************************************************************
...
// both ways to access the nested type definition:
   ...
   \endcode
*/
template <typename T> using CompositeType_t = typename T::CompositeType;
//*************************************************************************************************
...
// both ways to access the nested type definition:
   ...
   \endcode
*/
template <typename T> using ConstIterator_t = typename T::ConstIterator;
//*************************************************************************************************
...
// both ways to access the nested type definition:
   ...
   \endcode
*/
template <typename T> using ConstPointer_t = typename T::ConstPointer;
//*************************************************************************************************
...
// both ways to access the nested type definition:
   ...
   \endcode
*/
template <typename T> using ConstReference_t = typename T::ConstReference;
//*************************************************************************************************
...
// both ways to access the nested type definition:
   ...
   \endcode
*/
template <typename T> using ElementType_t = typename T::ElementType;
//*************************************************************************************************
...
// both ways to access the nested type definition:
   ...
   \endcode
*/
template <typename T> using LeftOperand_t = typename T::LeftOperand;
//*************************************************************************************************
...
// both ways to access the nested type definition:
   ...
   \endcode
*/
template <typename T> using MatrixType_t = typename T::MatrixType;
//*************************************************************************************************
...
// the nested type definition:
   ...
   \endcode
*/
template <typename T> using Operand_t = typename T::Operand;
//*************************************************************************************************
...
// ways to access the nested type definition:
   ...
   \endcode
*/
template <typename T> using Operation_t = typename T::Operation;
//*************************************************************************************************
...
// both ways to access the nested type definition:
   ...
   \endcode
*/
template <typename T> using OppositeType_t = typename T::OppositeType;
//*************************************************************************************************
...
// the nested class template:
   ...
   \endcode
*/
template <typename T1, typename T2> using Rebind_t = typename T1::template Rebind<T2>::Other;
//*************************************************************************************************
...
// both ways to access the nested type definition:
   ...
   \endcode
*/
template <typename T> using RepresentedType_t = typename T::RepresentedType;
//*************************************************************************************************
...
// the nested class template:
   ...
   \endcode
*/
template <typename T, size_t... Ns> using Resize_t = typename T::template Resize<Ns...>::Other;
//*************************************************************************************************
...
// both ways to access the nested type definition:
   ...
   \endcode
*/
template <typename T> using ResultType_t = typename T::ResultType;
//*************************************************************************************************
...
// both ways to access the nested type definition:
   ...
   \endcode
*/
template <typename T> using ReturnType_t = typename T::ReturnType;
//*************************************************************************************************
...
// both ways to access the nested type definition:
   ...
   \endcode
*/
template <typename T> using RightOperand_t = typename T::RightOperand;
//*************************************************************************************************
...
// both ways to access the nested type definition:
   ...
   \endcode
*/
template <typename T> using SIMDType_t = typename T::SIMDType;
//*************************************************************************************************
...
// both ways to access the nested type definition:
   ...
   \endcode
*/
template <typename T> using TagType_t = typename ResultType_t<T>::TagType;
//*************************************************************************************************
...
// both ways to access the nested type definition:
   ...
   \endcode
*/
template <typename T> using TransposeType_t = typename T::TransposeType;
//*************************************************************************************************
...
// both ways to access the nested type definition:
   ...
   \endcode
*/
template <typename T> using ValueType_t = typename T::ValueType;
//*************************************************************************************************
...
// both ways to access the nested type definition:
   ...
   \endcode
*/
template <typename T> using VectorType_t = typename T::VectorType;
//*************************************************************************************************
...
// both ways to access the nested type definition:
   ...
   \endcode
*/
template <typename T> using ViewedType_t = typename T::ViewedType;
//*************************************************************************************************
