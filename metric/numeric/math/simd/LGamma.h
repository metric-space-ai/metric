...
#ifndef METRIC_NUMERIC_MATH_SIMD_LGAMMA_H
#define METRIC_NUMERIC_MATH_SIMD_LGAMMA_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
METRIC_NUMERIC_ALWAYS_INLINE const SIMDfloat lgamma(const SIMDf32<T> &a) noexcept
#if METRIC_NUMERIC_SLEEF_MODE
...
*/
template <typename T> // Type of the operand
METRIC_NUMERIC_ALWAYS_INLINE const SIMDdouble lgamma(const SIMDf64<T> &a) noexcept
#if METRIC_NUMERIC_SLEEF_MODE
#if METRIC_NUMERIC_AVX512F_MODE || METRIC_NUMERIC_MIC_MODE
{
