...
#ifndef METRIC_NUMERIC_MATH_SIMD_EQUAL_H
#define METRIC_NUMERIC_MATH_SIMD_EQUAL_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
METRIC_NUMERIC_ALWAYS_INLINE bool equal(const SIMDi8<T> &a, const SIMDi8<T> &b) noexcept
...
template <RelaxationFlag RF // Relaxation flag
		  ,
		  typename T> // Type of both operands
METRIC_NUMERIC_ALWAYS_INLINE bool equal(const SIMDci8<T> &a, const SIMDci8<T> &b) noexcept
#if METRIC_NUMERIC_AVX512BW_MODE
{
	return _mm512_cmpeq_epi8_mask((*a).value, (*b).value) == 0xffffffffffffffff;
}
...
METRIC_NUMERIC_ALWAYS_INLINE bool operator==(const SIMDi8<T> &a, const SIMDi8<T> &b) noexcept
{
...
*/
template <typename T> // Type of both operands
METRIC_NUMERIC_ALWAYS_INLINE bool operator==(const SIMDci8<T> &a, const SIMDci8<T> &b) noexcept
{
	return equal<strict>(*a, *b);
}
//*************************************************************************************************
...
template <RelaxationFlag RF // Relaxation flag
		  ,
		  typename T> // Type of both operands
METRIC_NUMERIC_ALWAYS_INLINE bool equal(const SIMDi16<T> &a, const SIMDi16<T> &b) noexcept
#if METRIC_NUMERIC_AVX512BW_MODE
{
...
template <RelaxationFlag RF // Relaxation flag
		  ,
		  typename T> // Type of both operands
METRIC_NUMERIC_ALWAYS_INLINE bool equal(const SIMDci16<T> &a, const SIMDci16<T> &b) noexcept
#if METRIC_NUMERIC_AVX512BW_MODE
{
	return _mm512_cmpeq_epi16_mask((*a).value, (*b).value) == 0xffffffff;
}
...
*/
template <typename T> // Type of both operands
METRIC_NUMERIC_ALWAYS_INLINE bool operator==(const SIMDi16<T> &a, const SIMDi16<T> &b) noexcept
{
	return equal<strict>(*a, *b);
}
//*************************************************************************************************
...
*/
template <typename T> // Type of both operands
METRIC_NUMERIC_ALWAYS_INLINE bool operator==(const SIMDci16<T> &a, const SIMDci16<T> &b) noexcept
{
	return equal<strict>(*a, *b);
}
//*************************************************************************************************
...
template <RelaxationFlag RF // Relaxation flag
		  ,
		  typename T> // Type of both operands
METRIC_NUMERIC_ALWAYS_INLINE bool equal(const SIMDi32<T> &a, const SIMDi32<T> &b) noexcept
...
template <RelaxationFlag RF // Relaxation flag
		  ,
		  typename T> // Type of both operands
METRIC_NUMERIC_ALWAYS_INLINE bool equal(const SIMDci32<T> &a, const SIMDci32<T> &b) noexcept
#if METRIC_NUMERIC_AVX512F_MODE || METRIC_NUMERIC_MIC_MODE
{
	return _mm512_cmpeq_epi32_mask((*a).value, (*b).value) == 0xffff;
}
...
*/
template <typename T> // Type of both operands
METRIC_NUMERIC_ALWAYS_INLINE bool operator==(const SIMDi32<T> &a, const SIMDi32<T> &b) noexcept
{
	return equal<strict>(*a, *b);
}
//*************************************************************************************************
...
*/
template <typename T> // Type of both operands
METRIC_NUMERIC_ALWAYS_INLINE bool operator==(const SIMDci32<T> &a, const SIMDci32<T> &b) noexcept
{
	return equal<strict>(*a, *b);
}
//*************************************************************************************************
...
template <RelaxationFlag RF // Relaxation flag
		  ,
		  typename T> // Type of both operands
METRIC_NUMERIC_ALWAYS_INLINE bool equal(const SIMDi64<T> &a, const SIMDi64<T> &b) noexcept
...
template <RelaxationFlag RF // Relaxation flag
		  ,
		  typename T> // Type of both operands
METRIC_NUMERIC_ALWAYS_INLINE bool equal(const SIMDci64<T> &a, const SIMDci64<T> &b) noexcept
#if METRIC_NUMERIC_AVX512F_MODE
{
	return _mm512_cmpeq_epi64_mask((*a).value, (*b).value) == 0xff;
}
...
*/
template <typename T> // Type of both operands
METRIC_NUMERIC_ALWAYS_INLINE bool operator==(const SIMDi64<T> &a, const SIMDi64<T> &b) noexcept
{
	return equal<strict>(*a, *b);
}
//*************************************************************************************************
...
*/
template <typename T> // Type of both operands
METRIC_NUMERIC_ALWAYS_INLINE bool operator==(const SIMDci64<T> &a, const SIMDci64<T> &b) noexcept
{
	return equal<strict>(*a, *b);
}
//*************************************************************************************************
...
*/
template <RelaxationFlag RF> // Relaxation flag
METRIC_NUMERIC_ALWAYS_INLINE bool equal(const SIMDfloat &a, const SIMDfloat &b) noexcept
...
*/
template <RelaxationFlag RF> // Relaxation flag
METRIC_NUMERIC_ALWAYS_INLINE bool equal(const SIMDcfloat &a, const SIMDcfloat &b) noexcept
#if (METRIC_NUMERIC_AVX512F_MODE || METRIC_NUMERIC_MIC_MODE) && METRIC_NUMERIC_GNU_COMPILER
	= delete;
#elif METRIC_NUMERIC_AVX512F_MODE || METRIC_NUMERIC_MIC_MODE
{
...
METRIC_NUMERIC_ALWAYS_INLINE bool operator==(const SIMDf32<T1> &a, const SIMDf32<T2> &b) noexcept
#if (METRIC_NUMERIC_AVX512F_MODE || METRIC_NUMERIC_MIC_MODE) && METRIC_NUMERIC_GNU_COMPILER
	= delete;
#elif METRIC_NUMERIC_AVX512F_MODE || METRIC_NUMERIC_MIC_MODE
{
...
// This operation is only available for SSE, AVX, MIC, and AVX-512.
*/
METRIC_NUMERIC_ALWAYS_INLINE bool operator==(const SIMDcfloat &a, const SIMDcfloat &b) noexcept
#if (METRIC_NUMERIC_AVX512F_MODE || METRIC_NUMERIC_MIC_MODE) && METRIC_NUMERIC_GNU_COMPILER
	= delete;
#elif METRIC_NUMERIC_AVX512F_MODE || METRIC_NUMERIC_MIC_MODE
{
...
*/
template <RelaxationFlag RF> // Relaxation flag
METRIC_NUMERIC_ALWAYS_INLINE bool equal(const SIMDdouble &a, const SIMDdouble &b) noexcept
#if (METRIC_NUMERIC_AVX512F_MODE || METRIC_NUMERIC_MIC_MODE) && METRIC_NUMERIC_GNU_COMPILER
	= delete;
#elif METRIC_NUMERIC_AVX512F_MODE || METRIC_NUMERIC_MIC_MODE
{
...
*/
template <RelaxationFlag RF> // Relaxation flag
METRIC_NUMERIC_ALWAYS_INLINE bool equal(const SIMDcdouble &a, const SIMDcdouble &b) noexcept
#if (METRIC_NUMERIC_AVX512F_MODE || METRIC_NUMERIC_MIC_MODE) && METRIC_NUMERIC_GNU_COMPILER
	= delete;
#elif METRIC_NUMERIC_AVX512F_MODE || METRIC_NUMERIC_MIC_MODE
{
...
template <typename T1 // Type of the left-hand side operand
		  ,
		  typename T2> // Type of the right-hand side operand
METRIC_NUMERIC_ALWAYS_INLINE bool operator==(const SIMDf64<T1> &a, const SIMDf64<T2> &b) noexcept
#if (METRIC_NUMERIC_AVX512F_MODE || METRIC_NUMERIC_MIC_MODE) && METRIC_NUMERIC_GNU_COMPILER
	= delete;
#elif METRIC_NUMERIC_AVX512F_MODE || METRIC_NUMERIC_MIC_MODE
{
...
// This operation is only available for SSE2, AVX, MIC, and AVX-512.
*/
METRIC_NUMERIC_ALWAYS_INLINE bool operator==(const SIMDcdouble &a, const SIMDcdouble &b) noexcept
#if (METRIC_NUMERIC_AVX512F_MODE || METRIC_NUMERIC_MIC_MODE) && METRIC_NUMERIC_GNU_COMPILER
	= delete;
#elif METRIC_NUMERIC_AVX512F_MODE || METRIC_NUMERIC_MIC_MODE
{
...
*/
template <typename T> // Type of both operands
METRIC_NUMERIC_ALWAYS_INLINE bool operator!=(const SIMDPack<T> &a, const SIMDPack<T> &b) noexcept
{
	return !((*a) == (*b));
}
//*************************************************************************************************
