...
#ifndef METRIC_NUMERIC_MATH_SIMD_LOADA_H
#define METRIC_NUMERIC_MATH_SIMD_LOADA_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
*/
METRIC_NUMERIC_ALWAYS_INLINE const SIMDfloat loada(const float *address) noexcept
{
	METRIC_NUMERIC_INTERNAL_ASSERT(checkAlignment(address), "Invalid alignment detected");
...
// in case of AVX, and 64-byte alignment in case of AVX-512/MIC).
*/
METRIC_NUMERIC_ALWAYS_INLINE const SIMDcfloat loada(const complex<float> *address) noexcept
{
...
// of AVX, and 64-byte alignment in case of AVX-512/MIC).
*/
METRIC_NUMERIC_ALWAYS_INLINE const SIMDdouble loada(const double *address) noexcept
{
	METRIC_NUMERIC_INTERNAL_ASSERT(checkAlignment(address), "Invalid alignment detected");
...
// in case of AVX, and 64-byte alignment in case of AVX-512/MIC).
*/
METRIC_NUMERIC_ALWAYS_INLINE const SIMDcdouble loada(const complex<double> *address) noexcept
{
