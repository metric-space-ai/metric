...
#ifndef METRIC_NUMERIC_MATH_SIMD_STREAM_H
#define METRIC_NUMERIC_MATH_SIMD_STREAM_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
METRIC_NUMERIC_ALWAYS_INLINE EnableIf_t<IsIntegral_v<T1> && HasSize_v<T1, 1UL>> stream(T1 *address,
...
METRIC_NUMERIC_ALWAYS_INLINE void stream(float *address, const SIMDf32<T> &value) noexcept
{
	METRIC_NUMERIC_INTERNAL_ASSERT(checkAlignment(address), "Invalid alignment detected");
...
// \return void
*/
METRIC_NUMERIC_ALWAYS_INLINE void stream(complex<float> *address, const SIMDcfloat &value) noexcept
{
...
*/
template <typename T> // Type of the operand
METRIC_NUMERIC_ALWAYS_INLINE void stream(double *address, const SIMDf64<T> &value) noexcept
{
	METRIC_NUMERIC_INTERNAL_ASSERT(checkAlignment(address), "Invalid alignment detected");
...
// \return void
*/
METRIC_NUMERIC_ALWAYS_INLINE void stream(complex<double> *address, const SIMDcdouble &value) noexcept
{
