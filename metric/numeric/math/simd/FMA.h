...
#ifndef METRIC_NUMERIC_MATH_SIMD_FMA_H
#define METRIC_NUMERIC_MATH_SIMD_FMA_H
//*************************************************************************************************
// Includes
//*************************************************************************************************

#include <metric/numeric/math/simd/Add.h>
#include <metric/numeric/math/simd/BasicTypes.h>
#include <metric/numeric/math/simd/Mult.h>
...
struct SIMDf32FmaddExpr : public SIMDf32<SIMDf32FmaddExpr<T1, T2, T3>> {
	...
	*/
	METRIC_NUMERIC_ALWAYS_INLINE SIMDf32FmaddExpr(const T1 &a, const T2 &b, const T3 &c)
	...
	*/
	METRIC_NUMERIC_ALWAYS_INLINE const SIMDfloat eval() const noexcept
#if METRIC_NUMERIC_FMA_MODE && (METRIC_NUMERIC_AVX512F_MODE || METRIC_NUMERIC_MIC_MODE)
	{
		return _mm512_fmadd_ps(a_.eval().value, b_.eval().value, c_.eval().value);
	}
#elif METRIC_NUMERIC_FMA_MODE && METRIC_NUMERIC_AVX_MODE
	{
		return _mm256_fmadd_ps(a_.eval().value, b_.eval().value, c_.eval().value);
	}
#elif METRIC_NUMERIC_FMA_MODE && METRIC_NUMERIC_SSE2_MODE
	{
...
struct SIMDf32FmsubExpr : public SIMDf32<SIMDf32FmsubExpr<T1, T2, T3>> {
	...
	*/
	METRIC_NUMERIC_ALWAYS_INLINE SIMDf32FmsubExpr(const T1 &a, const T2 &b, const T3 &c)
		: a_(a) // The left-hand side operand for the multiplication
		  ,
		  b_(b) // The right-hand side operand for the multiplication
		  ,
...
METRIC_NUMERIC_ALWAYS_INLINE const SIMDf32FmaddExpr<T1, T2, T3> operator+(const SIMDf32MultExpr<T1, T2> &a,
																		  const SIMDf32<T3> &b)
{
...
METRIC_NUMERIC_ALWAYS_INLINE const SIMDf32FmaddExpr<T2, T3, T1> operator+(const SIMDf32<T1> &a,
...
METRIC_NUMERIC_ALWAYS_INLINE const SIMDf32FmaddExpr<T1, T2, SIMDf32MultExpr<T3, T4>>
...
METRIC_NUMERIC_ALWAYS_INLINE decltype(auto) operator+(const SIMDf32FmaddExpr<T1, T2, T3> &a, const SIMDf32<T4> &b)
{
...
METRIC_NUMERIC_ALWAYS_INLINE decltype(auto) operator+(const SIMDf32<T1> &a, const SIMDf32FmaddExpr<T2, T3, T4> &b)
{
...
METRIC_NUMERIC_ALWAYS_INLINE const SIMDf32FmaddExpr<T4, T5, SIMDf32FmaddExpr<T1, T2, T3>>
...
METRIC_NUMERIC_ALWAYS_INLINE const SIMDf32FmaddExpr<T1, T2, SIMDf32FmaddExpr<T3, T4, T5>>
...
METRIC_NUMERIC_ALWAYS_INLINE decltype(auto) operator+(const SIMDf32FmaddExpr<T1, T2, T3> &a,
...
template <typename T1 // Type of the first multiplication operand of the left-hand side FMA
		  ...
		  ,
		  typename T6> // Type of the addition operand of the right-hand side FMA
METRIC_NUMERIC_ALWAYS_INLINE decltype(auto) operator+(const SIMDf32FmsubExpr<T1, T2, T3> &a,
													  const SIMDf32FmaddExpr<T4, T5, T6> &b)
{
...
METRIC_NUMERIC_ALWAYS_INLINE const SIMDf32FmsubExpr<T1, T2, T3> operator-(const SIMDf32MultExpr<T1, T2> &a,
																		  const SIMDf32<T3> &b)
{
...
template <typename T1 // Type of the first operand of the left-hand side multiplication
		  ...
		  ,
		  typename T4> // Type of the second operand of the right-hand side multiplication
METRIC_NUMERIC_ALWAYS_INLINE const SIMDf32FmsubExpr<T1, T2, SIMDf32MultExpr<T3, T4>>
operator-(const SIMDf32MultExpr<T1, T2> &a, const SIMDf32MultExpr<T3, T4> &b)
{
...
METRIC_NUMERIC_ALWAYS_INLINE decltype(auto) operator-(const SIMDf32FmsubExpr<T1, T2, T3> &a, const SIMDf32<T4> &b)
{
	return (a.a_ * a.b_) - (a.c_ + (*b));
}
#endif
...
METRIC_NUMERIC_ALWAYS_INLINE const SIMDf32FmsubExpr<T1, T2, SIMDf32FmsubExpr<T3, T4, T5>>
...
struct SIMDf64FmaddExpr : public SIMDf64<SIMDf64FmaddExpr<T1, T2, T3>> {
	...
	// \param c The right-hand side operand for the addition.
	*/
	METRIC_NUMERIC_ALWAYS_INLINE SIMDf64FmaddExpr(const T1 &a, const T2 &b, const T3 &c)
		: a_(a) // The left-hand side operand for the multiplication
		  ,
		  b_(b) // The right-hand side operand for the multiplication
		  ,
	...
	*/
	METRIC_NUMERIC_ALWAYS_INLINE const SIMDdouble eval() const noexcept
#if METRIC_NUMERIC_FMA_MODE && (METRIC_NUMERIC_AVX512F_MODE || METRIC_NUMERIC_MIC_MODE)
	{
...
struct SIMDf64FmsubExpr : public SIMDf64<SIMDf64FmsubExpr<T1, T2, T3>> {
	...
	// \param c The right-hand side operand for the subtraction.
	*/
	METRIC_NUMERIC_ALWAYS_INLINE SIMDf64FmsubExpr(const T1 &a, const T2 &b, const T3 &c)
		: a_(a) // The left-hand side operand for the multiplication
		  ,
		  b_(b) // The right-hand side operand for the multiplication
		  ,
...
template <typename T1 // Type of the first multiplication operand
		  ...
		  ,
		  typename T3> // Type of the second addition operand
METRIC_NUMERIC_ALWAYS_INLINE const SIMDf64FmaddExpr<T1, T2, T3> operator+(const SIMDf64MultExpr<T1, T2> &a,
																		  const SIMDf64<T3> &b)
{
...
template <typename T1 // Type of the first addition operand
		  ...
		  ,
		  typename T3> // Type of the second multiplication operand
METRIC_NUMERIC_ALWAYS_INLINE const SIMDf64FmaddExpr<T2, T3, T1> operator+(const SIMDf64<T1> &a,
...
template <typename T1 // Type of the first operand of the left-hand side multiplication
		  ...
		  ,
		  typename T4> // Type of the second operand of the right-hand side multiplication
METRIC_NUMERIC_ALWAYS_INLINE const SIMDf64FmaddExpr<T1, T2, SIMDf64MultExpr<T3, T4>>
...
template <typename T1 // Type of the first FMA multiplication operand
		  ...
		  ,
		  typename T4> // Type of the second addition operand
METRIC_NUMERIC_ALWAYS_INLINE decltype(auto) operator+(const SIMDf64FmaddExpr<T1, T2, T3> &a, const SIMDf64<T4> &b)
{
	return (a.a_ * a.b_) + (a.c_ + (*b));
}
#endif
...
template <typename T1 // Type of the first addition operand
		  ...
		  ,
		  typename T4> // Type of the FMA addition operand
METRIC_NUMERIC_ALWAYS_INLINE decltype(auto) operator+(const SIMDf64<T1> &a, const SIMDf64FmaddExpr<T2, T3, T4> &b)
{
	return (b.a_ * b.b_) + (b.c_ + (*a));
}
#endif
...
template <typename T1 // Type of the first FMA multiplication operand
		  ...
		  ,
		  typename T5> // Type of the second multiplication operand
METRIC_NUMERIC_ALWAYS_INLINE const SIMDf64FmaddExpr<T4, T5, SIMDf64FmaddExpr<T1, T2, T3>>
...
template <typename T1 // Type of the first multiplication operand
		  ...
		  ,
		  typename T5> // Type of the FMA addition operand
METRIC_NUMERIC_ALWAYS_INLINE const SIMDf64FmaddExpr<T1, T2, SIMDf64FmaddExpr<T3, T4, T5>>
...
template <typename T1 // Type of the first multiplication operand of the left-hand side FMA
		  ...
		  ,
		  typename T6> // Type of the addition operand of the right-hand side FMA
METRIC_NUMERIC_ALWAYS_INLINE decltype(auto) operator+(const SIMDf64FmaddExpr<T1, T2, T3> &a,
...
template <typename T1 // Type of the first multiplication operand of the left-hand side FMA
		  ...
		  ,
		  typename T6> // Type of the addition operand of the right-hand side FMA
METRIC_NUMERIC_ALWAYS_INLINE decltype(auto) operator+(const SIMDf64FmsubExpr<T1, T2, T3> &a,
													  const SIMDf64FmaddExpr<T4, T5, T6> &b)
{
	return (a.a_ * a.b_) + ((b.a_ * b.b_) + (b.c_ - a.c_));
}
...
template <typename T1 // Type of the first multiplication operand
		  ...
		  ,
		  typename T3> // Type of the second subtraction operand
METRIC_NUMERIC_ALWAYS_INLINE const SIMDf64FmsubExpr<T1, T2, T3> operator-(const SIMDf64MultExpr<T1, T2> &a,
																		  const SIMDf64<T3> &b)
{
...
template <typename T1 // Type of the first operand of the left-hand side multiplication
		  ...
		  ,
		  typename T4> // Type of the second operand of the right-hand side multiplication
METRIC_NUMERIC_ALWAYS_INLINE const SIMDf64FmsubExpr<T1, T2, SIMDf64MultExpr<T3, T4>>
operator-(const SIMDf64MultExpr<T1, T2> &a, const SIMDf64MultExpr<T3, T4> &b)
{
...
template <typename T1 // Type of the first FMA multiplication operand
		  ...
		  ,
		  typename T4> // Type of the second subtraction operand
METRIC_NUMERIC_ALWAYS_INLINE decltype(auto) operator-(const SIMDf64FmsubExpr<T1, T2, T3> &a, const SIMDf64<T4> &b)
{
	return (a.a_ * a.b_) - (a.c_ + (*b));
}
#endif
...
template <typename T1 // Type of the first multiplication operand
		  ...
		  ,
		  typename T5> // Type of the FMA subtraction operand
METRIC_NUMERIC_ALWAYS_INLINE const SIMDf64FmsubExpr<T1, T2, SIMDf64FmsubExpr<T3, T4, T5>>
