...
#ifndef METRIC_NUMERIC_MATH_SIMD_ATAN_H
#define METRIC_NUMERIC_MATH_SIMD_ATAN_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
METRIC_NUMERIC_ALWAYS_INLINE const SIMDfloat atan(const SIMDf32<T> &a) noexcept
...
*/
template <typename T> // Type of the operand
METRIC_NUMERIC_ALWAYS_INLINE const SIMDdouble atan(const SIMDf64<T> &a) noexcept
#if METRIC_NUMERIC_SVML_MODE
#if (METRIC_NUMERIC_AVX512F_MODE || METRIC_NUMERIC_MIC_MODE)
{
