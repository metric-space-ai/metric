...
#ifndef METRIC_NUMERIC_MATH_SIMD_MIN_H
#define METRIC_NUMERIC_MATH_SIMD_MIN_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
*/
METRIC_NUMERIC_ALWAYS_INLINE const SIMDint8 min(const SIMDint8 &a, const SIMDint8 &b) noexcept
...
*/
METRIC_NUMERIC_ALWAYS_INLINE const SIMDuint8 min(const SIMDuint8 &a, const SIMDuint8 &b) noexcept
#if METRIC_NUMERIC_AVX512BW_MODE
{
...
// This operation is only available for SSE2, AVX2, and AVX-512.
*/
METRIC_NUMERIC_ALWAYS_INLINE const SIMDint16 min(const SIMDint16 &a, const SIMDint16 &b) noexcept
#if METRIC_NUMERIC_AVX512BW_MODE
{
...
// This operation is only available for SSE4, AVX2, and AVX-512.
*/
METRIC_NUMERIC_ALWAYS_INLINE const SIMDuint16 min(const SIMDuint16 &a, const SIMDuint16 &b) noexcept
#if METRIC_NUMERIC_AVX512BW_MODE
{
...
*/
METRIC_NUMERIC_ALWAYS_INLINE const SIMDint32 min(const SIMDint32 &a, const SIMDint32 &b) noexcept
...
// This operation is only available for SSE4, AVX2, MIC, and AVX-512.
*/
METRIC_NUMERIC_ALWAYS_INLINE const SIMDuint32 min(const SIMDuint32 &a, const SIMDuint32 &b) noexcept
#if METRIC_NUMERIC_AVX512F_MODE || METRIC_NUMERIC_MIC_MODE
{
...
METRIC_NUMERIC_ALWAYS_INLINE const SIMDfloat min(const SIMDf32<T1> &a, const SIMDf32<T2> &b) noexcept
#if METRIC_NUMERIC_AVX512F_MODE || METRIC_NUMERIC_MIC_MODE
{
...
template <typename T1 // Type of the left-hand side operand
		  ,
		  typename T2> // Type of the right-hand side operand
METRIC_NUMERIC_ALWAYS_INLINE const SIMDdouble min(const SIMDf64<T1> &a, const SIMDf64<T2> &b) noexcept
#if METRIC_NUMERIC_AVX512F_MODE || METRIC_NUMERIC_MIC_MODE
{
