...
#ifndef METRIC_NUMERIC_MATH_SIMD_MULT_H
#define METRIC_NUMERIC_MATH_SIMD_MULT_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
// This operation is only available for SSE2 and AVX2.
*/
METRIC_NUMERIC_ALWAYS_INLINE const SIMDcint16 operator*(const SIMDint16 &a, const SIMDcint16 &b) noexcept
#if METRIC_NUMERIC_AVX512BW_MODE
{
	return _mm512_mullo_epi16((*a).value, (*b).value);
}
...
// This operation is only available for SSE2 and AVX2.
*/
METRIC_NUMERIC_ALWAYS_INLINE const SIMDcuint16 operator*(const SIMDuint16 &a, const SIMDcuint16 &b) noexcept
#if METRIC_NUMERIC_AVX512BW_MODE
{
	return _mm512_mullo_epi16((*a).value, (*b).value);
}
...
#if METRIC_NUMERIC_AVX512BW_MODE
{
	...
	const __m512i a_ii_b_ri_signed = _mm512_mask_sub_epi16(a_ii_b_ri, 0x55555555, _mm512_setzero_si512(), a_ii_b_ri);
...
template <typename T1 // Type of the left-hand side operand
		  ,
		  typename T2> // Type of the right-hand side operand
METRIC_NUMERIC_ALWAYS_INLINE const SIMDcint32 operator*(const SIMDint32 &a, const SIMDcint32 &b) noexcept
#if METRIC_NUMERIC_AVX512F_MODE || METRIC_NUMERIC_MIC_MODE
{
	return _mm512_mullo_epi32((*a).value, (*b).value);
}
...
template <typename T1 // Type of the left-hand side operand
		  ,
		  typename T2> // Type of the right-hand side operand
METRIC_NUMERIC_ALWAYS_INLINE const SIMDcuint32 operator*(const SIMDuint32 &a, const SIMDcuint32 &b) noexcept
#if METRIC_NUMERIC_AVX512F_MODE || METRIC_NUMERIC_MIC_MODE
{
	return _mm512_mullo_epi32((*a).value, (*b).value);
}
...
#if METRIC_NUMERIC_AVX512F_MODE
{
	...
	const __m512i a_ii_b_ri_signed =
		_mm512_mask_sub_epi32(a_ii_b_ri, 0b0101010101010101, _mm512_setzero_si512(), a_ii_b_ri);
...
#if METRIC_NUMERIC_AVX512DQ_MODE
{
...
template <typename T1 // Type of the left-hand side operand
		  ,
		  typename T2> // Type of the right-hand side operand
METRIC_NUMERIC_ALWAYS_INLINE const SIMDcint64 operator*(const SIMDint64 &a, const SIMDcint64 &b) noexcept
#if METRIC_NUMERIC_AVX512DQ_MODE
{
	return _mm512_mullo_epi64((*a).value, (*b).value);
}
...
template <typename T1 // Type of the left-hand side operand
		  ,
		  typename T2> // Type of the right-hand side operand
METRIC_NUMERIC_ALWAYS_INLINE const SIMDcuint64 operator*(const SIMDuint64 &a, const SIMDcuint64 &b) noexcept
#if METRIC_NUMERIC_AVX512DQ_MODE || METRIC_NUMERIC_MIC_MODE
{
	return _mm512_mullo_epi64((*a).value, (*b).value);
}
#else
...
struct SIMDf32MultExpr : public SIMDf32<SIMDf32MultExpr<T1, T2>> {
	...
	*/
	METRIC_NUMERIC_ALWAYS_INLINE SIMDf32MultExpr(const T1 &a, const T2 &b)
...
template <typename T1 // Type of the left-hand side operand
		  ,
		  typename T2> // Type of the right-hand side operand
METRIC_NUMERIC_ALWAYS_INLINE const SIMDf32MultExpr<T1, T2> operator*(const SIMDf32<T1> &a,
...
// This operation is only available for SSE, AVX, MIC, and AVX-512.
*/
METRIC_NUMERIC_ALWAYS_INLINE const SIMDcfloat operator*(const SIMDfloat &a, const SIMDcfloat &b) noexcept
#if METRIC_NUMERIC_AVX512F_MODE || METRIC_NUMERIC_MIC_MODE
{
	return _mm512_mul_ps(a.value, b.value);
}
...
struct SIMDf64MultExpr : public SIMDf64<SIMDf64MultExpr<T1, T2>> {
	...
	// \param b The right-hand side operand for the multiplication.
	*/
	METRIC_NUMERIC_ALWAYS_INLINE SIMDf64MultExpr(const T1 &a, const T2 &b)
		: a_(a) // The left-hand side operand for the multiplication
		  ,
		  b_(b) // The right-hand side operand for the multiplication
	{
...
template <typename T1 // Type of the left-hand side operand
		  ,
		  typename T2> // Type of the right-hand side operand
METRIC_NUMERIC_ALWAYS_INLINE const SIMDf64MultExpr<T1, T2> operator*(const SIMDf64<T1> &a,
...
// This operation is only available for SSE2, AVX, MIC, and AVX-512.
*/
METRIC_NUMERIC_ALWAYS_INLINE const SIMDcdouble operator*(const SIMDdouble &a, const SIMDcdouble &b) noexcept
#if METRIC_NUMERIC_AVX512F_MODE || METRIC_NUMERIC_MIC_MODE
{
	return _mm512_mul_pd(a.value, b.value);
}
