...
#ifndef METRIC_NUMERIC_MATH_UPPERMATRIX_H
#define METRIC_NUMERIC_MATH_UPPERMATRIX_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class Rand<UpperMatrix<MT, SO, DF>> {
  public:
	...
	*/
	template <typename Arg> // Min/max argument type
	inline const UpperMatrix<MT, SO, DF> generate(size_t n, size_t nonzeros, const Arg &min, const Arg &max) const
	{
		METRIC_NUMERIC_CONSTRAINT_MUST_BE_RESIZABLE_TYPE(MT);
		METRIC_NUMERIC_CONSTRAINT_MUST_BE_SPARSE_MATRIX_TYPE(MT);
	...
	*/
	template <typename Arg> // Min/max argument type
	inline void randomize(UpperMatrix<MT, false, DF> &matrix, size_t nonzeros, const Arg &min, const Arg &max) const
	{
		METRIC_NUMERIC_CONSTRAINT_MUST_BE_SPARSE_MATRIX_TYPE(MT);
	...
	*/
	template <typename Arg> // Min/max argument type
	inline void randomize(UpperMatrix<MT, true, DF> &matrix, size_t nonzeros, const Arg &min, const Arg &max) const
	{
		METRIC_NUMERIC_CONSTRAINT_MUST_BE_SPARSE_MATRIX_TYPE(MT);
