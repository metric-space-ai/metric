...
#ifndef METRIC_NUMERIC_MATH_ADAPTORS_STRICTLYLOWERMATRIX_SPARSE_H
#define METRIC_NUMERIC_MATH_ADAPTORS_STRICTLYLOWERMATRIX_SPARSE_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class StrictlyLowerMatrix<MT, SO, false> : public SparseMatrix<StrictlyLowerMatrix<MT, SO, false>, SO> {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	using OppositeType = StrictlyLowerMatrix<OT, !SO, false>;  //!< Result type with opposite storage order for
...
template <typename MT // Type of the adapted sparse matrix
		  ,
		  bool SO> // Storage order of the adapted sparse matrix
inline StrictlyLowerMatrix<MT, SO, false>::StrictlyLowerMatrix() : matrix_() // The adapted sparse matrix
{
...
template <typename MT // Type of the adapted sparse matrix
		  ,
		  bool SO> // Storage order of the adapted sparse matrix
inline StrictlyLowerMatrix<MT, SO, false>::StrictlyLowerMatrix(size_t n) : matrix_(n, n) // The adapted sparse matrix
{
...
// lower matrix by means of an initializer list:
   ...
   mtrc::numeric::StrictlyLowerMatrix< mtrc::numeric::CompressedMatrix<int,rowMajor> > A{ { },
																		  { 2 },
																		  { 4, 5 } };
   \endcode
...
{
	if (IsUniTriangular_v<MT2> || (!IsStrictlyLower_v<MT2> && !isStrictlyLower(matrix_))) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Invalid setup of strictly lower matrix");
	}
...
template <typename MT // Type of the adapted sparse matrix
		  ,
		  bool SO> // Storage order of the adapted sparse matrix
inline typename StrictlyLowerMatrix<MT, SO, false>::Reference StrictlyLowerMatrix<MT, SO, false>::operator()(size_t i,
																											 size_t j)
{
...
template <typename MT // Type of the adapted sparse matrix
		  ,
		  bool SO> // Storage order of the adapted sparse matrix
inline typename StrictlyLowerMatrix<MT, SO, false>::Reference StrictlyLowerMatrix<MT, SO, false>::at(size_t i, size_t j)
{
	if (i >= rows()) {
...
template <typename MT // Type of the adapted sparse matrix
		  ...
		  bool SO> // Storage order of the adapted sparse matrix
inline
	typename StrictlyLowerMatrix<MT, SO, false>::ConstReference StrictlyLowerMatrix<MT, SO, false>::at(size_t i,
																									   size_t j) const
{
	if (i >= rows()) {
		METRIC_NUMERIC_THROW_OUT_OF_RANGE("Invalid row access index");
...
template <typename MT // Type of the adapted sparse matrix
		  ,
		  bool SO> // Storage order of the adapted sparse matrix
inline typename StrictlyLowerMatrix<MT, SO, false>::Iterator StrictlyLowerMatrix<MT, SO, false>::begin(size_t i)
{
...
template <typename MT // Type of the adapted sparse matrix
		  ...
		  bool SO> // Storage order of the adapted sparse matrix
inline
	typename StrictlyLowerMatrix<MT, SO, false>::ConstIterator StrictlyLowerMatrix<MT, SO, false>::begin(size_t i) const
{
	return matrix_.begin(i);
}
/*! \endcond */
...
template <typename MT // Type of the adapted sparse matrix
		  ,
		  bool SO> // Storage order of the adapted sparse matrix
inline typename StrictlyLowerMatrix<MT, SO, false>::Iterator StrictlyLowerMatrix<MT, SO, false>::end(size_t i)
{
...
template <typename MT // Type of the adapted sparse matrix
		  ...
		  bool SO> // Storage order of the adapted sparse matrix
inline
	typename StrictlyLowerMatrix<MT, SO, false>::ConstIterator StrictlyLowerMatrix<MT, SO, false>::end(size_t i) const
{
	return matrix_.end(i);
}
/*! \endcond */
...
template <typename MT // Type of the adapted sparse matrix
		  ...
		  bool SO> // Storage order of the adapted sparse matrix
inline
	typename StrictlyLowerMatrix<MT, SO, false>::ConstIterator StrictlyLowerMatrix<MT, SO, false>::cend(size_t i) const
{
...
template <typename MT // Type of the adapted sparse matrix
		  ,
		  bool SO> // Storage order of the adapted sparse matrix
inline StrictlyLowerMatrix<MT, SO, false> &StrictlyLowerMatrix<MT, SO, false>::operator=(const StrictlyLowerMatrix &rhs)
{
	matrix_ = rhs.matrix_;
...
template <typename MT2 // Type of the right-hand side matrix
		  ,
		  bool SO2> // Storage order of the right-hand side matrix
inline auto StrictlyLowerMatrix<MT, SO, false>::operator%=(const Matrix<MT2, SO2> &rhs) -> StrictlyLowerMatrix &
{
...
template <typename MT // Type of the adapted sparse matrix
		  ,
		  bool SO> // Storage order of the adapted sparse matrix
inline typename StrictlyLowerMatrix<MT, SO, false>::Iterator StrictlyLowerMatrix<MT, SO, false>::erase(size_t i,
																									   Iterator pos)
{
	using mtrc::numeric::erase;
...
// how to remove all elements that are smaller than a certain threshold value:
   ...
   \code
   mtrc::numeric::StrictlyLowerMatrix< CompressedMatrix<double,mtrc::numeric::rowMajor> > A;
...
template <typename MT // Type of the adapted sparse matrix
		  ...
		  bool SO> // Storage order of the adapted sparse matrix
inline
	typename StrictlyLowerMatrix<MT, SO, false>::Iterator StrictlyLowerMatrix<MT, SO, false>::find(size_t i, size_t j)
{
...
template <typename MT // Type of the adapted sparse matrix
		  ...
		  bool SO> // Storage order of the adapted sparse matrix
inline
	typename StrictlyLowerMatrix<MT, SO, false>::ConstIterator StrictlyLowerMatrix<MT, SO, false>::find(size_t i,
																										size_t j) const
{
	return matrix_.find(i, j);
}
...
template <typename MT // Type of the adapted sparse matrix
		  ,
		  bool SO> // Storage order of the adapted sparse matrix
inline typename StrictlyLowerMatrix<MT, SO, false>::Iterator StrictlyLowerMatrix<MT, SO, false>::lowerBound(size_t i,
																											size_t j)
{
...
template <typename MT // Type of the adapted sparse matrix
		  ,
		  bool SO> // Storage order of the adapted sparse matrix
inline typename StrictlyLowerMatrix<MT, SO, false>::Iterator StrictlyLowerMatrix<MT, SO, false>::upperBound(size_t i,
																											size_t j)
{
...
// multiplication assignment operator:
   ...
   \code
   mtrc::numeric::StrictlyLowerMatrix< mtrc::numeric::CompressedMatrix<int> > A;
   // ... Resizing and initialization
...
inline StrictlyLowerMatrix<MT, SO, false> &StrictlyLowerMatrix<MT, SO, false>::scale(const Other &scalar)
{
