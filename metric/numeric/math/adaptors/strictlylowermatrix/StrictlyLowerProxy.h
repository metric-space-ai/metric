...
#ifndef METRIC_NUMERIC_MATH_ADAPTORS_LOWERMATRIX_STRICTLYLOWERPROXY_H
#define METRIC_NUMERIC_MATH_ADAPTORS_LOWERMATRIX_STRICTLYLOWERPROXY_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
// matrix:
   ...
   mtrc::numeric::StrictlyLowerMatrix< mtrc::numeric::DynamicMatrix<int> > A( 3UL );
...
class StrictlyLowerProxy : public Proxy<StrictlyLowerProxy<MT>, ElementType_t<MT>> {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	template <typename T> inline const StrictlyLowerProxy &operator=(initializer_list<T> list) const;

	template <typename T> inline const StrictlyLowerProxy &operator=(initializer_list<initializer_list<T>> list) const;
...
inline const StrictlyLowerProxy<MT> &StrictlyLowerProxy<MT>::operator=(initializer_list<T> list) const
{
	if (restricted_) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Invalid assignment to diagonal or upper matrix element");
	}
...
template <typename MT> // Type of the adapted matrix
template <typename T>  // Type of the right-hand side value
inline const StrictlyLowerProxy<MT> &StrictlyLowerProxy<MT>::operator=(initializer_list<initializer_list<T>> list) const
{
	if (restricted_) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Invalid assignment to diagonal or upper matrix element");
	}
