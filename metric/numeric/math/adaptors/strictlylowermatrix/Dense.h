...
#ifndef METRIC_NUMERIC_MATH_ADAPTORS_STRICTLYLOWERMATRIX_DENSE_H
#define METRIC_NUMERIC_MATH_ADAPTORS_STRICTLYLOWERMATRIX_DENSE_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
#include <metric/numeric/math/adaptors/strictlylowermatrix/StrictlyLowerProxy.h>
...
class StrictlyLowerMatrix<MT, SO, true> : public DenseMatrix<StrictlyLowerMatrix<MT, SO, true>, SO> {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	using OppositeType = StrictlyLowerMatrix<OT, !SO, true>; //!< Result type with opposite storage order for expression
	...
	template <typename Other> inline StrictlyLowerMatrix(size_t n, const Other *array);

	template <typename Other, size_t N> inline StrictlyLowerMatrix(const Other (&array)[N][N]);
	...
	template <typename Other, size_t N> inline StrictlyLowerMatrix &operator=(const Other (&array)[N][N]);
	...
	inline auto operator=(const Matrix<MT2, SO2> &rhs) -> DisableIf_t<IsComputation_v<MT2>, StrictlyLowerMatrix &>;

	template <typename MT2, bool SO2>
	inline auto operator=(const Matrix<MT2, SO2> &rhs) -> EnableIf_t<IsComputation_v<MT2>, StrictlyLowerMatrix &>;
	...
	template <typename MT2, bool SO2> inline auto operator%=(const Matrix<MT2, SO2> &rhs) -> StrictlyLowerMatrix &;

	template <typename ST> inline auto operator*=(ST rhs) -> EnableIf_t<IsScalar_v<ST>, StrictlyLowerMatrix &>;
  ...
  private:
	...
	//**Friend declarations*************************************************************************
	template <typename MT2, bool SO2, bool DF2> friend MT2 &derestrict(StrictlyLowerMatrix<MT2, SO2, DF2> &m);
	//**********************************************************************************************
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO>															// Storage order of the adapted dense matrix
inline StrictlyLowerMatrix<MT, SO, true>::StrictlyLowerMatrix() : matrix_() // The adapted dense matrix
{
	METRIC_NUMERIC_INTERNAL_ASSERT(isSquare(matrix_), "Non-square strictly lower matrix detected");
...
// lower matrix by means of an initializer list:
   ...
   mtrc::numeric::StrictlyLowerMatrix< mtrc::numeric::StaticMatrix<int,3,3,rowMajor> > A{ { },
																		  { 2 },
																		  { 4, 5 } };
   \endcode
	...
	: matrix_(list) // The adapted dense matrix
{
	if (!isStrictlyLower(matrix_)) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Invalid setup of strictly lower matrix");
	}
...
// matrix with a dynamic array:
   ...
   mtrc::numeric::StrictlyLowerMatrix< mtrc::numeric::DynamicMatrix<int,rowMajor> > v( 4UL, array );
   delete[] array;
   \endcode
...
// matrix with a static array:
   ...
   const int init[3][3] = { {  },
							{ 2 },
							{ 4, 5 } };
   mtrc::numeric::StrictlyLowerMatrix< mtrc::numeric::StaticMatrix<int,3,3,rowMajor> > A( init );
   \endcode
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename StrictlyLowerMatrix<MT, SO, true>::Reference StrictlyLowerMatrix<MT, SO, true>::operator()(size_t i,
																										   size_t j)
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename StrictlyLowerMatrix<MT, SO, true>::Reference StrictlyLowerMatrix<MT, SO, true>::at(size_t i, size_t j)
{
	if (i >= rows()) {
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename StrictlyLowerMatrix<MT, SO, true>::ConstReference StrictlyLowerMatrix<MT, SO, true>::at(size_t i,
																										size_t j) const
{
	if (i >= rows()) {
		METRIC_NUMERIC_THROW_OUT_OF_RANGE("Invalid row access index");
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename StrictlyLowerMatrix<MT, SO, true>::ConstPointer StrictlyLowerMatrix<MT, SO, true>::data() const noexcept
{
	return matrix_.data();
}
/*! \endcond */
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename StrictlyLowerMatrix<MT, SO, true>::Iterator StrictlyLowerMatrix<MT, SO, true>::begin(size_t i)
{
	if (SO)
...
template <typename MT // Type of the adapted dense matrix
		  ...
		  bool SO> // Storage order of the adapted dense matrix
inline
	typename StrictlyLowerMatrix<MT, SO, true>::ConstIterator StrictlyLowerMatrix<MT, SO, true>::begin(size_t i) const
{
...
template <typename MT // Type of the adapted dense matrix
		  ...
		  bool SO> // Storage order of the adapted dense matrix
inline
	typename StrictlyLowerMatrix<MT, SO, true>::ConstIterator StrictlyLowerMatrix<MT, SO, true>::cbegin(size_t i) const
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename StrictlyLowerMatrix<MT, SO, true>::Iterator StrictlyLowerMatrix<MT, SO, true>::end(size_t i)
{
	if (SO)
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename StrictlyLowerMatrix<MT, SO, true>::ConstIterator StrictlyLowerMatrix<MT, SO, true>::end(size_t i) const
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename StrictlyLowerMatrix<MT, SO, true>::ConstIterator StrictlyLowerMatrix<MT, SO, true>::cend(size_t i) const
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline StrictlyLowerMatrix<MT, SO, true> &StrictlyLowerMatrix<MT, SO, true>::operator=(const ElementType &rhs)
{
	if (SO) {
		for (size_t j = 0UL; j < columns(); ++j)
			for (size_t i = j + 1UL; i < rows(); ++i)
...
// lower matrix by means of an initializer list:
   ...
   mtrc::numeric::StrictlyLowerMatrix< mtrc::numeric::StaticMatrix<int,3UL,3UL,rowMajor> > A;
   A = { { },
		 { 2 },
		 { 4, 5 } };
   \endcode
...
StrictlyLowerMatrix<MT, SO, true>::operator=(initializer_list<initializer_list<ElementType>> list)
{
	...
	if (!isStrictlyLower(tmp)) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Invalid assignment to strictly lower matrix");
	}
...
template <typename Other // Data type of the initialization array
		  ,
		  size_t N> // Number of rows and columns of the initialization array
inline StrictlyLowerMatrix<MT, SO, true> &StrictlyLowerMatrix<MT, SO, true>::operator=(const Other (&array)[N][N])
{
	MT tmp(array);
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline StrictlyLowerMatrix<MT, SO, true> &StrictlyLowerMatrix<MT, SO, true>::operator=(const StrictlyLowerMatrix &rhs)
{
	matrix_ = rhs.matrix_;
...
{
	if (IsUniTriangular_v<MT2> || (!IsStrictlyLower_v<MT2> && !isStrictlyLower(*rhs))) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Invalid assignment to strictly lower matrix");
	}
...
template <typename MT2 // Type of the right-hand side matrix
		  ,
		  bool SO2> // Storage order of the right-hand side matrix
inline auto StrictlyLowerMatrix<MT, SO, true>::operator%=(const Matrix<MT2, SO2> &rhs) -> StrictlyLowerMatrix &
{
...
inline auto StrictlyLowerMatrix<MT, SO, true>::operator*=(ST rhs) -> EnableIf_t<IsScalar_v<ST>, StrictlyLowerMatrix &>
{
	matrix_ *= rhs;
	return *this;
}
...
// multiplication assignment operator:
   ...
   \code
   mtrc::numeric::StrictlyLowerMatrix< mtrc::numeric::DynamicMatrix<int> > A;
...
inline StrictlyLowerMatrix<MT, SO, true> &StrictlyLowerMatrix<MT, SO, true>::scale(const Other &scalar)
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
METRIC_NUMERIC_ALWAYS_INLINE typename StrictlyLowerMatrix<MT, SO, true>::SIMDType
...
inline const MT StrictlyLowerMatrix<MT, SO, true>::construct(const Matrix<MT2, SO2> &m, T)
{
	...
	if (IsUniTriangular_v<MT2> || (!IsStrictlyLower_v<MT2> && !isStrictlyLower(tmp))) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Invalid setup of strictly lower matrix");
	}
