...
#ifndef METRIC_NUMERIC_MATH_ADAPTORS_STRICTLYLOWERMATRIX_BASETEMPLATE_H
#define METRIC_NUMERIC_MATH_ADAPTORS_STRICTLYLOWERMATRIX_BASETEMPLATE_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
// The following examples give an impression of several possible strictly lower triangular matrices:
   ...
   mtrc::numeric::StrictlyLowerMatrix< mtrc::numeric::HybridMatrix<float,4UL,4UL,columnMajor> B;

   // Definition of a resizable row-major dense strictly lower matrix based on DynamicMatrix
   mtrc::numeric::StrictlyLowerMatrix< mtrc::numeric::DynamicMatrix<double,rowMajor> > C;

   // Definition of a fixed-size row-major dense strictly lower matrix based on CustomMatrix
   mtrc::numeric::StrictlyLowerMatrix< mtrc::numeric::CustomMatrix<double,unaligned,unpadded,rowMajor> > D;

   // Definition of a compressed row-major single precision strictly lower matrix
   mtrc::numeric::StrictlyLowerMatrix< mtrc::numeric::CompressedMatrix<float,rowMajor> > E;
   \endcode
...
// is specified as mtrc::numeric::rowMajor), the strictly lower matrix will also be a row-major matrix.
...
// exception is thrown:
   ...
   CustomStrictlyLower B( new double[9UL], 3UL, mtrc::numeric::ArrayDelete() );  // Throws an exception
   \endcode
...
// \n \subsection strictlylowermatrix_initialization The Diagonal and Upper Elements of a Dense Strictly Lower
...
//
// The \b Metric numeric library tries to exploit the properties of strictly lower triangular matrices
...
//
// When multiplying two matrices, at least one of which is strictly lower triangular, \b Metric numeric
