...
#ifndef METRIC_NUMERIC_MATH_ADAPTORS_STRICTLYUPPERMATRIX_SPARSE_H
#define METRIC_NUMERIC_MATH_ADAPTORS_STRICTLYUPPERMATRIX_SPARSE_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class StrictlyUpperMatrix<MT, SO, false> : public SparseMatrix<StrictlyUpperMatrix<MT, SO, false>, SO> {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	using OppositeType = StrictlyUpperMatrix<OT, !SO, false>;  //!< Result type with opposite storage order for
...
template <typename MT // Type of the adapted sparse matrix
		  ,
		  bool SO> // Storage order of the adapted sparse matrix
inline StrictlyUpperMatrix<MT, SO, false>::StrictlyUpperMatrix() : matrix_() // The adapted sparse matrix
{
...
template <typename MT // Type of the adapted sparse matrix
		  ,
		  bool SO> // Storage order of the adapted sparse matrix
inline StrictlyUpperMatrix<MT, SO, false>::StrictlyUpperMatrix(size_t n) : matrix_(n, n) // The adapted sparse matrix
{
...
// upper matrix by means of an initializer list:
   ...
   mtrc::numeric::StrictlyUpperMatrix< mtrc::numeric::CompressedMatrix<int,rowMajor> > A{ { 0, 2, 3 },
																		  { 0, 0 },
																		  { 0, 0, 0 } };
   \endcode
...
{
	if (IsUniTriangular_v<MT2> || (!IsStrictlyUpper_v<MT2> && !isStrictlyUpper(matrix_))) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Invalid setup of strictly upper matrix");
	}
...
template <typename MT // Type of the adapted sparse matrix
		  ,
		  bool SO> // Storage order of the adapted sparse matrix
inline typename StrictlyUpperMatrix<MT, SO, false>::Reference StrictlyUpperMatrix<MT, SO, false>::operator()(size_t i,
																											 size_t j)
{
...
template <typename MT // Type of the adapted sparse matrix
		  ,
		  bool SO> // Storage order of the adapted sparse matrix
inline typename StrictlyUpperMatrix<MT, SO, false>::Reference StrictlyUpperMatrix<MT, SO, false>::at(size_t i, size_t j)
{
	if (i >= rows()) {
...
template <typename MT // Type of the adapted sparse matrix
		  ...
		  bool SO> // Storage order of the adapted sparse matrix
inline
	typename StrictlyUpperMatrix<MT, SO, false>::ConstReference StrictlyUpperMatrix<MT, SO, false>::at(size_t i,
																									   size_t j) const
{
	if (i >= rows()) {
		METRIC_NUMERIC_THROW_OUT_OF_RANGE("Invalid row access index");
...
template <typename MT // Type of the adapted sparse matrix
		  ,
		  bool SO> // Storage order of the adapted sparse matrix
inline typename StrictlyUpperMatrix<MT, SO, false>::Iterator StrictlyUpperMatrix<MT, SO, false>::begin(size_t i)
{
...
template <typename MT // Type of the adapted sparse matrix
		  ...
		  bool SO> // Storage order of the adapted sparse matrix
inline
	typename StrictlyUpperMatrix<MT, SO, false>::ConstIterator StrictlyUpperMatrix<MT, SO, false>::begin(size_t i) const
{
	return matrix_.begin(i);
}
/*! \endcond */
...
template <typename MT // Type of the adapted sparse matrix
		  ,
		  bool SO> // Storage order of the adapted sparse matrix
inline typename StrictlyUpperMatrix<MT, SO, false>::Iterator StrictlyUpperMatrix<MT, SO, false>::end(size_t i)
{
...
template <typename MT // Type of the adapted sparse matrix
		  ...
		  bool SO> // Storage order of the adapted sparse matrix
inline
	typename StrictlyUpperMatrix<MT, SO, false>::ConstIterator StrictlyUpperMatrix<MT, SO, false>::end(size_t i) const
{
	return matrix_.end(i);
}
/*! \endcond */
...
template <typename MT // Type of the adapted sparse matrix
		  ...
		  bool SO> // Storage order of the adapted sparse matrix
inline
	typename StrictlyUpperMatrix<MT, SO, false>::ConstIterator StrictlyUpperMatrix<MT, SO, false>::cend(size_t i) const
{
...
// upper matrix by means of an initializer list:
   ...
   mtrc::numeric::StrictlyUpperMatrix< mtrc::numeric::CompressedMatrix<int,rowMajor> > A;
   A = { { 0, 2, 3 },
		 { 0, 0 },
		 { 0, 0, 0 } };
   \endcode
...
template <typename MT // Type of the adapted sparse matrix
		  ,
		  bool SO> // Storage order of the adapted sparse matrix
inline StrictlyUpperMatrix<MT, SO, false> &StrictlyUpperMatrix<MT, SO, false>::operator=(const StrictlyUpperMatrix &rhs)
{
	matrix_ = rhs.matrix_;
...
template <typename MT2 // Type of the right-hand side matrix
		  ,
		  bool SO2> // Storage order of the right-hand side matrix
inline auto StrictlyUpperMatrix<MT, SO, false>::operator%=(const Matrix<MT2, SO2> &rhs) -> StrictlyUpperMatrix &
{
...
template <typename MT // Type of the adapted sparse matrix
		  ,
		  bool SO> // Storage order of the adapted sparse matrix
inline typename StrictlyUpperMatrix<MT, SO, false>::Iterator StrictlyUpperMatrix<MT, SO, false>::erase(size_t i,
																									   Iterator pos)
{
	using mtrc::numeric::erase;
...
// how to remove all elements that are smaller than a certain threshold value:
   ...
   \code
   mtrc::numeric::StrictlyUpperMatrix< CompressedMatrix<double,mtrc::numeric::rowMajor> > A;
...
template <typename MT // Type of the adapted sparse matrix
		  ...
		  bool SO> // Storage order of the adapted sparse matrix
inline
	typename StrictlyUpperMatrix<MT, SO, false>::Iterator StrictlyUpperMatrix<MT, SO, false>::find(size_t i, size_t j)
{
...
template <typename MT // Type of the adapted sparse matrix
		  ...
		  bool SO> // Storage order of the adapted sparse matrix
inline
	typename StrictlyUpperMatrix<MT, SO, false>::ConstIterator StrictlyUpperMatrix<MT, SO, false>::find(size_t i,
																										size_t j) const
{
	return matrix_.find(i, j);
}
...
template <typename MT // Type of the adapted sparse matrix
		  ,
		  bool SO> // Storage order of the adapted sparse matrix
inline typename StrictlyUpperMatrix<MT, SO, false>::Iterator StrictlyUpperMatrix<MT, SO, false>::lowerBound(size_t i,
																											size_t j)
{
...
template <typename MT // Type of the adapted sparse matrix
		  ,
		  bool SO> // Storage order of the adapted sparse matrix
inline typename StrictlyUpperMatrix<MT, SO, false>::Iterator StrictlyUpperMatrix<MT, SO, false>::upperBound(size_t i,
																											size_t j)
{
...
// multiplication assignment operator:
   ...
   \code
   mtrc::numeric::StrictlyUpperMatrix< mtrc::numeric::CompressedMatrix<int> > A;
   // ... Resizing and initialization
...
inline StrictlyUpperMatrix<MT, SO, false> &StrictlyUpperMatrix<MT, SO, false>::scale(const Other &scalar)
{
