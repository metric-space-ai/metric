...
#ifndef METRIC_NUMERIC_MATH_ADAPTORS_UNIUPPERMATRIX_H
#define METRIC_NUMERIC_MATH_ADAPTORS_UNIUPPERMATRIX_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
#include <metric/numeric/math/adaptors/uniuppermatrix/Dense.h>
#include <metric/numeric/math/adaptors/uniuppermatrix/Sparse.h>
...
//@{
template <RelaxationFlag RF, typename MT, bool SO, bool DF> bool isDefault(const UniUpperMatrix<MT, SO, DF> &m);

template <typename MT, bool SO, bool DF> bool isIntact(const UniUpperMatrix<MT, SO, DF> &m);
...
inline void invert(UniUpperMatrix<MT, SO, true> &m)
{
	...
	constexpr InversionFlag flag((IF == byLU || IF == asGeneral || IF == asUpper || IF == asUniUpper) ? (asUniUpper)
																									  : (asDiagonal));
...
inline void lu(const UniUpperMatrix<MT1, SO1, true> &A, DenseMatrix<MT2, SO1> &L, DenseMatrix<MT3, SO1> &U,
			   Matrix<MT4, SO2> &P)
{
...
inline bool trySet(const UniUpperMatrix<MT, SO, DF> &mat, size_t i, size_t j, const ET &value)
{
	...
	return (i < j) || (i == j && isOne(value)) || isDefault(value);
}
/*! \endcond */
//*************************************************************************************************
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool trySet(const UniUpperMatrix<MT, SO, DF> &mat, size_t row, size_t column, size_t m,
										 size_t n, const ET &value)
{
	...
	return (m == 0UL) || (n == 0UL) || (column >= row + m) || ((row >= column + n) && isDefault(value)) ||
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryAdd(const UniUpperMatrix<MT, SO, DF> &mat, size_t row, size_t column, size_t m,
										 size_t n, const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*mat).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*mat).columns(), "Invalid column access index");
	...
	return (m == 0UL) || (n == 0UL) || (column >= row + m) || isDefault(value);
}
/*! \endcond */
//*************************************************************************************************
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool trySub(const UniUpperMatrix<MT, SO, DF> &mat, size_t row, size_t column, size_t m,
										 size_t n, const ET &value)
{
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryMult(const UniUpperMatrix<MT, SO, DF> &mat, size_t row, size_t column, size_t m,
										  size_t n, const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*mat).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*mat).columns(), "Invalid column access index");
	...
	return (m == 0UL) || (n == 0UL) || (column >= row + m) || (row >= column + n) || isOne(value);
}
/*! \endcond */
//*************************************************************************************************
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryDiv(const UniUpperMatrix<MT, SO, DF> &mat, size_t row, size_t column, size_t m,
										 size_t n, const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*mat).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*mat).columns(), "Invalid column access index");
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  bool DF> // Density flag
METRIC_NUMERIC_ALWAYS_INLINE bool tryShift(const UniUpperMatrix<MT, SO, DF> &mat, size_t row, size_t column, size_t m,
										   size_t n, int count)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*mat).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*mat).columns(), "Invalid column access index");
	...
	return (m == 0UL) || (n == 0UL) || (column >= row + m) || (row >= column + n) || isDefault(count);
}
/*! \endcond */
//*************************************************************************************************
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryBitand(const UniUpperMatrix<MT, SO, DF> &mat, size_t row, size_t column, size_t m,
											size_t n, const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*mat).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*mat).columns(), "Invalid column access index");
	...
	return (m == 0UL) || (n == 0UL) || (column >= row + m) || (row >= column + n) || (ElementType_t<MT>(1) & value);
}
/*! \endcond */
//*************************************************************************************************
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryBitor(const UniUpperMatrix<MT, SO, DF> &mat, size_t row, size_t column, size_t m,
										   size_t n, const ET &value)
{
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryBitxor(const UniUpperMatrix<MT, SO, DF> &mat, size_t row, size_t column, size_t m,
											size_t n, const ET &value)
{
	return tryAdd(mat, row, column, m, n, value);
}
...
inline bool tryAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const DenseVector<VT, false> &rhs, size_t row,
					  size_t column)
{
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  typename VT> // Type of the right-hand side dense vector
inline bool tryAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const DenseVector<VT, true> &rhs, size_t row,
					  size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(VT);
...
inline bool tryAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const DenseVector<VT, TF> &rhs, ptrdiff_t band, size_t row,
					  size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(VT);
...
inline bool tryAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const SparseVector<VT, false> &rhs, size_t row,
					  size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(VT);
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  typename VT> // Type of the right-hand side sparse vector
inline bool tryAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const SparseVector<VT, true> &rhs, size_t row,
					  size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(VT);
...
inline bool tryAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const SparseVector<VT, TF> &rhs, ptrdiff_t band,
...
inline bool tryAssign(const UniUpperMatrix<MT1, SO, DF> &lhs, const DenseMatrix<MT2, false> &rhs, size_t row,
					  size_t column)
{
...
template <typename MT1 // Type of the adapted matrix
		  ...
		  ,
		  typename MT2> // Type of the right-hand side dense matrix
inline bool tryAssign(const UniUpperMatrix<MT1, SO, DF> &lhs, const DenseMatrix<MT2, true> &rhs, size_t row,
					  size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(MT2);
...
inline bool tryAssign(const UniUpperMatrix<MT1, SO, DF> &lhs, const SparseMatrix<MT2, false> &rhs, size_t row,
					  size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(MT2);
...
template <typename MT1 // Type of the adapted matrix
		  ...
		  ,
		  typename MT2> // Type of the right-hand side sparse matrix
inline bool tryAssign(const UniUpperMatrix<MT1, SO, DF> &lhs, const SparseMatrix<MT2, true> &rhs, size_t row,
					  size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(MT2);
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  typename VT> // Type of the right-hand side dense vector
inline bool tryAddAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const DenseVector<VT, false> &rhs, size_t row,
						 size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(VT);
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  typename VT> // Type of the right-hand side dense vector
inline bool tryAddAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const DenseVector<VT, true> &rhs, size_t row,
						 size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(VT);
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side dense vector
inline bool tryAddAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const DenseVector<VT, TF> &rhs, ptrdiff_t band,
						 size_t row, size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(VT);
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  typename VT> // Type of the right-hand side sparse vector
inline bool tryAddAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const SparseVector<VT, false> &rhs, size_t row,
						 size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(VT);
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  typename VT> // Type of the right-hand side sparse vector
inline bool tryAddAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const SparseVector<VT, true> &rhs, size_t row,
						 size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(VT);
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side sparse vector
inline bool tryAddAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const SparseVector<VT, TF> &rhs, ptrdiff_t band,
						 size_t row, size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(VT);
...
template <typename MT1 // Type of the adapted matrix
		  ...
		  ,
		  typename MT2> // Type of the right-hand side dense matrix
inline bool tryAddAssign(const UniUpperMatrix<MT1, SO, DF> &lhs, const DenseMatrix<MT2, false> &rhs, size_t row,
						 size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(MT2);
...
template <typename MT1 // Type of the adapted matrix
		  ...
		  ,
		  typename MT2> // Type of the right-hand side dense matrix
inline bool tryAddAssign(const UniUpperMatrix<MT1, SO, DF> &lhs, const DenseMatrix<MT2, true> &rhs, size_t row,
						 size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(MT2);
...
template <typename MT1 // Type of the adapted matrix
		  ...
		  ,
		  typename MT2> // Type of the right-hand side sparse matrix
inline bool tryAddAssign(const UniUpperMatrix<MT1, SO, DF> &lhs, const SparseMatrix<MT2, false> &rhs, size_t row,
						 size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(MT2);
...
template <typename MT1 // Type of the adapted matrix
		  ...
		  ,
		  typename MT2> // Type of the right-hand side sparse matrix
inline bool tryAddAssign(const UniUpperMatrix<MT1, SO, DF> &lhs, const SparseMatrix<MT2, true> &rhs, size_t row,
						 size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(MT2);
...
inline bool trySubAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const Vector<VT, TF> &rhs, size_t row, size_t column)
{
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side vector
inline bool trySubAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const Vector<VT, TF> &rhs, ptrdiff_t band, size_t row,
						 size_t column)
{
...
inline bool trySubAssign(const UniUpperMatrix<MT1, SO1, DF> &lhs, const Matrix<MT2, SO2> &rhs, size_t row,
						 size_t column)
{
	return tryAddAssign(lhs, *rhs, row, column);
}
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  typename VT> // Type of the right-hand side vector
inline bool tryMultAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const Vector<VT, false> &rhs, size_t row,
						  size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(VT);
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  typename VT> // Type of the right-hand side vector
inline bool tryMultAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const Vector<VT, true> &rhs, size_t row, size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(VT);
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side dense vector
inline bool tryMultAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const DenseVector<VT, TF> &rhs, ptrdiff_t band,
						  size_t row, size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(VT);
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side sparse vector
inline bool tryMultAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const SparseVector<VT, TF> &rhs, ptrdiff_t band,
						  size_t row, size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(VT);
...
template <typename MT1 // Type of the adapted matrix
		  ...
		  ,
		  bool SO2> // Storage order of the right-hand side matrix
inline bool trySchurAssign(const UniUpperMatrix<MT1, SO1, DF> &lhs, const Matrix<MT2, SO2> &rhs, size_t row,
						   size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(MT2);
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side vector
inline bool tryDivAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const Vector<VT, TF> &rhs, size_t row, size_t column)
{
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side vector
inline bool tryDivAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const Vector<VT, TF> &rhs, ptrdiff_t band, size_t row,
						 size_t column)
{
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  typename VT> // Type of the right-hand side vector
inline bool tryShiftAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const Vector<VT, false> &rhs, size_t row,
						   size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(VT);
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  typename VT> // Type of the right-hand side vector
inline bool tryShiftAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const Vector<VT, true> &rhs, size_t row,
						   size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(VT);
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side dense vector
inline bool tryShiftAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const DenseVector<VT, TF> &rhs, ptrdiff_t band,
						   size_t row, size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(VT);
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side sparse vector
inline bool tryShiftAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const SparseVector<VT, TF> &rhs, ptrdiff_t band,
						   size_t row, size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(VT);
...
template <typename MT1 // Type of the adapted matrix
		  ...
		  ,
		  bool SO2> // Storage order of the right-hand side matrix
inline bool tryShiftAssign(const UniUpperMatrix<MT1, SO1, DF> &lhs, const Matrix<MT2, SO2> &rhs, size_t row,
						   size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(MT2);
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  typename VT> // Type of the right-hand side vector
inline bool tryBitandAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const Vector<VT, false> &rhs, size_t row,
							size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(VT);
	...
	return (column < row) || ((*rhs).size() <= column - row) || (ElementType_t<MT>(1) & (*rhs)[column - row]);
}
/*! \endcond */
//*************************************************************************************************
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  typename VT> // Type of the right-hand side vector
inline bool tryBitandAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const Vector<VT, true> &rhs, size_t row,
							size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(VT);
	...
	return (row < column) || ((*rhs).size() <= row - column) || (ElementType_t<MT>(1) & (*rhs)[row - column]);
}
/*! \endcond */
//*************************************************************************************************
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side dense vector
inline bool tryBitandAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const DenseVector<VT, TF> &rhs, ptrdiff_t band,
							size_t row, size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(VT);
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side sparse vector
inline bool tryBitandAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const SparseVector<VT, TF> &rhs, ptrdiff_t band,
							size_t row, size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(VT);
...
template <typename MT1 // Type of the adapted matrix
		  ...
		  ,
		  bool SO2> // Storage order of the right-hand side matrix
inline bool tryBitandAssign(const UniUpperMatrix<MT1, SO1, DF> &lhs, const Matrix<MT2, SO2> &rhs, size_t row,
							size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(MT2);
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side vector
inline bool tryBitorAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const Vector<VT, TF> &rhs, size_t row, size_t column)
{
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side vector
inline bool tryBitorAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const Vector<VT, TF> &rhs, ptrdiff_t band, size_t row,
						   size_t column)
{
...
template <typename MT1 // Type of the adapted matrix
		  ...
		  ,
		  bool SO2> // Storage order of the right-hand side matrix
inline bool tryBitorAssign(const UniUpperMatrix<MT1, SO1, DF> &lhs, const Matrix<MT2, SO2> &rhs, size_t row,
						   size_t column)
{
	return tryAssign(lhs, *rhs, row, column);
}
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side vector
inline bool tryBitxorAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const Vector<VT, TF> &rhs, size_t row, size_t column)
{
	return tryAddAssign(lhs, *rhs, row, column);
}
/*! \endcond */
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side vector
inline bool tryBitxorAssign(const UniUpperMatrix<MT, SO, DF> &lhs, const Vector<VT, TF> &rhs, ptrdiff_t band,
							size_t row, size_t column)
{
	return tryAddAssign(lhs, *rhs, band, row, column);
}
...
template <typename MT1 // Type of the adapted matrix
		  ...
		  ,
		  bool SO2> // Storage order of the right-hand side matrix
inline bool tryBitxorAssign(const UniUpperMatrix<MT1, SO1, DF> &lhs, const Matrix<MT2, SO2> &rhs, size_t row,
							size_t column)
{
	return tryAddAssign(lhs, *rhs, row, column);
}
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct Size<UniUpperMatrix<MT, SO, DF>, 0UL> : public Size<MT, 0UL> {};

template <typename MT, bool SO, bool DF> struct Size<UniUpperMatrix<MT, SO, DF>, 1UL> : public Size<MT, 1UL> {};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct MaxSize<UniUpperMatrix<MT, SO, DF>, 0UL> : public MaxSize<MT, 0UL> {};

template <typename MT, bool SO, bool DF> struct MaxSize<UniUpperMatrix<MT, SO, DF>, 1UL> : public MaxSize<MT, 1UL> {};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct IsSquare<UniUpperMatrix<MT, SO, DF>> : public TrueType {};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct IsUniUpper<UniUpperMatrix<MT, SO, DF>> : public TrueType {};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct IsAdaptor<UniUpperMatrix<MT, SO, DF>> : public TrueType {};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct IsRestricted<UniUpperMatrix<MT, SO, DF>> : public TrueType {};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO> struct HasConstDataAccess<UniUpperMatrix<MT, SO, true>> : public TrueType {};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct IsAligned<UniUpperMatrix<MT, SO, DF>> : public IsAligned<MT> {};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct IsContiguous<UniUpperMatrix<MT, SO, DF>> : public IsContiguous<MT> {};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct IsPadded<UniUpperMatrix<MT, SO, DF>> : public IsPadded<MT> {};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct RemoveAdaptor<UniUpperMatrix<MT, SO, DF>> {
	using Type = MT;
};
/*! \endcond */
//*************************************************************************************************
...
struct AddTraitEval1<
	...
	EnableIf_t<IsMatrix_v<T1> && IsMatrix_v<T2> &&
			   ((IsUniUpper_v<T1> && IsStrictlyUpper_v<T2> && !(IsUniLower_v<T1> && IsStrictlyLower_v<T2>)) ||
				(IsStrictlyUpper_v<T1> && IsUniUpper_v<T2> && !(IsStrictlyLower_v<T1> && IsUniLower_v<T2>))) &&
...
struct SchurTraitEval1<T1, T2,
					   EnableIf_t<IsMatrix_v<T1> && IsMatrix_v<T2> && (IsUniUpper_v<T1> && IsUniUpper_v<T2>) &&
								  !(IsDiagonal_v<T1> || IsDiagonal_v<T2>) && !(IsZero_v<T1> || IsZero_v<T2>)>> {
...
struct UnaryMapTraitEval1<T, OP, EnableIf_t<YieldsUniUpper_v<OP, T> && !YieldsIdentity_v<OP, T>>> {
...
struct BinaryMapTraitEval1<T1, T2, OP, EnableIf_t<YieldsUniUpper_v<OP, T1, T2> && !YieldsIdentity_v<OP, T1, T2>>> {
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct DeclSymTrait<UniUpperMatrix<MT, SO, DF>> {
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct DeclHermTrait<UniUpperMatrix<MT, SO, DF>> {
	using Type = IdentityMatrix<ElementType_t<MT>, SO>;
};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct DeclLowTrait<UniUpperMatrix<MT, SO, DF>> {
	using Type = IdentityMatrix<ElementType_t<MT>, SO>;
};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct DeclUniLowTrait<UniUpperMatrix<MT, SO, DF>> {
	using Type = IdentityMatrix<ElementType_t<MT>, SO>;
};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct DeclStrLowTrait<UniUpperMatrix<MT, SO, DF>> {
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct DeclUppTrait<UniUpperMatrix<MT, SO, DF>> {
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct DeclUniUppTrait<UniUpperMatrix<MT, SO, DF>> {
	using Type = UniUpperMatrix<MT, SO, DF>;
};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct DeclStrUppTrait<UniUpperMatrix<MT, SO, DF>> {
	using Type = INVALID_TYPE;
};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct DeclDiagTrait<UniUpperMatrix<MT, SO, DF>> {
	using Type = IdentityMatrix<ElementType_t<MT>, SO>;
};
/*! \endcond */
//*************************************************************************************************
...
struct SubmatrixTraitEval1<MT, I, I, N, N, EnableIf_t<I != inf && N != inf && IsUniUpper_v<MT> && !IsIdentity_v<MT>>> {
