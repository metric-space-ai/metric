...
#ifndef METRIC_NUMERIC_MATH_ADAPTORS_UNILOWERMATRIX_BASETEMPLATE_H
#define METRIC_NUMERIC_MATH_ADAPTORS_UNILOWERMATRIX_BASETEMPLATE_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
// The following examples give an impression of several possible lower unitriangular matrices:
   ...
   mtrc::numeric::UniLowerMatrix< mtrc::numeric::HybridMatrix<float,4UL,4UL,columnMajor> B;

   // Definition of a resizable row-major dense unilower matrix based on DynamicMatrix
   mtrc::numeric::UniLowerMatrix< mtrc::numeric::DynamicMatrix<double,rowMajor> > C;

   // Definition of a fixed-size row-major dense unilower matrix based on CustomMatrix
   mtrc::numeric::UniLowerMatrix< mtrc::numeric::CustomMatrix<double,unaligned,unpadded,rowMajor> > D;

   // Definition of a compressed row-major single precision unilower matrix
   mtrc::numeric::UniLowerMatrix< mtrc::numeric::CompressedMatrix<float,rowMajor> > E;
   \endcode
...
// is specified as mtrc::numeric::rowMajor), the unilower matrix will also be a row-major matrix.
...
// exception is thrown:
   ...
   CustomUniLower B( new double[9UL], 3UL, mtrc::numeric::ArrayDelete() );  // Throws an exception
   \endcode
...
// \n \subsection unilowermatrix_initialization The Upper Elements of a Dense Lower Unitriangular Matrix are Always
Default Initialized!
//
...
//
// The \b Metric numeric library tries to exploit the properties of lower (uni)-triangular matrices whenever
...
//
// When multiplying two matrices, at least one of which is lower (uni)-triangular, \b Metric numeric can
