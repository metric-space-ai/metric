...
#ifndef METRIC_NUMERIC_MATH_ADAPTORS_UNILOWERMATRIX_DENSE_H
#define METRIC_NUMERIC_MATH_ADAPTORS_UNILOWERMATRIX_DENSE_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class UniLowerMatrix<MT, SO, true> : public DenseMatrix<UniLowerMatrix<MT, SO, true>, SO> {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	using OppositeType =
		UniLowerMatrix<OT, !SO, true>; //!< Result type with opposite storage order for expression template evaluations.
	...
	class Iterator {
	  public:
		...
		*/
		inline ReferenceType operator*() const { return ReferenceType(*matrix_, row_, column_); }
		//*******************************************************************************************
		...
		// \return The resulting value.
		*/
		inline PointerType operator->() const { return PointerType(*matrix_, row_, column_); }
		//*******************************************************************************************
		...
		*/
		inline SIMDType load() const { return (*matrix_).load(row_, column_); }
		//*******************************************************************************************
		...
		// explicitly might result in erroneous results and/or in compilation errors.
		*/
		inline SIMDType loada() const { return (*matrix_).loada(row_, column_); }
		//*******************************************************************************************
		...
		// explicitly might result in erroneous results and/or in compilation errors.
		*/
		inline SIMDType loadu() const { return (*matrix_).loadu(row_, column_); }
		//*******************************************************************************************
	...
	template <typename Other> inline UniLowerMatrix(size_t n, const Other *array);

	template <typename Other, size_t N> inline UniLowerMatrix(const Other (&array)[N][N]);
	...
	template <typename Other, size_t N> inline UniLowerMatrix &operator=(const Other (&array)[N][N]);
  ...
  private:
	...
	template <typename MT2, bool SO2, typename T> inline const MT construct(const Matrix<MT2, SO2> &m, T);
	//@}
	//**********************************************************************************************
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO>												  // Storage order of the adapted dense matrix
inline UniLowerMatrix<MT, SO, true>::UniLowerMatrix() : matrix_() // The adapted dense matrix
{
...
// matrix by means of an initializer list:
   ...
   mtrc::numeric::UniLowerMatrix< mtrc::numeric::StaticMatrix<int,3,3,rowMajor> > A{ { 1, 0, 0 },
																	 { 2, 1 },
																	 { 4, 5, 1 } };
   \endcode
...
// with a dynamic array:
   ...
   mtrc::numeric::UniLowerMatrix< mtrc::numeric::DynamicMatrix<int,rowMajor> > v( 4UL, array );
   delete[] array;
   \endcode
...
// with a static array:
   ...
   const int init[3][3] = { { 1, 0, 0 },
							{ 2, 1 },
							{ 4, 5, 1 } };
   mtrc::numeric::UniLowerMatrix< mtrc::numeric::StaticMatrix<int,3,3,rowMajor> > A( init );
   \endcode
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename UniLowerMatrix<MT, SO, true>::Reference UniLowerMatrix<MT, SO, true>::operator()(size_t i, size_t j)
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename UniLowerMatrix<MT, SO, true>::ConstReference UniLowerMatrix<MT, SO, true>::operator()(size_t i,
																									  size_t j) const
{
	METRIC_NUMERIC_USER_ASSERT(i < rows(), "Invalid row access index");
	METRIC_NUMERIC_USER_ASSERT(j < columns(), "Invalid column access index");
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename UniLowerMatrix<MT, SO, true>::Reference UniLowerMatrix<MT, SO, true>::at(size_t i, size_t j)
{
	if (i >= rows()) {
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename UniLowerMatrix<MT, SO, true>::ConstReference UniLowerMatrix<MT, SO, true>::at(size_t i, size_t j) const
{
	if (i >= rows()) {
		METRIC_NUMERIC_THROW_OUT_OF_RANGE("Invalid row access index");
	}
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename UniLowerMatrix<MT, SO, true>::ConstPointer UniLowerMatrix<MT, SO, true>::data() const noexcept
{
	return matrix_.data();
}
/*! \endcond */
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename UniLowerMatrix<MT, SO, true>::ConstPointer UniLowerMatrix<MT, SO, true>::data(size_t i) const noexcept
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename UniLowerMatrix<MT, SO, true>::Iterator UniLowerMatrix<MT, SO, true>::begin(size_t i)
{
	if (SO)
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename UniLowerMatrix<MT, SO, true>::ConstIterator UniLowerMatrix<MT, SO, true>::begin(size_t i) const
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename UniLowerMatrix<MT, SO, true>::ConstIterator UniLowerMatrix<MT, SO, true>::cbegin(size_t i) const
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename UniLowerMatrix<MT, SO, true>::Iterator UniLowerMatrix<MT, SO, true>::end(size_t i)
{
	if (SO)
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename UniLowerMatrix<MT, SO, true>::ConstIterator UniLowerMatrix<MT, SO, true>::end(size_t i) const
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename UniLowerMatrix<MT, SO, true>::ConstIterator UniLowerMatrix<MT, SO, true>::cend(size_t i) const
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline UniLowerMatrix<MT, SO, true> &UniLowerMatrix<MT, SO, true>::operator=(const ElementType &rhs)
{
	if (SO) {
		for (size_t j = 0UL; j < columns(); ++j)
			for (size_t i = j + 1UL; i < rows(); ++i)
...
// matrix by means of an initializer list:
   ...
   mtrc::numeric::UniLowerMatrix< mtrc::numeric::StaticMatrix<int,3UL,3UL,rowMajor> > A;
   A = { { 1, 0, 0 },
		 { 2, 1 },
		 { 4, 5, 1 } };
   \endcode
...
template <typename Other // Data type of the initialization array
		  ,
		  size_t N> // Number of rows and columns of the initialization array
inline UniLowerMatrix<MT, SO, true> &UniLowerMatrix<MT, SO, true>::operator=(const Other (&array)[N][N])
{
	MT tmp(array);
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline UniLowerMatrix<MT, SO, true> &UniLowerMatrix<MT, SO, true>::operator=(const UniLowerMatrix &rhs)
{
	matrix_ = rhs.matrix_;
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline UniLowerMatrix<MT, SO, true> &UniLowerMatrix<MT, SO, true>::operator=(UniLowerMatrix &&rhs) noexcept
{
...
template <typename MT2 // Type of the right-hand side matrix
		  ,
		  bool SO2> // Storage order of the right-hand side matrix
inline auto UniLowerMatrix<MT, SO, true>::operator%=(const Matrix<MT2, SO2> &rhs) -> UniLowerMatrix &
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
constexpr size_t UniLowerMatrix<MT, SO, true>::rows() const noexcept
{
	return matrix_.rows();
}
/*! \endcond */
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
constexpr size_t UniLowerMatrix<MT, SO, true>::columns() const noexcept
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
constexpr size_t UniLowerMatrix<MT, SO, true>::spacing() const noexcept
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
constexpr size_t UniLowerMatrix<MT, SO, true>::capacity() const noexcept
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
constexpr size_t UniLowerMatrix<MT, SO, true>::capacity(size_t i) const noexcept
{
...
METRIC_NUMERIC_ALWAYS_INLINE
	typename UniLowerMatrix<MT, SO, true>::SIMDType UniLowerMatrix<MT, SO, true>::load(size_t i,
...
template <typename MT // Type of the adapted dense matrix
		  ...
		  bool SO> // Storage order of the adapted dense matrix
METRIC_NUMERIC_ALWAYS_INLINE
	typename UniLowerMatrix<MT, SO, true>::SIMDType UniLowerMatrix<MT, SO, true>::loada(size_t i,
																						size_t j) const noexcept
{
...
template <typename MT // Type of the adapted dense matrix
		  ...
		  bool SO> // Storage order of the adapted dense matrix
METRIC_NUMERIC_ALWAYS_INLINE
	typename UniLowerMatrix<MT, SO, true>::SIMDType UniLowerMatrix<MT, SO, true>::loadu(size_t i,
																						size_t j) const noexcept
{
...
inline const MT UniLowerMatrix<MT, SO, true>::construct(const ElementType &init, FalseType)
{
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_SQUARE_MATRIX_TYPE(MT);
