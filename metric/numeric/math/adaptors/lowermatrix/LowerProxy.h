...
#ifndef METRIC_NUMERIC_MATH_ADAPTORS_LOWERMATRIX_LOWERPROXY_H
#define METRIC_NUMERIC_MATH_ADAPTORS_LOWERMATRIX_LOWERPROXY_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
// this by means of a \f$ 3 \times 3 \f$ dense lower matrix:
   ...
   mtrc::numeric::LowerMatrix< mtrc::numeric::DynamicMatrix<int> > A( 3UL );
...
class LowerProxy : public Proxy<LowerProxy<MT>, ElementType_t<MT>> {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	template <typename T> inline const LowerProxy &operator=(initializer_list<T> list) const;

	template <typename T> inline const LowerProxy &operator=(initializer_list<initializer_list<T>> list) const;
...
{
	if (restricted_) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Invalid assignment to upper matrix element");
	}
