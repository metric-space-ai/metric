...
#ifndef METRIC_NUMERIC_MATH_ADAPTORS_DIAGONALMATRIX_DENSE_H
#define METRIC_NUMERIC_MATH_ADAPTORS_DIAGONALMATRIX_DENSE_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
#include <metric/numeric/math/adaptors/diagonalmatrix/DiagonalProxy.h>
...
class DiagonalMatrix<MT, SO, true> : public DenseMatrix<DiagonalMatrix<MT, SO, true>, SO> {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	using OppositeType =
		DiagonalMatrix<OT, !SO, true>; //!< Result type with opposite storage order for expression template evaluations.
	...
	template <typename Other> inline DiagonalMatrix(size_t n, const Other *array);

	template <typename Other, size_t N> inline DiagonalMatrix(const Other (&array)[N][N]);
	...
	template <typename Other, size_t N> inline DiagonalMatrix &operator=(const Other (&array)[N][N]);

	inline DiagonalMatrix &operator=(const DiagonalMatrix &rhs);
	inline DiagonalMatrix &operator=(DiagonalMatrix &&rhs) noexcept;

	template <typename MT2, bool SO2>
	inline auto operator=(const Matrix<MT2, SO2> &rhs) -> DisableIf_t<IsComputation_v<MT2>, DiagonalMatrix &>;

	template <typename MT2, bool SO2>
	inline auto operator=(const Matrix<MT2, SO2> &rhs) -> EnableIf_t<IsComputation_v<MT2>, DiagonalMatrix &>;
	...
	template <typename MT2, bool SO2> inline auto operator%=(const Matrix<MT2, SO2> &rhs) -> DiagonalMatrix &;

	template <typename ST> inline auto operator*=(ST rhs) -> EnableIf_t<IsScalar_v<ST>, DiagonalMatrix &>;
  ...
  private:
	...
	//**Friend declarations*************************************************************************
	template <typename MT2, bool SO2, bool DF2> friend MT2 &derestrict(DiagonalMatrix<MT2, SO2, DF2> &m);
	//**********************************************************************************************
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO>												  // Storage order of the adapted dense matrix
inline DiagonalMatrix<MT, SO, true>::DiagonalMatrix() : matrix_() // The adapted dense matrix
{
	METRIC_NUMERIC_INTERNAL_ASSERT(isSquare(matrix_), "Non-square diagonal matrix detected");
...
// matrix by means of an initializer list:
   ...
   mtrc::numeric::DiagonalMatrix< mtrc::numeric::StaticMatrix<int,3,3,rowMajor> > A{ { 1, 0, 0 },
																	 { 0, 2 },
																	 { 0, 0, 3 } };
   \endcode
	...
	: matrix_(list) // The adapted dense matrix
{
	if (!isDiagonal(matrix_)) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Invalid setup of diagonal matrix");
	}
...
// with a dynamic array:
   ...
   mtrc::numeric::DiagonalMatrix< mtrc::numeric::DynamicMatrix<int,rowMajor> > v( 4UL, array );
   delete[] array;
   \endcode
...
// with a static array:
   ...
   const int init[3][3] = { { 1, 0, 0 },
							{ 0, 2 },
							{ 0, 0, 3 } };
   mtrc::numeric::DiagonalMatrix< mtrc::numeric::StaticMatrix<int,3,3,rowMajor> > A( init );
   \endcode
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename DiagonalMatrix<MT, SO, true>::Reference DiagonalMatrix<MT, SO, true>::operator()(size_t i, size_t j)
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename DiagonalMatrix<MT, SO, true>::ConstReference DiagonalMatrix<MT, SO, true>::operator()(size_t i,
																									  size_t j) const
{
	METRIC_NUMERIC_USER_ASSERT(i < rows(), "Invalid row access index");
	METRIC_NUMERIC_USER_ASSERT(j < columns(), "Invalid column access index");
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename DiagonalMatrix<MT, SO, true>::Reference DiagonalMatrix<MT, SO, true>::at(size_t i, size_t j)
{
	if (i >= rows()) {
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename DiagonalMatrix<MT, SO, true>::ConstReference DiagonalMatrix<MT, SO, true>::at(size_t i, size_t j) const
{
	if (i >= rows()) {
		METRIC_NUMERIC_THROW_OUT_OF_RANGE("Invalid row access index");
	}
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename DiagonalMatrix<MT, SO, true>::ConstPointer DiagonalMatrix<MT, SO, true>::data() const noexcept
{
	return matrix_.data();
}
/*! \endcond */
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename DiagonalMatrix<MT, SO, true>::ConstPointer DiagonalMatrix<MT, SO, true>::data(size_t i) const noexcept
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename DiagonalMatrix<MT, SO, true>::Iterator DiagonalMatrix<MT, SO, true>::begin(size_t i)
{
	if (SO)
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename DiagonalMatrix<MT, SO, true>::ConstIterator DiagonalMatrix<MT, SO, true>::begin(size_t i) const
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename DiagonalMatrix<MT, SO, true>::ConstIterator DiagonalMatrix<MT, SO, true>::cbegin(size_t i) const
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename DiagonalMatrix<MT, SO, true>::Iterator DiagonalMatrix<MT, SO, true>::end(size_t i)
{
	if (SO)
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename DiagonalMatrix<MT, SO, true>::ConstIterator DiagonalMatrix<MT, SO, true>::end(size_t i) const
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename DiagonalMatrix<MT, SO, true>::ConstIterator DiagonalMatrix<MT, SO, true>::cend(size_t i) const
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline DiagonalMatrix<MT, SO, true> &DiagonalMatrix<MT, SO, true>::operator=(const ElementType &rhs)
{
...
// matrix by means of an initializer list:
   ...
   mtrc::numeric::DiagonalMatrix< mtrc::numeric::StaticMatrix<int,3UL,3UL,rowMajor> > A;
   A = { { 1, 0, 0 },
		 { 0, 2 },
		 { 0, 0, 3 } };
   \endcode
...
DiagonalMatrix<MT, SO, true>::operator=(initializer_list<initializer_list<ElementType>> list)
{
	...
	if (!isDiagonal(tmp)) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Invalid assignment to diagonal matrix");
	}
...
template <typename Other // Data type of the initialization array
		  ,
		  size_t N> // Number of rows and columns of the initialization array
inline DiagonalMatrix<MT, SO, true> &DiagonalMatrix<MT, SO, true>::operator=(const Other (&array)[N][N])
{
	MT tmp(array);
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline DiagonalMatrix<MT, SO, true> &DiagonalMatrix<MT, SO, true>::operator=(const DiagonalMatrix &rhs)
{
	matrix_ = rhs.matrix_;
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline DiagonalMatrix<MT, SO, true> &DiagonalMatrix<MT, SO, true>::operator=(DiagonalMatrix &&rhs) noexcept
{
...
template <typename MT2 // Type of the right-hand side matrix
		  ,
		  bool SO2> // Storage order of the right-hand side matrix
inline auto DiagonalMatrix<MT, SO, true>::operator%=(const Matrix<MT2, SO2> &rhs) -> DiagonalMatrix &
{
	if (!IsSquare_v<MT2> && !isSquare(*rhs)) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Invalid assignment to diagonal matrix");
	}
...
inline auto DiagonalMatrix<MT, SO, true>::operator*=(ST scalar) -> EnableIf_t<IsScalar_v<ST>, DiagonalMatrix &>
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
constexpr size_t DiagonalMatrix<MT, SO, true>::rows() const noexcept
{
	return matrix_.rows();
}
/*! \endcond */
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
constexpr size_t DiagonalMatrix<MT, SO, true>::columns() const noexcept
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
constexpr size_t DiagonalMatrix<MT, SO, true>::spacing() const noexcept
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
constexpr size_t DiagonalMatrix<MT, SO, true>::capacity() const noexcept
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
constexpr size_t DiagonalMatrix<MT, SO, true>::capacity(size_t i) const noexcept
{
...
// multiplication assignment operator:
   ...
   \code
   mtrc::numeric::DiagonalMatrix< mtrc::numeric::DynamicMatrix<int> > A;
...
METRIC_NUMERIC_ALWAYS_INLINE
	typename DiagonalMatrix<MT, SO, true>::SIMDType DiagonalMatrix<MT, SO, true>::load(size_t i,
...
template <typename MT // Type of the adapted dense matrix
		  ...
		  bool SO> // Storage order of the adapted dense matrix
METRIC_NUMERIC_ALWAYS_INLINE
	typename DiagonalMatrix<MT, SO, true>::SIMDType DiagonalMatrix<MT, SO, true>::loada(size_t i,
																						size_t j) const noexcept
{
...
template <typename MT // Type of the adapted dense matrix
		  ...
		  bool SO> // Storage order of the adapted dense matrix
METRIC_NUMERIC_ALWAYS_INLINE
	typename DiagonalMatrix<MT, SO, true>::SIMDType DiagonalMatrix<MT, SO, true>::loadu(size_t i,
																						size_t j) const noexcept
{
