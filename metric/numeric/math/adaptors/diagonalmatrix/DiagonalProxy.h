...
#ifndef METRIC_NUMERIC_MATH_ADAPTORS_DIAGONALMATRIX_DIAGONALPROXY_H
#define METRIC_NUMERIC_MATH_ADAPTORS_DIAGONALMATRIX_DIAGONALPROXY_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
// this by means of a \f$ 3 \times 3 \f$ dense diagonal matrix:
   ...
   mtrc::numeric::DiagonalMatrix< mtrc::numeric::DynamicMatrix<int> > A( 3UL );
...
class DiagonalProxy : public Proxy<DiagonalProxy<MT>, ElementType_t<MT>> {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	template <typename T> inline DiagonalProxy &operator=(initializer_list<T> list);

	template <typename T> inline DiagonalProxy &operator=(initializer_list<initializer_list<T>> list);
...
{
	if (restricted_) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Invalid assignment to non-diagonal matrix element");
	}
