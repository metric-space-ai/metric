...
#ifndef METRIC_NUMERIC_MATH_ADAPTORS_HERMITIANMATRIX_DENSE_H
#define METRIC_NUMERIC_MATH_ADAPTORS_HERMITIANMATRIX_DENSE_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class HermitianMatrix<MT, SO, true> : public DenseMatrix<HermitianMatrix<MT, SO, true>, SO> {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	using OppositeType = HermitianMatrix<OT, !SO, true>;  //!< Result type with opposite storage order for expression
	...
	template <typename Other> inline HermitianMatrix(size_t n, const Other *array);

	template <typename Other, size_t N> inline HermitianMatrix(const Other (&array)[N][N]);
	...
	template <typename Other, size_t N> inline HermitianMatrix &operator=(const Other (&array)[N][N]);
  ...
  private:
	...
	//**Friend declarations*************************************************************************
	template <InversionFlag IF, typename MT2, bool SO2> friend void invert(HermitianMatrix<MT2, SO2, true> &m);
	//**********************************************************************************************
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO>													// Storage order of the adapted dense matrix
inline HermitianMatrix<MT, SO, true>::HermitianMatrix() : matrix_() // The adapted dense matrix
{
...
// matrix by means of an initializer list:
   ...
   using MT = mtrc::numeric::HermitianMatrix< mtrc::numeric::StaticMatrix<int,3,3,rowMajor> >;
...
// with a dynamic array:
   ...
   mtrc::numeric::HermitianMatrix< mtrc::numeric::DynamicMatrix<cplx,rowMajor> > v( 4UL, array );
   delete[] array;
   \endcode
...
// with a static array:
   ...
   const cplx init[3][3] = { { cplx(1, 0), cplx(2, 2), cplx(4,-4) },
							 { cplx(2,-2), cplx(3, 0), cplx(5, 5) },
							 { cplx(4, 4), cplx(5,-5), cplx(4, 0) } };
   mtrc::numeric::HermitianMatrix< mtrc::numeric::StaticMatrix<int,3,3,rowMajor> > A( init );
   \endcode
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename HermitianMatrix<MT, SO, true>::Reference HermitianMatrix<MT, SO, true>::operator()(size_t i, size_t j)
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename HermitianMatrix<MT, SO, true>::ConstReference HermitianMatrix<MT, SO, true>::operator()(size_t i,
																										size_t j) const
{
	METRIC_NUMERIC_USER_ASSERT(i < rows(), "Invalid row access index");
	METRIC_NUMERIC_USER_ASSERT(j < columns(), "Invalid column access index");
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename HermitianMatrix<MT, SO, true>::Reference HermitianMatrix<MT, SO, true>::at(size_t i, size_t j)
{
	if (i >= rows()) {
...
template <typename MT // Type of the adapted dense matrix
		  ...
		  bool SO> // Storage order of the adapted dense matrix
inline
	typename HermitianMatrix<MT, SO, true>::ConstReference HermitianMatrix<MT, SO, true>::at(size_t i, size_t j) const
{
	if (i >= rows()) {
		METRIC_NUMERIC_THROW_OUT_OF_RANGE("Invalid row access index");
	}
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename HermitianMatrix<MT, SO, true>::ConstPointer HermitianMatrix<MT, SO, true>::data() const noexcept
{
	return matrix_.data();
}
/*! \endcond */
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename HermitianMatrix<MT, SO, true>::ConstPointer HermitianMatrix<MT, SO, true>::data(size_t i) const noexcept
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename HermitianMatrix<MT, SO, true>::Iterator HermitianMatrix<MT, SO, true>::begin(size_t i)
{
	if (SO)
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename HermitianMatrix<MT, SO, true>::ConstIterator HermitianMatrix<MT, SO, true>::begin(size_t i) const
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename HermitianMatrix<MT, SO, true>::ConstIterator HermitianMatrix<MT, SO, true>::cbegin(size_t i) const
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename HermitianMatrix<MT, SO, true>::Iterator HermitianMatrix<MT, SO, true>::end(size_t i)
{
	if (SO)
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename HermitianMatrix<MT, SO, true>::ConstIterator HermitianMatrix<MT, SO, true>::end(size_t i) const
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline typename HermitianMatrix<MT, SO, true>::ConstIterator HermitianMatrix<MT, SO, true>::cend(size_t i) const
{
...
// matrix by means of an initializer list:
   ...
   mtrc::numeric::HermitianMatrix< mtrc::numeric::StaticMatrix<cplx,3UL,3UL,rowMajor> > A;
...
template <typename Other // Data type of the initialization array
		  ,
		  size_t N> // Number of rows and columns of the initialization array
inline HermitianMatrix<MT, SO, true> &HermitianMatrix<MT, SO, true>::operator=(const Other (&array)[N][N])
{
	MT tmp(array);
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline HermitianMatrix<MT, SO, true> &HermitianMatrix<MT, SO, true>::operator=(const HermitianMatrix &rhs)
{
	matrix_ = rhs.matrix_;
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline HermitianMatrix<MT, SO, true> &HermitianMatrix<MT, SO, true>::operator=(HermitianMatrix &&rhs) noexcept
{
...
inline auto HermitianMatrix<MT, SO, true>::operator*=(ST rhs) -> EnableIf_t<IsScalar_v<ST>, HermitianMatrix &>
{
	matrix_ *= rhs;
	return *this;
}
...
// The following example demonstrates this by means of a \f$ 5 \times 5 \f$ Hermitian matrix:
   ...
   \code
   mtrc::numeric::HermitianMatrix< mtrc::numeric::DynamicMatrix< mtrc::numeric::complex<double> > > A;
...
// multiplication assignment operator:
   ...
   \code
   mtrc::numeric::HermitianMatrix< mtrc::numeric::DynamicMatrix<int> > A;
...
inline HermitianMatrix<MT, SO, true> &HermitianMatrix<MT, SO, true>::scale(const Other &scalar)
{
...
METRIC_NUMERIC_ALWAYS_INLINE
	typename HermitianMatrix<MT, SO, true>::SIMDType HermitianMatrix<MT, SO, true>::load(size_t i,
...
template <typename MT // Type of the adapted dense matrix
		  ...
		  bool SO> // Storage order of the adapted dense matrix
METRIC_NUMERIC_ALWAYS_INLINE
	typename HermitianMatrix<MT, SO, true>::SIMDType HermitianMatrix<MT, SO, true>::loada(size_t i,
																						  size_t j) const noexcept
{
...
template <typename MT // Type of the adapted dense matrix
		  ...
		  bool SO> // Storage order of the adapted dense matrix
METRIC_NUMERIC_ALWAYS_INLINE
	typename HermitianMatrix<MT, SO, true>::SIMDType HermitianMatrix<MT, SO, true>::loadu(size_t i,
																						  size_t j) const noexcept
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline void HermitianMatrix<MT, SO, true>::store(size_t i, size_t j, const SIMDType &value) noexcept
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline void HermitianMatrix<MT, SO, true>::storea(size_t i, size_t j, const SIMDType &value) noexcept
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline void HermitianMatrix<MT, SO, true>::storeu(size_t i, size_t j, const SIMDType &value) noexcept
{
...
template <typename MT // Type of the adapted dense matrix
		  ,
		  bool SO> // Storage order of the adapted dense matrix
inline void HermitianMatrix<MT, SO, true>::stream(size_t i, size_t j, const SIMDType &value) noexcept
{
