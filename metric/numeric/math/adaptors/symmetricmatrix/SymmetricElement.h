...
#ifndef METRIC_NUMERIC_MATH_ADAPTORS_SYMMETRICMATRIX_SYMMETRICELEMENT_H
#define METRIC_NUMERIC_MATH_ADAPTORS_SYMMETRICMATRIX_SYMMETRICELEMENT_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
{
	METRIC_NUMERIC_INTERNAL_ASSERT(isSynced(), "Missing matrix element detected");
}
//*************************************************************************************************
