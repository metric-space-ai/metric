...
#ifndef METRIC_NUMERIC_MATH_ADAPTORS_STRICTLYUPPERMATRIX_H
#define METRIC_NUMERIC_MATH_ADAPTORS_STRICTLYUPPERMATRIX_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
#include <metric/numeric/math/adaptors/strictlyuppermatrix/Dense.h>
#include <metric/numeric/math/adaptors/strictlyuppermatrix/Sparse.h>
...
//@{
template <RelaxationFlag RF, typename MT, bool SO, bool DF> bool isDefault(const StrictlyUpperMatrix<MT, SO, DF> &m);

template <typename MT, bool SO, bool DF> bool isIntact(const StrictlyUpperMatrix<MT, SO, DF> &m);
...
// following example demonstrates the use of the \a isDefault function:
   ...
   using mtrc::numeric::StrictlyUpperMatrix;
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool trySet(const StrictlyUpperMatrix<MT, SO, DF> &mat, size_t row, size_t column,
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryAdd(const StrictlyUpperMatrix<MT, SO, DF> &mat, size_t row, size_t column,
										 size_t m, size_t n, const ET &value)
{
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool trySub(const StrictlyUpperMatrix<MT, SO, DF> &mat, size_t row, size_t column,
										 size_t m, size_t n, const ET &value)
{
	return trySet(mat, row, column, m, n, value);
}
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryBitor(const StrictlyUpperMatrix<MT, SO, DF> &mat, size_t row, size_t column,
										   size_t m, size_t n, const ET &value)
{
	return trySet(mat, row, column, m, n, value);
}
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryBitxor(const StrictlyUpperMatrix<MT, SO, DF> &mat, size_t row, size_t column,
											size_t m, size_t n, const ET &value)
{
...
inline bool tryAssign(const StrictlyUpperMatrix<MT, SO, DF> &lhs, const DenseVector<VT, false> &rhs, size_t row,
					  size_t column)
{
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  typename VT> // Type of the right-hand side dense vector
inline bool tryAssign(const StrictlyUpperMatrix<MT, SO, DF> &lhs, const DenseVector<VT, true> &rhs, size_t row,
					  size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(VT);
...
inline bool tryAssign(const StrictlyUpperMatrix<MT, SO, DF> &lhs, const DenseVector<VT, TF> &rhs, ptrdiff_t band,
...
inline bool tryAssign(const StrictlyUpperMatrix<MT, SO, DF> &lhs, const SparseVector<VT, false> &rhs, size_t row,
					  size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(VT);
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  typename VT> // Type of the right-hand side sparse vector
inline bool tryAssign(const StrictlyUpperMatrix<MT, SO, DF> &lhs, const SparseVector<VT, true> &rhs, size_t row,
					  size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(VT);
...
inline bool tryAssign(const StrictlyUpperMatrix<MT, SO, DF> &lhs, const SparseVector<VT, TF> &rhs, ptrdiff_t band,
					  size_t row, size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(VT);
...
inline bool tryAssign(const StrictlyUpperMatrix<MT1, SO, DF> &lhs, const DenseMatrix<MT2, false> &rhs, size_t row,
					  size_t column)
{
...
template <typename MT1 // Type of the adapted matrix
		  ...
		  ,
		  typename MT2> // Type of the right-hand side dense matrix
inline bool tryAssign(const StrictlyUpperMatrix<MT1, SO, DF> &lhs, const DenseMatrix<MT2, true> &rhs, size_t row,
					  size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(MT2);
...
inline bool tryAssign(const StrictlyUpperMatrix<MT1, SO, DF> &lhs, const SparseMatrix<MT2, false> &rhs, size_t row,
					  size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(MT2);
...
template <typename MT1 // Type of the adapted matrix
		  ...
		  ,
		  typename MT2> // Type of the right-hand side sparse matrix
inline bool tryAssign(const StrictlyUpperMatrix<MT1, SO, DF> &lhs, const SparseMatrix<MT2, true> &rhs, size_t row,
					  size_t column)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(MT2);
...
inline bool tryAddAssign(const StrictlyUpperMatrix<MT, SO, DF> &lhs, const Vector<VT, TF> &rhs, size_t row,
						 size_t column)
{
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side vector
inline bool tryAddAssign(const StrictlyUpperMatrix<MT, SO, DF> &lhs, const Vector<VT, TF> &rhs, ptrdiff_t band,
						 size_t row, size_t column)
{
...
inline bool tryAddAssign(const StrictlyUpperMatrix<MT1, SO1, DF> &lhs, const Matrix<MT2, SO2> &rhs, size_t row,
						 size_t column)
{
	return tryAssign(lhs, *rhs, row, column);
}
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side vector
inline bool trySubAssign(const StrictlyUpperMatrix<MT, SO, DF> &lhs, const Vector<VT, TF> &rhs, size_t row,
						 size_t column)
{
	return tryAssign(lhs, *rhs, row, column);
}
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side vector
inline bool trySubAssign(const StrictlyUpperMatrix<MT, SO, DF> &lhs, const Vector<VT, TF> &rhs, ptrdiff_t band,
						 size_t row, size_t column)
{
	return tryAssign(lhs, *rhs, band, row, column);
}
...
template <typename MT1 // Type of the adapted matrix
		  ...
		  ,
		  bool SO2> // Storage order of the right-hand side matrix
inline bool trySubAssign(const StrictlyUpperMatrix<MT1, SO1, DF> &lhs, const Matrix<MT2, SO2> &rhs, size_t row,
						 size_t column)
{
	return tryAssign(lhs, *rhs, row, column);
}
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side vector
inline bool tryBitorAssign(const StrictlyUpperMatrix<MT, SO, DF> &lhs, const Vector<VT, TF> &rhs, size_t row,
						   size_t column)
{
	return tryAssign(lhs, *rhs, row, column);
}
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side vector
inline bool tryBitorAssign(const StrictlyUpperMatrix<MT, SO, DF> &lhs, const Vector<VT, TF> &rhs, ptrdiff_t band,
						   size_t row, size_t column)
{
	return tryAssign(lhs, *rhs, band, row, column);
}
...
template <typename MT1 // Type of the adapted matrix
		  ...
		  ,
		  bool SO2> // Storage order of the right-hand side matrix
inline bool tryBitorAssign(const StrictlyUpperMatrix<MT1, SO1, DF> &lhs, const Matrix<MT2, SO2> &rhs, size_t row,
						   size_t column)
{
	return tryAssign(lhs, *rhs, row, column);
}
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side vector
inline bool tryBitxorAssign(const StrictlyUpperMatrix<MT, SO, DF> &lhs, const Vector<VT, TF> &rhs, size_t row,
							size_t column)
{
	return tryAssign(lhs, *rhs, row, column);
}
...
template <typename MT // Type of the adapted matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side vector
inline bool tryBitxorAssign(const StrictlyUpperMatrix<MT, SO, DF> &lhs, const Vector<VT, TF> &rhs, ptrdiff_t band,
							size_t row, size_t column)
{
	return tryAssign(lhs, *rhs, band, row, column);
}
...
template <typename MT1 // Type of the adapted matrix
		  ...
		  ,
		  bool SO2> // Storage order of the right-hand side matrix
inline bool tryBitxorAssign(const StrictlyUpperMatrix<MT1, SO1, DF> &lhs, const Matrix<MT2, SO2> &rhs, size_t row,
							size_t column)
{
	return tryAssign(lhs, *rhs, row, column);
}
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct Size<StrictlyUpperMatrix<MT, SO, DF>, 0UL> : public Size<MT, 0UL> {};

template <typename MT, bool SO, bool DF> struct Size<StrictlyUpperMatrix<MT, SO, DF>, 1UL> : public Size<MT, 1UL> {};
/*! \endcond */
//*************************************************************************************************
...
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF>
struct MaxSize<StrictlyUpperMatrix<MT, SO, DF>, 0UL> : public MaxSize<MT, 0UL> {};

template <typename MT, bool SO, bool DF>
struct MaxSize<StrictlyUpperMatrix<MT, SO, DF>, 1UL> : public MaxSize<MT, 1UL> {};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct IsSquare<StrictlyUpperMatrix<MT, SO, DF>> : public TrueType {};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct IsUniform<StrictlyUpperMatrix<MT, SO, DF>> : public IsUniform<MT> {};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct IsSymmetric<StrictlyUpperMatrix<MT, SO, DF>> : public IsUniform<MT> {};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct IsHermitian<StrictlyUpperMatrix<MT, SO, DF>> : public IsUniform<MT> {};
/*! \endcond */
//*************************************************************************************************
...
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF>
struct IsStrictlyLower<StrictlyUpperMatrix<MT, SO, DF>> : public IsUniform<MT> {};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct IsStrictlyUpper<StrictlyUpperMatrix<MT, SO, DF>> : public TrueType {};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct IsAdaptor<StrictlyUpperMatrix<MT, SO, DF>> : public TrueType {};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct IsRestricted<StrictlyUpperMatrix<MT, SO, DF>> : public TrueType {};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO> struct HasConstDataAccess<StrictlyUpperMatrix<MT, SO, true>> : public TrueType {};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct IsAligned<StrictlyUpperMatrix<MT, SO, DF>> : public IsAligned<MT> {};
/*! \endcond */
//*************************************************************************************************
...
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF>
struct IsContiguous<StrictlyUpperMatrix<MT, SO, DF>> : public IsContiguous<MT> {};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct IsPadded<StrictlyUpperMatrix<MT, SO, DF>> : public IsPadded<MT> {};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct RemoveAdaptor<StrictlyUpperMatrix<MT, SO, DF>> {
	using Type = MT;
};
/*! \endcond */
//*************************************************************************************************
...
struct AddTraitEval1<T1, T2,
					 EnableIf_t<IsMatrix_v<T1> && IsMatrix_v<T2> && (IsStrictlyUpper_v<T1> && IsStrictlyUpper_v<T2>) &&
...
struct SchurTraitEval1<
	T1, T2,
	EnableIf_t<IsMatrix_v<T1> && IsMatrix_v<T2> &&
			   ((IsStrictlyUpper_v<T1> && !IsLower_v<T2>) || (!IsLower_v<T1> && IsStrictlyUpper_v<T2>)) &&
			   !(IsZero_v<T1> || IsZero_v<T2>)>> {
...
struct MultTraitEval1<T1, T2,
					  EnableIf_t<IsMatrix_v<T1> && IsScalar_v<T2> && (IsStrictlyUpper_v<T1> && !IsUniform_v<T1>)>> {
	using Type = StrictlyUpperMatrix<typename MultTraitEval2<T1, T2>::Type>;
};

template <typename T1, typename T2>
struct MultTraitEval1<T1, T2,
					  EnableIf_t<IsScalar_v<T1> && IsMatrix_v<T2> && (IsStrictlyUpper_v<T2> && !IsUniform_v<T2>)>> {
	using Type = StrictlyUpperMatrix<typename MultTraitEval2<T1, T2>::Type>;
};
...
struct MultTraitEval1<
	T1, T2,
	EnableIf_t<IsMatrix_v<T1> && IsMatrix_v<T2> &&
			   ((IsStrictlyUpper_v<T1> && IsUpper_v<T2>) || (IsUpper_v<T1> && IsStrictlyUpper_v<T2>)) &&
			   !(IsIdentity_v<T1> || IsIdentity_v<T2>) && !(IsZero_v<T1> || IsZero_v<T2>)>> {
	using Type = StrictlyUpperMatrix<typename MultTraitEval2<T1, T2>::Type>;
};
/*! \endcond */
...
struct KronTraitEval1<T1, T2,
					  EnableIf_t<IsMatrix_v<T1> && IsMatrix_v<T2> &&
								 ((IsStrictlyUpper_v<T1>) || (IsUpper_v<T1> && IsStrictlyUpper_v<T2>)) &&
								 !(IsZero_v<T1> || IsZero_v<T2>)>> {
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename T1, typename T2> struct DivTraitEval1<T1, T2, EnableIf_t<IsStrictlyUpper_v<T1> && IsScalar_v<T2>>> {
...
struct UnaryMapTraitEval1<T, OP, EnableIf_t<YieldsStrictlyUpper_v<OP, T> && !YieldsDiagonal_v<OP, T>>> {
...
struct BinaryMapTraitEval1<T1, T2, OP, EnableIf_t<YieldsStrictlyUpper_v<OP, T1, T2> && !YieldsDiagonal_v<OP, T1, T2>>> {
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct DeclSymTrait<StrictlyUpperMatrix<MT, SO, DF>> {
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct DeclHermTrait<StrictlyUpperMatrix<MT, SO, DF>> {
	using Type = ZeroMatrix<typename MT::ElementType, SO>;
};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct DeclLowTrait<StrictlyUpperMatrix<MT, SO, DF>> {
	using Type = ZeroMatrix<typename MT::ElementType, SO>;
};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct DeclUniLowTrait<StrictlyUpperMatrix<MT, SO, DF>> {
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct DeclStrLowTrait<StrictlyUpperMatrix<MT, SO, DF>> {
	using Type = ZeroMatrix<typename MT::ElementType, SO>;
};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct DeclUppTrait<StrictlyUpperMatrix<MT, SO, DF>> {
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct DeclUniUppTrait<StrictlyUpperMatrix<MT, SO, DF>> {
	using Type = INVALID_TYPE;
};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct DeclStrUppTrait<StrictlyUpperMatrix<MT, SO, DF>> {
	using Type = StrictlyUpperMatrix<MT, SO, DF>;
};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO, bool DF> struct DeclDiagTrait<StrictlyUpperMatrix<MT, SO, DF>> {
	using Type = ZeroMatrix<typename MT::ElementType, SO>;
};
/*! \endcond */
//*************************************************************************************************
...
struct SubmatrixTraitEval1<MT, I, I, N, N, EnableIf_t<I != inf && N != inf && IsStrictlyUpper_v<MT> && !IsZero_v<MT>>> {
