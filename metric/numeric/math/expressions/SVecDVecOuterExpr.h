...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SVECDVECOUTEREXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SVECDVECOUTEREXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SVecDVecOuterExpr : public VecTVecMultExpr<SparseMatrix<SVecDVecOuterExpr<VT1, VT2>, true>>, private Computation {
  private:
	//**Type definitions****************************************************************************
	...
	static constexpr bool UseVectorizedKernel_v =
		(useOptimizedKernels && T1::simdEnabled && T3::simdEnabled && IsSame_v<ElementType_t<T1>, ElementType_t<T2>> &&
  ...
  public:
	...
	class ConstIterator {
	  public:
		...
		*/
		inline const Element operator*() const { return Element(it_->value() * v_, it_->index()); }
		//*******************************************************************************************
		...
		*/
		...
		// \return The current value of the sparse element.
		*/
		inline ReturnType value() const { return it_->value() * v_; }
		//*******************************************************************************************
	...
	*/
	inline ConstIterator begin(size_t i) const { return ConstIterator(lhs_.begin(), rhs_[i]); }
	//**********************************************************************************************
	...
	*/
	inline ConstIterator end(size_t i) const { return ConstIterator(lhs_.end(), rhs_[i]); }
	//**********************************************************************************************
	...
	*/
	inline size_t nonZeros() const { return lhs_.nonZeros() * rhs_.size(); }
	//**********************************************************************************************
	...
	*/
	...
	{
		METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(VT1);
  ...
  private:
	...
	*/
	template <typename MT> // Type of the target dense matrix
	friend inline auto assign(DenseMatrix<MT, true> &lhs, const SVecDVecOuterExpr &rhs) -> EnableIf_t<UseAssign_v<MT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename MT> // Type of the target sparse matrix
	friend inline auto assign(SparseMatrix<MT, true> &lhs, const SVecDVecOuterExpr &rhs) -> EnableIf_t<UseAssign_v<MT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_ZERO_TYPE(VT1);
...
inline const SVecDVecOuterExpr<VT1, VT2> svecdvecouter(const SparseVector<VT1, false> &lhs,
...
inline decltype(auto) svecdvecouter(const SparseVector<VT1, false> &lhs, const DenseVector<VT2, true> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename VT1 // Type of the left-hand side sparse vector
		  ,
		  typename VT2> // Type of the right-hand side dense vector
inline decltype(auto) operator*(const SparseVector<VT1, false> &lhs, const DenseVector<VT2, true> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename VT1, typename VT2> struct Size<SVecDVecOuterExpr<VT1, VT2>, 0UL> : public Size<VT1, 0UL> {};

template <typename VT1, typename VT2> struct Size<SVecDVecOuterExpr<VT1, VT2>, 1UL> : public Size<VT2, 0UL> {};
/*! \endcond */
//*************************************************************************************************
