...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SMATDECLUNIUPPEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SMATDECLUNIUPPEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SMatDeclUniUppExpr : public DeclUniUppExpr<SparseMatrix<SMatDeclUniUppExpr<MT, SO>, SO>>, public Declaration<MT> {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	*/
	explicit inline SMatDeclUniUppExpr(const MT &sm) noexcept : sm_(sm) // Sparse matrix of the decluniupp expression
	{
  ...
  private:
	...
	*/
	...
	friend inline auto assign(DenseMatrix<MT2, SO2> &lhs, const SMatDeclUniUppExpr &rhs) -> EnableIf_t<UseAssign_v<MT2>>
	{
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO> struct IsUniUpper<SMatDeclUniUppExpr<MT, SO>> : public TrueType {};
/*! \endcond */
//*************************************************************************************************
