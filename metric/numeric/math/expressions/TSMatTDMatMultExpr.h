...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_TSMATTDMATMULTEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_TSMATTDMATMULTEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
template <typename MT1 // Type of the left-hand side dense matrix
		  ...
		  ,
		  bool UF> // Upper flag
class TSMatTDMatMultExpr : public MatMatMultExpr<DenseMatrix<TSMatTDMatMultExpr<MT1, MT2, SF, HF, LF, UF>, true>>,
						   private Computation {
  private:
	//**Type definitions****************************************************************************
...
inline const TSMatTDMatMultExpr<MT1, MT2, false, false, false, false> tsmattdmatmult(const SparseMatrix<MT1, true> &lhs,
...
inline const MT2 &tsmattdmatmult(const SparseMatrix<MT1, true> &lhs, const DenseMatrix<MT2, true> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
inline decltype(auto) tsmattdmatmult(const SparseMatrix<MT1, true> &lhs, const DenseMatrix<MT2, true> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
// dense matrix:
   ...
   mtrc::numeric::DynamicMatrix<double,columnMajor> B, C;
...
struct Size<TSMatTDMatMultExpr<MT1, MT2, SF, HF, LF, UF>, 0UL> : public Size<MT1, 0UL> {};

template <typename MT1, typename MT2, bool SF, bool HF, bool LF, bool UF>
struct Size<TSMatTDMatMultExpr<MT1, MT2, SF, HF, LF, UF>, 1UL> : public Size<MT2, 1UL> {};
/*! \endcond */
//*************************************************************************************************
...
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT1, typename MT2, bool SF, bool HF, bool LF, bool UF>
struct IsAligned<TSMatTDMatMultExpr<MT1, MT2, SF, HF, LF, UF>> : public IsAligned<MT2> {};
/*! \endcond */
//*************************************************************************************************
