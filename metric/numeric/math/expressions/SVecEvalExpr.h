...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SVECEVALEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SVECEVALEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SVecEvalExpr : public VecEvalExpr<SparseVector<SVecEvalExpr<VT, TF>, TF>>, private Computation {
  public:
	//**Type definitions****************************************************************************
	...
	*/
	explicit inline SVecEvalExpr(const VT &sv) noexcept : sv_(sv) // Sparse vector of the evaluation expression
	{
	}
	//**********************************************************************************************
