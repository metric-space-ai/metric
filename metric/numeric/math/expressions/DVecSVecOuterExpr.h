...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DVECSVECOUTEREXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DVECSVECOUTEREXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DVecSVecOuterExpr : public VecTVecMultExpr<SparseMatrix<DVecSVecOuterExpr<VT1, VT2>, false>>,
						  private Computation {
  private:
	//**Type definitions****************************************************************************
	...
	static constexpr bool UseVectorizedKernel_v =
		(useOptimizedKernels && T1::simdEnabled && T2::simdEnabled && IsSame_v<ElementType_t<T1>, ElementType_t<T2>> &&
		 IsSame_v<ElementType_t<T1>, ElementType_t<T3>> && HasSIMDMult_v<ElementType_t<T1>, ElementType_t<T1>>);
	/*! \endcond */
	//**********************************************************************************************
  ...
  public:
	...
	class ConstIterator {
	  public:
		...
		*/
		inline const Element operator*() const { return Element(v_ * it_->value(), it_->index()); }
		//*******************************************************************************************
		...
		*/
		...
		// \return The current value of the sparse element.
		*/
		inline ReturnType value() const { return v_ * it_->value(); }
		//*******************************************************************************************
		...
		*/
		inline size_t index() const { return it_->index(); }
		//*******************************************************************************************
		...
		*/
		inline bool operator==(const ConstIterator &rhs) const { return it_ == rhs.it_; }
		//*******************************************************************************************
		...
		*/
		inline DifferenceType operator-(const ConstIterator &rhs) const { return it_ - rhs.it_; }
		//*******************************************************************************************
	...
	*/
	...
	{
		METRIC_NUMERIC_INTERNAL_ASSERT(i < lhs_.size(), "Invalid row access index");
		METRIC_NUMERIC_INTERNAL_ASSERT(j < rhs_.size(), "Invalid column access index");
	...
	*/
	inline ConstIterator begin(size_t i) const { return ConstIterator(lhs_[i], rhs_.begin()); }
	//**********************************************************************************************
	...
	*/
	inline ConstIterator end(size_t i) const { return ConstIterator(lhs_[i], rhs_.end()); }
	//**********************************************************************************************
	...
	*/
	inline size_t rows() const noexcept { return lhs_.size(); }
	//**********************************************************************************************
	...
	*/
	inline size_t columns() const noexcept { return rhs_.size(); }
	//**********************************************************************************************
	...
	*/
	inline size_t nonZeros() const { return lhs_.size() * rhs_.nonZeros(); }
	//**********************************************************************************************
	...
	*/
	...
	{
		METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(VT2);
  ...
  private:
	...
	*/
	...
	friend inline auto assign(DenseMatrix<MT, false> &lhs, const DVecSVecOuterExpr &rhs) -> EnableIf_t<UseAssign_v<MT>>
	{
		...
		METRIC_NUMERIC_INTERNAL_ASSERT(x.size() == (*lhs).rows(), "Invalid vector size");
		METRIC_NUMERIC_INTERNAL_ASSERT(y.size() == (*lhs).columns(), "Invalid vector size");
	...
	*/
	...
	friend inline auto assign(SparseMatrix<MT, false> &lhs, const DVecSVecOuterExpr &rhs) -> EnableIf_t<UseAssign_v<MT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;

		METRIC_NUMERIC_INTERNAL_ASSERT((*lhs).rows() == rhs.rows(), "Invalid number of rows");
		METRIC_NUMERIC_INTERNAL_ASSERT((*lhs).columns() == rhs.columns(), "Invalid number of columns");
		METRIC_NUMERIC_INTERNAL_ASSERT((*lhs).capacity() >= rhs.nonZeros(), "Insufficient capacity");
	...
	*/
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_COLUMN_VECTOR_TYPE(VT1);
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_SPARSE_VECTOR_TYPE(VT2);
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_ROW_VECTOR_TYPE(VT2);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_ZERO_TYPE(VT2);
	METRIC_NUMERIC_CONSTRAINT_MUST_FORM_VALID_VECTVECMULTEXPR(VT1, VT2);
	/*! \endcond */
	//**********************************************************************************************
};
//*************************************************************************************************
...
inline const DVecSVecOuterExpr<VT1, VT2> dvecsvecouter(const DenseVector<VT1, false> &lhs,
...
inline decltype(auto) dvecsvecouter(const DenseVector<VT1, false> &lhs, const SparseVector<VT2, true> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename VT1 // Type of the left-hand side dense vector
		  ,
		  typename VT2> // Type of the right-hand side sparse vector
inline decltype(auto) operator*(const DenseVector<VT1, false> &lhs, const SparseVector<VT2, true> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename VT1, typename VT2> struct Size<DVecSVecOuterExpr<VT1, VT2>, 0UL> : public Size<VT1, 0UL> {};

template <typename VT1, typename VT2> struct Size<DVecSVecOuterExpr<VT1, VT2>, 1UL> : public Size<VT2, 0UL> {};
/*! \endcond */
//*************************************************************************************************
