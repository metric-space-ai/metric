...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DVECSCALARMULTEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DVECSCALARMULTEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DVecScalarMultExpr : public VecScalarMultExpr<DenseVector<DVecScalarMultExpr<VT, ST, TF>, TF>>,
						   private Computation {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	class ConstIterator {
	  public:
		...
		*/
		inline METRIC_NUMERIC_DEVICE_CALLABLE ConstIterator(IteratorType iterator, RightOperand scalar)
		...
		*/
		inline METRIC_NUMERIC_DEVICE_CALLABLE ReturnType operator*() const { return *iterator_ * scalar_; }
		//*******************************************************************************************
	...
	static constexpr bool simdEnabled =
		(VT::simdEnabled && IsNumeric_v<ET> && (HasSIMDMult_v<ET, ST> || HasSIMDMult_v<UnderlyingElement_t<ET>, ST>));
	...
	*/
	inline bool isAligned() const noexcept { return vector_.isAligned(); }
	//**********************************************************************************************
  ...
  private:
	...
	*/
	...
	friend inline auto assign(DenseVector<VT2, TF> &lhs, const DVecScalarMultExpr &rhs) -> EnableIf_t<UseAssign_v<VT2>>
	{
	...
	*/
	...
	friend inline auto assign(SparseVector<VT2, TF> &lhs, const DVecScalarMultExpr &rhs) -> EnableIf_t<UseAssign_v<VT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
...
{
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_SCALAR_TYPE(ElementType_t<VT>);
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename VT, typename ST, bool TF> struct IsAligned<DVecScalarMultExpr<VT, ST, TF>> : public IsAligned<VT> {};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename VT, typename ST, bool TF> struct IsPadded<DVecScalarMultExpr<VT, ST, TF>> : public IsPadded<VT> {};
/*! \endcond */
//*************************************************************************************************
