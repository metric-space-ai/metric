...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_TDMATSMATSUBEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_TDMATSMATSUBEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class TDMatSMatSubExpr : public MatMatSubExpr<DenseMatrix<TDMatSMatSubExpr<MT1, MT2>, true>>, private Computation {
  private:
	//**Type definitions****************************************************************************
	...
	template <typename MT> static constexpr bool UseSMPAssign_v = (!MT1::smpAssignable || !MT2::smpAssignable);
	/*! \endcond */
	//**********************************************************************************************
  ...
  public:
	...
	*/
	inline TDMatSMatSubExpr(const MT1 &lhs, const MT2 &rhs) noexcept
	...
	*/
	...
	{
		return (IsExpression_v<MT1> && lhs_.canAlias(alias)) || (rhs_.canAlias(alias));
	}
	//**********************************************************************************************
  ...
  private:
	...
	*/
	template <typename MT // Type of the target dense matrix
			  ,
			  bool SO2> // Storage order of the target dense matrix
	friend inline auto smpAssign(DenseMatrix<MT, SO2> &lhs, const TDMatSMatSubExpr &rhs)
	...
	*/
	template <typename MT // Type of the target sparse matrix
			  ,
			  bool SO2> // Storage order of the target sparse matrix
	friend inline auto smpAssign(SparseMatrix<MT, SO2> &lhs, const TDMatSMatSubExpr &rhs)
		-> EnableIf_t<UseSMPAssign_v<MT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename MT // Type of the target dense matrix
			  ,
			  bool SO2> // Storage order of the target dense matrix
	friend inline auto smpAddAssign(DenseMatrix<MT, SO2> &lhs, const TDMatSMatSubExpr &rhs)
		-> EnableIf_t<UseSMPAssign_v<MT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename MT // Type of the target dense matrix
			  ,
			  bool SO2> // Storage order of the target dense matrix
	friend inline auto smpSubAssign(DenseMatrix<MT, SO2> &lhs, const TDMatSMatSubExpr &rhs)
		-> EnableIf_t<UseSMPAssign_v<MT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename MT // Type of the target dense matrix
			  ,
			  bool SO2> // Storage order of the target dense matrix
	friend inline auto smpSchurAssign(DenseMatrix<MT, SO2> &lhs, const TDMatSMatSubExpr &rhs)
		-> EnableIf_t<UseSMPAssign_v<MT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
/*!\brief Backend implementation of the subtraction between a column-major dense matrix and a
...
template <typename MT1 // Type of the left-hand side dense matrix
		  ...
		  typename MT2 // Type of the right-hand side sparse matrix
		  ,
		  DisableIf_t<IsZero_v<MT2> && IsSame_v<ElementType_t<MT1>, ElementType_t<MT2>>> * = nullptr>
inline const TDMatSMatSubExpr<MT1, MT2> tdmatsmatsub(const DenseMatrix<MT1, true> &lhs,
													 const SparseMatrix<MT2, false> &rhs)
{
	...
	return TDMatSMatSubExpr<MT1, MT2>(*lhs, *rhs);
}
/*! \endcond */
//*************************************************************************************************
...
// a column-major dense matrix and a row-major zero matrix. It returns a reference to the
...
template <typename MT1 // Type of the left-hand side dense matrix
		  ...
		  typename MT2 // Type of the right-hand side sparse matrix
		  ,
		  EnableIf_t<IsZero_v<MT2> && IsSame_v<ElementType_t<MT1>, ElementType_t<MT2>>> * = nullptr>
inline const MT1 &tdmatsmatsub(const DenseMatrix<MT1, true> &lhs, const SparseMatrix<MT2, false> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
inline decltype(auto) operator+(const TDMatSMatSubExpr<MT1, MT2> &lhs, const DenseMatrix<MT3, SO> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
