...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DVECSCALARDIVEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DVECSCALARDIVEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DVecScalarDivExpr : public VecScalarDivExpr<DenseVector<DVecScalarDivExpr<VT, ST, TF>, TF>>, private Computation {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	static constexpr bool simdEnabled =
		(VT::simdEnabled && IsNumeric_v<ET> && (HasSIMDDiv_v<ET, ST> || HasSIMDDiv_v<UnderlyingElement_t<ET>, ST>));
  ...
  private:
	...
	*/
	...
	friend inline auto assign(DenseVector<VT2, TF> &lhs, const DVecScalarDivExpr &rhs) -> EnableIf_t<UseAssign_v<VT2>>
	{
	...
	*/
	...
	friend inline auto assign(SparseVector<VT2, TF> &lhs, const DVecScalarDivExpr &rhs) -> EnableIf_t<UseAssign_v<VT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename VT, typename ST, bool TF> struct IsAligned<DVecScalarDivExpr<VT, ST, TF>> : public IsAligned<VT> {};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename VT, typename ST, bool TF> struct IsPadded<DVecScalarDivExpr<VT, ST, TF>> : public IsPadded<VT> {};
/*! \endcond */
//*************************************************************************************************
