...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DMATREPEATEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DMATREPEATEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DMatRepeatExpr : public MatRepeatExpr<DenseMatrix<DMatRepeatExpr<MT, SO, CRAs...>, SO>, CRAs...>,
  ...
  public:
	...
	*/
	inline size_t rows() const noexcept { return dm_.rows() * this->template repetitions<0UL>(); }
	//**********************************************************************************************
	...
	*/
	inline size_t columns() const noexcept { return dm_.columns() * this->template repetitions<1UL>(); }
	//**********************************************************************************************
...
// This function returns an expression representing the repeated dense matrix:
   ...
   mtrc::numeric::DynamicMatrix<int,rowMajor> A1{ { 1, 0, -2 }, { 0, 5, 0 } };
   mtrc::numeric::DynamicMatrix<int,columnMajor> B1{ { 0, -1 }, { 0, 4 }, { 7, 0 } };

   mtrc::numeric::DynamicMatrix<int,rowMajor> A2;
   mtrc::numeric::DynamicMatrix<int,columnMajor> B2;
