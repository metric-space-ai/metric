...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SMATDECLSYMEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SMATDECLSYMEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SMatDeclSymExpr : public DeclSymExpr<SparseMatrix<SMatDeclSymExpr<MT, SO>, SO>>, public Declaration<MT> {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	*/
	explicit inline SMatDeclSymExpr(const MT &sm) noexcept : sm_(sm) // Sparse matrix of the declsym expression
	{
  ...
  private:
	...
	*/
	...
	friend inline auto assign(DenseMatrix<MT2, SO2> &lhs, const SMatDeclSymExpr &rhs) -> EnableIf_t<UseAssign_v<MT2>>
	{
	...
	*/
	...
	friend inline auto assign(SparseMatrix<MT2, SO2> &lhs, const SMatDeclSymExpr &rhs) -> EnableIf_t<UseAssign_v<MT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename MT2 // Type of the target dense matrix
			  ,
			  bool SO2> // Storage order of the target dense matrix
	friend inline auto addAssign(DenseMatrix<MT2, SO2> &lhs, const SMatDeclSymExpr &rhs) -> EnableIf_t<UseAssign_v<MT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename MT2 // Type of the target dense matrix
			  ,
			  bool SO2> // Storage order of the target dense matrix
	friend inline auto subAssign(DenseMatrix<MT2, SO2> &lhs, const SMatDeclSymExpr &rhs) -> EnableIf_t<UseAssign_v<MT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO> struct IsSymmetric<SMatDeclSymExpr<MT, SO>> : public TrueType {};
/*! \endcond */
//*************************************************************************************************
