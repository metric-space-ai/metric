...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SMATSVECMULTEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SMATSVECMULTEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SMatSVecMultExpr : public MatVecMultExpr<SparseVector<SMatSVecMultExpr<MT, VT>, false>>, private Computation {
  private:
	//**Type definitions****************************************************************************
...
inline const SMatSVecMultExpr<MT, VT> smatsvecmult(const SparseMatrix<MT, false> &mat,
...
template <typename MT // Type of the left-hand side sparse matrix
		  ...
		  EnableIf_t<IsSymmetric_v<MT> && !(IsIdentity_v<MT> && IsSame_v<ElementType_t<MT>, ElementType_t<VT>>) &&
					 !(IsZero_v<MT> || IsZero_v<VT>)> * = nullptr>
inline decltype(auto) smatsvecmult(const SparseMatrix<MT, false> &mat, const SparseVector<VT, false> &vec)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
inline const VT &smatsvecmult(const SparseMatrix<MT, false> &mat, const SparseVector<VT, false> &vec)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename MT // Type of the left-hand side sparse matrix
		  ,
		  typename VT> // Type of the right-hand side sparse vector
inline decltype(auto) operator*(const SparseMatrix<MT, false> &mat, const SparseVector<VT, false> &vec)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
