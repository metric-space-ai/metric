...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SMATSMATSCHUREXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SMATSMATSCHUREXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SMatSMatSchurExpr : public SchurExpr<SparseMatrix<SMatSMatSchurExpr<MT1, MT2>, false>>, private Computation {
  private:
	//**Type definitions****************************************************************************
...
inline const SMatSMatSchurExpr<MT1, MT2> smatsmatschur(const SparseMatrix<MT1, false> &lhs,
...
inline decltype(auto) smatsmatschur(const SparseMatrix<MT1, false> &lhs, const SparseMatrix<MT2, false> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
