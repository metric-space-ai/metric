...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SMATSERIALEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SMATSERIALEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SMatSerialExpr : public MatSerialExpr<SparseMatrix<SMatSerialExpr<MT, SO>, SO>>, private Computation {
  public:
	//**Type definitions****************************************************************************
	...
	*/
	explicit inline SMatSerialExpr(const MT &sm) noexcept : sm_(sm) // Sparse matrix of the serial evaluation expression
	{
	}
	//**********************************************************************************************
	...
	*/
	...
	// \return The sparse matrix operand.
	*/
	inline operator Operand() const noexcept { return sm_; }
	//**********************************************************************************************
