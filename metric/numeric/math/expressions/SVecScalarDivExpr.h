...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SVECSCALARDIVEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SVECSCALARDIVEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SVecScalarDivExpr : public VecScalarDivExpr<SparseVector<SVecScalarDivExpr<VT, ST, TF>, TF>>,
						  private Computation {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	class ConstIterator {
	  public:
		...
		*/
		inline const Element operator*() const { return Element(vector_->value() / scalar_, vector_->index()); }
		//*******************************************************************************************
		...
		*/
		...
		// \return The current value of the sparse element.
		*/
		inline ReturnType value() const { return vector_->value() / scalar_; }
		//*******************************************************************************************
		...
		*/
		inline size_t index() const { return vector_->index(); }
		//*******************************************************************************************
		...
		*/
		inline bool operator==(const ConstIterator &rhs) const { return vector_ == rhs.vector_; }
		//*******************************************************************************************
		...
		*/
		inline DifferenceType operator-(const ConstIterator &rhs) const { return vector_ - rhs.vector_; }
		//*******************************************************************************************
	...
	*/
	inline ConstIterator begin() const { return ConstIterator(vector_.begin(), scalar_); }
	//**********************************************************************************************
	...
	*/
	inline ConstIterator end() const { return ConstIterator(vector_.end(), scalar_); }
	//**********************************************************************************************
	...
	*/
	inline size_t size() const noexcept { return vector_.size(); }
	//**********************************************************************************************
	...
	*/
	inline size_t nonZeros() const { return vector_.nonZeros(); }
	//**********************************************************************************************
	...
	*/
	inline LeftOperand leftOperand() const noexcept { return vector_; }
	//**********************************************************************************************
	...
	*/
	inline RightOperand rightOperand() const noexcept { return scalar_; }
	//**********************************************************************************************
	...
	*/
	template <typename T> inline bool canAlias(const T *alias) const noexcept { return vector_.canAlias(alias); }
	//**********************************************************************************************
	...
	*/
	template <typename T> inline bool isAliased(const T *alias) const noexcept { return vector_.isAliased(alias); }
	//**********************************************************************************************
  ...
  private:
	...
	*/
	...
	friend inline auto assign(DenseVector<VT2, TF> &lhs, const SVecScalarDivExpr &rhs) -> EnableIf_t<UseAssign_v<VT2>>
	{
	...
	*/
	...
	friend inline auto assign(SparseVector<VT2, TF> &lhs, const SVecScalarDivExpr &rhs) -> EnableIf_t<UseAssign_v<VT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT2> // Type of the target dense vector
	friend inline auto addAssign(DenseVector<VT2, TF> &lhs, const SVecScalarDivExpr &rhs)
	...
	*/
	template <typename VT2> // Type of the target dense vector
	friend inline auto subAssign(DenseVector<VT2, TF> &lhs, const SVecScalarDivExpr &rhs)
		-> EnableIf_t<UseAssign_v<VT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT2> // Type of the target dense vector
	friend inline auto multAssign(DenseVector<VT2, TF> &lhs, const SVecScalarDivExpr &rhs)
		-> EnableIf_t<UseAssign_v<VT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT2> // Type of the target dense vector
	friend inline auto smpAddAssign(DenseVector<VT2, TF> &lhs, const SVecScalarDivExpr &rhs)
	...
	*/
	template <typename VT2> // Type of the target dense vector
	friend inline auto smpSubAssign(DenseVector<VT2, TF> &lhs, const SVecScalarDivExpr &rhs)
		-> EnableIf_t<UseSMPAssign_v<VT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT2> // Type of the target dense vector
	friend inline auto smpMultAssign(DenseVector<VT2, TF> &lhs, const SVecScalarDivExpr &rhs)
		-> EnableIf_t<UseSMPAssign_v<VT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_FLOATING_POINT_TYPE(ST);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_FLOATING_POINT_TYPE(ElementType);
...
using SVecScalarDivExprHelper_t =
	If_t<IsFloatingPoint_v<UnderlyingBuiltin_t<VT>> || IsFloatingPoint_v<UnderlyingBuiltin_t<ST>>,
		 If_t<IsBuiltin_v<ST>, DivTrait_t<UnderlyingBuiltin_t<VT>, ST>, decltype(inv(std::declval<ST>()))>, ST>;
/*! \endcond */
//*************************************************************************************************
...
//
// This function implements the default treatment of the sparse vector/scalar division.
*/
template <typename VT // Type of the left-hand side sparse vector
		  ,
		  ...
		  typename ST // Type of the right-hand side scalar
		  ,
		  EnableIf_t<!IsZero_v<VT> && !IsInvertible_v<SVecScalarDivExprHelper_t<VT, ST>>> * = nullptr>
inline decltype(auto) svecscalardiv(const SparseVector<VT, TF> &vec, ST scalar)
{
	METRIC_NUMERIC_FUNCTION_TRACE;

	using ScalarType = SVecScalarDivExprHelper_t<VT, ST>;
	using ReturnType = const SVecScalarDivExpr<VT, ScalarType, TF>;
...
// \return The scaled result vector.
//
// This function implements a performance optimized treatment of the sparse vector/scalar division.
*/
template <typename VT // Type of the left-hand side sparse vector
		  ,
		  bool TF // Transpose flag of the left-hand side sparse vector
...
inline decltype(auto) svecscalardiv(const SparseVector<VT, TF> &vec, ST scalar)
{
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_VECTOR_WITH_TRANSPOSE_FLAG(ReturnType, TF);
...
inline decltype(auto) operator/(const SparseVector<VT, TF> &vec, ST scalar)
{
	...
	METRIC_NUMERIC_USER_ASSERT(scalar != ST{}, "Division by zero detected");
