...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DVECDVECKRONEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DVECDVECKRONEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DVecDVecKronExpr : public VecVecKronExpr<DenseVector<DVecDVecKronExpr<VT1, VT2, TF>, TF>>, private Computation {
  private:
	//**Type definitions****************************************************************************
...
template <typename VT1 // Type of the left-hand side dense vector
		  ...
		  ,
		  bool TF> // Transpose flag
inline decltype(auto) kron(const DenseVector<VT1, TF> &lhs, const DenseVector<VT2, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
