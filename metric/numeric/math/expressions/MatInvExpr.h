...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_MATINVEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_MATINVEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
struct MatInvExpr : public Expression<MT> {};
//*************************************************************************************************
...
inline decltype(auto) operator*(const MatInvExpr<MT> &mat, const DenseVector<VT, false> &vec)
{
...
inline decltype(auto) operator*(const DenseVector<VT, true> &vec, const MatInvExpr<MT> &mat)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
inline decltype(auto) operator*(const MatInvExpr<MT1> &lhs, const DenseMatrix<MT2, SO> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
inline decltype(auto) operator*(const DenseMatrix<MT1, SO> &lhs, const MatInvExpr<MT2> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
