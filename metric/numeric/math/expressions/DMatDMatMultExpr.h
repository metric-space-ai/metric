...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DMATDMATMULTEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DMATDMATMULTEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
template <typename MT1 // Type of the left-hand side dense matrix
		  ...
		  ,
		  bool UF> // Upper flag
class DMatDMatMultExpr : public MatMatMultExpr<DenseMatrix<DMatDMatMultExpr<MT1, MT2, SF, HF, LF, UF>, false>>,
						 private Computation {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	static constexpr bool simdEnabled = (!IsDiagonal_v<MT2> && MT1::simdEnabled && MT2::simdEnabled &&
	...
	*/
	inline bool canSMPAssign() const noexcept
	{
		return (!METRIC_NUMERIC_BLAS_MODE || !METRIC_NUMERIC_USE_BLAS_MATRIX_MATRIX_MULTIPLICATION ||
				!METRIC_NUMERIC_BLAS_IS_PARALLEL || (rows() * columns() < DMATDMATMULT_THRESHOLD)) &&
			   (rows() * columns() >= SMP_DMATDMATMULT_THRESHOLD) && !IsDiagonal_v<MT1> && !IsDiagonal_v<MT2>;
	}
	//**********************************************************************************************
  ...
  private:
	...
	*/
	...
	{
		if ((IsDiagonal_v<MT5>) || (!METRIC_NUMERIC_DEBUG_MODE && B.columns() <= SIMDSIZE * 10UL) ||
	...
	*/
	...
	static inline auto selectDefaultAssignKernel(MT3 &C, const MT4 &A, const MT5 &B)
		-> EnableIf_t<!IsDiagonal_v<MT4> && IsDiagonal_v<MT5>>
	{
		METRIC_NUMERIC_CONSTRAINT_MUST_BE_ROW_MAJOR_MATRIX_TYPE(MT3);
	...
	*/
		...
		-> EnableIf_t<IsColumnMajorMatrix_v<MT3> && UseVectorizedDefaultKernel_v<MT3, MT4, MT5>>
	{
		...
		METRIC_NUMERIC_CONSTRAINT_MUST_BE_COLUMN_MAJOR_MATRIX_TYPE(OppositeType_t<MT4>);
...
class DMatScalarMultExpr<DMatDMatMultExpr<MT1, MT2, SF, HF, LF, UF>, ST, false>
	: public MatScalarMultExpr<
		  DenseMatrix<DMatScalarMultExpr<DMatDMatMultExpr<MT1, MT2, SF, HF, LF, UF>, ST, false>, false>>,
	  private Computation {
  private:
	//**Type definitions****************************************************************************
	...
	template <typename T1, typename T2, typename T3, typename T4>
	static constexpr bool UseVectorizedDefaultKernel_v =
		(useOptimizedKernels && !IsDiagonal_v<T3> && T1::simdEnabled && T2::simdEnabled && T3::simdEnabled &&
  ...
  public:
	...
	static constexpr bool simdEnabled =
		(!IsDiagonal_v<MT2> && MT1::simdEnabled && MT2::simdEnabled && IsSIMDCombinable_v<ET1, ET2, ST> &&
		 HasSIMDAdd_v<ET1, ET2> && HasSIMDMult_v<ET1, ET2>);
...
// This operator represents the multiplication of two row-major dense matrices:
   ...
   mtrc::numeric::DynamicMatrix<double,rowMajor> A, B, C;
...
template <typename MT1 // Type of the left-hand side dense matrix
		  ,
		  typename MT2> // Type of the right-hand side dense matrix
inline decltype(auto) operator*(const DenseMatrix<MT1, false> &lhs, const DenseMatrix<MT2, false> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
struct Size<DMatDMatMultExpr<MT1, MT2, SF, HF, LF, UF>, 0UL> : public Size<MT1, 0UL> {};

template <typename MT1, typename MT2, bool SF, bool HF, bool LF, bool UF>
struct Size<DMatDMatMultExpr<MT1, MT2, SF, HF, LF, UF>, 1UL> : public Size<MT2, 1UL> {};
/*! \endcond */
//*************************************************************************************************
