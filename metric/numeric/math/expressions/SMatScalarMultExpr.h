...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SMATSCALARMULTEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SMATSCALARMULTEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SMatScalarMultExpr : public MatScalarMultExpr<SparseMatrix<SMatScalarMultExpr<MT, ST, SO>, SO>>,
						   private Computation {
  private:
	//**Type definitions****************************************************************************
  ...
  private:
	...
	*/
	...
	friend inline auto assign(DenseMatrix<MT2, SO2> &lhs, const SMatScalarMultExpr &rhs) -> EnableIf_t<UseAssign_v<MT2>>
	{
...
inline decltype(auto) smatscalarmult(const SparseMatrix<MT, SO> &mat, ST scalar)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
