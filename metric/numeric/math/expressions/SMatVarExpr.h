...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SMATVAREXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SMATVAREXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
*/
template <typename MT> // Type of the sparse matrix
class SMatVarExpr<MT, columnwise> : public MatReduceExpr<DenseVector<SMatVarExpr<MT, columnwise>, true>, columnwise>,
									private Computation {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	*/
	explicit inline SMatVarExpr(const MT &sm) noexcept : sm_(sm) // Sparse matrix of the variance expression
	{
	}
	//**********************************************************************************************
...
*/
template <typename MT> // Type of the sparse matrix
class SMatVarExpr<MT, rowwise> : public MatReduceExpr<DenseVector<SMatVarExpr<MT, rowwise>, false>, rowwise>,
								 private Computation {
  private:
	//**Type definitions****************************************************************************
	using RT = ResultType_t<MT>; //!< Result type of the sparse matrix expression.
  ...
  public:
	...
	class ConstIterator {
	  public:
		...
		*/
		...
		// \return The resulting value.
		*/
		inline ReturnType operator*() const { return var(row(sm_, index_, unchecked)); }
		//*******************************************************************************************
	...
	*/
	inline ConstIterator begin() const { return ConstIterator(sm_, 0UL); }
	//**********************************************************************************************
	...
	*/
	inline ConstIterator end() const { return ConstIterator(sm_, size()); }
	//**********************************************************************************************
  ...
  private:
	...
	*/
	...
	friend inline auto assign(Vector<VT1, false> &lhs, const SMatVarExpr &rhs) -> EnableIf_t<UseAssign_v<VT1>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT1> // Type of the target vector
	friend inline auto addAssign(Vector<VT1, false> &lhs, const SMatVarExpr &rhs) -> EnableIf_t<UseAssign_v<VT1>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT1> // Type of the target vector
	friend inline auto subAssign(Vector<VT1, false> &lhs, const SMatVarExpr &rhs) -> EnableIf_t<UseAssign_v<VT1>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT1> // Type of the target vector
	friend inline auto multAssign(Vector<VT1, false> &lhs, const SMatVarExpr &rhs) -> EnableIf_t<UseAssign_v<VT1>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT1> // Type of the target vector
	friend inline auto divAssign(Vector<VT1, false> &lhs, const SMatVarExpr &rhs) -> EnableIf_t<UseAssign_v<VT1>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
...
inline decltype(auto) var_backend(const SparseMatrix<MT, SO> &sm, TrueType)
{
	...
	METRIC_NUMERIC_INTERNAL_ASSERT(size(*sm) > 1UL, "Invalid matrix size detected");
