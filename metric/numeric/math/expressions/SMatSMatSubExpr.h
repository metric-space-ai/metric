...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SMATSMATSUBEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SMATSMATSUBEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SMatSMatSubExpr : public MatMatSubExpr<SparseMatrix<SMatSMatSubExpr<MT1, MT2>, false>>, private Computation {
  private:
	//**Type definitions****************************************************************************
...
inline const SMatSMatSubExpr<MT1, MT2> smatsmatsub(const SparseMatrix<MT1, false> &lhs,
...
inline const MT1 &smatsmatsub(const SparseMatrix<MT1, false> &lhs, const SparseMatrix<MT2, false> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename MT1 // Type of the left-hand side sparse matrix
		  ...
		  ,
		  EnableIf_t<IsZero_v<MT1> && !IsZero_v<MT2> && IsSame_v<ElementType_t<MT1>, ElementType_t<MT2>>> * = nullptr>
inline decltype(auto) smatsmatsub(const SparseMatrix<MT1, false> &lhs, const SparseMatrix<MT2, false> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
