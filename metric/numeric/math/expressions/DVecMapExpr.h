...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DVECMAPEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DVECMAPEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DVecMapExpr : public VecMapExpr<DenseVector<DVecMapExpr<VT, OP, TF>, TF>>, private Computation {
  private:
	//**Type definitions****************************************************************************
	...
	static constexpr bool UseSMPAssign_v = ((!VT2::smpAssignable || !VT::smpAssignable) && useAssign);
	/*! \endcond */
	//**********************************************************************************************
  ...
  public:
	...
	static constexpr bool simdEnabled =
		(VT::simdEnabled && If_t<HasSIMDEnabled_v<OP>, GetSIMDEnabled<OP, ET>, HasLoad<OP>>::value);
	...
	*/
	inline ConstIterator begin() const { return ConstIterator(dv_.begin(), op_); }
	//**********************************************************************************************
	...
	*/
	inline ConstIterator end() const { return ConstIterator(dv_.end(), op_); }
	//**********************************************************************************************
  ...
  private:
	...
	*/
	...
	friend inline auto assign(DenseVector<VT2, TF> &lhs, const DVecMapExpr &rhs)
		-> EnableIf_t<UseAssign_v<VT2> && IsSame_v<UnderlyingScalar_t<VT>, UnderlyingScalar_t<VT2>>>
	{
	...
	*/
	...
	friend inline auto assign(SparseVector<VT2, TF> &lhs, const DVecMapExpr &rhs) -> EnableIf_t<UseAssign_v<VT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT2> // Type of the target dense vector
	friend inline auto addAssign(DenseVector<VT2, TF> &lhs, const DVecMapExpr &rhs) -> EnableIf_t<UseAssign_v<VT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT2> // Type of the target dense vector
	friend inline auto subAssign(DenseVector<VT2, TF> &lhs, const DVecMapExpr &rhs) -> EnableIf_t<UseAssign_v<VT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT2> // Type of the target dense vector
	friend inline auto multAssign(DenseVector<VT2, TF> &lhs, const DVecMapExpr &rhs) -> EnableIf_t<UseAssign_v<VT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT2> // Type of the target dense vector
	friend inline auto divAssign(DenseVector<VT2, TF> &lhs, const DVecMapExpr &rhs) -> EnableIf_t<UseAssign_v<VT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	...
	friend inline auto smpAssign(DenseVector<VT2, TF> &lhs, const DVecMapExpr &rhs)
		-> EnableIf_t<UseSMPAssign_v<VT2> && IsSame_v<UnderlyingScalar_t<VT>, UnderlyingScalar_t<VT2>>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT2> // Type of the target sparse vector
	friend inline auto smpAssign(SparseVector<VT2, TF> &lhs, const DVecMapExpr &rhs) -> EnableIf_t<UseSMPAssign_v<VT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
...
// The following example demonstrates the use of the \a conj() function:
   ...
   \code
   mtrc::numeric::DynamicVector< complex<double> > a, b;
   // ... Resizing and initialization
   b = conj( a );
   \endcode
*/
...
inline decltype(auto) pow(const DenseVector<VT, TF> &dv, ST exp)
{
	...
	return map(*dv, mtrc::numeric::bind2nd(Pow(), ScalarType(exp)));
}
//*************************************************************************************************
...
inline decltype(auto) operator+(const DenseVector<VT, TF> &vec, ST scalar)
{
	...
	return map(*vec, mtrc::numeric::bind2nd(Add{}, ScalarType(scalar)));
}
//*************************************************************************************************
...
inline decltype(auto) operator+(ST scalar, const DenseVector<VT, TF> &vec)
{
	...
	return map(*vec, mtrc::numeric::bind1st(Add{}, ScalarType(scalar)));
}
//*************************************************************************************************
...
inline decltype(auto) operator-(const DenseVector<VT, TF> &vec, ST scalar)
{
	...
	return map(*vec, mtrc::numeric::bind2nd(Sub{}, ScalarType(scalar)));
}
//*************************************************************************************************
...
inline decltype(auto) operator-(ST scalar, const DenseVector<VT, TF> &vec)
{
	...
	return map(*vec, mtrc::numeric::bind1st(Sub{}, ScalarType(scalar)));
}
//*************************************************************************************************
...
inline decltype(auto) operator/(ST scalar, const DenseVector<VT, TF> &vec)
{
	...
	return map(*vec, mtrc::numeric::bind1st(Div{}, ScalarType(scalar)));
}
//*************************************************************************************************
...
// This operator represents the uniform left-shift of all elements of a dense vector:
   ...
   \code
   mtrc::numeric::DynamicVector<unsigned int> a, b;
   // ... Resizing and initialization
   b = a << 3;
   \endcode
*/
...
inline decltype(auto) operator&(const DenseVector<VT, TF> &vec, ST scalar)
{
	...
	return map(*vec, mtrc::numeric::bind2nd(Bitand{}, scalar));
}
//*************************************************************************************************
...
inline decltype(auto) operator|(const DenseVector<VT, TF> &vec, ST scalar)
{
	...
	return map(*vec, mtrc::numeric::bind2nd(Bitor{}, scalar));
}
//*************************************************************************************************
...
inline decltype(auto) operator^(const DenseVector<VT, TF> &vec, ST scalar)
{
	...
	return map(*vec, mtrc::numeric::bind2nd(Bitxor{}, scalar));
}
//*************************************************************************************************
...
// This operator represents the logical NOT of all elements of a dense vector:
   ...
   \code
   mtrc::numeric::DynamicVector<bool> a, b;
   // ... Resizing and initialization
   b = !a;
   \endcode
*/
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename VT, typename OP, bool TF> struct IsAligned<DVecMapExpr<VT, OP, TF>> : public IsAligned<VT> {};
/*! \endcond */
//*************************************************************************************************
...
struct IsPadded<DVecMapExpr<VT, OP, TF>> : public BoolConstant<IsPadded_v<VT> && IsPaddingEnabled_v<OP>> {};
/*! \endcond */
//*************************************************************************************************
