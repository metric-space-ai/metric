...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_TSMATTSMATSUBEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_TSMATTSMATSUBEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class TSMatTSMatSubExpr : public MatMatSubExpr<SparseMatrix<TSMatTSMatSubExpr<MT1, MT2>, true>>, private Computation {
  private:
	//**Type definitions****************************************************************************
...
inline const TSMatTSMatSubExpr<MT1, MT2> tsmattsmatsub(const SparseMatrix<MT1, true> &lhs,
...
inline const MT1 &tsmattsmatsub(const SparseMatrix<MT1, true> &lhs, const SparseMatrix<MT2, true> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename MT1 // Type of the left-hand side sparse matrix
		  ...
		  ,
		  EnableIf_t<IsZero_v<MT1> && !IsZero_v<MT2> && IsSame_v<ElementType_t<MT1>, ElementType_t<MT2>>> * = nullptr>
inline decltype(auto) tsmattsmatsub(const SparseMatrix<MT1, true> &lhs, const SparseMatrix<MT2, true> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
