...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DVECDVECADDEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DVECDVECADDEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
#include <metric/numeric/util/constraints/Double.h>
#include <metric/numeric/util/constraints/Float.h>
...
class DVecDVecAddExpr : public VecVecAddExpr<DenseVector<DVecDVecAddExpr<VT1, VT2, TF>, TF>>, private Computation {
  private:
	//**Type definitions****************************************************************************
	...
	static constexpr bool useAssign = (RequiresEvaluation_v<VT1> || RequiresEvaluation_v<VT2> || !returnExpr);
  ...
  public:
	...
	class ConstIterator {
	  public:
		...
		*/
		inline METRIC_NUMERIC_DEVICE_CALLABLE ReturnType operator*() const { return (*left_) + (*right_); }
		//*******************************************************************************************
	...
	static constexpr bool simdEnabled = (VT1::simdEnabled && VT2::simdEnabled && HasSIMDAdd_v<ET1, ET2>);
	...
	*/
	inline ConstIterator begin() const { return ConstIterator(lhs_.begin(), rhs_.begin()); }
	//**********************************************************************************************
	...
	*/
	inline ConstIterator end() const { return ConstIterator(lhs_.end(), rhs_.end()); }
	//**********************************************************************************************
	...
	*/
	...
	{
		return lhs_.canSMPAssign() || rhs_.canSMPAssign() || (size() > SMP_DVECDVECADD_THRESHOLD);
	}
	//**********************************************************************************************
  ...
  private:
	...
	*/
	...
	friend inline auto assign(DenseVector<VT, TF> &lhs, const DVecDVecAddExpr &rhs) -> EnableIf_t<UseAssign_v<VT>>
	{
	...
	*/
	...
	friend inline auto assign(SparseVector<VT, TF> &lhs, const DVecDVecAddExpr &rhs) -> EnableIf_t<UseAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT> // Type of the target dense vector
	friend inline auto addAssign(DenseVector<VT, TF> &lhs, const DVecDVecAddExpr &rhs) -> EnableIf_t<UseAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT> // Type of the target dense vector
	friend inline auto subAssign(DenseVector<VT, TF> &lhs, const DVecDVecAddExpr &rhs) -> EnableIf_t<UseAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT> // Type of the target dense vector
	friend inline auto multAssign(DenseVector<VT, TF> &lhs, const DVecDVecAddExpr &rhs) -> EnableIf_t<UseAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT> // Type of the target dense vector
	friend inline auto divAssign(DenseVector<VT, TF> &lhs, const DVecDVecAddExpr &rhs) -> EnableIf_t<UseAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT> // Type of the target dense vector
	friend inline auto smpAssign(DenseVector<VT, TF> &lhs, const DVecDVecAddExpr &rhs) -> EnableIf_t<UseSMPAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_FORM_VALID_VECVECADDEXPR(VT1, VT2);
	/*! \endcond */
	//**********************************************************************************************
};
//*************************************************************************************************
...
struct IsAligned<DVecDVecAddExpr<VT1, VT2, TF>> : public BoolConstant<IsAligned_v<VT1> && IsAligned_v<VT2>> {};
/*! \endcond */
//*************************************************************************************************
...
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename VT1, typename VT2, bool TF>
struct IsPadded<DVecDVecAddExpr<VT1, VT2, TF>> : public BoolConstant<IsPadded_v<VT1> && IsPadded_v<VT2>> {};
/*! \endcond */
//*************************************************************************************************
