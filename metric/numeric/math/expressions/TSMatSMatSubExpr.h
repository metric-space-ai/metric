...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_TSMATSMATSUBEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_TSMATSMATSUBEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class TSMatSMatSubExpr : public MatMatSubExpr<SparseMatrix<TSMatSMatSubExpr<MT1, MT2>, IsZero_v<MT2>>>,
						 private Computation {
  private:
	//**Type definitions****************************************************************************
...
inline const TSMatSMatSubExpr<MT1, MT2> tsmatsmatsub(const SparseMatrix<MT1, true> &lhs,
...
inline const MT1 &tsmatsmatsub(const SparseMatrix<MT1, true> &lhs, const SparseMatrix<MT2, false> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename MT1 // Type of the left-hand side sparse matrix
		  ...
		  ,
		  EnableIf_t<IsZero_v<MT1> && !IsZero_v<MT2> && IsSame_v<ElementType_t<MT1>, ElementType_t<MT2>>> * = nullptr>
inline decltype(auto) tsmatsmatsub(const SparseMatrix<MT1, true> &lhs, const SparseMatrix<MT2, false> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
