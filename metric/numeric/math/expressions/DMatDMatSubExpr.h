...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DMATDMATSUBEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DMATDMATSUBEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DMatDMatSubExpr : public MatMatSubExpr<DenseMatrix<DMatDMatSubExpr<MT1, MT2, SO>, SO>>, private Computation {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	static constexpr bool simdEnabled = (MT1::simdEnabled && MT2::simdEnabled && HasSIMDSub_v<ET1, ET2>);
	...
	*/
	...
	{
		return lhs_.canSMPAssign() || rhs_.canSMPAssign() || (rows() * columns() >= SMP_DMATDMATSUB_THRESHOLD);
	}
	//**********************************************************************************************
  ...
  private:
	...
	*/
	...
	friend inline auto assign(DenseMatrix<MT, SO2> &lhs, const DMatDMatSubExpr &rhs) -> EnableIf_t<UseAssign_v<MT>>
	{
	...
	*/
	...
	friend inline auto assign(SparseMatrix<MT, SO2> &lhs, const DMatDMatSubExpr &rhs) -> EnableIf_t<UseAssign_v<MT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename MT // Type of the target dense matrix
			  ,
			  bool SO2> // Storage order of the target dense matrix
	friend inline auto addAssign(DenseMatrix<MT, SO2> &lhs, const DMatDMatSubExpr &rhs) -> EnableIf_t<UseAssign_v<MT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename MT // Type of the target dense matrix
			  ,
			  bool SO2> // Storage order of the target dense matrix
	friend inline auto subAssign(DenseMatrix<MT, SO2> &lhs, const DMatDMatSubExpr &rhs) -> EnableIf_t<UseAssign_v<MT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename MT // Type of the target dense matrix
			  ,
			  bool SO2> // Storage order of the target dense matrix
	friend inline auto schurAssign(DenseMatrix<MT, SO2> &lhs, const DMatDMatSubExpr &rhs) -> EnableIf_t<UseAssign_v<MT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_FORM_VALID_MATMATSUBEXPR(MT1, MT2);
	/*! \endcond */
	//**********************************************************************************************
};
//*************************************************************************************************
...
struct IsAligned<DMatDMatSubExpr<MT1, MT2, SO>> : public BoolConstant<IsAligned_v<MT1> && IsAligned_v<MT2>> {};
/*! \endcond */
//*************************************************************************************************
...
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT1, typename MT2, bool SO>
struct IsPadded<DMatDMatSubExpr<MT1, MT2, SO>> : public BoolConstant<IsPadded_v<MT1> && IsPadded_v<MT2>> {};
/*! \endcond */
//*************************************************************************************************
