...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SVECDVECKRONEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SVECDVECKRONEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SVecDVecKronExpr : public VecVecKronExpr<SparseVector<SVecDVecKronExpr<VT1, VT2, TF>, TF>>, private Computation {
  private:
	//**Type definitions****************************************************************************
...
inline const SVecDVecKronExpr<VT1, VT2, TF> svecdveckron(const SparseVector<VT1, TF> &lhs,
...
inline decltype(auto) svecdveckron(const SparseVector<VT1, TF> &lhs, const DenseVector<VT2, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename VT1 // Type of the left-hand side sparse vector
		  ...
		  ,
		  bool TF> // Transpose flag
inline decltype(auto) kron(const SparseVector<VT1, TF> &lhs, const DenseVector<VT2, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
