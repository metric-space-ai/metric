...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DMATTDMATSUBEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DMATTDMATSUBEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DMatTDMatSubExpr : public MatMatSubExpr<DenseMatrix<DMatTDMatSubExpr<MT1, MT2>, false>>, private Computation {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	*/
	...
	{
		return lhs_.canSMPAssign() || rhs_.canSMPAssign() || (rows() * columns() >= SMP_DMATTDMATSUB_THRESHOLD);
	}
	//**********************************************************************************************
  ...
  private:
	...
	*/
	...
	friend inline auto assign(DenseMatrix<MT, SO> &lhs, const DMatTDMatSubExpr &rhs) -> DisableIf_t<UseAssign_v<MT>>
	{
	...
	*/
	template <typename MT // Type of the target dense matrix
			  ,
			  bool SO> // Storage order of the target dense matrix
	friend inline auto assign(DenseMatrix<MT, SO> &lhs, const DMatTDMatSubExpr &rhs) -> EnableIf_t<UseAssign_v<MT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename MT // Type of the target dense matrix
			  ,
			  bool SO> // Storage order of the target dense matrix
	friend inline auto addAssign(DenseMatrix<MT, SO> &lhs, const DMatTDMatSubExpr &rhs) -> DisableIf_t<UseAssign_v<MT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename MT // Type of the target dense matrix
			  ,
			  bool SO> // Storage order of the target dense matrix
	friend inline auto addAssign(DenseMatrix<MT, SO> &lhs, const DMatTDMatSubExpr &rhs) -> EnableIf_t<UseAssign_v<MT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename MT // Type of the target dense matrix
			  ,
			  bool SO> // Storage order of the target dense matrix
	friend inline auto subAssign(DenseMatrix<MT, SO> &lhs, const DMatTDMatSubExpr &rhs) -> DisableIf_t<UseAssign_v<MT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename MT // Type of the target dense matrix
			  ,
			  bool SO> // Storage order of the target dense matrix
	friend inline auto subAssign(DenseMatrix<MT, SO> &lhs, const DMatTDMatSubExpr &rhs) -> EnableIf_t<UseAssign_v<MT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename MT // Type of the target dense matrix
			  ,
			  bool SO> // Storage order of the target dense matrix
	friend inline auto schurAssign(DenseMatrix<MT, SO> &lhs, const DMatTDMatSubExpr &rhs) -> EnableIf_t<UseAssign_v<MT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
...
inline const DMatTDMatSubExpr<MT1, MT2> dmattdmatsub(const DenseMatrix<MT1, false> &lhs,
...
template <typename MT1 // Type of the left-hand side dense matrix
		  ...
		  ,
		  EnableIf_t<IsSymmetric_v<MT1> && !IsSymmetric_v<MT2>> * = nullptr>
inline decltype(auto) dmattdmatsub(const DenseMatrix<MT1, false> &lhs, const DenseMatrix<MT2, true> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename MT1 // Type of the left-hand side dense matrix
		  ...
		  ,
		  EnableIf_t<!IsSymmetric_v<MT1> && !IsSymmetric_v<MT2>> * = nullptr>
inline const DMatTDMatSubExpr<MT1, MT2> tdmatdmatsub(const DenseMatrix<MT1, true> &lhs,
...
template <typename MT1 // Type of the left-hand side dense matrix
		  ...
		  ,
		  EnableIf_t<!IsSymmetric_v<MT1> && IsSymmetric_v<MT2>> * = nullptr>
inline decltype(auto) tdmatdmatsub(const DenseMatrix<MT1, true> &lhs, const DenseMatrix<MT2, false> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
struct IsAligned<DMatTDMatSubExpr<MT1, MT2>> : public BoolConstant<IsAligned_v<MT1> && IsAligned_v<MT2>> {};
/*! \endcond */
//*************************************************************************************************
