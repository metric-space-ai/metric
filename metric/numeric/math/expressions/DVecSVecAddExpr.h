...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DVECSVECADDEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DVECSVECADDEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DVecSVecAddExpr : public VecVecAddExpr<DenseVector<DVecSVecAddExpr<VT1, VT2, TF>, TF>>, private Computation {
  private:
	//**Type definitions****************************************************************************
	...
	template <typename VT> static constexpr bool UseSMPAssign_v = (!VT1::smpAssignable || !VT2::smpAssignable);
	/*! \endcond */
	//**********************************************************************************************
  ...
  public:
	...
	*/
	...
	{
		return (IsExpression_v<VT1> && lhs_.canAlias(alias)) || (rhs_.canAlias(alias));
	}
	//**********************************************************************************************
  ...
  private:
	...
	*/
	template <typename VT> // Type of the target dense vector
	friend inline auto smpAssign(DenseVector<VT, TF> &lhs, const DVecSVecAddExpr &rhs) -> EnableIf_t<UseSMPAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename VT1 // Type of the left-hand side dense vector
		  ...
		  bool TF // Transpose flag
		  ,
		  DisableIf_t<IsZero_v<VT2> && IsSame_v<ElementType_t<VT1>, ElementType_t<VT2>>> * = nullptr>
inline const DVecSVecAddExpr<VT1, VT2, TF> dvecsvecadd(const DenseVector<VT1, TF> &lhs,
...
template <typename VT1 // Type of the left-hand side dense vector
		  ...
		  bool TF // Transpose flag
		  ,
		  EnableIf_t<IsZero_v<VT2> && IsSame_v<ElementType_t<VT1>, ElementType_t<VT2>>> * = nullptr>
inline const VT1 &dvecsvecadd(const DenseVector<VT1, TF> &lhs, const SparseVector<VT2, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
// This operator represents the addition of a dense vector and a sparse vector:
   ...
   \code
   mtrc::numeric::DynamicVector<double> a, c;
...
// This operator represents the addition of a sparse vector and a dense vector:
   ...
   mtrc::numeric::DynamicVector<double> b, c;
   // ... Resizing and initialization
   c = a + b;
   \endcode
...
inline decltype(auto) operator+(const DVecSVecAddExpr<VT1, VT2, TF> &lhs, const DenseVector<VT3, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
