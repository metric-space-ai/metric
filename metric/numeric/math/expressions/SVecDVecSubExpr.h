...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SVECDVECSUBEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SVECDVECSUBEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SVecDVecSubExpr : public VecVecSubExpr<DenseVector<SVecDVecSubExpr<VT1, VT2, TF>, TF>>, private Computation {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	*/
	...
	{
		return (lhs_.canAlias(alias)) || (IsExpression_v<VT2> && rhs_.canAlias(alias));
	}
	//**********************************************************************************************
  ...
  private:
	...
	*/
	template <typename VT> // Type of the target dense vector
	friend inline auto smpAssign(DenseVector<VT, TF> &lhs, const SVecDVecSubExpr &rhs) -> EnableIf_t<UseSMPAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename VT1 // Type of the left-hand side sparse vector
		  ...
		  bool TF // Transpose flag
		  ,
		  DisableIf_t<IsZero_v<VT1> && IsSame_v<ElementType_t<VT1>, ElementType_t<VT2>>> * = nullptr>
inline const SVecDVecSubExpr<VT1, VT2, TF> svecdvecsub(const SparseVector<VT1, TF> &lhs,
...
template <typename VT1 // Type of the left-hand side sparse vector
		  ...
		  bool TF // Transpose flag
		  ,
		  EnableIf_t<IsZero_v<VT1> && IsSame_v<ElementType_t<VT1>, ElementType_t<VT2>>> * = nullptr>
inline decltype(auto) svecdvecsub(const SparseVector<VT1, TF> &lhs, const DenseVector<VT2, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
inline decltype(auto) operator+(const SVecDVecSubExpr<VT1, VT2, TF> &lhs, const DenseVector<VT3, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
