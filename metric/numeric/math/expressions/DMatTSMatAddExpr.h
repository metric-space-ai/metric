...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DMATTSMATADDEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DMATTSMATADDEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DMatTSMatAddExpr : public MatMatAddExpr<DenseMatrix<DMatTSMatAddExpr<MT1, MT2>, false>>, private Computation {
  private:
	//**Type definitions****************************************************************************
...
inline const DMatTSMatAddExpr<MT1, MT2> dmattsmatadd(const DenseMatrix<MT1, false> &lhs,
...
inline const MT1 &dmattsmatadd(const DenseMatrix<MT1, false> &lhs, const SparseMatrix<MT2, true> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
inline decltype(auto) operator+(const DMatTSMatAddExpr<MT1, MT2> &lhs, const DenseMatrix<MT3, SO> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
