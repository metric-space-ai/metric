...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_TSMATTSMATSCHUREXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_TSMATTSMATSCHUREXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class TSMatTSMatSchurExpr : public SchurExpr<SparseMatrix<TSMatTSMatSchurExpr<MT1, MT2>, true>>, private Computation {
  private:
	//**Type definitions****************************************************************************
...
inline const TSMatTSMatSchurExpr<MT1, MT2> tsmattsmatschur(const SparseMatrix<MT1, true> &lhs,
...
inline decltype(auto) tsmattsmatschur(const SparseMatrix<MT1, true> &lhs, const SparseMatrix<MT2, true> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
