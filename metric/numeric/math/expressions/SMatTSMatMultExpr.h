...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SMATTSMATMULTEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SMATTSMATMULTEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SMatTSMatMultExpr : public MatMatMultExpr<SparseMatrix<SMatTSMatMultExpr<MT1, MT2>, IsIdentity_v<MT1>>>,
						  private Computation {
  private:
	//**Type definitions****************************************************************************
	...
	static constexpr bool CanExploitSymmetry_v =
		((IsRowMajorMatrix_v<T1> && IsSymmetric_v<T3>) || (IsColumnMajorMatrix_v<T1> && IsSymmetric_v<T2>));
	/*! \endcond */
	//**********************************************************************************************
  ...
  public:
	...
	*/
	inline bool canSMPAssign() const noexcept { return (rows() * columns() >= SMP_SMATTSMATMULT_THRESHOLD); }
	//**********************************************************************************************
  ...
  private:
	...
	*/
		...
		-> DisableIf_t<CanExploitSymmetry_v<MT, MT1, MT2>>
	{
		...
		METRIC_NUMERIC_CONSTRAINT_MUST_BE_ROW_MAJOR_MATRIX_TYPE(OppositeType_t<MT2>);
	...
	*/
		...
		-> DisableIf_t<CanExploitSymmetry_v<MT, MT1, MT2>>
	{
		...
		METRIC_NUMERIC_CONSTRAINT_MUST_BE_COLUMN_MAJOR_MATRIX_TYPE(OppositeType_t<MT1>);
...
inline const SMatTSMatMultExpr<MT1, MT2> smattsmatmult(const SparseMatrix<MT1, false> &lhs,
...
inline const MT1 &smattsmatmult(const SparseMatrix<MT1, false> &lhs, const SparseMatrix<MT2, true> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <
	...
	,
	EnableIf_t<IsIdentity_v<MT1> && !IsIdentity_v<MT2> && IsSame_v<ElementType_t<MT1>, ElementType_t<MT2>>> * = nullptr>
inline const MT2 &smattsmatmult(const SparseMatrix<MT1, false> &lhs, const SparseMatrix<MT2, true> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
inline decltype(auto) smattsmatmult(const SparseMatrix<MT1, false> &lhs, const SparseMatrix<MT2, true> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
