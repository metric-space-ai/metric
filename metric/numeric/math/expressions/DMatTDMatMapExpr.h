...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DMATTDMATMAPEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DMATTDMATMAPEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DMatTDMatMapExpr : public MatMatMapExpr<DenseMatrix<DMatTDMatMapExpr<MT1, MT2, OP>, false>>, private Computation {
  private:
	//**Type definitions****************************************************************************
  ...
  private:
	...
	*/
	...
	friend inline auto assign(DenseMatrix<MT, SO> &lhs, const DMatTDMatMapExpr &rhs) -> DisableIf_t<UseAssign_v<MT>>
	{
	...
	*/
	template <typename MT // Type of the target dense matrix
			  ,
			  bool SO> // Storage order of the target dense matrix
	friend inline auto assign(DenseMatrix<MT, SO> &lhs, const DMatTDMatMapExpr &rhs) -> EnableIf_t<UseAssign_v<MT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	...
	friend inline auto assign(SparseMatrix<MT, SO> &lhs, const DMatTDMatMapExpr &rhs) -> EnableIf_t<UseAssign_v<MT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename MT // Type of the target dense matrix
			  ,
			  bool SO> // Storage order of the target dense matrix
	friend inline auto addAssign(DenseMatrix<MT, SO> &lhs, const DMatTDMatMapExpr &rhs) -> DisableIf_t<UseAssign_v<MT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename MT // Type of the target dense matrix
			  ,
			  bool SO> // Storage order of the target dense matrix
	friend inline auto addAssign(DenseMatrix<MT, SO> &lhs, const DMatTDMatMapExpr &rhs) -> EnableIf_t<UseAssign_v<MT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename MT // Type of the target dense matrix
			  ,
			  bool SO> // Storage order of the target dense matrix
	friend inline auto subAssign(DenseMatrix<MT, SO> &lhs, const DMatTDMatMapExpr &rhs) -> DisableIf_t<UseAssign_v<MT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename MT // Type of the target dense matrix
			  ,
			  bool SO> // Storage order of the target dense matrix
	friend inline auto subAssign(DenseMatrix<MT, SO> &lhs, const DMatTDMatMapExpr &rhs) -> EnableIf_t<UseAssign_v<MT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename MT // Type of the target dense matrix
			  ,
			  bool SO> // Storage order of the target dense matrix
	friend inline auto schurAssign(DenseMatrix<MT, SO> &lhs, const DMatTDMatMapExpr &rhs) -> EnableIf_t<UseAssign_v<MT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
...
inline const DMatTDMatMapExpr<MT1, MT2, OP> map_backend(const DenseMatrix<MT1, false> &lhs,
...
template <typename MT1 // Type of the left-hand side dense matrix
		  ...
		  ,
		  EnableIf_t<IsSymmetric_v<MT1> && !IsSymmetric_v<MT2>> * = nullptr>
inline decltype(auto) map_backend(const DenseMatrix<MT1, false> &lhs, const DenseMatrix<MT2, true> &rhs, OP op)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename MT1 // Type of the left-hand side dense matrix
		  ...
		  ,
		  typename OP> // Type of the custom operation
inline decltype(auto) map(const DenseMatrix<MT1, false> &lhs, const DenseMatrix<MT2, true> &rhs, OP op)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename MT1 // Type of the left-hand side dense matrix
		  ...
		  ,
		  EnableIf_t<!IsSymmetric_v<MT1> && !IsSymmetric_v<MT2>> * = nullptr>
inline const DMatTDMatMapExpr<MT1, MT2, OP> map_backend(const DenseMatrix<MT1, true> &lhs,
...
template <typename MT1 // Type of the left-hand side dense matrix
		  ...
		  ,
		  EnableIf_t<!IsSymmetric_v<MT1> && IsSymmetric_v<MT2>> * = nullptr>
inline decltype(auto) map_backend(const DenseMatrix<MT1, true> &lhs, const DenseMatrix<MT2, false> &rhs, OP op)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename MT1 // Type of the left-hand side dense matrix
		  ...
		  ,
		  typename OP> // Type of the custom operation
inline decltype(auto) map(const DenseMatrix<MT1, true> &lhs, const DenseMatrix<MT2, false> &rhs, OP op)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
struct IsAligned<DMatTDMatMapExpr<MT1, MT2, OP>> : public BoolConstant<IsAligned_v<MT1> && IsAligned_v<MT2>> {};
/*! \endcond */
//*************************************************************************************************
...
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT1, typename MT2, typename OP>
struct IsPadded<DMatTDMatMapExpr<MT1, MT2, OP>> : public BoolConstant<IsPadded_v<MT1> && IsPadded_v<MT2>> {};
/*! \endcond */
//*************************************************************************************************
