...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DMATDMATSOLVEEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DMATDMATSOLVEEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DMatDMatSolveExpr : public MatMatSolveExpr<DenseMatrix<DMatDMatSolveExpr<MT1, MT2, SO>, SO>>,
						  private Computation {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	*/
	inline size_t rows() const noexcept { return rhs_.rows(); }
	//**********************************************************************************************
  ...
  private:
	...
	*/
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_FORM_VALID_MATMATSOLVEEXPR(MT1, MT2);
	/*! \endcond */
	//**********************************************************************************************
};
//*************************************************************************************************
...
// of equations (LSE):
   ...
   mtrc::numeric::DynamicMatrix<double> B, X;
