...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_TDMATSMATADDEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_TDMATSMATADDEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class TDMatSMatAddExpr : public MatMatAddExpr<DenseMatrix<TDMatSMatAddExpr<MT1, MT2>, true>>, private Computation {
  private:
	//**Type definitions****************************************************************************
...
inline const TDMatSMatAddExpr<MT1, MT2> tdmatsmatadd(const DenseMatrix<MT1, true> &lhs,
...
inline const MT1 &tdmatsmatadd(const DenseMatrix<MT1, true> &lhs, const SparseMatrix<MT2, false> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
inline decltype(auto) operator+(const TDMatSMatAddExpr<MT1, MT2> &lhs, const DenseMatrix<MT3, SO> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
