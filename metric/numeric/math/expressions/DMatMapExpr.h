...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DMATMAPEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DMATMAPEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DMatMapExpr : public MatMapExpr<DenseMatrix<DMatMapExpr<MT, OP, SO>, SO>>, private Computation {
  private:
	//**Type definitions****************************************************************************
	...
	template <typename MT2> static constexpr bool UseAssign_v = useAssign;
	/*! \endcond */
	//**********************************************************************************************
	...
	static constexpr bool UseSMPAssign_v = ((!MT2::smpAssignable || !MT::smpAssignable) && useAssign);
	/*! \endcond */
	//**********************************************************************************************
  ...
  public:
	...
	class ConstIterator {
	  public:
		...
		*/
		inline METRIC_NUMERIC_DEVICE_CALLABLE ConstIterator(IteratorType it, OP op)
		...
		*/
		inline METRIC_NUMERIC_DEVICE_CALLABLE const ConstIterator operator++(int) { return ConstIterator(it_++, op_); }
		//*******************************************************************************************
		...
		*/
		inline METRIC_NUMERIC_DEVICE_CALLABLE ReturnType operator*() const { return op_(*it_); }
		//*******************************************************************************************
		...
		*/
		inline auto load() const noexcept { return op_.load(it_.load()); }
		//*******************************************************************************************
		...
		*/
		inline METRIC_NUMERIC_DEVICE_CALLABLE bool operator==(const ConstIterator &rhs) const { return it_ == rhs.it_; }
		//*******************************************************************************************
	...
	static constexpr bool simdEnabled =
		(MT::simdEnabled && If_t<HasSIMDEnabled_v<OP>, GetSIMDEnabled<OP, ET>, HasLoad<OP>>::value);
	...
	*/
	...
	{
		METRIC_NUMERIC_INTERNAL_ASSERT(i < dm_.rows(), "Invalid row access index");
		METRIC_NUMERIC_INTERNAL_ASSERT(j < dm_.columns(), "Invalid column access index");
		return op_(dm_(i, j));
	}
	//**********************************************************************************************
	...
	*/
	inline ConstIterator begin(size_t i) const { return ConstIterator(dm_.begin(i), op_); }
	//**********************************************************************************************
	...
	*/
	inline ConstIterator end(size_t i) const { return ConstIterator(dm_.end(i), op_); }
	//**********************************************************************************************
	...
	*/
	inline size_t rows() const noexcept { return dm_.rows(); }
	//**********************************************************************************************
	...
	*/
	inline size_t columns() const noexcept { return dm_.columns(); }
	//**********************************************************************************************
	...
	*/
	inline bool isAligned() const noexcept { return dm_.isAligned(); }
	//**********************************************************************************************
	...
	*/
	inline bool canSMPAssign() const noexcept { return dm_.canSMPAssign(); }
	//**********************************************************************************************
  ...
  private:
	...
	*/
	...
	friend inline auto assign(DenseMatrix<MT2, SO2> &lhs, const DMatMapExpr &rhs)
		-> EnableIf_t<UseAssign_v<MT2> && IsSame_v<UnderlyingScalar_t<MT>, UnderlyingScalar_t<MT2>>>
	{
	...
	*/
		...
		-> EnableIf_t<UseAssign_v<MT2> && !IsSame_v<UnderlyingScalar_t<MT>, UnderlyingScalar_t<MT2>>>
	{
		...
		METRIC_NUMERIC_CONSTRAINT_MUST_BE_MATRIX_WITH_STORAGE_ORDER(RT, SO);
	...
	*/
	...
	friend inline auto assign(SparseMatrix<MT2, SO2> &lhs, const DMatMapExpr &rhs) -> EnableIf_t<UseAssign_v<MT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
		...
		METRIC_NUMERIC_CONSTRAINT_MUST_BE_DENSE_MATRIX_TYPE(RT);
		METRIC_NUMERIC_CONSTRAINT_MUST_BE_DENSE_MATRIX_TYPE(OT);
		METRIC_NUMERIC_CONSTRAINT_MUST_BE_MATRIX_WITH_STORAGE_ORDER(RT, SO);
		METRIC_NUMERIC_CONSTRAINT_MUST_BE_MATRIX_WITH_STORAGE_ORDER(OT, !SO);
		METRIC_NUMERIC_CONSTRAINT_MATRICES_MUST_HAVE_SAME_STORAGE_ORDER(MT2, TmpType);
	...
	*/
	...
	friend inline auto addAssign(DenseMatrix<MT2, SO2> &lhs, const DMatMapExpr &rhs) -> EnableIf_t<UseAssign_v<MT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename MT2 // Type of the target dense matrix
			  ,
			  bool SO2> // Storage order of the target dense matrix
	friend inline auto subAssign(DenseMatrix<MT2, SO2> &lhs, const DMatMapExpr &rhs) -> EnableIf_t<UseAssign_v<MT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename MT2 // Type of the target dense matrix
			  ,
			  bool SO2> // Storage order of the target dense matrix
	friend inline auto schurAssign(DenseMatrix<MT2, SO2> &lhs, const DMatMapExpr &rhs) -> EnableIf_t<UseAssign_v<MT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	...
	friend inline auto smpAssign(DenseMatrix<MT2, SO2> &lhs, const DMatMapExpr &rhs)
		-> EnableIf_t<UseSMPAssign_v<MT2> && IsSame_v<UnderlyingScalar_t<MT>, UnderlyingScalar_t<MT2>>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename MT2 // Type of the target sparse matrix
			  ,
			  bool SO2> // Storage order or the target sparse matrix
	friend inline auto smpAssign(SparseMatrix<MT2, SO2> &lhs, const DMatMapExpr &rhs) -> EnableIf_t<UseSMPAssign_v<MT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
...
// The following example demonstrates the use of the \a conj() function:
   ...
   \code
   mtrc::numeric::DynamicMatrix< complex<double> > A, B;
   // ... Resizing and initialization
   B = conj( A );
   \endcode
*/
...
inline decltype(auto) pow(const DenseMatrix<MT, SO> &dm, ST exp)
{
	...
	return map(*dm, mtrc::numeric::bind2nd(Pow(), ScalarType(exp)));
}
//*************************************************************************************************
...
inline decltype(auto) operator+(const DenseMatrix<MT, SO> &mat, ST scalar)
{
	...
	return map(*mat, mtrc::numeric::bind2nd(Add{}, ScalarType(scalar)));
}
//*************************************************************************************************
...
inline decltype(auto) operator+(ST scalar, const DenseMatrix<MT, SO> &mat)
{
	...
	return map(*mat, mtrc::numeric::bind1st(Add{}, ScalarType(scalar)));
}
//*************************************************************************************************
...
inline decltype(auto) operator-(const DenseMatrix<MT, SO> &mat, ST scalar)
{
	...
	return map(*mat, mtrc::numeric::bind2nd(Sub{}, ScalarType(scalar)));
}
//*************************************************************************************************
...
inline decltype(auto) operator-(ST scalar, const DenseMatrix<MT, SO> &mat)
{
	...
	return map(*mat, mtrc::numeric::bind1st(Sub{}, ScalarType(scalar)));
}
//*************************************************************************************************
...
inline decltype(auto) operator/(ST scalar, const DenseMatrix<MT, SO> &mat)
{
	...
	return map(*mat, mtrc::numeric::bind1st(Div{}, ScalarType(scalar)));
}
//*************************************************************************************************
...
// This operator represents the uniform left-shift of all elements of a dense matrix:
   ...
   \code
   mtrc::numeric::DynamicMatrix<unsigned int> A, B;
   // ... Resizing and initialization
   B = A << 3;
   \endcode
*/
...
inline decltype(auto) operator&(const DenseMatrix<MT, SO> &mat, ST scalar)
{
	...
	return map(*mat, mtrc::numeric::bind2nd(Bitand{}, scalar));
}
//*************************************************************************************************
...
inline decltype(auto) operator|(const DenseMatrix<MT, SO> &mat, ST scalar)
{
	...
	return map(*mat, mtrc::numeric::bind2nd(Bitor{}, scalar));
}
//*************************************************************************************************
...
inline decltype(auto) operator^(const DenseMatrix<MT, SO> &mat, ST scalar)
{
	...
	return map(*mat, mtrc::numeric::bind2nd(Bitxor{}, scalar));
}
//*************************************************************************************************
...
// This operator represents the logical NOT of all elements of a dense matrix:
   ...
   \code
   mtrc::numeric::DynamicMatrix<bool> A, B;
   // ... Resizing and initialization
   B = !A;
   \endcode
*/
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, typename OP, bool SO> struct IsAligned<DMatMapExpr<MT, OP, SO>> : public IsAligned<MT> {};
/*! \endcond */
//*************************************************************************************************
...
struct IsPadded<DMatMapExpr<MT, OP, SO>> : public BoolConstant<IsPadded_v<MT> && IsPaddingEnabled_v<OP>> {};
/*! \endcond */
//*************************************************************************************************
