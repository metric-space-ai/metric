...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_MATRIX_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_MATRIX_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
// \ingroup matrix
//
// The Matrix class is a base class for all dense and sparse matrix classes within the Metric numeric
...
class Matrix {
  public:
	...
	//@{
	[[deprecated]] METRIC_NUMERIC_ALWAYS_INLINE constexpr MT &operator~() noexcept;
	[[deprecated]] METRIC_NUMERIC_ALWAYS_INLINE constexpr const MT &operator~() const noexcept;
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order
[[deprecated]] METRIC_NUMERIC_ALWAYS_INLINE constexpr MT &Matrix<MT, SO>::operator~() noexcept
{
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order
[[deprecated]] METRIC_NUMERIC_ALWAYS_INLINE constexpr const MT &Matrix<MT, SO>::operator~() const noexcept
{
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order
METRIC_NUMERIC_ALWAYS_INLINE constexpr MT &Matrix<MT, SO>::operator*() noexcept
{
	return static_cast<MT &>(*this);
}
//*************************************************************************************************
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order
METRIC_NUMERIC_ALWAYS_INLINE constexpr const MT &Matrix<MT, SO>::operator*() const noexcept
{
	return static_cast<const MT &>(*this);
}
//*************************************************************************************************
...
//@{
template <typename MT, bool SO> MT &crtp_cast(Matrix<MT, SO> &matrix);

template <typename MT, bool SO> const MT &crtp_cast(const Matrix<MT, SO> &matrix);

template <typename MT, bool SO> typename MT::Iterator begin(Matrix<MT, SO> &matrix, size_t i);

template <typename MT, bool SO> typename MT::ConstIterator begin(const Matrix<MT, SO> &matrix, size_t i);

template <typename MT, bool SO> typename MT::ConstIterator cbegin(const Matrix<MT, SO> &matrix, size_t i);

template <typename MT, bool SO> typename MT::Iterator end(Matrix<MT, SO> &matrix, size_t i);

template <typename MT, bool SO> typename MT::ConstIterator end(const Matrix<MT, SO> &matrix, size_t i);

template <typename MT, bool SO> typename MT::ConstIterator cend(const Matrix<MT, SO> &matrix, size_t i);

template <typename MT, bool SO> constexpr size_t rows(const Matrix<MT, SO> &matrix) noexcept;

template <typename MT, bool SO> constexpr size_t columns(const Matrix<MT, SO> &matrix) noexcept;

template <typename MT, bool SO> constexpr size_t size(const Matrix<MT, SO> &matrix) noexcept;

template <typename MT, bool SO> size_t capacity(const Matrix<MT, SO> &matrix) noexcept;

template <typename MT, bool SO> size_t capacity(const Matrix<MT, SO> &matrix, size_t i) noexcept;

template <typename MT, bool SO> size_t nonZeros(const Matrix<MT, SO> &matrix);

template <typename MT, bool SO> size_t nonZeros(const Matrix<MT, SO> &matrix, size_t i);

template <typename MT, bool SO> constexpr void reset(Matrix<MT, SO> &matrix);

template <typename MT, bool SO> constexpr void reset(Matrix<MT, SO> &&matrix);

template <typename MT, bool SO> constexpr void reset(Matrix<MT, SO> &matrix, size_t i);

template <typename MT, bool SO> constexpr void reset(Matrix<MT, SO> &&matrix, size_t i);

template <typename MT, bool SO> constexpr void clear(Matrix<MT, SO> &matrix);

template <typename MT, bool SO> constexpr void clear(Matrix<MT, SO> &&matrix);

template <typename MT, bool SO> void resize(Matrix<MT, SO> &matrix, size_t rows, size_t columns, bool preserve = true);

template <typename MT, bool SO> void shrinkToFit(Matrix<MT, SO> &matrix);

template <typename MT, bool SO> void transpose(Matrix<MT, SO> &matrix);

template <typename MT, bool SO> void ctranspose(Matrix<MT, SO> &matrix);

template <typename MT, bool SO> typename MT::ResultType evaluate(const Matrix<MT, SO> &matrix);

template <bool B, typename MT, bool SO> typename MT::ResultType evaluateIf(const Matrix<MT, SO> &matrix);

template <typename MT, bool SO> constexpr bool isEmpty(const Matrix<MT, SO> &matrix) noexcept;

template <typename MT, bool SO> bool isSquare(const Matrix<MT, SO> &matrix) noexcept;
...
METRIC_NUMERIC_ALWAYS_INLINE MT &crtp_cast(Matrix<MT, SO> &matrix)
{
	return *matrix;
}
//*************************************************************************************************
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order of the matrix
METRIC_NUMERIC_ALWAYS_INLINE const MT &crtp_cast(const Matrix<MT, SO> &matrix)
{
	return *matrix;
}
//*************************************************************************************************
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order of the matrix
METRIC_NUMERIC_ALWAYS_INLINE typename MT::Iterator begin(Matrix<MT, SO> &matrix, size_t i)
{
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order of the matrix
METRIC_NUMERIC_ALWAYS_INLINE typename MT::ConstIterator begin(const Matrix<MT, SO> &matrix, size_t i)
{
	return (*matrix).begin(i);
}
//*************************************************************************************************
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order of the matrix
METRIC_NUMERIC_ALWAYS_INLINE typename MT::ConstIterator cbegin(const Matrix<MT, SO> &matrix, size_t i)
{
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order of the matrix
METRIC_NUMERIC_ALWAYS_INLINE typename MT::Iterator end(Matrix<MT, SO> &matrix, size_t i)
{
	return (*matrix).end(i);
}
//*************************************************************************************************
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order of the matrix
METRIC_NUMERIC_ALWAYS_INLINE typename MT::ConstIterator end(const Matrix<MT, SO> &matrix, size_t i)
{
	return (*matrix).end(i);
}
//*************************************************************************************************
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order of the matrix
METRIC_NUMERIC_ALWAYS_INLINE typename MT::ConstIterator cend(const Matrix<MT, SO> &matrix, size_t i)
{
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order of the matrix
METRIC_NUMERIC_ALWAYS_INLINE constexpr size_t rows(const Matrix<MT, SO> &matrix) noexcept
{
	return (*matrix).rows();
}
//*************************************************************************************************
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order of the matrix
METRIC_NUMERIC_ALWAYS_INLINE constexpr size_t columns(const Matrix<MT, SO> &matrix) noexcept
{
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order of the matrix
METRIC_NUMERIC_ALWAYS_INLINE constexpr size_t size(const Matrix<MT, SO> &matrix) noexcept
{
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order of the matrix
METRIC_NUMERIC_ALWAYS_INLINE size_t capacity(const Matrix<MT, SO> &matrix) noexcept
{
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order of the matrix
METRIC_NUMERIC_ALWAYS_INLINE size_t capacity(const Matrix<MT, SO> &matrix, size_t i) noexcept
{
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order of the matrix
METRIC_NUMERIC_ALWAYS_INLINE size_t nonZeros(const Matrix<MT, SO> &matrix)
{
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order of the matrix
METRIC_NUMERIC_ALWAYS_INLINE size_t nonZeros(const Matrix<MT, SO> &matrix, size_t i)
{
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order of the matrix
constexpr auto reset_backend(Matrix<MT, SO> &matrix) -> DisableIf_t<IsZero_v<MT> || IsIdentity_v<MT>>
{
	(*matrix).reset();
}
/*! \endcond */
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order of the matrix
constexpr auto reset_backend(Matrix<MT, SO> &matrix) -> EnableIf_t<IsZero_v<MT> || IsIdentity_v<MT>>
{
	MAYBE_UNUSED(matrix);
}
/*! \endcond */
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order of the matrix
constexpr auto reset_backend(Matrix<MT, SO> &matrix, size_t i) -> DisableIf_t<IsZero_v<MT> || IsIdentity_v<MT>>
{
	(*matrix).reset(i);
}
/*! \endcond */
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order of the matrix
constexpr auto reset_backend(Matrix<MT, SO> &matrix, size_t i) -> EnableIf_t<IsZero_v<MT> || IsIdentity_v<MT>>
{
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order of the matrix
constexpr auto clear_backend(Matrix<MT, SO> &matrix) -> DisableIf_t<IsClearable_v<MT>>
{
	(*matrix).reset();
}
/*! \endcond */
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order of the matrix
constexpr auto clear_backend(Matrix<MT, SO> &matrix) -> EnableIf_t<IsClearable_v<MT>>
{
	(*matrix).clear();
}
/*! \endcond */
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order of the matrix
METRIC_NUMERIC_ALWAYS_INLINE auto resize_backend(Matrix<MT, SO> &matrix, size_t m, size_t n, bool preserve)
	-> DisableIf_t<IsResizable_v<MT>>
{
	MAYBE_UNUSED(preserve);

	if ((*matrix).rows() != m || (*matrix).columns() != n) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Matrix cannot be resized");
	}
}
/*! \endcond */
//*************************************************************************************************
...
{
	if (m != n) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Invalid resize arguments for square matrix");
	}
...
// mtrc::numeric::SymmetricMatrix adaptor, ...) the specified number of rows must be identical to the
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order of the matrix
METRIC_NUMERIC_ALWAYS_INLINE void resize(Matrix<MT, SO> &matrix, size_t m, size_t n, bool preserve)
{
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order of the matrix
METRIC_NUMERIC_ALWAYS_INLINE auto shrinkToFit_backend(Matrix<MT, SO> &matrix) -> DisableIf_t<IsShrinkable_v<MT>>
{
	MAYBE_UNUSED(matrix);
}
/*! \endcond */
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order of the matrix
METRIC_NUMERIC_ALWAYS_INLINE auto shrinkToFit_backend(Matrix<MT, SO> &matrix) -> EnableIf_t<IsShrinkable_v<MT>>
{
	(*matrix).shrinkToFit();
}
/*! \endcond */
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order of the matrix
METRIC_NUMERIC_ALWAYS_INLINE void shrinkToFit(Matrix<MT, SO> &matrix)
{
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order of the matrix
METRIC_NUMERIC_ALWAYS_INLINE void transpose(Matrix<MT, SO> &matrix)
{
	(*matrix).transpose();
}
//*************************************************************************************************
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order of the matrix
METRIC_NUMERIC_ALWAYS_INLINE void ctranspose(Matrix<MT, SO> &matrix)
{
	(*matrix).ctranspose();
}
//*************************************************************************************************
...
// purpose. This task is more elegantly and efficiently handled by the \a eval() function:
   ...
   \code
   mtrc::numeric::DynamicMatrix<double> A, B, C, D;
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order of the matrix
METRIC_NUMERIC_ALWAYS_INLINE constexpr bool isEmpty(const Matrix<MT, SO> &matrix) noexcept
{
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order
METRIC_NUMERIC_ALWAYS_INLINE bool isSquare(const Matrix<MT, SO> &matrix) noexcept
{
...
// \a false.
   ...
   \code
   mtrc::numeric::DynamicMatrix<int> mat1( 4UL, 5UL );  // Setup of a 4x5 dynamic matrix
   mtrc::numeric::DynamicMatrix<int> mat2( 4UL, 5UL );  // Setup of a second 4x5 dynamic matrix
...
template <typename MT1 // Type of the left-hand side matrix
		  ...
		  ,
		  bool SO2> // Storage order of the right-hand side matrix
METRIC_NUMERIC_ALWAYS_INLINE bool isSame(const Matrix<MT1, SO1> &a, const Matrix<MT2, SO2> &b) noexcept
{
	return (IsSame_v<MT1, MT2> && reinterpret_cast<const void *>(&a) == reinterpret_cast<const void *>(&b));
}
//*************************************************************************************************
...
METRIC_NUMERIC_ALWAYS_INLINE void assign_backend(Matrix<MT1, SO> &lhs, const Matrix<MT2, SO> &rhs)
{
...
template <typename MT1 // Type of the left-hand side matrix
		  ...
		  ,
		  typename MT2> // Type of the right-hand side matrix
METRIC_NUMERIC_ALWAYS_INLINE auto assign_backend(Matrix<MT1, SO> &lhs, const Matrix<MT2, !SO> &rhs)
	-> DisableIf_t<IsSymmetric_v<MT2>>
{
	METRIC_NUMERIC_FUNCTION_TRACE;

	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_SYMMETRIC_MATRIX_TYPE(MT1);
	...
	-> EnableIf_t<IsSymmetric_v<MT2>>
{
	...
	METRIC_NUMERIC_INTERNAL_ASSERT(isSquare(*rhs), "Non-square symmetric matrix detected");
...
template <typename MT1 // Type of the left-hand side matrix
		  ...
		  ,
		  bool SO2> // Storage order of the right-hand side matrix
METRIC_NUMERIC_ALWAYS_INLINE void assign(Matrix<MT1, SO1> &lhs, const Matrix<MT2, SO2> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename MT1 // Type of the left-hand side matrix
		  ...
		  ,
		  bool SO> // Storage order of both matrices
METRIC_NUMERIC_ALWAYS_INLINE void addAssign_backend(Matrix<MT1, SO> &lhs, const Matrix<MT2, SO> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename MT1 // Type of the left-hand side matrix
		  ...
		  ,
		  typename MT2> // Type of the right-hand side matrix
METRIC_NUMERIC_ALWAYS_INLINE auto addAssign_backend(Matrix<MT1, SO> &lhs, const Matrix<MT2, !SO> &rhs)
	-> DisableIf_t<IsSymmetric_v<MT2>>
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename MT1 // Type of the left-hand side matrix
		  ...
		  ,
		  bool SO2> // Storage order of the right-hand side matrix
METRIC_NUMERIC_ALWAYS_INLINE void addAssign(Matrix<MT1, SO1> &lhs, const Matrix<MT2, SO2> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename MT1 // Type of the left-hand side matrix
		  ...
		  ,
		  bool SO> // Storage order of both matrices
METRIC_NUMERIC_ALWAYS_INLINE void subAssign_backend(Matrix<MT1, SO> &lhs, const Matrix<MT2, SO> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename MT1 // Type of the left-hand side matrix
		  ...
		  ,
		  typename MT2> // Type of the right-hand side matrix
METRIC_NUMERIC_ALWAYS_INLINE auto subAssign_backend(Matrix<MT1, SO> &lhs, const Matrix<MT2, !SO> &rhs)
	-> DisableIf_t<IsSymmetric_v<MT2>>
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename MT1 // Type of the left-hand side matrix
		  ...
		  ,
		  bool SO2> // Storage order of the right-hand side matrix
METRIC_NUMERIC_ALWAYS_INLINE void subAssign(Matrix<MT1, SO1> &lhs, const Matrix<MT2, SO2> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename MT1 // Type of the left-hand side matrix
		  ...
		  ,
		  bool SO> // Storage order of both matrices
METRIC_NUMERIC_ALWAYS_INLINE void schurAssign_backend(Matrix<MT1, SO> &lhs, const Matrix<MT2, SO> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename MT1 // Type of the left-hand side matrix
		  ...
		  ,
		  typename MT2> // Type of the right-hand side matrix
METRIC_NUMERIC_ALWAYS_INLINE auto schurAssign_backend(Matrix<MT1, SO> &lhs, const Matrix<MT2, !SO> &rhs)
	-> DisableIf_t<IsSymmetric_v<MT2>>
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename MT1 // Type of the left-hand side matrix
		  ...
		  ,
		  bool SO2> // Storage order of the right-hand side matrix
METRIC_NUMERIC_ALWAYS_INLINE void schurAssign(Matrix<MT1, SO1> &lhs, const Matrix<MT2, SO2> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename MT1 // Type of the left-hand side matrix
		  ...
		  ,
		  bool SO2> // Storage order of the right-hand side matrix
METRIC_NUMERIC_ALWAYS_INLINE void multAssign(Matrix<MT1, SO1> &lhs, const Matrix<MT2, SO2> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
METRIC_NUMERIC_ALWAYS_INLINE bool trySet(const Matrix<MT, SO> &mat, size_t i, size_t j, const ET &value)
{
...
template <typename MT // Type of the matrix
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool trySet(const Matrix<MT, SO> &mat, size_t row, size_t column, size_t m, size_t n,
										 const ET &value)
{
...
template <typename MT // Type of the matrix
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryAdd(const Matrix<MT, SO> &mat, size_t i, size_t j, const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(i < (*mat).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(j < (*mat).columns(), "Invalid column access index");
...
template <typename MT // Type of the matrix
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryAdd(const Matrix<MT, SO> &mat, size_t row, size_t column, size_t m, size_t n,
										 const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*mat).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*mat).columns(), "Invalid column access index");
...
template <typename MT // Type of the matrix
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool trySub(const Matrix<MT, SO> &mat, size_t i, size_t j, const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(i < (*mat).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(j < (*mat).columns(), "Invalid column access index");
...
template <typename MT // Type of the matrix
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool trySub(const Matrix<MT, SO> &mat, size_t row, size_t column, size_t m, size_t n,
										 const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*mat).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*mat).columns(), "Invalid column access index");
...
template <typename MT // Type of the matrix
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryMult(const Matrix<MT, SO> &mat, size_t i, size_t j, const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(i < (*mat).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(j < (*mat).columns(), "Invalid column access index");
...
template <typename MT // Type of the matrix
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryMult(const Matrix<MT, SO> &mat, size_t row, size_t column, size_t m, size_t n,
										  const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*mat).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*mat).columns(), "Invalid column access index");
...
template <typename MT // Type of the matrix
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryDiv(const Matrix<MT, SO> &mat, size_t i, size_t j, const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(i < (*mat).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(j < (*mat).columns(), "Invalid column access index");
...
template <typename MT // Type of the matrix
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryDiv(const Matrix<MT, SO> &mat, size_t row, size_t column, size_t m, size_t n,
										 const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*mat).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*mat).columns(), "Invalid column access index");
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order
METRIC_NUMERIC_ALWAYS_INLINE bool tryShift(const Matrix<MT, SO> &mat, size_t i, size_t j, int count)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(i < (*mat).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(j < (*mat).columns(), "Invalid column access index");
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order
METRIC_NUMERIC_ALWAYS_INLINE bool tryShift(const Matrix<MT, SO> &mat, size_t row, size_t column, size_t m, size_t n,
										   int count)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*mat).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*mat).columns(), "Invalid column access index");
...
template <typename MT // Type of the matrix
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryBitand(const Matrix<MT, SO> &mat, size_t i, size_t j, const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(i < (*mat).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(j < (*mat).columns(), "Invalid column access index");
...
template <typename MT // Type of the matrix
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryBitand(const Matrix<MT, SO> &mat, size_t row, size_t column, size_t m, size_t n,
											const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*mat).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*mat).columns(), "Invalid column access index");
...
template <typename MT // Type of the matrix
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryBitor(const Matrix<MT, SO> &mat, size_t i, size_t j, const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(i < (*mat).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(j < (*mat).columns(), "Invalid column access index");
...
template <typename MT // Type of the matrix
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryBitor(const Matrix<MT, SO> &mat, size_t row, size_t column, size_t m, size_t n,
										   const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*mat).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*mat).columns(), "Invalid column access index");
...
template <typename MT // Type of the matrix
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryBitxor(const Matrix<MT, SO> &mat, size_t i, size_t j, const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(i < (*mat).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(j < (*mat).columns(), "Invalid column access index");
...
template <typename MT // Type of the matrix
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryBitxor(const Matrix<MT, SO> &mat, size_t row, size_t column, size_t m, size_t n,
											const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*mat).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*mat).columns(), "Invalid column access index");
...
METRIC_NUMERIC_ALWAYS_INLINE bool tryAssign(const Matrix<MT, SO> &lhs, const Vector<VT, TF> &rhs, size_t row,
											size_t column)
{
	...
	METRIC_NUMERIC_INTERNAL_ASSERT(TF || (row + (*rhs).size() <= (*lhs).rows()), "Invalid number of rows");
	METRIC_NUMERIC_INTERNAL_ASSERT(!TF || (column + (*rhs).size() <= (*lhs).columns()), "Invalid number of columns");
...
template <typename MT // Type of the left-hand side matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side vector
METRIC_NUMERIC_ALWAYS_INLINE bool tryAssign(const Matrix<MT, SO> &lhs, const Vector<VT, TF> &rhs, ptrdiff_t band,
...
template <typename MT1 // Type of the left-hand side matrix
		  ...
		  ,
		  bool SO2> // Storage order of the right-hand side matrix
METRIC_NUMERIC_ALWAYS_INLINE bool tryAssign(const Matrix<MT1, SO1> &lhs, const Matrix<MT2, SO2> &rhs, size_t row,
											size_t column)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*lhs).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*lhs).columns(), "Invalid column access index");
...
template <typename MT // Type of the left-hand side matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side vector
METRIC_NUMERIC_ALWAYS_INLINE bool tryAddAssign(const Matrix<MT, SO> &lhs, const Vector<VT, TF> &rhs, size_t row,
											   size_t column)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*lhs).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*lhs).columns(), "Invalid column access index");
...
template <typename MT // Type of the left-hand side matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side vector
METRIC_NUMERIC_ALWAYS_INLINE bool tryAddAssign(const Matrix<MT, SO> &lhs, const Vector<VT, TF> &rhs, ptrdiff_t band,
											   size_t row, size_t column)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*lhs).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*lhs).columns(), "Invalid column access index");
...
template <typename MT1 // Type of the left-hand side matrix
		  ...
		  ,
		  bool SO2> // Storage order of the right-hand side matrix
METRIC_NUMERIC_ALWAYS_INLINE bool tryAddAssign(const Matrix<MT1, SO1> &lhs, const Matrix<MT2, SO2> &rhs, size_t row,
											   size_t column)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*lhs).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*lhs).columns(), "Invalid column access index");
...
template <typename MT // Type of the left-hand side matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side vector
METRIC_NUMERIC_ALWAYS_INLINE bool trySubAssign(const Matrix<MT, SO> &lhs, const Vector<VT, TF> &rhs, size_t row,
											   size_t column)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*lhs).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*lhs).columns(), "Invalid column access index");
...
template <typename MT // Type of the left-hand side matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side vector
METRIC_NUMERIC_ALWAYS_INLINE bool trySubAssign(const Matrix<MT, SO> &lhs, const Vector<VT, TF> &rhs, ptrdiff_t band,
											   size_t row, size_t column)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*lhs).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*lhs).columns(), "Invalid column access index");
...
template <typename MT1 // Type of the left-hand side matrix
		  ...
		  ,
		  bool SO2> // Storage order of the right-hand side matrix
METRIC_NUMERIC_ALWAYS_INLINE bool trySubAssign(const Matrix<MT1, SO1> &lhs, const Matrix<MT2, SO2> &rhs, size_t row,
											   size_t column)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*lhs).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*lhs).columns(), "Invalid column access index");
...
template <typename MT // Type of the left-hand side matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side vector
METRIC_NUMERIC_ALWAYS_INLINE bool tryMultAssign(const Matrix<MT, SO> &lhs, const Vector<VT, TF> &rhs, size_t row,
												size_t column)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*lhs).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*lhs).columns(), "Invalid column access index");
...
template <typename MT // Type of the left-hand side matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side vector
METRIC_NUMERIC_ALWAYS_INLINE bool tryMultAssign(const Matrix<MT, SO> &lhs, const Vector<VT, TF> &rhs, ptrdiff_t band,
												size_t row, size_t column)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*lhs).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*lhs).columns(), "Invalid column access index");
...
template <typename MT1 // Type of the left-hand side matrix
		  ...
		  ,
		  bool SO2> // Storage order of the right-hand side matrix
METRIC_NUMERIC_ALWAYS_INLINE bool trySchurAssign(const Matrix<MT1, SO1> &lhs, const Matrix<MT2, SO2> &rhs, size_t row,
												 size_t column)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*lhs).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*lhs).columns(), "Invalid column access index");
...
template <typename MT // Type of the left-hand side matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side vector
METRIC_NUMERIC_ALWAYS_INLINE bool tryDivAssign(const Matrix<MT, SO> &lhs, const Vector<VT, TF> &rhs, size_t row,
											   size_t column)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*lhs).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*lhs).columns(), "Invalid column access index");
...
template <typename MT // Type of the left-hand side matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side vector
METRIC_NUMERIC_ALWAYS_INLINE bool tryDivAssign(const Matrix<MT, SO> &lhs, const Vector<VT, TF> &rhs, ptrdiff_t band,
											   size_t row, size_t column)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*lhs).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*lhs).columns(), "Invalid column access index");
...
template <typename MT // Type of the left-hand side matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side vector
METRIC_NUMERIC_ALWAYS_INLINE bool tryShiftAssign(const Matrix<MT, SO> &lhs, const Vector<VT, TF> &rhs, size_t row,
												 size_t column)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*lhs).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*lhs).columns(), "Invalid column access index");
...
template <typename MT // Type of the left-hand side matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side vector
METRIC_NUMERIC_ALWAYS_INLINE bool tryShiftAssign(const Matrix<MT, SO> &lhs, const Vector<VT, TF> &rhs, ptrdiff_t band,
												 size_t row, size_t column)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*lhs).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*lhs).columns(), "Invalid column access index");
...
template <typename MT1 // Type of the left-hand side matrix
		  ...
		  ,
		  bool SO2> // Storage order of the right-hand side matrix
METRIC_NUMERIC_ALWAYS_INLINE bool tryShiftAssign(const Matrix<MT1, SO1> &lhs, const Matrix<MT2, SO2> &rhs, size_t row,
												 size_t column)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*lhs).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*lhs).columns(), "Invalid column access index");
...
template <typename MT // Type of the left-hand side matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side vector
METRIC_NUMERIC_ALWAYS_INLINE bool tryBitandAssign(const Matrix<MT, SO> &lhs, const Vector<VT, TF> &rhs, size_t row,
												  size_t column)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*lhs).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*lhs).columns(), "Invalid column access index");
...
template <typename MT // Type of the left-hand side matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side vector
METRIC_NUMERIC_ALWAYS_INLINE bool tryBitandAssign(const Matrix<MT, SO> &lhs, const Vector<VT, TF> &rhs, ptrdiff_t band,
												  size_t row, size_t column)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*lhs).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*lhs).columns(), "Invalid column access index");
...
template <typename MT1 // Type of the left-hand side matrix
		  ...
		  ,
		  bool SO2> // Storage order of the right-hand side matrix
METRIC_NUMERIC_ALWAYS_INLINE bool tryBitandAssign(const Matrix<MT1, SO1> &lhs, const Matrix<MT2, SO2> &rhs, size_t row,
												  size_t column)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*lhs).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*lhs).columns(), "Invalid column access index");
...
template <typename MT // Type of the left-hand side matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side vector
METRIC_NUMERIC_ALWAYS_INLINE bool tryBitorAssign(const Matrix<MT, SO> &lhs, const Vector<VT, TF> &rhs, size_t row,
												 size_t column)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*lhs).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*lhs).columns(), "Invalid column access index");
...
template <typename MT // Type of the left-hand side matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side vector
METRIC_NUMERIC_ALWAYS_INLINE bool tryBitorAssign(const Matrix<MT, SO> &lhs, const Vector<VT, TF> &rhs, ptrdiff_t band,
												 size_t row, size_t column)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*lhs).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*lhs).columns(), "Invalid column access index");
...
template <typename MT1 // Type of the left-hand side matrix
		  ...
		  ,
		  bool SO2> // Storage order of the right-hand side matrix
METRIC_NUMERIC_ALWAYS_INLINE bool tryBitorAssign(const Matrix<MT1, SO1> &lhs, const Matrix<MT2, SO2> &rhs, size_t row,
												 size_t column)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*lhs).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*lhs).columns(), "Invalid column access index");
...
template <typename MT // Type of the left-hand side matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side vector
METRIC_NUMERIC_ALWAYS_INLINE bool tryBitxorAssign(const Matrix<MT, SO> &lhs, const Vector<VT, TF> &rhs, size_t row,
												  size_t column)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*lhs).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*lhs).columns(), "Invalid column access index");
...
template <typename MT // Type of the left-hand side matrix
		  ...
		  ,
		  bool TF> // Transpose flag of the right-hand side vector
METRIC_NUMERIC_ALWAYS_INLINE bool tryBitxorAssign(const Matrix<MT, SO> &lhs, const Vector<VT, TF> &rhs, ptrdiff_t band,
												  size_t row, size_t column)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*lhs).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*lhs).columns(), "Invalid column access index");
...
template <typename MT1 // Type of the left-hand side matrix
		  ...
		  ,
		  bool SO2> // Storage order of the right-hand side matrix
METRIC_NUMERIC_ALWAYS_INLINE bool tryBitxorAssign(const Matrix<MT1, SO1> &lhs, const Matrix<MT2, SO2> &rhs, size_t row,
												  size_t column)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(row <= (*lhs).rows(), "Invalid row access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(column <= (*lhs).columns(), "Invalid column access index");
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order
METRIC_NUMERIC_ALWAYS_INLINE MT &derestrict(Matrix<MT, SO> &matrix)
{
	return *matrix;
}
/*! \endcond */
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order
METRIC_NUMERIC_ALWAYS_INLINE MT &unview(Matrix<MT, SO> &matrix)
{
	return *matrix;
}
/*! \endcond */
...
template <typename MT // Type of the matrix
		  ,
		  bool SO> // Storage order
METRIC_NUMERIC_ALWAYS_INLINE const MT &unview(const Matrix<MT, SO> &matrix)
{
	return *matrix;
}
/*! \endcond */
