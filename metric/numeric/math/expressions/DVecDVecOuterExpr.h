...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DVECDVECOUTEREXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DVECDVECOUTEREXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DVecDVecOuterExpr : public VecTVecMapExpr<DenseMatrix<DVecDVecOuterExpr<VT1, VT2, OP>, false>>,
						  private Computation {
  private:
	//**Type definitions****************************************************************************
	...
	template <typename VT> static constexpr bool UseSMPAssign_v = evaluateRight;
	/*! \endcond */
	//**********************************************************************************************
	...
	static constexpr bool UseVectorizedKernel_v =
		(useOptimizedKernels && T1::simdEnabled && T2::simdEnabled && T3::simdEnabled &&
  ...
  public:
	...
	class ConstIterator {
	  public:
		...
		*/
		inline auto load() const noexcept { return op_.load(set(*left_), right_.load()); }
		//*******************************************************************************************
	...
	*/
	inline bool canSMPAssign() const noexcept { return (rows() * columns() >= SMP_DVECDVECOUTER_THRESHOLD); }
	//**********************************************************************************************
...
template <typename VT1 // Type of the left-hand side dense vector
		  ...
		  ,
		  typename OP> // Type of the custom operation
inline decltype(auto) map(const DenseVector<VT1, false> &lhs, const DenseVector<VT2, true> &rhs, OP op)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename VT1 // Type of the left-hand side dense vector
		  ,
		  typename VT2> // Type of the right-hand side dense vector
inline decltype(auto) operator+(const DenseVector<VT1, false> &lhs, const DenseVector<VT2, true> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
struct Size<DVecDVecOuterExpr<VT1, VT2, OP>, 0UL> : public Size<VT1, 0UL> {};

template <typename VT1, typename VT2, typename OP>
struct Size<DVecDVecOuterExpr<VT1, VT2, OP>, 1UL> : public Size<VT2, 0UL> {};
/*! \endcond */
//*************************************************************************************************
...
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename VT1, typename VT2, typename OP>
struct IsAligned<DVecDVecOuterExpr<VT1, VT2, OP>> : public BoolConstant<IsAligned_v<VT1> && IsAligned_v<VT2>> {};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename VT1, typename VT2> struct IsPadded<DVecDVecOuterExpr<VT1, VT2, Mult>> : public IsPadded<VT2> {};
/*! \endcond */
//*************************************************************************************************
