...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DVECSVECKRONEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DVECSVECKRONEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DVecSVecKronExpr : public VecVecKronExpr<SparseVector<DVecSVecKronExpr<VT1, VT2, TF>, TF>>, private Computation {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	*/
	inline size_t size() const noexcept { return lhs_.size() * rhs_.size(); }
	//**********************************************************************************************
  ...
  private:
	...
	*/
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_FORM_VALID_VECVECKRONEXPR(VT1, VT2);
	/*! \endcond */
	//**********************************************************************************************
};
//*************************************************************************************************
...
inline const DVecSVecKronExpr<VT1, VT2, TF> dvecsveckron(const DenseVector<VT1, TF> &lhs,
...
inline decltype(auto) dvecsveckron(const DenseVector<VT1, TF> &lhs, const SparseVector<VT2, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename VT1 // Type of the left-hand side dense vector
		  ...
		  ,
		  bool TF> // Transpose flag
inline decltype(auto) kron(const DenseVector<VT1, TF> &lhs, const SparseVector<VT2, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
