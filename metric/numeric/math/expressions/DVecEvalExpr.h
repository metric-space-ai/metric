...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DVECEVALEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DVECEVALEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DVecEvalExpr : public VecEvalExpr<DenseVector<DVecEvalExpr<VT, TF>, TF>>, private Computation {
  public:
	//**Type definitions****************************************************************************
	//! Type of this DVecEvalExpr instance.
	using This = DVecEvalExpr<VT, TF>;

	//! Base type of this DVecEvalExpr instance.
	using BaseType = VecEvalExpr<DenseVector<This, TF>>;
	...
	*/
	explicit inline DVecEvalExpr(const VT &dv) noexcept : dv_(dv) // Dense vector of the evaluation expression
	{
	}
	//**********************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename VT, bool TF> struct IsAligned<DVecEvalExpr<VT, TF>> : public IsAligned<VT> {};
/*! \endcond */
//*************************************************************************************************
