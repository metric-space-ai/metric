...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DMATINVEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DMATINVEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DMatInvExpr : public MatInvExpr<DenseMatrix<DMatInvExpr<MT, SO>, SO>>, private Computation {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	*/
	explicit inline DMatInvExpr(const MT &dm) noexcept : dm_(dm) // Dense matrix of the inversion expression
	{
