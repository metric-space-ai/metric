...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DMATDETEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DMATDETEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
//@{
template <typename MT, bool SO> inline ElementType_t<MT> det(const DenseMatrix<MT, SO> &dm);
//@}
//*************************************************************************************************
...
{
	METRIC_NUMERIC_INTERNAL_ASSERT(isSquare(*dm), "Non-square symmetric matrix detected");

	using RT = ResultType_t<MT>;
	using ET = ElementType_t<MT>;
	using URT = RemoveAdaptor_t<RT>;

	METRIC_NUMERIC_CONSTRAINT_MUST_BE_DENSE_MATRIX_TYPE(URT);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(URT);
	METRIC_NUMERIC_CONSTRAINT_MUST_HAVE_MUTABLE_DATA_ACCESS(URT);
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_BLAS_COMPATIBLE_TYPE(ET);
