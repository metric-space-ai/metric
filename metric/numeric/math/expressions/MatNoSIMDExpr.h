...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_MATNOSIMDEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_MATNOSIMDEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
struct MatNoSIMDExpr : public NoSIMDExpr<MT> {};
//*************************************************************************************************
...
inline decltype(auto) nosimd(const MatMatMapExpr<MT> &matrix)
{
	...
	return map(nosimd((*matrix).leftOperand()), nosimd((*matrix).rightOperand()), (*matrix).operation());
}
/*! \endcond */
//*************************************************************************************************
...
inline decltype(auto) nosimd(const MatRepeatExpr<MT> &matrix)
{
	...
	return repeat(nosimd((*matrix).operand()), (*matrix).template repetitions<0UL>(),
