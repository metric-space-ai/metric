...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DMATREDUCEEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DMATREDUCEEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DMatReduceExpr<MT, OP, columnwise>
	: public MatReduceExpr<DenseVector<DMatReduceExpr<MT, OP, columnwise>, true>, columnwise>, private Computation {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	*/
	...
	{
		METRIC_NUMERIC_INTERNAL_ASSERT(index < dm_.columns(), "Invalid vector access index");
	...
	*/
	inline size_t size() const noexcept { return dm_.columns(); }
	//**********************************************************************************************
	...
	*/
	inline bool canSMPAssign() const noexcept { return dm_.canSMPAssign() || (size() > SMP_DMATREDUCE_THRESHOLD); }
	//**********************************************************************************************
  ...
  private:
	...
	*/
	template <typename VT1> // Type of the target vector
	friend inline auto smpAssign(Vector<VT1, true> &lhs, const DMatReduceExpr &rhs) -> EnableIf_t<UseSMPAssign_v<VT1>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
...
class DMatReduceExpr<MT, OP, rowwise>
	: public MatReduceExpr<DenseVector<DMatReduceExpr<MT, OP, rowwise>, false>, rowwise>, private Computation {
  private:
	//**Type definitions****************************************************************************
	using RT = ResultType_t<MT>; //!< Result type of the dense matrix expression.
	//**********************************************************************************************
  ...
  public:
	...
	class ConstIterator {
	  public:
		...
		*/
		inline METRIC_NUMERIC_DEVICE_CALLABLE const ConstIterator operator++(int) { return ConstIterator(index_++); }
		//*******************************************************************************************
		...
		*/
		...
		// \return The resulting value.
		*/
		inline ReturnType operator*() const { return reduce(row(dm_, index_, unchecked), op_); }
		//*******************************************************************************************
	...
	*/
	inline ReturnType operator[](size_t index) const
	{
		METRIC_NUMERIC_INTERNAL_ASSERT(index < dm_.rows(), "Invalid vector access index");
	...
	*/
	inline ConstIterator begin() const { return ConstIterator(dm_, 0UL, op_); }
	//**********************************************************************************************
	...
	*/
	inline ConstIterator end() const { return ConstIterator(dm_, size(), op_); }
	//**********************************************************************************************
  ...
  private:
	...
	*/
	template <typename VT1> // Type of the target vector
	friend inline auto assign(Vector<VT1, false> &lhs, const DMatReduceExpr &rhs) -> EnableIf_t<UseAssign_v<VT1>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT1> // Type of the target vector
	friend inline auto addAssign(Vector<VT1, false> &lhs, const DMatReduceExpr &rhs) -> EnableIf_t<UseAssign_v<VT1>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT1> // Type of the target vector
	friend inline auto subAssign(Vector<VT1, false> &lhs, const DMatReduceExpr &rhs) -> EnableIf_t<UseAssign_v<VT1>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT1> // Type of the target vector
	friend inline auto multAssign(Vector<VT1, false> &lhs, const DMatReduceExpr &rhs) -> EnableIf_t<UseAssign_v<VT1>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT1> // Type of the target vector
	friend inline auto divAssign(Vector<VT1, false> &lhs, const DMatReduceExpr &rhs) -> EnableIf_t<UseAssign_v<VT1>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT1> // Type of the target vector
	friend inline auto smpAssign(Vector<VT1, false> &lhs, const DMatReduceExpr &rhs) -> EnableIf_t<UseSMPAssign_v<VT1>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
...
// This function reduces the given dense matrix \a dm by means of addition:
   ...
   \code
   mtrc::numeric::DynamicMatrix<int> A{ { 1, 2 }, { 3, 4 } };
...
// addition. In case the reduction flag \a RF is set to \a mtrc::numeric::columnwise, the elements of
// the matrix are reduced column-wise and the result is a row vector. In case \a RF is set to
// \a mtrc::numeric::rowwise, the elements of the matrix are reduced row-wise and the result is a
// column vector:

   \code
   using mtrc::numeric::columnwise;

   mtrc::numeric::DynamicMatrix<int> A{ { 1, 0, 2 }, { 1, 3, 4 } };
...
//
// This function reduces the rows or columns of the given dense matrix \a dm by means of
// multiplication. In case the reduction flag \a RF is set to \a mtrc::numeric::columnwise, the elements
// of the matrix are reduced column-wise and the result is a row vector. In case \a RF is set to
// \a mtrc::numeric::rowwise, the elements of the matrix are reduced row-wise and the result is a column
// vector:
   ...
   mtrc::numeric::DynamicMatrix<int> A{ { 1, 0, 2 }, { 1, 3, 4 } };
   mtrc::numeric::DynamicVector<int,rowVector> colprod;
   ...
   mtrc::numeric::DynamicMatrix<int> A{ { 1, 0, 2 }, { 1, 3, 4 } };
   mtrc::numeric::DynamicVector<int,columnVector> rowprod;
...
// smallest element of each column is returned. In case \a RF is set to \a mtrc::numeric::rowwise, a
...
// In case the reduction flag \a RF is set to \a mtrc::numeric::columnwise, a row vector containing the
// largest element of each column is returned. In case \a RF is set to \a mtrc::numeric::rowwise, a
