...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DMATTSMATSUBEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DMATTSMATSUBEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DMatTSMatSubExpr : public MatMatSubExpr<DenseMatrix<DMatTSMatSubExpr<MT1, MT2>, false>>, private Computation {
  private:
	//**Type definitions****************************************************************************
...
inline const DMatTSMatSubExpr<MT1, MT2> dmattsmatsub(const DenseMatrix<MT1, false> &lhs,
...
inline const MT1 &dmattsmatsub(const DenseMatrix<MT1, false> &lhs, const SparseMatrix<MT2, true> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
inline decltype(auto) operator+(const DMatTSMatSubExpr<MT1, MT2> &lhs, const DenseMatrix<MT3, SO> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
