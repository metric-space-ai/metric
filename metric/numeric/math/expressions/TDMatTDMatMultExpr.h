...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_TDMATTDMATMULTEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_TDMATTDMATMULTEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
template <typename MT1 // Type of the left-hand side dense matrix
		  ...
		  ,
		  bool UF> // Upper flag
class TDMatTDMatMultExpr : public MatMatMultExpr<DenseMatrix<TDMatTDMatMultExpr<MT1, MT2, SF, HF, LF, UF>, true>>,
						   private Computation {
  private:
	//**Type definitions****************************************************************************
	...
	static constexpr bool CanExploitSymmetry_v = (IsRowMajorMatrix_v<T1> && (IsSymmetric_v<T2> || IsSymmetric_v<T3>));
	/*! \endcond */
	//**********************************************************************************************
  ...
  public:
	...
	static constexpr bool simdEnabled = (!IsDiagonal_v<MT1> && MT1::simdEnabled && MT2::simdEnabled &&
										 HasSIMDAdd_v<ET1, ET2> && HasSIMDMult_v<ET1, ET2>);
	...
	*/
	inline bool canSMPAssign() const noexcept
	{
		return (!METRIC_NUMERIC_BLAS_MODE || !METRIC_NUMERIC_USE_BLAS_MATRIX_MATRIX_MULTIPLICATION ||
				!METRIC_NUMERIC_BLAS_IS_PARALLEL || (rows() * columns() < TDMATTDMATMULT_THRESHOLD)) &&
			   (rows() * columns() >= SMP_TDMATTDMATMULT_THRESHOLD) && !IsDiagonal_v<MT1> && !IsDiagonal_v<MT2>;
	}
	//**********************************************************************************************
  ...
  private:
	...
	*/
	...
	{
		if ((IsDiagonal_v<MT4>) || (!METRIC_NUMERIC_DEBUG_MODE && A.rows() <= SIMDSIZE * 10UL) ||
	...
	*/
	...
	static inline auto selectDefaultAssignKernel(MT3 &C, const MT4 &A, const MT5 &B)
		-> EnableIf_t<!IsDiagonal_v<MT4> && IsDiagonal_v<MT5>>
	{
		METRIC_NUMERIC_CONSTRAINT_MUST_BE_COLUMN_MAJOR_MATRIX_TYPE(MT3);
	...
	*/
	...
	{
		METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_SYMMETRIC_MATRIX_TYPE(MT4);
		METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_SYMMETRIC_MATRIX_TYPE(MT5);
		METRIC_NUMERIC_CONSTRAINT_MUST_BE_ROW_MAJOR_MATRIX_TYPE(OppositeType_t<MT4>);
		METRIC_NUMERIC_CONSTRAINT_MUST_BE_ROW_MAJOR_MATRIX_TYPE(OppositeType_t<MT5>);
...
class DMatScalarMultExpr<TDMatTDMatMultExpr<MT1, MT2, SF, HF, LF, UF>, ST, true>
	: public MatScalarMultExpr<
		  DenseMatrix<DMatScalarMultExpr<TDMatTDMatMultExpr<MT1, MT2, SF, HF, LF, UF>, ST, true>, true>>,
	  private Computation {
  private:
	//**Type definitions****************************************************************************
	...
	template <typename T1, typename T2, typename T3, typename T4>
	static constexpr bool UseVectorizedDefaultKernel_v =
		(useOptimizedKernels && !IsDiagonal_v<T2> && T1::simdEnabled && T2::simdEnabled && T3::simdEnabled &&
		 IsSIMDCombinable_v<ElementType_t<T1>, ElementType_t<T2>, ElementType_t<T3>, T4> &&
		 HasSIMDAdd_v<ElementType_t<T2>, ElementType_t<T2>> && HasSIMDMult_v<ElementType_t<T3>, ElementType_t<T3>>);
	//**********************************************************************************************
  ...
  public:
	...
	static constexpr bool simdEnabled =
		(!IsDiagonal_v<MT1> && MT1::simdEnabled && MT2::simdEnabled && IsSIMDCombinable_v<ET1, ET2, ST> &&
		 HasSIMDAdd_v<ET1, ET2> && HasSIMDMult_v<ET1, ET2>);
...
// This operator represents the multiplication of two column-major dense matrices:
   ...
   mtrc::numeric::DynamicMatrix<double,columnMajor> A, B, C;
...
template <typename MT1 // Type of the left-hand side dense matrix
		  ,
		  typename MT2> // Type of the right-hand side dense matrix
inline decltype(auto) operator*(const DenseMatrix<MT1, true> &lhs, const DenseMatrix<MT2, true> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
struct Size<TDMatTDMatMultExpr<MT1, MT2, SF, HF, LF, UF>, 0UL> : public Size<MT1, 0UL> {};

template <typename MT1, typename MT2, bool SF, bool HF, bool LF, bool UF>
struct Size<TDMatTDMatMultExpr<MT1, MT2, SF, HF, LF, UF>, 1UL> : public Size<MT2, 1UL> {};
/*! \endcond */
//*************************************************************************************************
