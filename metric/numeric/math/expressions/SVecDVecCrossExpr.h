...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SVECDVECCROSSEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SVECDVECCROSSEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SVecDVecCrossExpr : public CrossExpr<DenseVector<SVecDVecCrossExpr<VT1, VT2, TF>, TF>>, private Computation {
  private:
	//**Type definitions****************************************************************************
...
inline const SVecDVecCrossExpr<VT1, VT2, TF> svecdveccross(const SparseVector<VT1, TF> &lhs,
...
inline decltype(auto) svecdveccross(const SparseVector<VT1, TF> &lhs, const DenseVector<VT2, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
// This operator represents the cross product of a sparse vector and a dense vector:
   ...
   \code
   mtrc::numeric::CompressedVector<double> a( 3UL );
   mtrc::numeric::DynamicVector<double> b( 3UL );
