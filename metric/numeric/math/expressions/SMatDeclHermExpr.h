...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SMATDECLHERMEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SMATDECLHERMEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SMatDeclHermExpr : public DeclHermExpr<SparseMatrix<SMatDeclHermExpr<MT, SO>, SO>>, public Declaration<MT> {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	*/
	explicit inline SMatDeclHermExpr(const MT &sm) noexcept : sm_(sm) // Sparse matrix of the declherm expression
	{
  ...
  private:
	...
	*/
	...
	friend inline auto assign(DenseMatrix<MT2, SO2> &lhs, const SMatDeclHermExpr &rhs) -> EnableIf_t<UseAssign_v<MT2>>
	{
	...
	*/
	...
	friend inline auto assign(SparseMatrix<MT2, SO2> &lhs, const SMatDeclHermExpr &rhs) -> EnableIf_t<UseAssign_v<MT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO> struct IsHermitian<SMatDeclHermExpr<MT, SO>> : public TrueType {};
/*! \endcond */
//*************************************************************************************************
