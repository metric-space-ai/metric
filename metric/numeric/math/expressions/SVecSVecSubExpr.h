...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SVECSVECSUBEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SVECSVECSUBEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SVecSVecSubExpr : public VecVecSubExpr<SparseVector<SVecSVecSubExpr<VT1, VT2, TF>, TF>>, private Computation {
  private:
	//**Type definitions****************************************************************************
...
inline const SVecSVecSubExpr<VT1, VT2, TF> svecsvecsub(const SparseVector<VT1, TF> &lhs,
...
inline const VT1 &svecsvecsub(const SparseVector<VT1, TF> &lhs, const SparseVector<VT2, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename VT1 // Type of the left-hand side sparse vector
		  ...
		  ,
		  EnableIf_t<IsZero_v<VT1> && !IsZero_v<VT2> && IsSame_v<ElementType_t<VT1>, ElementType_t<VT2>>> * = nullptr>
inline decltype(auto) svecsvecsub(const SparseVector<VT1, TF> &lhs, const SparseVector<VT2, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
