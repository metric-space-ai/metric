...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DMATDVECSOLVEEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DMATDVECSOLVEEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DMatDVecSolveExpr : public MatVecSolveExpr<DenseVector<DMatDVecSolveExpr<MT, VT, TF>, TF>>, private Computation {
  private:
	//**Type definitions****************************************************************************
  ...
  private:
	...
	*/
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_FORM_VALID_MATVECSOLVEEXPR(MT, VT);
	/*! \endcond */
	//**********************************************************************************************
};
//*************************************************************************************************
...
// of equations (LSE):
   ...
   mtrc::numeric::DynamicVector<double> b, x;
