...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DMATTDMATADDEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DMATTDMATADDEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DMatTDMatAddExpr : public MatMatAddExpr<DenseMatrix<DMatTDMatAddExpr<MT1, MT2>, false>>, private Computation {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	*/
	...
	{
		return lhs_.canSMPAssign() || rhs_.canSMPAssign() || (rows() * columns() >= SMP_DMATTDMATADD_THRESHOLD);
	}
	//**********************************************************************************************
  ...
  private:
	...
	*/
	...
	friend inline auto assign(DenseMatrix<MT, SO> &lhs, const DMatTDMatAddExpr &rhs) -> DisableIf_t<UseAssign_v<MT>>
	{
	...
	*/
	template <typename MT // Type of the target dense matrix
			  ,
			  bool SO> // Storage order of the target dense matrix
	friend inline auto assign(DenseMatrix<MT, SO> &lhs, const DMatTDMatAddExpr &rhs) -> EnableIf_t<UseAssign_v<MT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename MT // Type of the target dense matrix
			  ,
			  bool SO> // Storage order of the target dense matrix
	friend inline auto addAssign(DenseMatrix<MT, SO> &lhs, const DMatTDMatAddExpr &rhs) -> DisableIf_t<UseAssign_v<MT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename MT // Type of the target dense matrix
			  ,
			  bool SO> // Storage order of the target dense matrix
	friend inline auto addAssign(DenseMatrix<MT, SO> &lhs, const DMatTDMatAddExpr &rhs) -> EnableIf_t<UseAssign_v<MT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename MT // Type of the target dense matrix
			  ,
			  bool SO> // Storage order of the target dense matrix
	friend inline auto subAssign(DenseMatrix<MT, SO> &lhs, const DMatTDMatAddExpr &rhs) -> DisableIf_t<UseAssign_v<MT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename MT // Type of the target dense matrix
			  ,
			  bool SO> // Storage order of the target dense matrix
	friend inline auto subAssign(DenseMatrix<MT, SO> &lhs, const DMatTDMatAddExpr &rhs) -> EnableIf_t<UseAssign_v<MT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
...
inline const DMatTDMatAddExpr<MT1, MT2> dmattdmatadd(const DenseMatrix<MT1, false> &lhs,
...
template <typename MT1 // Type of the left-hand side dense matrix
		  ...
		  ,
		  EnableIf_t<IsSymmetric_v<MT1> && !IsSymmetric_v<MT2>> * = nullptr>
inline decltype(auto) dmattdmatadd(const DenseMatrix<MT1, false> &lhs, const DenseMatrix<MT2, true> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename MT1 // Type of the left-hand side dense matrix
		  ...
		  ,
		  EnableIf_t<!IsSymmetric_v<MT1> && !IsSymmetric_v<MT2>> * = nullptr>
inline const DMatTDMatAddExpr<MT2, MT1> tdmatdmatadd(const DenseMatrix<MT1, true> &lhs,
...
template <typename MT1 // Type of the left-hand side dense matrix
		  ...
		  ,
		  EnableIf_t<!IsSymmetric_v<MT1> && IsSymmetric_v<MT2>> * = nullptr>
inline decltype(auto) tdmatdmatadd(const DenseMatrix<MT1, true> &lhs, const DenseMatrix<MT2, false> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
struct IsAligned<DMatTDMatAddExpr<MT1, MT2>> : public BoolConstant<IsAligned_v<MT1> && IsAligned_v<MT2>> {};
/*! \endcond */
//*************************************************************************************************
