...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DVECNOSIMDEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DVECNOSIMDEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DVecNoSIMDExpr : public VecNoSIMDExpr<DenseVector<DVecNoSIMDExpr<VT, TF>, TF>>, private Modification<VT> {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	*/
	explicit inline DVecNoSIMDExpr(const VT &dv) noexcept : dv_(dv) // Dense vector of the no-SIMD expression
	{
	}
	//**********************************************************************************************
  ...
  private:
	...
	*/
	...
	friend inline auto assign(DenseVector<VT2, TF> &lhs, const DVecNoSIMDExpr &rhs) -> EnableIf_t<UseAssign_v<VT2>>
	{
	...
	*/
	...
	friend inline auto assign(SparseVector<VT2, TF> &lhs, const DVecNoSIMDExpr &rhs) -> EnableIf_t<UseAssign_v<VT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT2> // Type of the target dense vector
	friend inline auto addAssign(DenseVector<VT2, TF> &lhs, const DVecNoSIMDExpr &rhs) -> EnableIf_t<UseAssign_v<VT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT2> // Type of the target dense vector
	friend inline auto subAssign(DenseVector<VT2, TF> &lhs, const DVecNoSIMDExpr &rhs) -> EnableIf_t<UseAssign_v<VT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT2> // Type of the target dense vector
	friend inline auto multAssign(DenseVector<VT2, TF> &lhs, const DVecNoSIMDExpr &rhs) -> EnableIf_t<UseAssign_v<VT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT2> // Type of the target dense vector
	friend inline auto divAssign(DenseVector<VT2, TF> &lhs, const DVecNoSIMDExpr &rhs) -> EnableIf_t<UseAssign_v<VT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename VT, bool TF> struct HasConstDataAccess<DVecNoSIMDExpr<VT, TF>> : public HasConstDataAccess<VT> {};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename VT, bool TF> struct IsAligned<DVecNoSIMDExpr<VT, TF>> : public IsAligned<VT> {};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename VT, bool TF> struct IsPadded<DVecNoSIMDExpr<VT, TF>> : public IsPadded<VT> {};
/*! \endcond */
//*************************************************************************************************
