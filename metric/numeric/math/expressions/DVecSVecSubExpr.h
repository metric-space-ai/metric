...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DVECSVECSUBEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DVECSVECSUBEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DVecSVecSubExpr : public VecVecSubExpr<DenseVector<DVecSVecSubExpr<VT1, VT2, TF>, TF>>, private Computation {
  private:
	//**Type definitions****************************************************************************
  ...
  private:
	...
	*/
	template <typename VT> // Type of the target dense vector
	friend inline auto smpAssign(DenseVector<VT, TF> &lhs, const DVecSVecSubExpr &rhs) -> EnableIf_t<UseSMPAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
...
inline const DVecSVecSubExpr<VT1, VT2, TF> dvecsvecsub(const DenseVector<VT1, TF> &lhs,
...
inline const VT1 &dvecsvecsub(const DenseVector<VT1, TF> &lhs, const SparseVector<VT2, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
inline decltype(auto) operator+(const DVecSVecSubExpr<VT1, VT2, TF> &lhs, const DenseVector<VT3, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
