...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_TSMATTSMATADDEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_TSMATTSMATADDEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class TSMatTSMatAddExpr : public MatMatAddExpr<SparseMatrix<TSMatTSMatAddExpr<MT1, MT2>, true>>, private Computation {
  private:
	//**Type definitions****************************************************************************
	...
	static constexpr bool UseSymmetricKernel_v = (IsRowMajorMatrix_v<T1> && IsSymmetric_v<T2> && IsSymmetric_v<T3>);
	/*! \endcond */
	//**********************************************************************************************
...
inline const TSMatTSMatAddExpr<MT1, MT2> tsmattsmatadd(const SparseMatrix<MT1, true> &lhs,
...
inline const MT1 &tsmattsmatadd(const SparseMatrix<MT1, true> &lhs, const SparseMatrix<MT2, true> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename MT1 // Type of the left-hand side sparse matrix
		  ...
		  ,
		  EnableIf_t<IsZero_v<MT1> && !IsZero_v<MT2> && IsSame_v<ElementType_t<MT1>, ElementType_t<MT2>>> * = nullptr>
inline const MT2 &tsmattsmatadd(const SparseMatrix<MT1, true> &lhs, const SparseMatrix<MT2, true> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
inline decltype(auto) tsmattsmatadd(const SparseMatrix<MT1, true> &lhs, const SparseMatrix<MT2, true> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
