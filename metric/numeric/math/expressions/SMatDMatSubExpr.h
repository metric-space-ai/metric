...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SMATDMATSUBEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SMATDMATSUBEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SMatDMatSubExpr : public MatMatSubExpr<DenseMatrix<SMatDMatSubExpr<MT1, MT2, SO>, SO>>, private Computation {
  private:
	//**Type definitions****************************************************************************
...
inline const SMatDMatSubExpr<MT1, MT2, SO> smatdmatsub(const SparseMatrix<MT1, SO> &lhs,
...
inline decltype(auto) smatdmatsub(const SparseMatrix<MT1, SO> &lhs, const DenseMatrix<MT2, SO> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
inline decltype(auto) operator+(const SMatDMatSubExpr<MT1, MT2, SO1> &lhs, const DenseMatrix<MT3, SO2> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
