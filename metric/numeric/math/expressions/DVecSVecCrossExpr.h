...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DVECSVECCROSSEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DVECSVECCROSSEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DVecSVecCrossExpr : public CrossExpr<DenseVector<DVecSVecCrossExpr<VT1, VT2, TF>, TF>>, private Computation {
  private:
	//**Type definitions****************************************************************************
...
inline const DVecSVecCrossExpr<VT1, VT2, TF> dvecsveccross(const DenseVector<VT1, TF> &lhs,
...
inline decltype(auto) dvecsveccross(const DenseVector<VT1, TF> &lhs, const SparseVector<VT2, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
// This operator represents the cross product of a dense vector and a sparse vector:
   ...
   \code
   mtrc::numeric::DynamicVector<double> a( 3UL );
   mtrc::numeric::CompressedVector<double> b( 3UL );
