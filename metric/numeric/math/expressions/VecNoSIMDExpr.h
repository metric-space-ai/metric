...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_VECNOSIMDEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_VECNOSIMDEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
struct VecNoSIMDExpr : public NoSIMDExpr<VT> {};
//*************************************************************************************************
...
inline decltype(auto) nosimd(const VecVecMapExpr<VT> &vector)
{
	...
	return map(nosimd((*vector).leftOperand()), nosimd((*vector).rightOperand()), (*vector).operation());
}
/*! \endcond */
//*************************************************************************************************
