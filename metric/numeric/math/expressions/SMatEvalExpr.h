...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SMATEVALEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SMATEVALEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SMatEvalExpr : public MatEvalExpr<SparseMatrix<SMatEvalExpr<MT, SO>, SO>>, private Computation {
  public:
	//**Type definitions****************************************************************************
	...
	*/
	explicit inline SMatEvalExpr(const MT &sm) noexcept : sm_(sm) // Sparse matrix of the evaluation expression
	{
	}
	//**********************************************************************************************
