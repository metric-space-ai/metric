...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DMATSMATSUBEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DMATSMATSUBEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DMatSMatSubExpr : public MatMatSubExpr<DenseMatrix<DMatSMatSubExpr<MT1, MT2, SO>, SO>>, private Computation {
  private:
	//**Type definitions****************************************************************************
...
inline const DMatSMatSubExpr<MT1, MT2, SO> dmatsmatsub(const DenseMatrix<MT1, SO> &lhs,
...
inline const MT1 &dmatsmatsub(const DenseMatrix<MT1, SO> &lhs, const SparseMatrix<MT2, SO> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
inline decltype(auto) operator+(const DMatSMatSubExpr<MT1, MT2, SO1> &lhs, const DenseMatrix<MT3, SO2> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
