...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DVECDVECCROSSEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DVECDVECCROSSEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DVecDVecCrossExpr : public CrossExpr<DenseVector<DVecDVecCrossExpr<VT1, VT2, TF>, TF>>, private Computation {
  private:
	//**Type definitions****************************************************************************
	...
	using ExprReturnType =
		decltype((std::declval<RN1>() * std::declval<RN2>()) - (std::declval<RN1>() * std::declval<RN2>()));
	//**********************************************************************************************
  ...
  public:
	...
	using CompositeType =
		If_t<!RequiresEvaluation_v<VT1> && !RequiresEvaluation_v<VT2>, const DVecDVecCrossExpr &, const ResultType>;
	...
	class ConstIterator {
	  public:
		...
		*/
		inline METRIC_NUMERIC_DEVICE_CALLABLE ConstIterator(const LeftOperand &left, const RightOperand &right,
															size_t index)
		...
		*/
		inline METRIC_NUMERIC_DEVICE_CALLABLE ReturnType operator*() const
		{
			METRIC_NUMERIC_INTERNAL_ASSERT(index_ < 3UL, "Invalid vector access index");
			if (index_ == 0UL)
		...
		*/
		...
		{
			METRIC_NUMERIC_INTERNAL_ASSERT(index_ == 0UL, "Invalid vector access index");
			...
			return setall(x[1UL] * y[2UL] - x[2UL] * y[1UL], x[2UL] * y[0UL] - x[0UL] * y[2UL],
	...
	*/
	...
	{
		METRIC_NUMERIC_INTERNAL_ASSERT(lhs.size() == 3UL, "Invalid vector size");
		METRIC_NUMERIC_INTERNAL_ASSERT(rhs.size() == 3UL, "Invalid vector size");
	}
	//**********************************************************************************************
	...
	*/
	...
	{
		METRIC_NUMERIC_INTERNAL_ASSERT(index < 3UL, "Invalid vector access index");
	...
	*/
	...
	{
		METRIC_NUMERIC_INTERNAL_ASSERT(index == 0UL, "Invalid vector access index");
	...
	*/
	inline ConstIterator begin() const { return ConstIterator(lhs_, rhs_, 0UL); }
	//**********************************************************************************************
	...
	*/
	inline ConstIterator end() const { return ConstIterator(lhs_, rhs_, 3UL); }
	//**********************************************************************************************
	...
	*/
	constexpr size_t size() const noexcept { return 3UL; }
	//**********************************************************************************************
...
struct IsPadded<DVecDVecCrossExpr<VT1, VT2, TF>> : public BoolConstant<DVecDVecCrossExpr<VT1, VT2, TF>::simdEnabled> {};
/*! \endcond */
//*************************************************************************************************
