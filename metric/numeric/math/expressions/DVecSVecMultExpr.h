...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DVECSVECMULTEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DVECSVECMULTEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DVecSVecMultExpr : public VecVecMultExpr<SparseVector<DVecSVecMultExpr<VT1, VT2, TF>, TF>>, private Computation {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	class ConstIterator {
	  public:
		...
		*/
		inline const Element operator*() const { return Element(vec_[it_->index()] * it_->value(), it_->index()); }
		//*******************************************************************************************
		...
		*/
		...
		// \return The current value of the sparse element.
		*/
		inline ReturnType value() const { return vec_[it_->index()] * it_->value(); }
		//*******************************************************************************************
	...
	*/
	inline ConstIterator begin() const { return ConstIterator(lhs_, rhs_.begin()); }
	//**********************************************************************************************
	...
	*/
	inline ConstIterator end() const { return ConstIterator(lhs_, rhs_.end()); }
	//**********************************************************************************************
  ...
  private:
	...
	*/
	...
	friend inline auto assign(DenseVector<VT, TF> &lhs, const DVecSVecMultExpr &rhs) -> EnableIf_t<UseAssign_v<VT>>
	{
		...
		METRIC_NUMERIC_INTERNAL_ASSERT(x.size() == (*lhs).size(), "Invalid vector size");
	...
	*/
	...
	friend inline auto assign(SparseVector<VT, TF> &lhs, const DVecSVecMultExpr &rhs) -> EnableIf_t<UseAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT> // Type of the target dense vector
	friend inline auto addAssign(DenseVector<VT, TF> &lhs, const DVecSVecMultExpr &rhs) -> EnableIf_t<UseAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT> // Type of the target dense vector
	friend inline auto subAssign(DenseVector<VT, TF> &lhs, const DVecSVecMultExpr &rhs) -> EnableIf_t<UseAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT> // Type of the target dense vector
	friend inline auto multAssign(DenseVector<VT, TF> &lhs, const DVecSVecMultExpr &rhs) -> EnableIf_t<UseAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
...
inline const DVecSVecMultExpr<VT1, VT2, TF> dvecsvecmult(const DenseVector<VT1, TF> &lhs,
...
inline decltype(auto) dvecsvecmult(const DenseVector<VT1, TF> &lhs, const SparseVector<VT2, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
// vector:
   ...
   mtrc::numeric::CompressedVector<double> b, c;
...
template <typename VT1 // Type of the left-hand side dense vector
		  ...
		  ,
		  bool TF> // Transpose flag
inline decltype(auto) operator*(const DenseVector<VT1, TF> &lhs, const SparseVector<VT2, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
struct Size<DVecSVecMultExpr<VT1, VT2, TF>, 0UL> : public Max_t<Size<VT1, 0UL>, Size<VT2, 0UL>> {};
/*! \endcond */
//*************************************************************************************************
