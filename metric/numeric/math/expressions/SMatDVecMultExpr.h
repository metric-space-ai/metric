...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SMATDVECMULTEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SMATDVECMULTEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SMatDVecMultExpr : public MatVecMultExpr<DenseVector<SMatDVecMultExpr<MT, VT>, false>>, private Computation {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	*/
	inline bool canSMPAssign() const noexcept { return (size() > SMP_SMATDVECMULT_THRESHOLD); }
	//**********************************************************************************************
  ...
  private:
	...
	*/
	...
	friend inline auto assign(DenseVector<VT1, false> &lhs, const SMatDVecMultExpr &rhs) -> EnableIf_t<UseAssign_v<VT1>>
	{
...
template <typename MT // Type of the left-hand side sparse matrix
		  ...
		  typename VT // Type of the right-hand side dense vector
		  ,
		  DisableIf_t<(IsIdentity_v<MT> && IsSame_v<ElementType_t<MT>, ElementType_t<VT>>) || IsZero_v<MT>> * = nullptr>
inline const SMatDVecMultExpr<MT, VT> smatdvecmult(const SparseMatrix<MT, false> &mat,
...
inline const VT &smatdvecmult(const SparseMatrix<MT, false> &mat, const DenseVector<VT, false> &vec)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
inline decltype(auto) smatdvecmult(const SparseMatrix<MT, false> &mat, const DenseVector<VT, false> &vec)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename MT // Type of the left-hand side sparse matrix
		  ,
		  typename VT> // Type of the right-hand side dense vector
inline decltype(auto) operator*(const SparseMatrix<MT, false> &mat, const DenseVector<VT, false> &vec)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, typename VT> struct IsAligned<SMatDVecMultExpr<MT, VT>> : public IsAligned<VT> {};
/*! \endcond */
//*************************************************************************************************
