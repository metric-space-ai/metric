...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_TSMATDMATSUBEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_TSMATDMATSUBEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class TSMatDMatSubExpr : public MatMatSubExpr<DenseMatrix<TSMatDMatSubExpr<MT1, MT2>, false>>, private Computation {
  private:
	//**Type definitions****************************************************************************
...
inline const TSMatDMatSubExpr<MT1, MT2> tsmatdmatsub(const SparseMatrix<MT1, true> &lhs,
...
inline decltype(auto) tsmatdmatsub(const SparseMatrix<MT1, true> &lhs, const DenseMatrix<MT2, false> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
inline decltype(auto) operator+(const TSMatDMatSubExpr<MT1, MT2> &lhs, const DenseMatrix<MT3, SO> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
