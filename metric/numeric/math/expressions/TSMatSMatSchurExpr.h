...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_TSMATSMATSCHUREXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_TSMATSMATSCHUREXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class TSMatSMatSchurExpr : public SchurExpr<SparseMatrix<TSMatSMatSchurExpr<MT1, MT2>, false>>, private Computation {
  private:
	//**Type definitions****************************************************************************
...
inline const TSMatSMatSchurExpr<MT1, MT2> tsmatsmatschur(const SparseMatrix<MT1, true> &lhs,
...
inline decltype(auto) tsmatsmatschur(const SparseMatrix<MT1, true> &lhs, const SparseMatrix<MT2, false> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
