...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SMATREPEATEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SMATREPEATEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SMatRepeatExpr : public MatRepeatExpr<SparseMatrix<SMatRepeatExpr<MT, SO, CRAs...>, SO>, CRAs...>,
  ...
  public:
	...
	*/
	inline size_t rows() const noexcept { return sm_.rows() * this->template repetitions<0UL>(); }
	//**********************************************************************************************
	...
	*/
	inline size_t columns() const noexcept { return sm_.columns() * this->template repetitions<1UL>(); }
	//**********************************************************************************************
  ...
  private:
	...
	*/
	...
	friend inline void assign(SparseMatrix<MT2, SO2> &lhs, const SMatRepeatExpr &rhs)
	{
		...
		METRIC_NUMERIC_CONSTRAINT_MUST_BE_SPARSE_MATRIX_TYPE(ResultType_t<MT>);
		METRIC_NUMERIC_CONSTRAINT_MUST_BE_SPARSE_MATRIX_TYPE(OppositeType_t<MT>);
		METRIC_NUMERIC_CONSTRAINT_MUST_BE_MATRIX_WITH_STORAGE_ORDER(ResultType_t<MT>, SO);
		METRIC_NUMERIC_CONSTRAINT_MUST_BE_MATRIX_WITH_STORAGE_ORDER(OppositeType_t<MT>, !SO);
		METRIC_NUMERIC_CONSTRAINT_MATRICES_MUST_HAVE_SAME_STORAGE_ORDER(MT2, RemoveReference_t<TmpType>);
		METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(RemoveReference_t<TmpType>);
...
// This function returns an expression representing the repeated sparse matrix:
   ...
   mtrc::numeric::CompressedMatrix<int,rowMajor> A1{ { 1, 0, -2 }, { 0, 5, 0 } };
   mtrc::numeric::CompressedMatrix<int,columnMajor> B1{ { 0, -1 }, { 0, 4 }, { 7, 0 } };

   mtrc::numeric::CompressedMatrix<int,rowMajor> A2;
   mtrc::numeric::CompressedMatrix<int,columnMajor> B2;
