...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SPARSEMATRIX_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SPARSEMATRIX_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SparseMatrix : public Matrix<MT, SO> {
  protected:
...
//@{
template <typename MT, bool SO> typename MT::Iterator find(SparseMatrix<MT, SO> &sm, size_t i, size_t j);

template <typename MT, bool SO> typename MT::ConstIterator find(const SparseMatrix<MT, SO> &sm, size_t i, size_t j);

template <typename MT, bool SO> typename MT::Iterator lowerBound(SparseMatrix<MT, SO> &sm, size_t i, size_t j);

template <typename MT, bool SO>
typename MT::ConstIterator lowerBound(const SparseMatrix<MT, SO> &sm, size_t i, size_t j);

template <typename MT, bool SO> typename MT::Iterator upperBound(SparseMatrix<MT, SO> &sm, size_t i, size_t j);
