...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SMATTSMATADDEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SMATTSMATADDEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SMatTSMatAddExpr : public MatMatAddExpr<SparseMatrix<SMatTSMatAddExpr<MT1, MT2>, IsZero_v<MT1>>>,
						 private Computation {
  private:
	//**Type definitions****************************************************************************
	...
	static constexpr bool UseSymmetricKernel_v = ((StorageOrder_v<T1> != StorageOrder_v<T2>) && IsSymmetric_v<T2>);
	/*! \endcond */
	//**********************************************************************************************
	...
	template <typename MT> static constexpr bool UseSMPAssign_v = MT::smpAssignable;
	/*! \endcond */
	//**********************************************************************************************
  ...
  public:
	...
	*/
	inline size_t nonZeros(size_t i) const { return lhs_.nonZeros(i) + rhs_.nonZeros(i); }
	//**********************************************************************************************
...
template <typename MT1 // Type of the left-hand side sparse matrix
		  ...
		  typename MT2 // Type of the right-hand side sparse matrix
		  ,
		  DisableIf_t<((IsZero_v<MT1> || IsZero_v<MT2>) && IsSame_v<ElementType_t<MT1>, ElementType_t<MT2>>) ||
					  (IsZero_v<MT1> && IsZero_v<MT2>)> * = nullptr>
inline const SMatTSMatAddExpr<MT1, MT2> smattsmatadd(const SparseMatrix<MT1, false> &lhs,
...
template <typename MT1 // Type of the left-hand side sparse matrix
		  ...
		  typename MT2 // Type of the right-hand side sparse matrix
		  ,
		  EnableIf_t<!IsZero_v<MT1> && IsZero_v<MT2> && IsSame_v<ElementType_t<MT1>, ElementType_t<MT2>>> * = nullptr>
inline const MT1 &smattsmatadd(const SparseMatrix<MT1, false> &lhs, const SparseMatrix<MT2, true> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename MT1 // Type of the left-hand side sparse matrix
		  ...
		  ,
		  EnableIf_t<IsZero_v<MT1> && !IsZero_v<MT2> && IsSame_v<ElementType_t<MT1>, ElementType_t<MT2>>> * = nullptr>
inline const MT2 &smattsmatadd(const SparseMatrix<MT1, false> &lhs, const SparseMatrix<MT2, true> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
inline decltype(auto) smattsmatadd(const SparseMatrix<MT1, false> &lhs, const SparseMatrix<MT2, true> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename MT1 // Type of the left-hand side sparse matrix
		  ,
		  typename MT2> // Type of the right-hand side sparse matrix
inline decltype(auto) operator+(const SparseMatrix<MT1, false> &lhs, const SparseMatrix<MT2, true> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename MT1 // Type of the left-hand side sparse matrix
		  ,
		  typename MT2> // Type of the right-hand side sparse matrix
inline decltype(auto) operator+(const SparseMatrix<MT1, true> &lhs, const SparseMatrix<MT2, false> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
