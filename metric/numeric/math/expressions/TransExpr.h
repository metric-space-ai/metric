...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_TRANSEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_TRANSEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
// Metric numeric library have to derive publicly from this class in order to qualify as transposition
...
struct TransExpr : public Expression<T> {};
//*************************************************************************************************
