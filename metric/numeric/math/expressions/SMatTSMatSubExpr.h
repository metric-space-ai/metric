...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SMATTSMATSUBEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SMATTSMATSUBEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SMatTSMatSubExpr : public MatMatSubExpr<SparseMatrix<SMatTSMatSubExpr<MT1, MT2>, IsZero_v<MT1>>>,
						 private Computation {
  private:
	//**Type definitions****************************************************************************
...
inline const SMatTSMatSubExpr<MT1, MT2> smattsmatsub(const SparseMatrix<MT1, false> &lhs,
...
inline const MT1 &smattsmatsub(const SparseMatrix<MT1, false> &lhs, const SparseMatrix<MT2, true> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename MT1 // Type of the left-hand side sparse matrix
		  ...
		  ,
		  EnableIf_t<IsZero_v<MT1> && !IsZero_v<MT2> && IsSame_v<ElementType_t<MT1>, ElementType_t<MT2>>> * = nullptr>
inline decltype(auto) smattsmatsub(const SparseMatrix<MT1, false> &lhs, const SparseMatrix<MT2, true> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
