...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SVECDVECDIVEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SVECDVECDIVEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SVecDVecDivExpr : public VecVecDivExpr<SparseVector<SVecDVecDivExpr<VT1, VT2, TF>, TF>>, private Computation {
  private:
	//**Type definitions****************************************************************************
  ...
  private:
	...
	*/
	...
	friend inline auto assign(DenseVector<VT, TF> &lhs, const SVecDVecDivExpr &rhs) -> EnableIf_t<UseAssign_v<VT>>
	{
	...
	*/
	...
	friend inline auto assign(SparseVector<VT, TF> &lhs, const SVecDVecDivExpr &rhs) -> EnableIf_t<UseAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT> // Type of the target dense vector
	friend inline auto addAssign(DenseVector<VT, TF> &lhs, const SVecDVecDivExpr &rhs) -> EnableIf_t<UseAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT> // Type of the target dense vector
	friend inline auto subAssign(DenseVector<VT, TF> &lhs, const SVecDVecDivExpr &rhs) -> EnableIf_t<UseAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT> // Type of the target dense vector
	friend inline auto multAssign(DenseVector<VT, TF> &lhs, const SVecDVecDivExpr &rhs) -> EnableIf_t<UseAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
...
inline const SVecDVecDivExpr<VT1, VT2, TF> svecdvecdiv(const SparseVector<VT1, TF> &lhs,
...
inline decltype(auto) svecdvecdiv(const SparseVector<VT1, TF> &lhs, const DenseVector<VT2, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
struct Size<SVecDVecDivExpr<VT1, VT2, TF>, 0UL> : public Max_t<Size<VT1, 0UL>, Size<VT2, 0UL>> {};
/*! \endcond */
//*************************************************************************************************
