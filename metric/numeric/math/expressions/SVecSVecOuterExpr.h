...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SVECSVECOUTEREXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SVECSVECOUTEREXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SVecSVecOuterExpr : public VecTVecMultExpr<SparseMatrix<SVecSVecOuterExpr<VT1, VT2>, false>>,
						  private Computation {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	*/
	inline size_t nonZeros(size_t i) const { return (isDefault(lhs_[i])) ? (size_t(0)) : (rhs_.nonZeros(i)); }
	//**********************************************************************************************
...
inline const SVecSVecOuterExpr<VT1, VT2> svecsvecouter(const SparseVector<VT1, false> &lhs,
...
inline decltype(auto) svecsvecouter(const SparseVector<VT1, false> &lhs, const SparseVector<VT2, true> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename VT1 // Type of the left-hand side sparse vector
		  ,
		  typename VT2> // Type of the right-hand side sparse vector
inline decltype(auto) operator*(const SparseVector<VT1, false> &lhs, const SparseVector<VT2, true> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
