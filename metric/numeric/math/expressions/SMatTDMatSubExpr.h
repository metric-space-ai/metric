...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SMATTDMATSUBEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SMATTDMATSUBEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SMatTDMatSubExpr : public MatMatSubExpr<DenseMatrix<SMatTDMatSubExpr<MT1, MT2>, true>>, private Computation {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	*/
	...
	{
		return (lhs_.canAlias(alias)) || (IsExpression_v<MT2> && rhs_.canAlias(alias));
	}
	//**********************************************************************************************
...
template <typename MT1 // Type of the left-hand side sparse matrix
		  ...
		  typename MT2 // Type of the right-hand side dense matrix
		  ,
		  DisableIf_t<IsZero_v<MT1> && IsSame_v<ElementType_t<MT1>, ElementType_t<MT2>>> * = nullptr>
inline const SMatTDMatSubExpr<MT1, MT2> smattdmatsub(const SparseMatrix<MT1, false> &lhs,
...
template <typename MT1 // Type of the left-hand side sparse matrix
		  ...
		  typename MT2 // Type of the right-hand side dense matrix
		  ,
		  EnableIf_t<IsZero_v<MT1> && IsSame_v<ElementType_t<MT1>, ElementType_t<MT2>>> * = nullptr>
inline decltype(auto) smattdmatsub(const SparseMatrix<MT1, false> &lhs, const DenseMatrix<MT2, true> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
inline decltype(auto) operator+(const SMatTDMatSubExpr<MT1, MT2> &lhs, const DenseMatrix<MT3, SO> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
