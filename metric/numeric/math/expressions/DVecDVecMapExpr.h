...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DVECDVECMAPEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DVECDVECMAPEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DVecDVecMapExpr : public VecVecMapExpr<DenseVector<DVecDVecMapExpr<VT1, VT2, OP, TF>, TF>>, private Computation {
  private:
	//**Type definitions****************************************************************************
	...
	template <typename VT> static constexpr bool UseAssign_v = useAssign;
	/*! \endcond */
	//**********************************************************************************************
	...
	static constexpr bool UseSMPAssign_v = ((!VT1::smpAssignable || !VT2::smpAssignable) && useAssign);
	/*! \endcond */
	//**********************************************************************************************
  ...
  public:
	...
	class ConstIterator {
	  public:
		...
		*/
		inline METRIC_NUMERIC_DEVICE_CALLABLE ConstIterator &operator+=(size_t inc)
		{
			left_ += inc;
			right_ += inc;
			return *this;
		...
		*/
		inline METRIC_NUMERIC_DEVICE_CALLABLE ConstIterator &operator-=(size_t dec)
		{
			left_ -= dec;
			right_ -= dec;
			return *this;
		...
		*/
		inline METRIC_NUMERIC_DEVICE_CALLABLE ConstIterator &operator++()
		{
			++left_;
			++right_;
			return *this;
		...
		*/
		inline METRIC_NUMERIC_DEVICE_CALLABLE const ConstIterator operator++(int)
		{
		...
		*/
		inline ReturnType operator*() const { return op_(*left_, *right_); }
		//*******************************************************************************************
		...
		*/
		inline auto load() const noexcept { return op_.load(left_.load(), right_.load()); }
		//*******************************************************************************************
		...
		*/
		inline bool operator==(const ConstIterator &rhs) const { return left_ == rhs.left_; }
		//*******************************************************************************************
		...
		*/
		inline DifferenceType operator-(const ConstIterator &rhs) const { return left_ - rhs.left_; }
		//*******************************************************************************************
	...
	static constexpr bool simdEnabled = (VT1::simdEnabled && VT2::simdEnabled &&
	...
	*/
	...
	{
		METRIC_NUMERIC_INTERNAL_ASSERT(index < lhs_.size(), "Invalid vector access index");
	...
	*/
	inline ConstIterator begin() const { return ConstIterator(lhs_.begin(), rhs_.begin(), op_); }
	//**********************************************************************************************
	...
	*/
	inline ConstIterator end() const { return ConstIterator(lhs_.end(), rhs_.end(), op_); }
	//**********************************************************************************************
	...
	*/
	inline size_t size() const noexcept { return lhs_.size(); }
	//**********************************************************************************************
	...
	*/
	...
	{
		return (IsExpression_v<VT1> && lhs_.canAlias(alias)) || (IsExpression_v<VT2> && rhs_.canAlias(alias));
	}
	//**********************************************************************************************
	...
	*/
	inline bool canSMPAssign() const noexcept { return lhs_.canSMPAssign() && rhs_.canSMPAssign(); }
	//**********************************************************************************************
  ...
  private:
	...
	*/
	...
	friend inline auto assign(DenseVector<VT, TF> &lhs, const DVecDVecMapExpr &rhs) -> EnableIf_t<UseAssign_v<VT>>
	{
		...
		METRIC_NUMERIC_INTERNAL_ASSERT(x.size() == rhs.lhs_.size(), "Invalid vector size");
		METRIC_NUMERIC_INTERNAL_ASSERT(y.size() == rhs.rhs_.size(), "Invalid vector size");
	...
	*/
	...
	friend inline auto assign(SparseVector<VT, TF> &lhs, const DVecDVecMapExpr &rhs) -> EnableIf_t<UseAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT> // Type of the target dense vector
	friend inline auto addAssign(DenseVector<VT, TF> &lhs, const DVecDVecMapExpr &rhs) -> EnableIf_t<UseAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT> // Type of the target dense vector
	friend inline auto subAssign(DenseVector<VT, TF> &lhs, const DVecDVecMapExpr &rhs) -> EnableIf_t<UseAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT> // Type of the target dense vector
	friend inline auto multAssign(DenseVector<VT, TF> &lhs, const DVecDVecMapExpr &rhs) -> EnableIf_t<UseAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT> // Type of the target dense vector
	friend inline auto divAssign(DenseVector<VT, TF> &lhs, const DVecDVecMapExpr &rhs) -> EnableIf_t<UseAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT> // Type of the target dense vector
	friend inline auto smpAssign(DenseVector<VT, TF> &lhs, const DVecDVecMapExpr &rhs) -> EnableIf_t<UseSMPAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT> // Type of the target sparse vector
	friend inline auto smpAssign(SparseVector<VT, TF> &lhs, const DVecDVecMapExpr &rhs)
	...
	*/
	template <typename VT> // Type of the target dense vector
	friend inline auto smpAddAssign(DenseVector<VT, TF> &lhs, const DVecDVecMapExpr &rhs)
		-> EnableIf_t<UseSMPAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT> // Type of the target dense vector
	friend inline auto smpSubAssign(DenseVector<VT, TF> &lhs, const DVecDVecMapExpr &rhs)
		-> EnableIf_t<UseSMPAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT> // Type of the target dense vector
	friend inline auto smpMultAssign(DenseVector<VT, TF> &lhs, const DVecDVecMapExpr &rhs)
		-> EnableIf_t<UseSMPAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT> // Type of the target dense vector
	friend inline auto smpDivAssign(DenseVector<VT, TF> &lhs, const DVecDVecMapExpr &rhs)
		-> EnableIf_t<UseSMPAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	//**Compile time checks*************************************************************************
	/*! \cond METRIC_NUMERIC_INTERNAL */
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_DENSE_VECTOR_TYPE(VT1);
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_DENSE_VECTOR_TYPE(VT2);
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_VECTOR_WITH_TRANSPOSE_FLAG(VT1, TF);
...
// The following example demonstrates the use of the \a map() function:
   ...
   \code
   mtrc::numeric::DynamicVector<double> a, b, c;
...
template <typename VT1 // Type of the left-hand side dense vector
		  ...
		  ,
		  typename OP> // Type of the custom operation
inline decltype(auto) map(const DenseVector<VT1, TF> &lhs, const DenseVector<VT2, TF> &rhs, OP op)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename VT1 // Type of the first dense vector
		  ...
		  ,
		  typename OP> // Type of the custom operation
inline decltype(auto) map(const DenseVector<VT1, TF> &dv1, const DenseVector<VT2, TF> &dv2,
...
template <typename VT1 // Type of the left-hand side dense vector
		  ...
		  ,
		  bool TF> // Transpose flag
inline decltype(auto) min(const DenseVector<VT1, TF> &lhs, const DenseVector<VT2, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename VT1 // Type of the left-hand side dense vector
		  ...
		  ,
		  bool TF> // Transpose flag
inline decltype(auto) max(const DenseVector<VT1, TF> &lhs, const DenseVector<VT2, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename VT1 // Type of the left-hand side dense vector
		  ...
		  ,
		  bool TF> // Transpose flag
inline decltype(auto) hypot(const DenseVector<VT1, TF> &lhs, const DenseVector<VT2, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename VT1 // Type of the left-hand side dense vector
		  ...
		  ,
		  bool TF> // Transpose flag
inline decltype(auto) pow(const DenseVector<VT1, TF> &lhs, const DenseVector<VT2, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename VT1 // Type of the left-hand side dense vector
		  ...
		  ,
		  bool TF> // Transpose flag
inline decltype(auto) atan2(const DenseVector<VT1, TF> &lhs, const DenseVector<VT2, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
// The following example demonstrates the use of the \a selec() function:
   ...
   \code
   mtrc::numeric::DynamicVector<bool> cond{ true, false, true false };
   mtrc::numeric::DynamicVector<int> a{ 1, -1, 1, -1 };
   mtrc::numeric::DynamicVector<int> b{ -2, 2, -2, 2 };
   mtrc::numeric::DynamicVector<int> c;
   // ... Resizing and initialization
...
template <typename VT1 // Type of the conditional dense vector
		  ...
		  ,
		  bool TF> // Transpose flag
inline decltype(auto) select(const DenseVector<VT1, TF> &cond, const DenseVector<VT2, TF> &lhs,
...
// This operator represents the elementwise left-shift of a given dense vector:
   ...
   \code
   mtrc::numeric::DynamicVector<unsigned int> a, b, c;
   // ... Resizing and initialization
   c = a << b;
   \endcode
...
template <typename VT1 // Type of the left-hand side dense vector
		  ...
		  ,
		  bool TF> // Transpose flag
inline decltype(auto) operator<<(const DenseVector<VT1, TF> &lhs, const DenseVector<VT2, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename VT1 // Type of the left-hand side dense vector
		  ...
		  ,
		  bool TF> // Transpose flag
inline decltype(auto) operator<<(const DVecDVecMapExpr<VT1, VT2, ShiftLV, TF> &lhs, const DenseVector<VT3, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename VT1 // Type of the left-hand side dense vector
		  ...
		  ,
		  bool TF> // Transpose flag
inline decltype(auto) operator>>(const DVecDVecMapExpr<VT1, VT2, ShiftRV, TF> &lhs, const DenseVector<VT3, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
// This operator represents the logical AND of the given two dense vectors:
   ...
   \code
   mtrc::numeric::DynamicVector<bool> a, b, c;
   // ... Resizing and initialization
   c = a && b;
   \endcode
...
//*************************************************************************************************
/*!\brief Logical OR operator for two dense vectors.
// \ingroup dense_vector
//
// \param lhs The left-hand side dense vector for the logical OR operation.
// \param rhs The right-hand side dense vector for the logical OR operation.
// \return The resulting dense vector.
// \exception std::invalid_argument Vector sizes do not match.
//
...
struct IsAligned<DVecDVecMapExpr<VT1, VT2, OP, TF>> : public BoolConstant<IsAligned_v<VT1> && IsAligned_v<VT2>> {};
/*! \endcond */
//*************************************************************************************************
