...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DVECDVECMULTEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DVECDVECMULTEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DVecDVecMultExpr : public VecVecMultExpr<DenseVector<DVecDVecMultExpr<VT1, VT2, TF>, TF>>, private Computation {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	static constexpr bool simdEnabled = (VT1::simdEnabled && VT2::simdEnabled && HasSIMDMult_v<ET1, ET2>);
	...
	*/
	...
	{
		return lhs_.canSMPAssign() || rhs_.canSMPAssign() || (size() > SMP_DVECDVECMULT_THRESHOLD);
	}
	//**********************************************************************************************
  ...
  private:
	...
	*/
	...
	friend inline auto assign(SparseVector<VT, TF> &lhs, const DVecDVecMultExpr &rhs) -> EnableIf_t<UseAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT> // Type of the target dense vector
	friend inline auto addAssign(DenseVector<VT, TF> &lhs, const DVecDVecMultExpr &rhs) -> EnableIf_t<UseAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT> // Type of the target dense vector
	friend inline auto subAssign(DenseVector<VT, TF> &lhs, const DVecDVecMultExpr &rhs) -> EnableIf_t<UseAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT> // Type of the target dense vector
	friend inline auto divAssign(DenseVector<VT, TF> &lhs, const DVecDVecMultExpr &rhs) -> EnableIf_t<UseAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_FORM_VALID_VECVECMULTEXPR(VT1, VT2);
	/*! \endcond */
	//**********************************************************************************************
};
//*************************************************************************************************
...
struct IsAligned<DVecDVecMultExpr<VT1, VT2, TF>> : public BoolConstant<IsAligned_v<VT1> && IsAligned_v<VT2>> {};
/*! \endcond */
//*************************************************************************************************
...
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename VT1, typename VT2, bool TF>
struct IsPadded<DVecDVecMultExpr<VT1, VT2, TF>> : public BoolConstant<IsPadded_v<VT1> && IsPadded_v<VT2>> {};
/*! \endcond */
//*************************************************************************************************
