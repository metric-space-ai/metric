...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DMATDECLUPPEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DMATDECLUPPEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DMatDeclUppExpr : public DeclUppExpr<DenseMatrix<DMatDeclUppExpr<MT, SO>, SO>>, public Declaration<MT> {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	*/
	explicit inline DMatDeclUppExpr(const MT &dm) noexcept : dm_(dm) // Dense matrix of the declupp expression
	{
  ...
  private:
	...
	*/
	...
	friend inline auto assign(DenseMatrix<MT2, SO2> &lhs, const DMatDeclUppExpr &rhs) -> EnableIf_t<UseAssign_v<MT2>>
	{
	...
	*/
	template <typename MT2 // Type of the target sparse matrix
			  ,
			  bool SO2> // Storage order of the target dense matrix
	friend inline auto assign(SparseMatrix<MT2, SO2> &lhs, const DMatDeclUppExpr &rhs) -> EnableIf_t<UseAssign_v<MT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename MT2 // Type of the target dense matrix
			  ,
			  bool SO2> // Storage order of the target dense matrix
	friend inline auto addAssign(DenseMatrix<MT2, SO2> &lhs, const DMatDeclUppExpr &rhs) -> EnableIf_t<UseAssign_v<MT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename MT2 // Type of the target dense matrix
			  ,
			  bool SO2> // Storage order of the target dense matrix
	friend inline auto subAssign(DenseMatrix<MT2, SO2> &lhs, const DMatDeclUppExpr &rhs) -> EnableIf_t<UseAssign_v<MT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_UNILOWER_MATRIX_TYPE(MT);
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO> struct HasConstDataAccess<DMatDeclUppExpr<MT, SO>> : public HasConstDataAccess<MT> {};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO> struct IsAligned<DMatDeclUppExpr<MT, SO>> : public IsAligned<MT> {};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO> struct IsUpper<DMatDeclUppExpr<MT, SO>> : public TrueType {};
/*! \endcond */
//*************************************************************************************************
