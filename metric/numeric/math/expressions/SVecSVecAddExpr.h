...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SVECSVECADDEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SVECSVECADDEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SVecSVecAddExpr : public VecVecAddExpr<SparseVector<SVecSVecAddExpr<VT1, VT2, TF>, TF>>, private Computation {
  private:
	//**Type definitions****************************************************************************
	...
	template <typename VT> static constexpr bool UseSMPAssign_v = VT::smpAssignable;
	/*! \endcond */
	//**********************************************************************************************
  ...
  public:
	...
	*/
	inline size_t nonZeros() const { return min(lhs_.size(), lhs_.nonZeros() + rhs_.nonZeros()); }
	//**********************************************************************************************
...
template <typename VT1 // Type of the left-hand side sparse vector
		  ...
		  bool TF // Transpose flag
		  ,
		  DisableIf_t<((IsZero_v<VT1> || IsZero_v<VT2>) && IsSame_v<ElementType_t<VT1>, ElementType_t<VT2>>) ||
					  (IsZero_v<VT1> && IsZero_v<VT2>)> * = nullptr>
inline const SVecSVecAddExpr<VT1, VT2, TF> svecsvecadd(const SparseVector<VT1, TF> &lhs,
...
template <typename VT1 // Type of the left-hand side sparse vector
		  ...
		  bool TF // Transpose flag
		  ,
		  EnableIf_t<!IsZero_v<VT1> && IsZero_v<VT2> && IsSame_v<ElementType_t<VT1>, ElementType_t<VT2>>> * = nullptr>
inline const VT1 &svecsvecadd(const SparseVector<VT1, TF> &lhs, const SparseVector<VT2, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename VT1 // Type of the left-hand side sparse vector
		  ...
		  ,
		  EnableIf_t<IsZero_v<VT1> && !IsZero_v<VT2> && IsSame_v<ElementType_t<VT1>, ElementType_t<VT2>>> * = nullptr>
inline const VT2 &svecsvecadd(const SparseVector<VT1, TF> &lhs, const SparseVector<VT2, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
inline decltype(auto) svecsvecadd(const SparseVector<VT1, TF> &lhs, const SparseVector<VT2, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
// This operator represents the addition of two sparse vectors:
   ...
   \code
   mtrc::numeric::CompressedVector<double> a, b, c;
...
template <typename VT1 // Type of the left-hand side sparse vector
		  ...
		  ,
		  bool TF> // Transpose flag
inline decltype(auto) operator+(const SparseVector<VT1, TF> &lhs, const SparseVector<VT2, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
