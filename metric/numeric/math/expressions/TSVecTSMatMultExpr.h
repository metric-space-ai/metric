...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_TSVECTSMATMULTEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_TSVECTSMATMULTEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class TSVecTSMatMultExpr : public TVecMatMultExpr<SparseVector<TSVecTSMatMultExpr<VT, MT>, true>>, private Computation {
  private:
	//**Type definitions****************************************************************************
...
inline const TSVecTSMatMultExpr<VT, MT> tsvectsmatmult(const SparseVector<VT, true> &vec,
...
inline decltype(auto) tsvectsmatmult(const SparseVector<VT, true> &vec, const SparseMatrix<MT, true> &mat)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
inline const VT &tsvectsmatmult(const SparseVector<VT, true> &vec, const SparseMatrix<MT, true> &mat)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename VT // Type of the left-hand side sparse vector
		  ,
		  typename MT> // Type of the right-hand side sparse matrix
inline decltype(auto) operator*(const SparseVector<VT, true> &vec, const SparseMatrix<MT, true> &mat)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
