...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SVECMAPEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SVECMAPEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SVecMapExpr : public VecMapExpr<SparseVector<SVecMapExpr<VT, OP, TF>, TF>>, private Computation {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	*/
	inline ConstIterator begin() const { return ConstIterator(sv_.begin(), op_); }
	//**********************************************************************************************
	...
	*/
	inline ConstIterator end() const { return ConstIterator(sv_.end(), op_); }
	//**********************************************************************************************
  ...
  private:
	...
	*/
	...
	friend inline auto assign(DenseVector<VT2, TF> &lhs, const SVecMapExpr &rhs) -> EnableIf_t<UseAssign_v<VT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;

		METRIC_NUMERIC_CONSTRAINT_MUST_BE_SPARSE_VECTOR_TYPE(RT);
	...
	*/
	template <typename VT2> // Type of the target dense vector
	friend inline auto addAssign(DenseVector<VT2, TF> &lhs, const SVecMapExpr &rhs) -> EnableIf_t<UseAssign_v<VT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT2> // Type of the target dense vector
	friend inline auto subAssign(DenseVector<VT2, TF> &lhs, const SVecMapExpr &rhs) -> EnableIf_t<UseAssign_v<VT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT2> // Type of the target dense vector
	friend inline auto multAssign(DenseVector<VT2, TF> &lhs, const SVecMapExpr &rhs) -> EnableIf_t<UseAssign_v<VT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT2> // Type of the target dense vector
	friend inline auto smpAssign(DenseVector<VT2, TF> &lhs, const SVecMapExpr &rhs) -> EnableIf_t<UseSMPAssign_v<VT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
...
// The following example demonstrates the use of the \a ctrans() function:
   ...
   \code
   mtrc::numeric::CompressedVector< complex<double> > a, b;
   // ... Resizing and initialization
   b = ctrans( a );
   \endcode
...
inline decltype(auto) pow(const SparseVector<VT, TF> &sv, ST exp)
{
	...
	return map(*sv, mtrc::numeric::bind2nd(Pow(), ScalarType(exp)));
}
//*************************************************************************************************
