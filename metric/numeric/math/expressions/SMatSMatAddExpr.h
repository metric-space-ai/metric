...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SMATSMATADDEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SMATSMATADDEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SMatSMatAddExpr : public MatMatAddExpr<SparseMatrix<SMatSMatAddExpr<MT1, MT2>, false>>, private Computation {
  private:
	//**Type definitions****************************************************************************
	...
	static constexpr bool UseSymmetricKernel_v = (IsColumnMajorMatrix_v<T1> && IsSymmetric_v<T2> && IsSymmetric_v<T3>);
	/*! \endcond */
	//**********************************************************************************************
...
inline const SMatSMatAddExpr<MT1, MT2> smatsmatadd(const SparseMatrix<MT1, false> &lhs,
...
inline const MT1 &smatsmatadd(const SparseMatrix<MT1, false> &lhs, const SparseMatrix<MT2, false> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename MT1 // Type of the left-hand side sparse matrix
		  ...
		  ,
		  EnableIf_t<IsZero_v<MT1> && !IsZero_v<MT2> && IsSame_v<ElementType_t<MT1>, ElementType_t<MT2>>> * = nullptr>
inline const MT2 &smatsmatadd(const SparseMatrix<MT1, false> &lhs, const SparseMatrix<MT2, false> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
inline decltype(auto) smatsmatadd(const SparseMatrix<MT1, false> &lhs, const SparseMatrix<MT2, false> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
