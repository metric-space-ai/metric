...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DMATSMATADDEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DMATSMATADDEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DMatSMatAddExpr : public MatMatAddExpr<DenseMatrix<DMatSMatAddExpr<MT1, MT2, SO>, SO>>, private Computation {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	*/
	inline LeftOperand leftOperand() const { return lhs_; }
	//**********************************************************************************************
...
inline const DMatSMatAddExpr<MT1, MT2, SO> dmatsmatadd(const DenseMatrix<MT1, SO> &lhs,
...
inline const MT1 &dmatsmatadd(const DenseMatrix<MT1, SO> &lhs, const SparseMatrix<MT2, SO> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
// This operator represents the addition of a dense matrix and a sparse matrix:
   ...
   \code
   mtrc::numeric::DynamicMatrix<double> A, C;
...
template <typename MT1 // Type of the left-hand side dense matrix
		  ...
		  ,
		  bool SO> // Storage order
inline decltype(auto) operator+(const DenseMatrix<MT1, SO> &lhs, const SparseMatrix<MT2, SO> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
// This operator represents the addition of a sparse matrix and a dense matrix:
   ...
   mtrc::numeric::DynamicMatrix<double> B, C;
   // ... Resizing and initialization
   C = A + B;
   \endcode
...
template <typename MT1 // Type of the left-hand side sparse matrix
		  ...
		  ,
		  bool SO> // Storage order
inline decltype(auto) operator+(const SparseMatrix<MT1, SO> &lhs, const DenseMatrix<MT2, SO> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
inline decltype(auto) operator+(const DMatSMatAddExpr<MT1, MT2, SO1> &lhs, const DenseMatrix<MT3, SO2> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
