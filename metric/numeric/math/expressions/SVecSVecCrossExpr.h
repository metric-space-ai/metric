...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SVECSVECCROSSEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SVECSVECCROSSEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SVecSVecCrossExpr : public CrossExpr<DenseVector<SVecSVecCrossExpr<VT1, VT2, TF>, TF>>, private Computation {
  private:
	//**Type definitions****************************************************************************
...
inline const SVecSVecCrossExpr<VT1, VT2, TF> svecsveccross(const SparseVector<VT1, TF> &lhs,
...
inline decltype(auto) svecsveccross(const SparseVector<VT1, TF> &lhs, const SparseVector<VT2, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
// This operator represents the cross product of two sparse vectors:
   ...
   \code
   mtrc::numeric::CompressedVector<double> a( 3UL ), b( 3UL );
