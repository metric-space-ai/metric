...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_TSVECSMATMULTEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_TSVECSMATMULTEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class TSVecSMatMultExpr : public TVecMatMultExpr<SparseVector<TSVecSMatMultExpr<VT, MT>, true>>, private Computation {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	*/
	inline size_t nonZeros() const { return mat_.columns(); }
	//**********************************************************************************************
	...
	*/
	inline bool canSMPAssign() const noexcept { return (size() > SMP_TSVECSMATMULT_THRESHOLD); }
	//**********************************************************************************************
...
template <typename VT // Type of the left-hand side sparse vector
		  ...
		  typename MT // Type of the right-hand side sparse matrix
		  ,
		  DisableIf_t<(IsIdentity_v<MT> && IsSame_v<ElementType_t<VT>, ElementType_t<MT>>) ||
					  (IsZero_v<MT> || IsZero_v<VT>)> * = nullptr>
inline const TSVecSMatMultExpr<VT, MT> tsvecsmatmult(const SparseVector<VT, true> &vec,
...
template <typename VT // Type of the left-hand side sparse vector
		  ...
		  typename MT // Type of the right-hand side sparse matrix
		  ,
		  EnableIf_t<(IsIdentity_v<MT> && IsSame_v<ElementType_t<VT>, ElementType_t<MT>>) && !IsZero_v<VT>> * = nullptr>
inline const VT &tsvecsmatmult(const SparseVector<VT, true> &vec, const SparseMatrix<MT, false> &mat)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
inline decltype(auto) tsvecsmatmult(const SparseVector<VT, true> &vec, const SparseMatrix<MT, false> &mat)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename VT // Type of the left-hand side sparse vector
		  ,
		  typename MT> // Type of the right-hand side sparse matrix
inline decltype(auto) operator*(const SparseVector<VT, true> &vec, const SparseMatrix<MT, false> &mat)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
