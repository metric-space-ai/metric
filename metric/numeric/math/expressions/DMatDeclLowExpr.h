...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DMATDECLLOWEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DMATDECLLOWEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DMatDeclLowExpr : public DeclLowExpr<DenseMatrix<DMatDeclLowExpr<MT, SO>, SO>>, public Declaration<MT> {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	*/
	explicit inline DMatDeclLowExpr(const MT &dm) noexcept : dm_(dm) // Dense matrix of the decllow expression
	{
  ...
  private:
	...
	*/
	...
	friend inline auto assign(DenseMatrix<MT2, SO2> &lhs, const DMatDeclLowExpr &rhs) -> EnableIf_t<UseAssign_v<MT2>>
	{
	...
	*/
	template <typename MT2 // Type of the target sparse matrix
			  ,
			  bool SO2> // Storage order of the target dense matrix
	friend inline auto assign(SparseMatrix<MT2, SO2> &lhs, const DMatDeclLowExpr &rhs) -> EnableIf_t<UseAssign_v<MT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename MT2 // Type of the target dense matrix
			  ,
			  bool SO2> // Storage order of the target dense matrix
	friend inline auto addAssign(DenseMatrix<MT2, SO2> &lhs, const DMatDeclLowExpr &rhs) -> EnableIf_t<UseAssign_v<MT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename MT2 // Type of the target dense matrix
			  ,
			  bool SO2> // Storage order of the target dense matrix
	friend inline auto subAssign(DenseMatrix<MT2, SO2> &lhs, const DMatDeclLowExpr &rhs) -> EnableIf_t<UseAssign_v<MT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_UNIUPPER_MATRIX_TYPE(MT);
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO> struct HasConstDataAccess<DMatDeclLowExpr<MT, SO>> : public HasConstDataAccess<MT> {};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO> struct IsAligned<DMatDeclLowExpr<MT, SO>> : public IsAligned<MT> {};
/*! \endcond */
//*************************************************************************************************
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
template <typename MT, bool SO> struct IsLower<DMatDeclLowExpr<MT, SO>> : public TrueType {};
/*! \endcond */
//*************************************************************************************************
