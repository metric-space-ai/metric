...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SVECEXPANDEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SVECEXPANDEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SVecExpandExpr : public VecExpandExpr<SparseMatrix<SVecExpandExpr<VT, TF, CEAs...>, !TF>, CEAs...>,
  ...
  private:
	...
	/*! This variable template is a helper for the selection of the parallel evaluation strategy.
		...
		chosen. */
	template <typename MT> static constexpr bool UseSMPAssign_v = (MT::smpAssignable && useAssign);
	/*! \endcond */
	//**********************************************************************************************
  ...
  public:
	...
	*/
	inline ReturnType operator()(size_t i, size_t j) const
	{
		if (TF) {
			...
			METRIC_NUMERIC_INTERNAL_ASSERT(j < sv_.size(), "Invalid column access index");
			return sv_[j];
		} else {
			METRIC_NUMERIC_INTERNAL_ASSERT(i < sv_.size(), "Invalid row access index");
	...
	*/
	inline size_t rows() const noexcept { return (TF ? expansion() : sv_.size()); }
	//**********************************************************************************************
	...
	*/
	inline size_t columns() const noexcept { return (TF ? sv_.size() : expansion()); }
	//**********************************************************************************************
	...
	*/
	inline size_t nonZeros() const { return sv_.nonZeros() * expansion(); }
	//**********************************************************************************************
	...
	*/
	template <typename T> inline bool canAlias(const T *alias) const noexcept { return sv_.isAliased(alias); }
	//**********************************************************************************************
  ...
  private:
	...
	*/
	...
	friend inline auto assign(Matrix<MT, SO> &lhs, const SVecExpandExpr &rhs) -> EnableIf_t<UseAssign_v<MT>>
	{
	...
	*/
	template <typename MT // Type of the target dense matrix
			  ,
			  bool SO> // Storage order of the target dense matrix
	friend inline auto addAssign(Matrix<MT, SO> &lhs, const SVecExpandExpr &rhs) -> EnableIf_t<UseAssign_v<MT>>
	{
		using mtrc::numeric::expand;
	...
	*/
	template <typename MT // Type of the target dense matrix
			  ,
			  bool SO> // Storage order of the target dense matrix
	friend inline auto subAssign(Matrix<MT, SO> &lhs, const SVecExpandExpr &rhs) -> EnableIf_t<UseAssign_v<MT>>
	{
		using mtrc::numeric::expand;
	...
	*/
	template <typename MT // Type of the target dense matrix
			  ,
			  bool SO> // Storage order of the target dense matrix
	friend inline auto schurAssign(Matrix<MT, SO> &lhs, const SVecExpandExpr &rhs) -> EnableIf_t<UseAssign_v<MT>>
	{
		using mtrc::numeric::expand;
	...
	*/
	template <typename MT // Type of the target dense matrix
			  ,
			  bool SO> // Storage order of the target dense matrix
	friend inline auto multAssign(Matrix<MT, SO> &lhs, const SVecExpandExpr &rhs) -> EnableIf_t<UseAssign_v<MT>>
	{
		using mtrc::numeric::expand;
	...
	*/
	...
	friend inline auto smpAssign(Matrix<MT, SO> &lhs, const SVecExpandExpr &rhs) -> EnableIf_t<UseSMPAssign_v<MT>>
	{
		using mtrc::numeric::expand;
	...
	*/
	template <typename MT // Type of the target matrix
			  ,
			  bool SO> // Storage order of the target matrix
	friend inline auto smpAddAssign(Matrix<MT, SO> &lhs, const SVecExpandExpr &rhs) -> EnableIf_t<UseSMPAssign_v<MT>>
	{
		using mtrc::numeric::expand;
	...
	*/
	template <typename MT // Type of the target matrix
			  ,
			  bool SO> // Storage order of the target matrix
	friend inline auto smpSubAssign(Matrix<MT, SO> &lhs, const SVecExpandExpr &rhs) -> EnableIf_t<UseSMPAssign_v<MT>>
	{
		using mtrc::numeric::expand;
	...
	*/
	template <typename MT // Type of the target matrix
			  ,
			  bool SO> // Storage order of the target matrix
	friend inline auto smpSchurAssign(Matrix<MT, SO> &lhs, const SVecExpandExpr &rhs) -> EnableIf_t<UseSMPAssign_v<MT>>
	{
		using mtrc::numeric::expand;
	...
	*/
	template <typename MT // Type of the target matrix
			  ,
			  bool SO> // Storage order of the target matrix
	friend inline auto smpMultAssign(Matrix<MT, SO> &lhs, const SVecExpandExpr &rhs) -> EnableIf_t<UseSMPAssign_v<MT>>
	{
		using mtrc::numeric::expand;
...
// This function returns an expression representing the expansion of the given sparse vector:
   ...
   mtrc::numeric::CompressedVector<int,columnVector> a{ 1, 0, -2, 0 }
   mtrc::numeric::CompressedVector<int,rowVector> b{ 0, -1, 7, 0 }
