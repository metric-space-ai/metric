...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DMATDMATKRONEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DMATDMATKRONEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DMatDMatKronExpr : public MatMatKronExpr<DenseMatrix<DMatDMatKronExpr<MT1, MT2, SO>, SO>>, private Computation {
  private:
	//**Type definitions****************************************************************************
...
inline decltype(auto) kron(const DenseMatrix<MT1, SO1> &lhs, const DenseMatrix<MT2, SO2> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
