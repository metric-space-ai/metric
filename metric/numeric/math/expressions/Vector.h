...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_VECTOR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_VECTOR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
// vector classes within the Metric numeric library. It provides an abstraction from the actual type of
...
class Vector {
  public:
	...
	//@{
	[[deprecated]] METRIC_NUMERIC_ALWAYS_INLINE constexpr VT &operator~() noexcept;
	[[deprecated]] METRIC_NUMERIC_ALWAYS_INLINE constexpr const VT &operator~() const noexcept;
...
template <typename VT // Type of the vector
		  ,
		  bool TF> // Transpose flag
[[deprecated]] METRIC_NUMERIC_ALWAYS_INLINE constexpr VT &Vector<VT, TF>::operator~() noexcept
{
...
template <typename VT // Type of the vector
		  ,
		  bool TF> // Transpose flag
[[deprecated]] METRIC_NUMERIC_ALWAYS_INLINE constexpr const VT &Vector<VT, TF>::operator~() const noexcept
{
...
template <typename VT // Type of the vector
		  ,
		  bool TF> // Transpose flag
METRIC_NUMERIC_ALWAYS_INLINE constexpr VT &Vector<VT, TF>::operator*() noexcept
{
	return static_cast<VT &>(*this);
}
//*************************************************************************************************
...
template <typename VT // Type of the vector
		  ,
		  bool TF> // Transpose flag
METRIC_NUMERIC_ALWAYS_INLINE constexpr const VT &Vector<VT, TF>::operator*() const noexcept
{
	return static_cast<const VT &>(*this);
}
//*************************************************************************************************
...
//@{
template <typename VT, bool TF> VT &crtp_cast(Vector<VT, TF> &vector);

template <typename VT, bool TF> const VT &crtp_cast(const Vector<VT, TF> &vector);

template <typename VT, bool TF> typename VT::Iterator begin(Vector<VT, TF> &vector);

template <typename VT, bool TF> typename VT::ConstIterator begin(const Vector<VT, TF> &vector);

template <typename VT, bool TF> typename VT::ConstIterator cbegin(const Vector<VT, TF> &vector);

template <typename VT, bool TF> typename VT::Iterator end(Vector<VT, TF> &vector);

template <typename VT, bool TF> typename VT::ConstIterator end(const Vector<VT, TF> &vector);

template <typename VT, bool TF> typename VT::ConstIterator cend(const Vector<VT, TF> &vector);

template <typename VT, bool TF> constexpr size_t size(const Vector<VT, TF> &vector) noexcept;

template <typename VT, bool TF> size_t capacity(const Vector<VT, TF> &vector) noexcept;

template <typename VT, bool TF> size_t nonZeros(const Vector<VT, TF> &vector);

template <typename VT, bool TF> constexpr void reset(Vector<VT, TF> &vector);

template <typename VT, bool TF> constexpr void reset(Vector<VT, TF> &&vector);

template <typename VT, bool TF> constexpr void clear(Vector<VT, TF> &vector);

template <typename VT, bool TF> constexpr void clear(Vector<VT, TF> &&vector);

template <typename VT, bool TF> void resize(Vector<VT, TF> &vector, size_t n, bool preserve = true);

template <typename VT, bool TF> void shrinkToFit(Vector<VT, TF> &vector);

template <typename VT, bool TF> typename VT::ResultType evaluate(const Vector<VT, TF> &vector);

template <bool B, typename VT, bool TF> decltype(auto) evaluateIf(const Vector<VT, TF> &vector);

template <typename VT, bool TF> constexpr bool isEmpty(const Vector<VT, TF> &vector) noexcept;
...
METRIC_NUMERIC_ALWAYS_INLINE VT &crtp_cast(Vector<VT, TF> &vector)
{
	return *vector;
}
//*************************************************************************************************
...
template <typename VT // Type of the vector
		  ,
		  bool TF> // Transpose flag of the vector
METRIC_NUMERIC_ALWAYS_INLINE const VT &crtp_cast(const Vector<VT, TF> &vector)
{
	return *vector;
}
//*************************************************************************************************
...
template <typename VT // Type of the vector
		  ,
		  bool TF> // Transpose flag of the vector
METRIC_NUMERIC_ALWAYS_INLINE typename VT::Iterator begin(Vector<VT, TF> &vector)
{
	return (*vector).begin();
}
//*************************************************************************************************
...
template <typename VT // Type of the vector
		  ,
		  bool TF> // Transpose flag of the vector
METRIC_NUMERIC_ALWAYS_INLINE typename VT::ConstIterator begin(const Vector<VT, TF> &vector)
{
	return (*vector).begin();
}
//*************************************************************************************************
...
template <typename VT // Type of the vector
		  ,
		  bool TF> // Transpose flag of the vector
METRIC_NUMERIC_ALWAYS_INLINE typename VT::ConstIterator cbegin(const Vector<VT, TF> &vector)
{
	return (*vector).begin();
}
//*************************************************************************************************
...
template <typename VT // Type of the vector
		  ,
		  bool TF> // Transpose flag of the vector
METRIC_NUMERIC_ALWAYS_INLINE typename VT::Iterator end(Vector<VT, TF> &vector)
{
	return (*vector).end();
}
//*************************************************************************************************
...
template <typename VT // Type of the vector
		  ,
		  bool TF> // Transpose flag of the vector
METRIC_NUMERIC_ALWAYS_INLINE typename VT::ConstIterator end(const Vector<VT, TF> &vector)
{
	return (*vector).end();
}
//*************************************************************************************************
...
template <typename VT // Type of the vector
		  ,
		  bool TF> // Transpose flag of the vector
METRIC_NUMERIC_ALWAYS_INLINE typename VT::ConstIterator cend(const Vector<VT, TF> &vector)
{
	return (*vector).end();
}
//*************************************************************************************************
...
template <typename VT // Type of the vector
		  ,
		  bool TF> // Transpose flag of the vector
METRIC_NUMERIC_ALWAYS_INLINE constexpr size_t size(const Vector<VT, TF> &vector) noexcept
{
	return (*vector).size();
}
//*************************************************************************************************
...
template <typename VT // Type of the vector
		  ,
		  bool TF> // Transpose flag of the vector
METRIC_NUMERIC_ALWAYS_INLINE size_t capacity(const Vector<VT, TF> &vector) noexcept
{
...
template <typename VT // Type of the vector
		  ,
		  bool TF> // Transpose flag of the vector
METRIC_NUMERIC_ALWAYS_INLINE size_t nonZeros(const Vector<VT, TF> &vector)
{
...
template <typename VT // Type of the vector
		  ,
		  bool TF> // Transpose flag of the vector
constexpr auto reset_backend(Vector<VT, TF> &vector) -> DisableIf_t<IsZero_v<VT>>
{
	(*vector).reset();
}
/*! \endcond */
...
template <typename VT // Type of the vector
		  ,
		  bool TF> // Transpose flag of the vector
constexpr auto reset_backend(Vector<VT, TF> &vector) -> EnableIf_t<IsZero_v<VT>>
{
	MAYBE_UNUSED(vector);
}
/*! \endcond */
...
template <typename VT // Type of the vector
		  ,
		  bool TF> // Transpose flag of the vector
constexpr auto clear_backend(Vector<VT, TF> &vector) -> DisableIf_t<IsClearable_v<VT>>
{
	(*vector).reset();
}
/*! \endcond */
...
template <typename VT // Type of the vector
		  ,
		  bool TF> // Transpose flag of the vector
constexpr auto clear_backend(Vector<VT, TF> &vector) -> EnableIf_t<IsClearable_v<VT>>
{
	(*vector).clear();
}
/*! \endcond */
...
template <typename VT // Type of the vector
		  ,
		  bool TF> // Transpose flag of the vector
METRIC_NUMERIC_ALWAYS_INLINE auto resize_backend(Vector<VT, TF> &vector, size_t n, bool preserve)
	-> DisableIf_t<IsResizable_v<VT>>
{
	MAYBE_UNUSED(preserve);

	if ((*vector).size() != n) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Vector cannot be resized");
	}
}
/*! \endcond */
//*************************************************************************************************
...
// identical to the current size of the vector, a \a std::invalid_argument exception is thrown.
   ...
   \code
   mtrc::numeric::DynamicVector<int> a( 3UL );
   resize( a, 5UL );  // OK: regular resize operation

   mtrc::numeric::StaticVector<int,3UL> b;
...
template <typename VT // Type of the vector
		  ,
		  bool TF> // Transpose flag of the vector
METRIC_NUMERIC_ALWAYS_INLINE void resize(Vector<VT, TF> &vector, size_t n, bool preserve)
{
...
template <typename VT // Type of the vector
		  ,
		  bool TF> // Transpose flag of the vector
METRIC_NUMERIC_ALWAYS_INLINE auto shrinkToFit_backend(Vector<VT, TF> &vector) -> DisableIf_t<IsShrinkable_v<VT>>
{
	MAYBE_UNUSED(vector);
}
/*! \endcond */
...
template <typename VT // Type of the vector
		  ,
		  bool TF> // Transpose flag of the vector
METRIC_NUMERIC_ALWAYS_INLINE auto shrinkToFit_backend(Vector<VT, TF> &vector) -> EnableIf_t<IsShrinkable_v<VT>>
{
	(*vector).shrinkToFit();
}
/*! \endcond */
...
template <typename VT // Type of the vector
		  ,
		  bool TF> // Transpose flag of the vector
METRIC_NUMERIC_ALWAYS_INLINE void shrinkToFit(Vector<VT, TF> &vector)
{
...
// purpose. This task is more elegantly and efficiently handled by the \a eval() function:
   ...
   \code
   mtrc::numeric::DynamicVector<double> a, b, c, d;
...
template <typename VT // Type of the vector
		  ,
		  bool TF> // Transpose flag of the vector
METRIC_NUMERIC_ALWAYS_INLINE constexpr bool isEmpty(const Vector<VT, TF> &vector) noexcept
{
...
// \a false.
   ...
   \code
   mtrc::numeric::DynamicVector<int> vec1( 4UL );  // Setup of a 4-dimensional dynamic vector
   mtrc::numeric::DynamicVector<int> vec2( 4UL );  // Setup of a second 4-dimensional dynamic vector
...
METRIC_NUMERIC_ALWAYS_INLINE bool isSame(const Vector<VT1, TF1> &a, const Vector<VT2, TF2> &b) noexcept
{
	return (IsSame_v<VT1, VT2> && reinterpret_cast<const void *>(&a) == reinterpret_cast<const void *>(&b));
}
//*************************************************************************************************
...
template <typename VT1 // Type of the left-hand side vector
		  ...
		  ,
		  bool TF2> // Transpose flag of the right-hand side vector
METRIC_NUMERIC_ALWAYS_INLINE void assign(Vector<VT1, TF1> &lhs, const Vector<VT2, TF2> &rhs)
{
...
template <typename VT1 // Type of the left-hand side vector
		  ...
		  ,
		  bool TF2> // Transpose flag of the right-hand side vector
METRIC_NUMERIC_ALWAYS_INLINE void addAssign(Vector<VT1, TF1> &lhs, const Vector<VT2, TF2> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename VT1 // Type of the left-hand side vector
		  ...
		  ,
		  bool TF2> // Transpose flag of the right-hand side vector
METRIC_NUMERIC_ALWAYS_INLINE void subAssign(Vector<VT1, TF1> &lhs, const Vector<VT2, TF2> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename VT1 // Type of the left-hand side vector
		  ...
		  ,
		  bool TF2> // Transpose flag of the right-hand side vector
METRIC_NUMERIC_ALWAYS_INLINE void multAssign(Vector<VT1, TF1> &lhs, const Vector<VT2, TF2> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename VT1 // Type of the left-hand side vector
		  ...
		  ,
		  bool TF2> // Transpose flag of the right-hand side vector
METRIC_NUMERIC_ALWAYS_INLINE void divAssign(Vector<VT1, TF1> &lhs, const Vector<VT2, TF2> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
METRIC_NUMERIC_ALWAYS_INLINE bool trySet(const Vector<VT, TF> &vec, size_t index, const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(index < (*vec).size(), "Invalid vector access index");
...
template <typename VT // Type of the vector
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool trySet(const Vector<VT, TF> &vec, size_t index, size_t size, const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(index <= (*vec).size(), "Invalid vector access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(index + size <= (*vec).size(), "Invalid range size");
...
template <typename VT // Type of the vector
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryAdd(const Vector<VT, TF> &vec, size_t index, const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(index < (*vec).size(), "Invalid vector access index");
...
template <typename VT // Type of the vector
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryAdd(const Vector<VT, TF> &vec, size_t index, size_t size, const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(index <= (*vec).size(), "Invalid vector access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(index + size <= (*vec).size(), "Invalid range size");
...
template <typename VT // Type of the vector
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool trySub(const Vector<VT, TF> &vec, size_t index, const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(index < (*vec).size(), "Invalid vector access index");
...
template <typename VT // Type of the vector
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool trySub(const Vector<VT, TF> &vec, size_t index, size_t size, const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(index <= (*vec).size(), "Invalid vector access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(index + size <= (*vec).size(), "Invalid range size");
...
template <typename VT // Type of the vector
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryMult(const Vector<VT, TF> &vec, size_t index, const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(index < (*vec).size(), "Invalid vector access index");
...
template <typename VT // Type of the vector
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryMult(const Vector<VT, TF> &vec, size_t index, size_t size, const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(index <= (*vec).size(), "Invalid vector access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(index + size <= (*vec).size(), "Invalid range size");
...
template <typename VT // Type of the vector
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryDiv(const Vector<VT, TF> &vec, size_t index, const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(index < (*vec).size(), "Invalid vector access index");
...
template <typename VT // Type of the vector
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryDiv(const Vector<VT, TF> &vec, size_t index, size_t size, const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(index <= (*vec).size(), "Invalid vector access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(index + size <= (*vec).size(), "Invalid range size");
...
template <typename VT // Type of the vector
		  ,
		  bool TF> // Transpose flag
METRIC_NUMERIC_ALWAYS_INLINE bool tryShift(const Vector<VT, TF> &vec, size_t index, int count)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(index < (*vec).size(), "Invalid vector access index");
...
template <typename VT // Type of the vector
		  ,
		  bool TF> // Transpose flag
METRIC_NUMERIC_ALWAYS_INLINE bool tryShift(const Vector<VT, TF> &vec, size_t index, size_t size, int count)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(index <= (*vec).size(), "Invalid vector access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(index + size <= (*vec).size(), "Invalid range size");
...
template <typename VT // Type of the vector
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryBitand(const Vector<VT, TF> &vec, size_t index, const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(index < (*vec).size(), "Invalid vector access index");
...
template <typename VT // Type of the vector
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryBitand(const Vector<VT, TF> &vec, size_t index, size_t size, const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(index <= (*vec).size(), "Invalid vector access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(index + size <= (*vec).size(), "Invalid range size");
...
template <typename VT // Type of the vector
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryBitor(const Vector<VT, TF> &vec, size_t index, const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(index < (*vec).size(), "Invalid vector access index");
...
template <typename VT // Type of the vector
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryBitor(const Vector<VT, TF> &vec, size_t index, size_t size, const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(index <= (*vec).size(), "Invalid vector access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(index + size <= (*vec).size(), "Invalid range size");
...
template <typename VT // Type of the vector
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryBitxor(const Vector<VT, TF> &vec, size_t index, const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(index < (*vec).size(), "Invalid vector access index");
...
template <typename VT // Type of the vector
		  ...
		  ,
		  typename ET> // Type of the element
METRIC_NUMERIC_ALWAYS_INLINE bool tryBitxor(const Vector<VT, TF> &vec, size_t index, size_t size, const ET &value)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(index <= (*vec).size(), "Invalid vector access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(index + size <= (*vec).size(), "Invalid range size");
...
template <typename VT1 // Type of the left-hand side vector
		  ...
		  ,
		  bool TF2> // Transpose flag of the right-hand side vector
METRIC_NUMERIC_ALWAYS_INLINE bool tryAssign(const Vector<VT1, TF1> &lhs, const Vector<VT2, TF2> &rhs, size_t index)
{
...
template <typename VT1 // Type of the left-hand side vector
		  ...
		  ,
		  bool TF2> // Transpose flag of the right-hand side vector
METRIC_NUMERIC_ALWAYS_INLINE bool tryAddAssign(const Vector<VT1, TF1> &lhs, const Vector<VT2, TF2> &rhs, size_t index)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(index <= (*lhs).size(), "Invalid vector access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(index + (*rhs).size() <= (*lhs).size(), "Invalid vector size");
...
template <typename VT1 // Type of the left-hand side vector
		  ...
		  ,
		  bool TF2> // Transpose flag of the right-hand side vector
METRIC_NUMERIC_ALWAYS_INLINE bool trySubAssign(const Vector<VT1, TF1> &lhs, const Vector<VT2, TF2> &rhs, size_t index)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(index <= (*lhs).size(), "Invalid vector access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(index + (*rhs).size() <= (*lhs).size(), "Invalid vector size");
...
template <typename VT1 // Type of the left-hand side vector
		  ...
		  ,
		  bool TF2> // Transpose flag of the right-hand side vector
METRIC_NUMERIC_ALWAYS_INLINE bool tryMultAssign(const Vector<VT1, TF1> &lhs, const Vector<VT2, TF2> &rhs, size_t index)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(index <= (*lhs).size(), "Invalid vector access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(index + (*rhs).size() <= (*lhs).size(), "Invalid vector size");
...
template <typename VT1 // Type of the left-hand side vector
		  ...
		  ,
		  bool TF2> // Transpose flag of the right-hand side vector
METRIC_NUMERIC_ALWAYS_INLINE bool tryDivAssign(const Vector<VT1, TF1> &lhs, const Vector<VT2, TF2> &rhs, size_t index)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(index <= (*lhs).size(), "Invalid vector access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(index + (*rhs).size() <= (*lhs).size(), "Invalid vector size");
...
template <typename VT1 // Type of the left-hand side vector
		  ...
		  ,
		  bool TF2> // Transpose flag of the right-hand side vector
METRIC_NUMERIC_ALWAYS_INLINE bool tryShiftAssign(const Vector<VT1, TF1> &lhs, const Vector<VT2, TF2> &rhs, size_t index)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(index <= (*lhs).size(), "Invalid vector access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(index + (*rhs).size() <= (*lhs).size(), "Invalid vector size");
...
template <typename VT1 // Type of the left-hand side vector
		  ...
		  ,
		  bool TF2> // Transpose flag of the right-hand side vector
METRIC_NUMERIC_ALWAYS_INLINE bool tryBitandAssign(const Vector<VT1, TF1> &lhs, const Vector<VT2, TF2> &rhs,
												  size_t index)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(index <= (*lhs).size(), "Invalid vector access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(index + (*rhs).size() <= (*lhs).size(), "Invalid vector size");
...
template <typename VT1 // Type of the left-hand side vector
		  ...
		  ,
		  bool TF2> // Transpose flag of the right-hand side vector
METRIC_NUMERIC_ALWAYS_INLINE bool tryBitorAssign(const Vector<VT1, TF1> &lhs, const Vector<VT2, TF2> &rhs, size_t index)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(index <= (*lhs).size(), "Invalid vector access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(index + (*rhs).size() <= (*lhs).size(), "Invalid vector size");
...
template <typename VT1 // Type of the left-hand side vector
		  ...
		  ,
		  bool TF2> // Transpose flag of the right-hand side vector
METRIC_NUMERIC_ALWAYS_INLINE bool tryBitxorAssign(const Vector<VT1, TF1> &lhs, const Vector<VT2, TF2> &rhs,
												  size_t index)
{
	METRIC_NUMERIC_INTERNAL_ASSERT(index <= (*lhs).size(), "Invalid vector access index");
	METRIC_NUMERIC_INTERNAL_ASSERT(index + (*rhs).size() <= (*lhs).size(), "Invalid vector size");
...
template <typename VT // Type of the vector
		  ,
		  bool TF> // Transpose flag of the vector
METRIC_NUMERIC_ALWAYS_INLINE VT &derestrict(Vector<VT, TF> &vector)
{
	return *vector;
}
/*! \endcond */
...
template <typename VT // Type of the vector
		  ,
		  bool TF> // Transpose flag of the vector
METRIC_NUMERIC_ALWAYS_INLINE VT &unview(Vector<VT, TF> &vector)
{
	return *vector;
}
/*! \endcond */
...
template <typename VT // Type of the vector
		  ,
		  bool TF> // Transpose flag of the vector
METRIC_NUMERIC_ALWAYS_INLINE const VT &unview(const Vector<VT, TF> &vector)
{
	return *vector;
}
/*! \endcond */
