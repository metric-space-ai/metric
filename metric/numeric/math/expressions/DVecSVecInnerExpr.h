...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_DVECSVECINNEREXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_DVECSVECINNEREXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
// vector:
   ...
   mtrc::numeric::DynamicVector<double,rowVector> a;
   mtrc::numeric::CompressedVector<double,columnVector> b;
...
inline decltype(auto) operator*(const DenseVector<VT1, true> &lhs, const SparseVector<VT2, false> &rhs)
{
