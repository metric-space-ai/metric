...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SVECDVECMULTEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SVECDVECMULTEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SVecDVecMultExpr : public VecVecMultExpr<SparseVector<SVecDVecMultExpr<VT1, VT2, TF>, TF>>, private Computation {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	class ConstIterator {
	  public:
		...
		*/
		inline const Element operator*() const { return Element(it_->value() * vec_[it_->index()], it_->index()); }
		//*******************************************************************************************
		...
		*/
		...
		// \return The current value of the sparse element.
		*/
		inline ReturnType value() const { return it_->value() * vec_[it_->index()]; }
		//*******************************************************************************************
	...
	*/
	inline ConstIterator begin() const { return ConstIterator(lhs_.begin(), rhs_); }
	//**********************************************************************************************
	...
	*/
	inline ConstIterator end() const { return ConstIterator(lhs_.end(), rhs_); }
	//**********************************************************************************************
	...
	*/
	inline size_t size() const noexcept { return rhs_.size(); }
	//**********************************************************************************************
  ...
  private:
	...
	*/
	...
	friend inline auto assign(DenseVector<VT, TF> &lhs, const SVecDVecMultExpr &rhs) -> EnableIf_t<UseAssign_v<VT>>
	{
	...
	*/
	...
	friend inline auto assign(SparseVector<VT, TF> &lhs, const SVecDVecMultExpr &rhs) -> EnableIf_t<UseAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT> // Type of the target dense vector
	friend inline auto addAssign(DenseVector<VT, TF> &lhs, const SVecDVecMultExpr &rhs) -> EnableIf_t<UseAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT> // Type of the target dense vector
	friend inline auto subAssign(DenseVector<VT, TF> &lhs, const SVecDVecMultExpr &rhs) -> EnableIf_t<UseAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
	...
	*/
	template <typename VT> // Type of the target dense vector
	friend inline auto multAssign(DenseVector<VT, TF> &lhs, const SVecDVecMultExpr &rhs) -> EnableIf_t<UseAssign_v<VT>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
...
inline const SVecDVecMultExpr<VT1, VT2, TF> svecdvecmult(const SparseVector<VT1, TF> &lhs,
...
inline decltype(auto) svecdvecmult(const SparseVector<VT1, TF> &lhs, const DenseVector<VT2, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
// vector:
   ...
   \code
   mtrc::numeric::CompressedVector<double> a, c;
...
template <typename VT1 // Type of the left-hand side sparse vector
		  ...
		  ,
		  bool TF> // Transpose flag
inline decltype(auto) operator*(const SparseVector<VT1, TF> &lhs, const DenseVector<VT2, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
struct Size<SVecDVecMultExpr<VT1, VT2, TF>, 0UL> : public Max_t<Size<VT1, 0UL>, Size<VT2, 0UL>> {};
/*! \endcond */
//*************************************************************************************************
