...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SVECSCALARMULTEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SVECSCALARMULTEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SVecScalarMultExpr : public VecScalarMultExpr<SparseVector<SVecScalarMultExpr<VT, ST, TF>, TF>>,
						   private Computation {
  private:
	//**Type definitions****************************************************************************
  ...
  private:
	...
	*/
	...
	friend inline auto assign(DenseVector<VT2, TF> &lhs, const SVecScalarMultExpr &rhs) -> EnableIf_t<UseAssign_v<VT2>>
	{
	...
	*/
	...
	friend inline auto assign(SparseVector<VT2, TF> &lhs, const SVecScalarMultExpr &rhs) -> EnableIf_t<UseAssign_v<VT2>>
	{
		METRIC_NUMERIC_FUNCTION_TRACE;
...
inline decltype(auto) svecscalarmult(const SparseVector<VT, TF> &vec, ST scalar)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
