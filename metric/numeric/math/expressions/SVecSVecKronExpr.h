...
#ifndef METRIC_NUMERIC_MATH_EXPRESSIONS_SVECSVECKRONEXPR_H
#define METRIC_NUMERIC_MATH_EXPRESSIONS_SVECSVECKRONEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class SVecSVecKronExpr : public VecVecKronExpr<SparseVector<SVecSVecKronExpr<VT1, VT2, TF>, TF>>, private Computation {
  private:
	//**Type definitions****************************************************************************
...
inline const SVecSVecKronExpr<VT1, VT2, TF> svecsveckron(const SparseVector<VT1, TF> &lhs,
...
inline decltype(auto) svecsveckron(const SparseVector<VT1, TF> &lhs, const SparseVector<VT2, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename VT1 // Type of the left-hand side sparse vector
		  ...
		  ,
		  bool TF> // Transpose flag
inline decltype(auto) kron(const SparseVector<VT1, TF> &lhs, const SparseVector<VT2, TF> &rhs)
{
	METRIC_NUMERIC_FUNCTION_TRACE;
