...
#ifndef METRIC_NUMERIC_MATH_PROXY_DENSEVECTORPROXY_H
#define METRIC_NUMERIC_MATH_PROXY_DENSEVECTORPROXY_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DenseVectorProxy : public DenseVector<PT, IsRowVector_v<VT>> {
  public:
	//**Type definitions****************************************************************************
...
template <typename PT // Type of the proxy
		  ,
		  typename VT> // Type of the dense vector
inline typename DenseVectorProxy<PT, VT>::Reference DenseVectorProxy<PT, VT>::operator[](size_t index) const
{
...
template <typename PT // Type of the proxy
		  ,
		  typename VT> // Type of the dense vector
inline typename DenseVectorProxy<PT, VT>::Reference DenseVectorProxy<PT, VT>::at(size_t index) const
{
	if ((**this).isRestricted()) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Invalid access to restricted element");
	}
...
typename DenseVectorProxy<PT, VT>::Iterator begin(const DenseVectorProxy<PT, VT> &proxy);

template <typename PT, typename VT>
typename DenseVectorProxy<PT, VT>::ConstIterator cbegin(const DenseVectorProxy<PT, VT> &proxy);

template <typename PT, typename VT>
typename DenseVectorProxy<PT, VT>::Iterator end(const DenseVectorProxy<PT, VT> &proxy);

template <typename PT, typename VT>
typename DenseVectorProxy<PT, VT>::ConstIterator cend(const DenseVectorProxy<PT, VT> &proxy);

template <typename PT, typename VT> size_t size(const DenseVectorProxy<PT, VT> &proxy);

template <typename PT, typename VT> size_t capacity(const DenseVectorProxy<PT, VT> &proxy);

template <typename PT, typename VT> size_t nonZeros(const DenseVectorProxy<PT, VT> &proxy);

template <typename PT, typename VT> void resize(const DenseVectorProxy<PT, VT> &proxy, size_t n, bool preserve = true);
//@}
//*************************************************************************************************
...
template <typename PT // Type of the proxy
		  ,
		  typename VT> // Type of the dense vector
METRIC_NUMERIC_ALWAYS_INLINE typename DenseVectorProxy<PT, VT>::Iterator begin(const DenseVectorProxy<PT, VT> &proxy)
{
	return proxy.begin();
}
//*************************************************************************************************
...
template <typename PT // Type of the proxy
		  ,
		  typename VT> // Type of the dense vector
METRIC_NUMERIC_ALWAYS_INLINE typename DenseVectorProxy<PT, VT>::Iterator end(const DenseVectorProxy<PT, VT> &proxy)
{
	return proxy.end();
}
//*************************************************************************************************
...
template <typename PT // Type of the proxy
		  ,
		  typename VT> // Type of the dense vector
METRIC_NUMERIC_ALWAYS_INLINE size_t size(const DenseVectorProxy<PT, VT> &proxy)
{
	return proxy.size();
}
//*************************************************************************************************
...
template <typename PT // Type of the proxy
		  ,
		  typename VT> // Type of the dense vector
METRIC_NUMERIC_ALWAYS_INLINE size_t capacity(const DenseVectorProxy<PT, VT> &proxy)
{
...
template <typename PT // Type of the proxy
		  ,
		  typename VT> // Type of the dense vector
METRIC_NUMERIC_ALWAYS_INLINE size_t nonZeros(const DenseVectorProxy<PT, VT> &proxy)
{
...
template <typename PT // Type of the proxy
		  ,
		  typename VT> // Type of the dense vector
METRIC_NUMERIC_ALWAYS_INLINE DisableIf_t<IsResizable_v<VT>> resize_backend(const DenseVectorProxy<PT, VT> &proxy,
...
template <typename PT // Type of the proxy
		  ,
		  typename VT> // Type of the dense vector
METRIC_NUMERIC_ALWAYS_INLINE EnableIf_t<IsResizable_v<VT>> resize_backend(const DenseVectorProxy<PT, VT> &proxy,
																		  size_t n, bool preserve)
{
...
template <typename PT // Type of the proxy
		  ,
		  typename VT> // Type of the dense vector
METRIC_NUMERIC_ALWAYS_INLINE void resize(const DenseVectorProxy<PT, VT> &proxy, size_t n, bool preserve)
{
