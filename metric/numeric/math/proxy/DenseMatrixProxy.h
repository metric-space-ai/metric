...
#ifndef METRIC_NUMERIC_MATH_PROXY_DENSEMATRIXPROXY_H
#define METRIC_NUMERIC_MATH_PROXY_DENSEMATRIXPROXY_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class DenseMatrixProxy : public DenseMatrix<PT, IsColumnMajorMatrix_v<MT>> {
  public:
	//**Type definitions****************************************************************************
...
template <typename PT // Type of the proxy
		  ,
		  typename MT> // Type of the dense matrix
inline typename DenseMatrixProxy<PT, MT>::Reference DenseMatrixProxy<PT, MT>::operator()(size_t i, size_t j) const
{
...
template <typename PT // Type of the proxy
		  ,
		  typename MT> // Type of the dense matrix
inline typename DenseMatrixProxy<PT, MT>::Reference DenseMatrixProxy<PT, MT>::at(size_t i, size_t j) const
{
	if ((**this).isRestricted()) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Invalid access to restricted element");
	}
...
template <typename PT // Type of the proxy
		  ,
		  typename MT> // Type of the dense matrix
inline typename DenseMatrixProxy<PT, MT>::Iterator DenseMatrixProxy<PT, MT>::begin(size_t i) const
{
	if ((**this).isRestricted()) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Invalid access to restricted element");
	}
...
template <typename PT // Type of the proxy
		  ,
		  typename MT> // Type of the dense matrix
inline typename DenseMatrixProxy<PT, MT>::ConstIterator DenseMatrixProxy<PT, MT>::cbegin(size_t i) const
{
...
template <typename PT // Type of the proxy
		  ,
		  typename MT> // Type of the dense matrix
inline typename DenseMatrixProxy<PT, MT>::Iterator DenseMatrixProxy<PT, MT>::end(size_t i) const
{
	if ((**this).isRestricted()) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Invalid access to restricted element");
	}
...
template <typename PT // Type of the proxy
		  ,
		  typename MT> // Type of the dense matrix
inline typename DenseMatrixProxy<PT, MT>::ConstIterator DenseMatrixProxy<PT, MT>::cend(size_t i) const
{
...
typename DenseMatrixProxy<PT, MT>::Iterator begin(const DenseMatrixProxy<PT, MT> &proxy, size_t i);

template <typename PT, typename MT>
typename DenseMatrixProxy<PT, MT>::ConstIterator cbegin(const DenseMatrixProxy<PT, MT> &proxy, size_t i);

template <typename PT, typename MT>
typename DenseMatrixProxy<PT, MT>::Iterator end(const DenseMatrixProxy<PT, MT> &proxy, size_t i);

template <typename PT, typename MT>
typename DenseMatrixProxy<PT, MT>::ConstIterator cend(const DenseMatrixProxy<PT, MT> &proxy, size_t i);

template <typename PT, typename MT> size_t rows(const DenseMatrixProxy<PT, MT> &proxy);

template <typename PT, typename MT> size_t columns(const DenseMatrixProxy<PT, MT> &proxy);

template <typename PT, typename MT> size_t capacity(const DenseMatrixProxy<PT, MT> &proxy);

template <typename PT, typename MT> size_t capacity(const DenseMatrixProxy<PT, MT> &proxy, size_t i);

template <typename PT, typename MT> size_t nonZeros(const DenseMatrixProxy<PT, MT> &proxy);

template <typename PT, typename MT> size_t nonZeros(const DenseMatrixProxy<PT, MT> &proxy, size_t i);
...
template <typename PT // Type of the proxy
		  ,
		  typename MT> // Type of the dense matrix
METRIC_NUMERIC_ALWAYS_INLINE size_t rows(const DenseMatrixProxy<PT, MT> &proxy)
{
	return proxy.rows();
}
//*************************************************************************************************
...
template <typename PT // Type of the proxy
		  ,
		  typename MT> // Type of the dense matrix
METRIC_NUMERIC_ALWAYS_INLINE size_t columns(const DenseMatrixProxy<PT, MT> &proxy)
{
...
template <typename PT // Type of the proxy
		  ,
		  typename MT> // Type of the dense matrix
METRIC_NUMERIC_ALWAYS_INLINE size_t capacity(const DenseMatrixProxy<PT, MT> &proxy)
{
...
template <typename PT // Type of the proxy
		  ,
		  typename MT> // Type of the dense matrix
METRIC_NUMERIC_ALWAYS_INLINE size_t capacity(const DenseMatrixProxy<PT, MT> &proxy, size_t i)
{
...
template <typename PT // Type of the proxy
		  ,
		  typename MT> // Type of the dense matrix
METRIC_NUMERIC_ALWAYS_INLINE size_t nonZeros(const DenseMatrixProxy<PT, MT> &proxy)
{
...
template <typename PT // Type of the proxy
		  ,
		  typename MT> // Type of the dense matrix
METRIC_NUMERIC_ALWAYS_INLINE size_t nonZeros(const DenseMatrixProxy<PT, MT> &proxy, size_t i)
{
...
template <typename PT // Type of the proxy
		  ,
		  typename MT> // Type of the dense matrix
METRIC_NUMERIC_ALWAYS_INLINE DisableIf_t<IsResizable_v<MT>> resize_backend(const DenseMatrixProxy<PT, MT> &proxy,
...
template <typename PT // Type of the proxy
		  ,
		  typename MT> // Type of the dense matrix
METRIC_NUMERIC_ALWAYS_INLINE EnableIf_t<IsResizable_v<MT> && !IsSquare_v<MT>>
...
template <typename PT // Type of the proxy
		  ,
		  typename MT> // Type of the dense matrix
METRIC_NUMERIC_ALWAYS_INLINE void resize(const DenseMatrixProxy<PT, MT> &proxy, size_t m, size_t n, bool preserve)
{
