...
#ifndef METRIC_NUMERIC_MATH_PROXY_COMPLEXPROXY_H
#define METRIC_NUMERIC_MATH_PROXY_COMPLEXPROXY_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
template <typename PT // Type of the proxy
		  ,
		  typename CT> // Type of the complex number
[[deprecated]] METRIC_NUMERIC_ALWAYS_INLINE PT &ComplexProxy<PT, CT>::operator~() noexcept
{
...
template <typename PT // Type of the proxy
		  ,
		  typename CT> // Type of the complex number
[[deprecated]] METRIC_NUMERIC_ALWAYS_INLINE const PT &ComplexProxy<PT, CT>::operator~() const noexcept
{
...
template <typename PT // Type of the proxy
		  ,
		  typename CT> // Type of the complex number
METRIC_NUMERIC_ALWAYS_INLINE PT &ComplexProxy<PT, CT>::operator*() noexcept
{
	return static_cast<PT &>(*this);
}
//*************************************************************************************************
...
template <typename PT // Type of the proxy
		  ,
		  typename CT> // Type of the complex number
METRIC_NUMERIC_ALWAYS_INLINE const PT &ComplexProxy<PT, CT>::operator*() const noexcept
{
	return static_cast<const PT &>(*this);
}
//*************************************************************************************************
...
//@{
template <typename PT, typename CT> PT &crtp_cast(ComplexProxy<PT, CT> &proxy);

template <typename PT, typename CT> const PT &crtp_cast(const ComplexProxy<PT, CT> &proxy);
//@}
//*************************************************************************************************
...
template <typename PT // Type of the proxy
		  ,
		  typename CT> // Type of the complex number
METRIC_NUMERIC_ALWAYS_INLINE PT &crtp_cast(ComplexProxy<PT, CT> &proxy)
{
	return *proxy;
}
//*************************************************************************************************
...
template <typename PT // Type of the proxy
		  ,
		  typename CT> // Type of the complex number
METRIC_NUMERIC_ALWAYS_INLINE const PT &crtp_cast(const ComplexProxy<PT, CT> &proxy)
{
	return *proxy;
}
//*************************************************************************************************
