...
#ifndef METRIC_NUMERIC_MATH_PROXY_PROXY_H
#define METRIC_NUMERIC_MATH_PROXY_PROXY_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
#include <metric/numeric/math/proxy/ComplexProxy.h>
#include <metric/numeric/math/proxy/DefaultProxy.h>
#include <metric/numeric/math/proxy/DenseMatrixProxy.h>
#include <metric/numeric/math/proxy/DenseVectorProxy.h>
#include <metric/numeric/math/proxy/SparseMatrixProxy.h>
#include <metric/numeric/math/proxy/SparseVectorProxy.h>
#include <metric/numeric/math/shims/Abs.h>
#include <metric/numeric/math/shims/Acos.h>
#include <metric/numeric/math/shims/Acosh.h>
#include <metric/numeric/math/shims/Asin.h>
#include <metric/numeric/math/shims/Asinh.h>
#include <metric/numeric/math/shims/Atan.h>
...
#include <metric/numeric/math/shims/Ceil.h>
#include <metric/numeric/math/shims/Clear.h>
#include <metric/numeric/math/shims/Conjugate.h>
#include <metric/numeric/math/shims/Cos.h>
#include <metric/numeric/math/shims/Cosh.h>
#include <metric/numeric/math/shims/Erf.h>
#include <metric/numeric/math/shims/Erfc.h>
...
#include <metric/numeric/math/shims/Imaginary.h>
#include <metric/numeric/math/shims/InvCbrt.h>
#include <metric/numeric/math/shims/InvSqrt.h>
...
#include <metric/numeric/math/shims/Log.h>
#include <metric/numeric/math/shims/Log10.h>
#include <metric/numeric/math/shims/Log2.h>
#include <metric/numeric/math/shims/Pow.h>
#include <metric/numeric/math/shims/Pow2.h>
#include <metric/numeric/math/shims/Pow3.h>
#include <metric/numeric/math/shims/Pow4.h>
#include <metric/numeric/math/shims/Real.h>
#include <metric/numeric/math/shims/Reset.h>
#include <metric/numeric/math/shims/Round.h>
#include <metric/numeric/math/shims/Sign.h>
#include <metric/numeric/math/shims/Sin.h>
#include <metric/numeric/math/shims/Sinh.h>
#include <metric/numeric/math/shims/Sqrt.h>
#include <metric/numeric/math/shims/Tan.h>
#include <metric/numeric/math/shims/Tanh.h>
#include <metric/numeric/math/shims/Trunc.h>
...
// \ingroup math
//
// The Proxy class is a base class for all proxy classes within the \b Metric numeric library that may
...
class Proxy
	: public If_t<IsVector_v<RT>, If_t<IsDenseVector_v<RT>, DenseVectorProxy<PT, RT>, SparseVectorProxy<PT, RT>>,
				  If_t<IsMatrix_v<RT>, If_t<IsDenseMatrix_v<RT>, DenseMatrixProxy<PT, RT>, SparseMatrixProxy<PT, RT>>,
					   If_t<IsComplex_v<RT>, ComplexProxy<PT, RT>, DefaultProxy<PT, RT>>>> {
  protected:
...
/*!\name Proxy operators */
//@{
template <typename T, typename PT, typename RT> decltype(auto) operator+=(T &lhs, const Proxy<PT, RT> &rhs);
...
template <typename PT, typename RT> std::ostream &operator<<(std::ostream &os, const Proxy<PT, RT> &proxy);
//@}
//*************************************************************************************************
...
*/
template <typename T, typename PT, typename RT> inline decltype(auto) operator+=(T &lhs, const Proxy<PT, RT> &rhs)
{
	return lhs += (*rhs).get();
}
//*************************************************************************************************
...
*/
template <typename PT, typename RT, typename T, typename> inline bool operator==(const Proxy<PT, RT> &lhs, const T &rhs)
{
	return ((*lhs).get() == rhs);
}
//*************************************************************************************************
...
*/
template <typename T, typename PT, typename RT, typename> inline bool operator==(const T &lhs, const Proxy<PT, RT> &rhs)
{
	return (lhs == (*rhs).get());
}
//*************************************************************************************************
...
*/
template <typename PT, typename RT> inline std::ostream &operator<<(std::ostream &os, const Proxy<PT, RT> &proxy)
{
	return os << (*proxy).get();
}
//*************************************************************************************************
...
//@{
template <typename PT, typename RT> decltype(auto) abs(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) sign(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) floor(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) ceil(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) trunc(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) round(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) conj(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) trans(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) ctrans(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) real(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) imag(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) sqrt(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) invsqrt(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) cbrt(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) invcbrt(const Proxy<PT, RT> &proxy);
...
template <typename PT, typename RT, typename ET> decltype(auto) pow(const Proxy<PT, RT> &proxy, const ET &exp);

template <typename PT, typename RT> decltype(auto) pow2(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) pow3(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) pow4(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) exp(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) exp2(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) exp10(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) log(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) log2(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) log10(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) sin(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) asin(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) sinh(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) asinh(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) cos(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) acos(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) cosh(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) acosh(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) tan(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) atan(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) tanh(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) atanh(const Proxy<PT, RT> &proxy);
...
template <typename PT, typename RT> decltype(auto) erf(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> decltype(auto) erfc(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> void reset(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> void reset(const Proxy<PT, RT> &proxy, size_t i);

template <typename PT, typename RT> void transpose(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> void ctranspose(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> void invert(const Proxy<PT, RT> &proxy);

template <InversionFlag IF, typename PT, typename RT> void invert(const Proxy<PT, RT> &proxy);

template <RelaxationFlag RF, typename PT, typename RT> bool isDefault(const Proxy<PT, RT> &proxy);

template <RelaxationFlag RF, typename PT, typename RT> bool isReal(const Proxy<PT, RT> &proxy);

template <RelaxationFlag RF, typename PT, typename RT> bool isZero(const Proxy<PT, RT> &proxy);

template <RelaxationFlag RF, typename PT, typename RT> bool isOne(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> bool isnan(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> bool isinf(const Proxy<PT, RT> &proxy);

template <typename PT, typename RT> bool isfinite(const Proxy<PT, RT> &proxy);
...
template <typename PT, typename RT> decltype(auto) evaluate(const Proxy<PT, RT> &proxy);
//@}
//*************************************************************************************************
...
*/
template <typename PT, typename RT> inline decltype(auto) abs(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::abs;
...
*/
template <typename PT, typename RT> inline decltype(auto) sign(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::sign;
...
*/
template <typename PT, typename RT> inline decltype(auto) floor(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::floor;
...
// structure the function returns an expression representing the operation.
*/
template <typename PT, typename RT> inline decltype(auto) ceil(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::ceil;
...
// structure the function returns an expression representing the operation.
*/
template <typename PT, typename RT> inline decltype(auto) trunc(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::trunc;
...
*/
template <typename PT, typename RT> inline decltype(auto) round(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::round;
...
*/
template <typename PT, typename RT> inline decltype(auto) conj(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::conj;
...
// the proxy.
*/
template <typename PT, typename RT> inline decltype(auto) trans(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::trans;
...
*/
template <typename PT, typename RT> inline decltype(auto) ctrans(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::ctrans;
...
*/
template <typename PT, typename RT> inline decltype(auto) real(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::real;
...
// representing the real part of each each element of the vector/matrix.
*/
template <typename PT, typename RT> inline decltype(auto) imag(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::imag;
...
*/
template <typename PT, typename RT> inline decltype(auto) sqrt(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::sqrt;
...
*/
template <typename PT, typename RT> inline decltype(auto) invsqrt(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::invsqrt;
...
*/
template <typename PT, typename RT> inline decltype(auto) cbrt(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::cbrt;
...
*/
template <typename PT, typename RT> inline decltype(auto) invcbrt(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::invcbrt;
...
*/
template <typename PT, typename RT, typename ET> inline decltype(auto) pow(const Proxy<PT, RT> &proxy, const ET &exp)
{
	using mtrc::numeric::pow;
...
*/
template <typename PT, typename RT, typename ET> inline decltype(auto) pow2(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::pow2;
...
*/
template <typename PT, typename RT, typename ET> inline decltype(auto) pow3(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::pow3;
...
*/
template <typename PT, typename RT, typename ET> inline decltype(auto) pow4(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::pow4;
...
*/
template <typename PT, typename RT> inline decltype(auto) exp(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::exp;
...
*/
template <typename PT, typename RT> inline decltype(auto) exp2(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::exp2;
...
*/
template <typename PT, typename RT> inline decltype(auto) exp10(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::exp10;
...
*/
template <typename PT, typename RT> inline decltype(auto) log(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::log;
...
*/
template <typename PT, typename RT> inline decltype(auto) log2(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::log2;
...
*/
template <typename PT, typename RT> inline decltype(auto) log10(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::log10;
...
*/
template <typename PT, typename RT> inline decltype(auto) log1p(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::log1p;
...
*/
template <typename PT, typename RT> inline decltype(auto) lgamma(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::lgamma;
...
*/
template <typename PT, typename RT> inline decltype(auto) sin(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::sin;
...
*/
template <typename PT, typename RT> inline decltype(auto) asin(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::asin;
...
*/
template <typename PT, typename RT> inline decltype(auto) sinh(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::sinh;
...
*/
template <typename PT, typename RT> inline decltype(auto) asinh(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::asinh;
...
*/
template <typename PT, typename RT> inline decltype(auto) cos(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::cos;
...
*/
template <typename PT, typename RT> inline decltype(auto) acos(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::acos;
...
*/
template <typename PT, typename RT> inline decltype(auto) cosh(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::cosh;
...
*/
template <typename PT, typename RT> inline decltype(auto) acosh(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::acosh;
...
*/
template <typename PT, typename RT> inline decltype(auto) tan(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::tan;
...
*/
template <typename PT, typename RT> inline decltype(auto) atan(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::atan;
...
*/
template <typename PT, typename RT> inline decltype(auto) tanh(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::tanh;
...
*/
template <typename PT, typename RT> inline decltype(auto) atanh(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::atanh;
...
*/
template <typename PT, typename RT> inline decltype(auto) erf(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::erf;
...
// vector/matrix.
*/
template <typename PT, typename RT> inline decltype(auto) erfc(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::erfc;
...
// \return void
*/
template <typename PT, typename RT> inline void reset(const Proxy<PT, RT> &proxy)
{
...
*/
template <typename PT, typename RT> inline void reset(const Proxy<PT, RT> &proxy, size_t i)
{
	using mtrc::numeric::reset;
...
// \return void
*/
template <typename PT, typename RT> inline void clear(const Proxy<PT, RT> &proxy)
{
...
*/
template <typename PT, typename RT> inline void transpose(const Proxy<PT, RT> &proxy)
{
	if ((*proxy).isRestricted()) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Invalid access to restricted element");
	}
...
// represented matrix cannot be modified, a \a std::invalid_argument exception is thrown.
*/
template <typename PT, typename RT> inline void ctranspose(const Proxy<PT, RT> &proxy)
{
	if ((*proxy).isRestricted()) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Invalid access to restricted element");
	}
...
// be created.
*/
template <typename PT, typename RT> inline void invert(const Proxy<PT, RT> &proxy)
{
	if ((*proxy).isRestricted()) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Invalid access to restricted element");
	}
...
// be created.
*/
template <InversionFlag IF, typename PT, typename RT> inline void invert(const Proxy<PT, RT> &proxy)
{
	if ((*proxy).isRestricted()) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Invalid access to restricted element");
	}
...
*/
template <RelaxationFlag RF, typename PT, typename RT> inline bool isDefault(const Proxy<PT, RT> &proxy)
{
...
*/
template <RelaxationFlag RF, typename PT, typename RT> inline bool isReal(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::isReal;
...
*/
template <RelaxationFlag RF, typename PT, typename RT> inline bool isZero(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::isZero;
...
*/
template <RelaxationFlag RF, typename PT, typename RT> inline bool isOne(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::isOne;
...
*/
template <typename PT, typename RT> inline bool isnan(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::isnan;
...
*/
template <typename PT, typename RT> inline bool isinf(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::isinf;
...
*/
template <typename PT, typename RT> inline bool isfinite(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::isfinite;
...
// the function returns \a true, otherwise it returns \a false.
*/
template <typename PT, typename RT> inline decltype(auto) evaluate(const Proxy<PT, RT> &proxy)
{
	using mtrc::numeric::evaluate;
