...
#ifndef METRIC_NUMERIC_MATH_CONSTRAINTS_VECVECDIVEXPR_H
#define METRIC_NUMERIC_MATH_CONSTRAINTS_VECVECDIVEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
*/
#define METRIC_NUMERIC_CONSTRAINT_MUST_BE_VECVECDIVEXPR_TYPE(T)                                                        \
	static_assert(::mtrc::numeric::IsVecVecDivExpr_v<T>, "Non-vector/vector division expression type detected")
//*************************************************************************************************
...
*/
#define METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_VECVECDIVEXPR_TYPE(T)                                                    \
	static_assert(!::mtrc::numeric::IsVecVecDivExpr_v<T>, "Vector/vector division expression type detected")
//*************************************************************************************************
...
*/
#define METRIC_NUMERIC_CONSTRAINT_MUST_FORM_VALID_VECVECDIVEXPR(T1, T2)                                                \
