...
#ifndef METRIC_NUMERIC_MATH_CONSTRAINTS_COLUMNMAJORMATRIX_H
#define METRIC_NUMERIC_MATH_CONSTRAINTS_COLUMNMAJORMATRIX_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
*/
#define METRIC_NUMERIC_CONSTRAINT_MUST_BE_COLUMN_MAJOR_MATRIX_TYPE(T)                                                  \
	static_assert(::mtrc::numeric::IsColumnMajorMatrix_v<T>, "Non-column-major matrix type detected")
//*************************************************************************************************
...
*/
#define METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_COLUMN_MAJOR_MATRIX_TYPE(T)                                              \
	static_assert(!::mtrc::numeric::IsColumnMajorMatrix_v<T>, "Column-major matrix type detected")
//*************************************************************************************************
