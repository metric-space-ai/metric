...
#ifndef METRIC_NUMERIC_MATH_INFINITY_H
#define METRIC_NUMERIC_MATH_INFINITY_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
// \ingroup math
//
// The NegativeInfinity class is a wrapper class around the functionality of the mtrc::numeric::Limits
...
class NegativeInfinity {
  ...
  public:
	...
	//@{
	template <typename T> constexpr bool equal(const T &rhs) const;
	//@}
	//**********************************************************************************************
...
{
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_BUILTIN_TYPE(T);
...
template <typename I, typename T> constexpr bool operator==(const NegativeInfinity<I> &lhs, const T &rhs);

template <typename I, typename T> constexpr bool operator==(const T &lhs, const NegativeInfinity<I> &rhs);
...
// \ingroup math
//
// The Infinity class is a wrapper class around the functionality of the mtrc::numeric::Limits class
...
// </ul>
//
// In order to be able to assign infinity values, the global Infinity instance mtrc::numeric::inf
...
*/
constexpr Infinity::operator unsigned char() const { return Limits<unsigned char>::inf(); }
//*************************************************************************************************
...
*/
constexpr Infinity::operator char() const { return Limits<char>::inf(); }
//*************************************************************************************************
...
*/
constexpr Infinity::operator signed char() const { return Limits<signed char>::inf(); }
//*************************************************************************************************
...
*/
constexpr Infinity::operator wchar_t() const { return Limits<wchar_t>::inf(); }
//*************************************************************************************************
...
*/
constexpr Infinity::operator unsigned short() const { return Limits<unsigned short>::inf(); }
//*************************************************************************************************
...
*/
constexpr Infinity::operator short() const { return Limits<short>::inf(); }
//*************************************************************************************************
...
*/
constexpr Infinity::operator unsigned int() const { return Limits<unsigned int>::inf(); }
//*************************************************************************************************
...
*/
constexpr Infinity::operator int() const { return Limits<int>::inf(); }
//*************************************************************************************************
...
*/
constexpr Infinity::operator unsigned long() const { return Limits<unsigned long>::inf(); }
//*************************************************************************************************
...
*/
constexpr Infinity::operator long() const { return Limits<long>::inf(); }
//*************************************************************************************************
...
*/
constexpr Infinity::operator size_t() const { return Limits<size_t>::inf(); }
#endif
//*************************************************************************************************
...
*/
constexpr Infinity::operator ptrdiff_t() const { return Limits<ptrdiff_t>::inf(); }
#endif
//*************************************************************************************************
...
*/
constexpr Infinity::operator float() const { return Limits<float>::inf(); }
//*************************************************************************************************
...
*/
constexpr Infinity::operator double() const { return Limits<double>::inf(); }
//*************************************************************************************************
...
*/
constexpr Infinity::operator long double() const { return Limits<long double>::inf(); }
//*************************************************************************************************
...
*/
constexpr const Infinity &Infinity::operator+() const { return *this; }
//*************************************************************************************************
...
*/
constexpr const Infinity::NegativeType Infinity::operator-() const { return NegativeType(); }
//*************************************************************************************************
...
// result in a compile time error.
*/
template <typename T> constexpr bool Infinity::equal(const T &rhs) const
{
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_BUILTIN_TYPE(T);
...
template <typename I> constexpr bool operator==(const Infinity &lhs, const NegativeInfinity<I> &rhs);

template <typename I> constexpr bool operator==(const NegativeInfinity<I> &lhs, const Infinity &rhs);

template <typename T> constexpr bool operator==(const Infinity &lhs, const T &rhs);

template <typename T> constexpr bool operator==(const T &lhs, const Infinity &rhs);
...
// \return \a true.
*/
constexpr bool operator==(const Infinity & /*lhs*/, const Infinity & /*rhs*/) { return true; }
//*************************************************************************************************
...
// types will result in a compile time error.
*/
template <typename T> constexpr bool operator==(const Infinity &lhs, const T &rhs) { return lhs.equal(rhs); }
//*************************************************************************************************
...
// types will result in a compile time error.
*/
template <typename T> constexpr bool operator==(const T &lhs, const Infinity &rhs) { return rhs.equal(lhs); }
//*************************************************************************************************
...
// \return \a false.
*/
constexpr bool operator!=(const Infinity & /*lhs*/, const Infinity & /*rhs*/) { return false; }
//*************************************************************************************************
...
// \ingroup math
//
// The mtrc::numeric::inf instance can be used wherever a built-in data type is expected. It is implicitly
