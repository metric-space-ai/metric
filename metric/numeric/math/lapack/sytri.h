...
#ifndef METRIC_NUMERIC_MATH_LAPACK_SYTRI_H
#define METRIC_NUMERIC_MATH_LAPACK_SYTRI_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
#include <metric/numeric/math/lapack/clapack/sytri.h>
...
//@{
template <typename MT, bool SO> void sytri(DenseMatrix<MT, SO> &A, char uplo, const blas_int_t *ipiv);
//@}
//*************************************************************************************************
