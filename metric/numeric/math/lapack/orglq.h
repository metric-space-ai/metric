...
#ifndef METRIC_NUMERIC_MATH_LAPACK_ORGLQ_H
#define METRIC_NUMERIC_MATH_LAPACK_ORGLQ_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
//@{
template <typename MT, bool SO> void orglq(DenseMatrix<MT, SO> &A, const ElementType_t<MT> *tau);
//@}
//*************************************************************************************************
...
// linker error.
*/
template <typename MT, bool SO> inline void orglq(DenseMatrix<MT, SO> &A, const ElementType_t<MT> *tau)
{
