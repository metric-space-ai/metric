...
#ifndef METRIC_NUMERIC_MATH_LAPACK_HEEVD_H
#define METRIC_NUMERIC_MATH_LAPACK_HEEVD_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
#include <metric/numeric/math/lapack/clapack/heevd.h>
...
inline void heevd(DenseMatrix<MT, SO> &A, DenseVector<VT, TF> &w, char jobz, char uplo)
{
	...
	heevd(jobz, uplo, n, (*A).data(), lda, (*w).data(), work.get(), lwork, rwork.get(), lrwork, iwork.get(), liwork,
		  &info);
