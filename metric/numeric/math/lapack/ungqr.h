...
#ifndef METRIC_NUMERIC_MATH_LAPACK_UNGQR_H
#define METRIC_NUMERIC_MATH_LAPACK_UNGQR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
#include <metric/numeric/math/lapack/clapack/unglq.h>
#include <metric/numeric/math/lapack/clapack/ungqr.h>
...
//@{
template <typename MT, bool SO> void ungqr(DenseMatrix<MT, SO> &A, const ElementType_t<MT> *tau);
//@}
//*************************************************************************************************
...
// linker error.
*/
template <typename MT, bool SO> inline void ungqr(DenseMatrix<MT, SO> &A, const ElementType_t<MT> *tau)
{
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_COMPLEX_TYPE(ElementType_t<MT>);
