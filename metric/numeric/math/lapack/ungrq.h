...
#ifndef METRIC_NUMERIC_MATH_LAPACK_UNGRQ_H
#define METRIC_NUMERIC_MATH_LAPACK_UNGRQ_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
//@{
template <typename MT, bool SO> void ungrq(DenseMatrix<MT, SO> &A, const ElementType_t<MT> *tau);
//@}
//*************************************************************************************************
...
// linker error.
*/
template <typename MT, bool SO> inline void ungrq(DenseMatrix<MT, SO> &A, const ElementType_t<MT> *tau)
{
