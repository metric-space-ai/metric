...
#ifndef METRIC_NUMERIC_MATH_LAPACK_UNGLQ_H
#define METRIC_NUMERIC_MATH_LAPACK_UNGLQ_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
//@{
template <typename MT, bool SO> void unglq(DenseMatrix<MT, SO> &A, const ElementType_t<MT> *tau);
//@}
//*************************************************************************************************
...
// linker error.
*/
template <typename MT, bool SO> inline void unglq(DenseMatrix<MT, SO> &A, const ElementType_t<MT> *tau)
{
