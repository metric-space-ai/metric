...
#ifndef METRIC_NUMERIC_MATH_LAPACK_GERQF_H
#define METRIC_NUMERIC_MATH_LAPACK_GERQF_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
//@{
template <typename MT, bool SO> void gerqf(DenseMatrix<MT, SO> &A, ElementType_t<MT> *tau);
//@}
//*************************************************************************************************
...
inline void gerqf(DenseMatrix<MT, SO> &A, ElementType_t<MT> *tau)
{
	...
	METRIC_NUMERIC_INTERNAL_ASSERT(info == 0, "Invalid argument for RQ decomposition");
}
//*************************************************************************************************
