...
#ifndef METRIC_NUMERIC_MATH_LAPACK_SYSV_H
#define METRIC_NUMERIC_MATH_LAPACK_SYSV_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
#include <metric/numeric/math/lapack/clapack/sysv.h>
...
inline void sysv(DenseMatrix<MT1, SO1> &A, DenseMatrix<MT2, SO2> &B, char uplo, blas_int_t *ipiv)
{
	...
	if (info > 0) {
		METRIC_NUMERIC_THROW_RUNTIME_ERROR("Inversion of singular matrix failed");
	}
}
//*************************************************************************************************
