...
#ifndef METRIC_NUMERIC_MATH_LAPACK_HETRF_H
#define METRIC_NUMERIC_MATH_LAPACK_HETRF_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
#include <metric/numeric/math/lapack/clapack/hetrf.h>
...
//@{
template <typename MT, bool SO> void hetrf(DenseMatrix<MT, SO> &A, char uplo, blas_int_t *ipiv);
//@}
//*************************************************************************************************
