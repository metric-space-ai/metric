...
#ifndef METRIC_NUMERIC_MATH_LAPACK_POTRF_H
#define METRIC_NUMERIC_MATH_LAPACK_POTRF_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
//@{
template <typename MT, bool SO> void potrf(DenseMatrix<MT, SO> &A, char uplo);
//@}
//*************************************************************************************************
...
inline void potrf(DenseMatrix<MT, SO> &A, char uplo)
{
	...
	if (info > 0) {
		METRIC_NUMERIC_THROW_LAPACK_ERROR("Decomposition of non-positive-definite matrix failed");
	}
}
//*************************************************************************************************
