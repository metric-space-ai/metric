...
#ifndef METRIC_NUMERIC_MATH_LAPACK_SYTRF_H
#define METRIC_NUMERIC_MATH_LAPACK_SYTRF_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
#include <metric/numeric/math/lapack/clapack/sytrf.h>
...
//@{
template <typename MT, bool SO> void sytrf(DenseMatrix<MT, SO> &A, char uplo, blas_int_t *ipiv);
//@}
//*************************************************************************************************
...
inline void sytrf(DenseMatrix<MT, SO> &A, char uplo, blas_int_t *ipiv)
{
	...
	METRIC_NUMERIC_INTERNAL_ASSERT(info >= 0, "Invalid argument for matrix decomposition");
}
//*************************************************************************************************
