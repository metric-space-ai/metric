...
#ifndef METRIC_NUMERIC_MATH_LAPACK_CLAPACK_SYTRF_H
#define METRIC_NUMERIC_MATH_LAPACK_CLAPACK_SYTRF_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
void ssytrf_(char *uplo, mtrc::numeric::blas_int_t *n, float *A, mtrc::numeric::blas_int_t *lda,
			 mtrc::numeric::blas_int_t *ipiv, float *work, mtrc::numeric::blas_int_t *lwork,
			 mtrc::numeric::blas_int_t *info, mtrc::numeric::fortran_charlen_t nuplo);
void dsytrf_(char *uplo, mtrc::numeric::blas_int_t *n, double *A, mtrc::numeric::blas_int_t *lda,
			 mtrc::numeric::blas_int_t *ipiv, double *work, mtrc::numeric::blas_int_t *lwork,
			 mtrc::numeric::blas_int_t *info, mtrc::numeric::fortran_charlen_t nuplo);
void csytrf_(char *uplo, mtrc::numeric::blas_int_t *n, float *A, mtrc::numeric::blas_int_t *lda,
			 mtrc::numeric::blas_int_t *ipiv, float *work, mtrc::numeric::blas_int_t *lwork,
			 mtrc::numeric::blas_int_t *info, mtrc::numeric::fortran_charlen_t nuplo);
void zsytrf_(char *uplo, mtrc::numeric::blas_int_t *n, double *A, mtrc::numeric::blas_int_t *lda,
			 mtrc::numeric::blas_int_t *ipiv, double *work, mtrc::numeric::blas_int_t *lwork,
			 mtrc::numeric::blas_int_t *info, mtrc::numeric::fortran_charlen_t nuplo);
}
#endif
...
//@{
void sytrf(char uplo, blas_int_t n, float *A, blas_int_t lda, blas_int_t *ipiv, float *work, blas_int_t lwork,
		   blas_int_t *info);

void sytrf(char uplo, blas_int_t n, double *A, blas_int_t lda, blas_int_t *ipiv, double *work, blas_int_t lwork,
		   blas_int_t *info);

void sytrf(char uplo, blas_int_t n, complex<float> *A, blas_int_t lda, blas_int_t *ipiv, complex<float> *work,
		   blas_int_t lwork, blas_int_t *info);

void sytrf(char uplo, blas_int_t n, complex<double> *A, blas_int_t lda, blas_int_t *ipiv, complex<double> *work,
		   blas_int_t lwork, blas_int_t *info);
//@}
//*************************************************************************************************
...
// linker error.
*/
inline void sytrf(char uplo, blas_int_t n, float *A, blas_int_t lda, blas_int_t *ipiv, float *work, blas_int_t lwork,
				  blas_int_t *info)
{
#if defined(INTEL_MKL_VERSION)
...
// linker error.
*/
inline void sytrf(char uplo, blas_int_t n, double *A, blas_int_t lda, blas_int_t *ipiv, double *work, blas_int_t lwork,
				  blas_int_t *info)
{
#if defined(INTEL_MKL_VERSION)
	METRIC_NUMERIC_STATIC_ASSERT(sizeof(MKL_INT) == sizeof(blas_int_t));
...
// linker error.
*/
inline void sytrf(char uplo, blas_int_t n, complex<float> *A, blas_int_t lda, blas_int_t *ipiv, complex<float> *work,
				  blas_int_t lwork, blas_int_t *info)
{
	...
	csytrf_(&uplo, &n, reinterpret_cast<ET *>(A), &lda, ipiv, reinterpret_cast<ET *>(work), &lwork, info
#if !defined(INTEL_MKL_VERSION)
			,
			mtrc::numeric::fortran_charlen_t(1)
#endif
...
// linker error.
*/
inline void sytrf(char uplo, blas_int_t n, complex<double> *A, blas_int_t lda, blas_int_t *ipiv, complex<double> *work,
				  blas_int_t lwork, blas_int_t *info)
{
	...
	zsytrf_(&uplo, &n, reinterpret_cast<ET *>(A), &lda, ipiv, reinterpret_cast<ET *>(work), &lwork, info
#if !defined(INTEL_MKL_VERSION)
			,
			mtrc::numeric::fortran_charlen_t(1)
#endif
