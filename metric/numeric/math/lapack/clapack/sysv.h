...
#ifndef METRIC_NUMERIC_MATH_LAPACK_CLAPACK_SYSV_H
#define METRIC_NUMERIC_MATH_LAPACK_CLAPACK_SYSV_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
void ssysv_(char *uplo, mtrc::numeric::blas_int_t *n, mtrc::numeric::blas_int_t *nrhs, float *A,
...
void dsysv_(char *uplo, mtrc::numeric::blas_int_t *n, mtrc::numeric::blas_int_t *nrhs, double *A,
			...
			mtrc::numeric::blas_int_t *info, mtrc::numeric::fortran_charlen_t nuplo);
void csysv_(char *uplo, mtrc::numeric::blas_int_t *n, mtrc::numeric::blas_int_t *nrhs, float *A,
			mtrc::numeric::blas_int_t *lda, mtrc::numeric::blas_int_t *ipiv, float *b,
			mtrc::numeric::blas_int_t *ldb, float *work, mtrc::numeric::blas_int_t *lwork,
			mtrc::numeric::blas_int_t *info, mtrc::numeric::fortran_charlen_t nuplo);
void zsysv_(char *uplo, mtrc::numeric::blas_int_t *n, mtrc::numeric::blas_int_t *nrhs, double *A,
			mtrc::numeric::blas_int_t *lda, mtrc::numeric::blas_int_t *ipiv, double *b,
			mtrc::numeric::blas_int_t *ldb, double *work, mtrc::numeric::blas_int_t *lwork,
			mtrc::numeric::blas_int_t *info, mtrc::numeric::fortran_charlen_t nuplo);
}
...
//@{
void sysv(char uplo, blas_int_t n, blas_int_t nrhs, float *A, blas_int_t lda, blas_int_t *ipiv, float *B,
		  blas_int_t ldb, float *work, blas_int_t lwork, blas_int_t *info);

void sysv(char uplo, blas_int_t n, blas_int_t nrhs, double *A, blas_int_t lda, blas_int_t *ipiv, double *B,
		  blas_int_t ldb, double *work, blas_int_t lwork, blas_int_t *info);

void sysv(char uplo, blas_int_t n, blas_int_t nrhs, complex<float> *A, blas_int_t lda, blas_int_t *ipiv,
		  complex<float> *B, blas_int_t ldb, complex<float> *work, blas_int_t lwork, blas_int_t *info);

void sysv(char uplo, blas_int_t n, blas_int_t nrhs, complex<double> *A, blas_int_t lda, blas_int_t *ipiv,
...
// linker error.
*/
inline void sysv(char uplo, blas_int_t n, blas_int_t nrhs, float *A, blas_int_t lda, blas_int_t *ipiv, float *B,
				 blas_int_t ldb, float *work, blas_int_t lwork, blas_int_t *info)
{
#if defined(INTEL_MKL_VERSION)
...
// linker error.
*/
inline void sysv(char uplo, blas_int_t n, blas_int_t nrhs, double *A, blas_int_t lda, blas_int_t *ipiv, double *B,
				 blas_int_t ldb, double *work, blas_int_t lwork, blas_int_t *info)
{
#if defined(INTEL_MKL_VERSION)
	METRIC_NUMERIC_STATIC_ASSERT(sizeof(MKL_INT) == sizeof(blas_int_t));
...
// linker error.
*/
inline void sysv(char uplo, blas_int_t n, blas_int_t nrhs, complex<float> *A, blas_int_t lda, blas_int_t *ipiv,
				 complex<float> *B, blas_int_t ldb, complex<float> *work, blas_int_t lwork, blas_int_t *info)
{
	...
	csysv_(&uplo, &n, &nrhs, reinterpret_cast<ET *>(A), &lda, ipiv, reinterpret_cast<ET *>(B), &ldb,
...
// linker error.
*/
inline void sysv(char uplo, blas_int_t n, blas_int_t nrhs, complex<double> *A, blas_int_t lda, blas_int_t *ipiv,
				 complex<double> *B, blas_int_t ldb, complex<double> *work, blas_int_t lwork, blas_int_t *info)
{
	...
	zsysv_(&uplo, &n, &nrhs, reinterpret_cast<ET *>(A), &lda, ipiv, reinterpret_cast<ET *>(B), &ldb,
		   reinterpret_cast<ET *>(work), &lwork, info
#if !defined(INTEL_MKL_VERSION)
		   ,
		   mtrc::numeric::fortran_charlen_t(1)
