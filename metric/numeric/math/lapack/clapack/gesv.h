...
#ifndef METRIC_NUMERIC_MATH_LAPACK_CLAPACK_GESV_H
#define METRIC_NUMERIC_MATH_LAPACK_CLAPACK_GESV_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
void sgesv_(mtrc::numeric::blas_int_t *n, mtrc::numeric::blas_int_t *nrhs, float *A,
			mtrc::numeric::blas_int_t *lda, mtrc::numeric::blas_int_t *ipiv, float *b,
			mtrc::numeric::blas_int_t *ldb, mtrc::numeric::blas_int_t *info);
void dgesv_(mtrc::numeric::blas_int_t *n, mtrc::numeric::blas_int_t *nrhs, double *A,
			mtrc::numeric::blas_int_t *lda, mtrc::numeric::blas_int_t *ipiv, double *b,
			mtrc::numeric::blas_int_t *ldb, mtrc::numeric::blas_int_t *info);
void cgesv_(mtrc::numeric::blas_int_t *n, mtrc::numeric::blas_int_t *nrhs, float *A,
			mtrc::numeric::blas_int_t *lda, mtrc::numeric::blas_int_t *ipiv, float *b,
			mtrc::numeric::blas_int_t *ldb, mtrc::numeric::blas_int_t *info);
void zgesv_(mtrc::numeric::blas_int_t *n, mtrc::numeric::blas_int_t *nrhs, double *A,
			mtrc::numeric::blas_int_t *lda, mtrc::numeric::blas_int_t *ipiv, double *b,
			mtrc::numeric::blas_int_t *ldb, mtrc::numeric::blas_int_t *info);
}
#endif
...
//@{
void gesv(blas_int_t n, blas_int_t nrhs, float *A, blas_int_t lda, blas_int_t *ipiv, float *B, blas_int_t ldb,
		  blas_int_t *info);

void gesv(blas_int_t n, blas_int_t nrhs, double *A, blas_int_t lda, blas_int_t *ipiv, double *B, blas_int_t ldb,
		  blas_int_t *info);

void gesv(blas_int_t n, blas_int_t nrhs, complex<float> *A, blas_int_t lda, blas_int_t *ipiv, complex<float> *B,
		  blas_int_t ldb, blas_int_t *info);

void gesv(blas_int_t n, blas_int_t nrhs, complex<double> *A, blas_int_t lda, blas_int_t *ipiv, complex<double> *B,
		  blas_int_t ldb, blas_int_t *info);
//@}
//*************************************************************************************************
...
// linker error.
*/
inline void gesv(blas_int_t n, blas_int_t nrhs, float *A, blas_int_t lda, blas_int_t *ipiv, float *B, blas_int_t ldb,
				 blas_int_t *info)
{
...
// linker error.
*/
inline void gesv(blas_int_t n, blas_int_t nrhs, double *A, blas_int_t lda, blas_int_t *ipiv, double *B, blas_int_t ldb,
				 blas_int_t *info)
{
#if defined(INTEL_MKL_VERSION)
	METRIC_NUMERIC_STATIC_ASSERT(sizeof(MKL_INT) == sizeof(blas_int_t));
...
// linker error.
*/
inline void gesv(blas_int_t n, blas_int_t nrhs, complex<float> *A, blas_int_t lda, blas_int_t *ipiv, complex<float> *B,
				 blas_int_t ldb, blas_int_t *info)
{
	...
	cgesv_(&n, &nrhs, reinterpret_cast<ET *>(A), &lda, ipiv, reinterpret_cast<ET *>(B), &ldb, info);
}
//*************************************************************************************************
...
// linker error.
*/
inline void gesv(blas_int_t n, blas_int_t nrhs, complex<double> *A, blas_int_t lda, blas_int_t *ipiv,
				 complex<double> *B, blas_int_t ldb, blas_int_t *info)
{
	...
	zgesv_(&n, &nrhs, reinterpret_cast<ET *>(A), &lda, ipiv, reinterpret_cast<ET *>(B), &ldb, info);
}
//*************************************************************************************************
