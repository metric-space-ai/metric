...
#ifndef METRIC_NUMERIC_MATH_LAPACK_CLAPACK_GETRI_H
#define METRIC_NUMERIC_MATH_LAPACK_CLAPACK_GETRI_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
void sgetri_(mtrc::numeric::blas_int_t *n, float *A, mtrc::numeric::blas_int_t *lda,
			 mtrc::numeric::blas_int_t *ipiv, float *work, mtrc::numeric::blas_int_t *lwork,
			 mtrc::numeric::blas_int_t *info);
void dgetri_(mtrc::numeric::blas_int_t *n, double *A, mtrc::numeric::blas_int_t *lda,
			 mtrc::numeric::blas_int_t *ipiv, double *work, mtrc::numeric::blas_int_t *lwork,
			 mtrc::numeric::blas_int_t *info);
void cgetri_(mtrc::numeric::blas_int_t *n, float *A, mtrc::numeric::blas_int_t *lda,
			 mtrc::numeric::blas_int_t *ipiv, float *work, mtrc::numeric::blas_int_t *lwork,
			 mtrc::numeric::blas_int_t *info);
void zgetri_(mtrc::numeric::blas_int_t *n, double *A, mtrc::numeric::blas_int_t *lda,
			 mtrc::numeric::blas_int_t *ipiv, double *work, mtrc::numeric::blas_int_t *lwork,
			 mtrc::numeric::blas_int_t *info);
}
#endif
...
//@{
void getri(blas_int_t n, float *A, blas_int_t lda, const blas_int_t *ipiv, float *work, blas_int_t lwork,
		   blas_int_t *info);

void getri(blas_int_t n, double *A, blas_int_t lda, const blas_int_t *ipiv, double *work, blas_int_t lwork,
		   blas_int_t *info);

void getri(blas_int_t n, complex<float> *A, blas_int_t lda, const blas_int_t *ipiv, complex<float> *work,
		   blas_int_t lwork, blas_int_t *info);

void getri(blas_int_t n, complex<double> *A, blas_int_t lda, const blas_int_t *ipiv, complex<double> *work,
		   blas_int_t lwork, blas_int_t *info);
//@}
//*************************************************************************************************
...
// linker error.
*/
inline void getri(blas_int_t n, float *A, blas_int_t lda, const blas_int_t *ipiv, float *work, blas_int_t lwork,
				  blas_int_t *info)
{
#if defined(INTEL_MKL_VERSION)
...
// linker error.
*/
inline void getri(blas_int_t n, double *A, blas_int_t lda, const blas_int_t *ipiv, double *work, blas_int_t lwork,
				  blas_int_t *info)
{
#if defined(INTEL_MKL_VERSION)
	METRIC_NUMERIC_STATIC_ASSERT(sizeof(MKL_INT) == sizeof(blas_int_t));
...
// linker error.
*/
inline void getri(blas_int_t n, complex<float> *A, blas_int_t lda, const blas_int_t *ipiv, complex<float> *work,
				  blas_int_t lwork, blas_int_t *info)
{
	...
	cgetri_(&n, reinterpret_cast<ET *>(A), &lda, const_cast<blas_int_t *>(ipiv), reinterpret_cast<ET *>(work), &lwork,
			info);
}
//*************************************************************************************************
...
// linker error.
*/
inline void getri(blas_int_t n, complex<double> *A, blas_int_t lda, const blas_int_t *ipiv, complex<double> *work,
				  blas_int_t lwork, blas_int_t *info)
{
	...
	zgetri_(&n, reinterpret_cast<ET *>(A), &lda, const_cast<blas_int_t *>(ipiv), reinterpret_cast<ET *>(work), &lwork,
			info);
}
//*************************************************************************************************
