...
#ifndef METRIC_NUMERIC_MATH_LAPACK_CLAPACK_HETRF_H
#define METRIC_NUMERIC_MATH_LAPACK_CLAPACK_HETRF_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
void chetrf_(char *uplo, mtrc::numeric::blas_int_t *n, float *A, mtrc::numeric::blas_int_t *lda,
...
void zhetrf_(char *uplo, mtrc::numeric::blas_int_t *n, double *A, mtrc::numeric::blas_int_t *lda,
...
//@{
void hetrf(char uplo, blas_int_t n, complex<float> *A, blas_int_t lda, blas_int_t *ipiv, complex<float> *work,
		   blas_int_t lwork, blas_int_t *info);

void hetrf(char uplo, blas_int_t n, complex<double> *A, blas_int_t lda, blas_int_t *ipiv, complex<double> *work,
		   blas_int_t lwork, blas_int_t *info);
//@}
//*************************************************************************************************
...
// linker error.
*/
inline void hetrf(char uplo, blas_int_t n, complex<float> *A, blas_int_t lda, blas_int_t *ipiv, complex<float> *work,
				  blas_int_t lwork, blas_int_t *info)
{
	...
	chetrf_(&uplo, &n, reinterpret_cast<ET *>(A), &lda, ipiv, reinterpret_cast<ET *>(work), &lwork, info
#if !defined(INTEL_MKL_VERSION)
			,
...
// linker error.
*/
inline void hetrf(char uplo, blas_int_t n, complex<double> *A, blas_int_t lda, blas_int_t *ipiv, complex<double> *work,
				  blas_int_t lwork, blas_int_t *info)
{
	...
	zhetrf_(&uplo, &n, reinterpret_cast<ET *>(A), &lda, ipiv, reinterpret_cast<ET *>(work), &lwork, info
#if !defined(INTEL_MKL_VERSION)
			,
			mtrc::numeric::fortran_charlen_t(1)
#endif
