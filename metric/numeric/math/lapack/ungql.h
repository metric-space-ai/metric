...
#ifndef METRIC_NUMERIC_MATH_LAPACK_UNGQL_H
#define METRIC_NUMERIC_MATH_LAPACK_UNGQL_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
#include <metric/numeric/math/lapack/clapack/ungql.h>
#include <metric/numeric/math/lapack/clapack/ungrq.h>
...
//@{
template <typename MT, bool SO> void ungql(DenseMatrix<MT, SO> &A, const ElementType_t<MT> *tau);
//@}
//*************************************************************************************************
...
// linker error.
*/
template <typename MT, bool SO> inline void ungql(DenseMatrix<MT, SO> &A, const ElementType_t<MT> *tau)
{
