...
#ifndef METRIC_NUMERIC_MATH_SMP_DEFAULT_SPARSEMATRIX_H
#define METRIC_NUMERIC_MATH_SMP_DEFAULT_SPARSEMATRIX_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
auto smpAssign(Matrix<MT1, SO1> &lhs, const Matrix<MT2, SO2> &rhs) -> EnableIf_t<IsSparseMatrix_v<MT1>>;

template <typename MT1, bool SO1, typename MT2, bool SO2>
auto smpAddAssign(Matrix<MT1, SO1> &lhs, const Matrix<MT2, SO2> &rhs) -> EnableIf_t<IsSparseMatrix_v<MT1>>;

template <typename MT1, bool SO1, typename MT2, bool SO2>
auto smpSubAssign(Matrix<MT1, SO1> &lhs, const Matrix<MT2, SO2> &rhs) -> EnableIf_t<IsSparseMatrix_v<MT1>>;

template <typename MT1, bool SO1, typename MT2, bool SO2>
auto smpSchurAssign(Matrix<MT1, SO1> &lhs, const Matrix<MT2, SO2> &rhs) -> EnableIf_t<IsSparseMatrix_v<MT1>>;
//@}
//*************************************************************************************************
...
inline auto smpAssign(Matrix<MT1, SO1> &lhs, const Matrix<MT2, SO2> &rhs) -> EnableIf_t<IsSparseMatrix_v<MT1>>
{
...
template <typename MT1 // Type of the left-hand side sparse matrix
		  ...
		  ,
		  bool SO2> // Storage order of the right-hand side matrix
inline auto smpAddAssign(Matrix<MT1, SO1> &lhs, const Matrix<MT2, SO2> &rhs) -> EnableIf_t<IsSparseMatrix_v<MT1>>
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename MT1 // Type of the left-hand side sparse matrix
		  ...
		  ,
		  bool SO2> // Storage order of the right-hand side matrix
inline auto smpSubAssign(Matrix<MT1, SO1> &lhs, const Matrix<MT2, SO2> &rhs) -> EnableIf_t<IsSparseMatrix_v<MT1>>
{
	METRIC_NUMERIC_FUNCTION_TRACE;
...
template <typename MT1 // Type of the left-hand side sparse matrix
		  ...
		  ,
		  bool SO2> // Storage order of the right-hand side matrix
inline auto smpSchurAssign(Matrix<MT1, SO1> &lhs, const Matrix<MT2, SO2> &rhs) -> EnableIf_t<IsSparseMatrix_v<MT1>>
{
	METRIC_NUMERIC_FUNCTION_TRACE;
