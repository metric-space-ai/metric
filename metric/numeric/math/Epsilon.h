...
#ifndef METRIC_NUMERIC_MATH_EPSILON_H
#define METRIC_NUMERIC_MATH_EPSILON_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
// \ingroup math
//
// The NegativeEpsilon class is a wrapper class around the functionality of the mtrc::numeric::Limits
...
//@{
template <typename E, typename T> constexpr bool operator==(const NegativeEpsilon<E> &lhs, const T &rhs);

template <typename E, typename T> constexpr bool operator==(const T &lhs, const NegativeEpsilon<E> &rhs);
...
// \ingroup math
//
// The Epsilon class is a wrapper class around the functionality of the mtrc::numeric::Limits class.
...
// In order to handle epsilon values conveniently, the global Epsilon instance mtrc::numeric::epsilon
...
// \return The positive epsilon value.
*/
constexpr const Epsilon &Epsilon::operator+() const { return *this; }
//*************************************************************************************************
...
// \return The negative epsilon value.
*/
constexpr const Epsilon::NegativeType Epsilon::operator-() const { return NegativeType(); }
//*************************************************************************************************
...
*/
template <typename T> constexpr Epsilon::operator const T() const
{
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_FLOATING_POINT_TYPE(T);
	return Limits<T>::epsilon();
}
...
//@{
template <typename T> constexpr bool operator==(const Epsilon &lhs, const T &rhs);

template <typename T> constexpr bool operator==(const T &lhs, const Epsilon &rhs);
...
// \ingroup math
//
// The mtrc::numeric::epsilon instance can be used wherever a floating point data type is expected.
