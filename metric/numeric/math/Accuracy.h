...
#ifndef METRIC_NUMERIC_MATH_ACCURACY_H
#define METRIC_NUMERIC_MATH_ACCURACY_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
// \ingroup math
//
// The NegativeAccuracy class is a wrapper class around the functionality of the mtrc::numeric::Limits
// class. It represents the negative computation accuracy of the Metric numeric library for any floating
...
class NegativeAccuracy {
  ...
  public:
	...
	//@{
	template <typename T> constexpr operator const T() const;
	//@}
	//**********************************************************************************************
...
*/
template <typename A> // Positive accuracy type
constexpr const typename NegativeAccuracy<A>::PositiveType NegativeAccuracy<A>::operator-() const
{
	return PositiveType();
}
//*************************************************************************************************
...
//@{
template <typename A, typename T> constexpr bool operator==(const NegativeAccuracy<A> &lhs, const T &rhs);

template <typename A, typename T> constexpr bool operator==(const T &lhs, const NegativeAccuracy<A> &rhs);
...
// \ingroup math
//
// The Accuracy class is a wrapper class around the functionality of the mtrc::numeric::Limits class.
// It represents the computation accuracy of the Metric numeric library for any floating point data
...
// In order to handle accuracy values conveniently, the global Accuracy instance mtrc::numeric::accuracy
...
// \return The positive computation accuracy.
*/
constexpr const Accuracy &Accuracy::operator+() const { return *this; }
//*************************************************************************************************
...
// \return The negative computation accuracy.
*/
constexpr const Accuracy::NegativeType Accuracy::operator-() const { return NegativeType(); }
//*************************************************************************************************
...
//@{
template <typename T> constexpr bool operator==(const Accuracy &lhs, const T &rhs);

template <typename T> constexpr bool operator==(const T &lhs, const Accuracy &rhs);
...
// \ingroup math
//
// The mtrc::numeric::accuracy instance can be used wherever a floating point data type is expected.
// It is implicitly converted to the corresponding floating point data type and represents
// the computation accuracy of the Metric numeric library for the according data type.
*/
constexpr Accuracy accuracy;
//*************************************************************************************************
