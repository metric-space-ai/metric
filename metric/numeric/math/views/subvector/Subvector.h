...
#ifndef METRIC_NUMERIC_MATH_VIEWS_SUBVECTOR_SUBVECTOR_H
#define METRIC_NUMERIC_MATH_VIEWS_SUBVECTOR_SUBVECTOR_H
//=================================================================================================
//
...
// function. It can be included via the header files
   ...
   // or
   #include <metric/numeric/math/Subvector.h>
   \endcode
...
// specifier:
   ...
   \code
   using VectorType = mtrc::numeric::DynamicVector<int>;
   using SubvectorType = decltype( mtrc::numeric::subvector<4UL,12UL>( std::declval<VectorType>() ) );
   \endcode
...
// The elements of a subvector can be directly accessed via the subscript operator:
   ...
   \code
   mtrc::numeric::DynamicVector<double,mtrc::numeric::rowVector> v;
   // ... Resizing and initialization
...
// subvectors an iterator to immutable elements is returned:
   ...
   \code
   mtrc::numeric::DynamicVector<int,mtrc::numeric::rowVector> v( 256UL );
   // ... Resizing and initialization
   ...
   \code
   mtrc::numeric::CompressedVector<int,mtrc::numeric::rowVector> v( 256UL );
   // ... Resizing and initialization
...
// The following example demonstrates all options:
   ...
   \code
   mtrc::numeric::CompressedVector<double,mtrc::numeric::rowVector> v( 256UL );  // Non-initialized vector of size
256
...
// a dense subvector view:
   ...
   \code
   mtrc::numeric::DynamicVector<int,mtrc::numeric::rowVector> v( 42UL );
   // ... Resizing and initialization
...
// fitting element types:
   ...
   \code
   mtrc::numeric::DynamicVector<double,mtrc::numeric::rowVector> d1, d2, d3;
   mtrc::numeric::CompressedVector<double,mtrc::numeric::rowVector> s1, s2;
...
// unaligned. This can be made explicit by the mtrc::numeric::unaligned flag:
...
// the mtrc::numeric::aligned flag is specified during setup, an aligned subvector is created:

   \code
   using mtrc::numeric::aligned;

   mtrc::numeric::CompressedVector<double,mtrc::numeric::rowVector> x;
   // ... Resizing and initialization
