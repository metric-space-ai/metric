...
#ifndef METRIC_NUMERIC_MATH_VIEWS_SUBVECTOR_SPARSE_H
#define METRIC_NUMERIC_MATH_VIEWS_SUBVECTOR_SPARSE_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class Subvector<VT, AF, TF, false, CSAs...> : public View<SparseVector<Subvector<VT, AF, TF, false, CSAs...>, TF>>,
  ...
  public:
	...
	class SubvectorElement : private SparseElement {
	  public:
		...
		*/
		inline const SubvectorElement *operator->() const { return this; }
		//*******************************************************************************************
	...
	class SubvectorIterator {
	  public:
		...
		*/
		inline DifferenceType operator-(const SubvectorIterator &rhs) const { return pos_ - rhs.pos_; }
		//*******************************************************************************************
...
template <typename VT // Type of the sparse vector
		  ...
		  ,
		  size_t... CSAs> // Compile time subvector arguments
inline typename Subvector<VT, AF, TF, false, CSAs...>::Reference Subvector<VT, AF, TF, false, CSAs...>::at(size_t index)
{
	if (index >= size()) {
...
template <typename VT // Type of the sparse vector
		  ...
		  ,
		  size_t... CSAs> // Compile time subvector arguments
inline typename Subvector<VT, AF, TF, false, CSAs...>::Iterator Subvector<VT, AF, TF, false, CSAs...>::begin()
{
	if (offset() == 0UL)
...
template <typename VT // Type of the sparse vector
		  ...
		  size_t... CSAs> // Compile time subvector arguments
inline
	typename Subvector<VT, AF, TF, false, CSAs...>::ConstIterator Subvector<VT, AF, TF, false, CSAs...>::begin() const
{
	if (offset() == 0UL)
...
template <typename VT // Type of the sparse vector
		  ...
		  size_t... CSAs> // Compile time subvector arguments
inline
	typename Subvector<VT, AF, TF, false, CSAs...>::ConstIterator Subvector<VT, AF, TF, false, CSAs...>::cbegin() const
{
	if (offset() == 0UL)
		return ConstIterator(vector_.cbegin(), offset());
	else
...
template <typename VT // Type of the sparse vector
		  ...
		  ,
		  size_t... CSAs> // Compile time subvector arguments
inline typename Subvector<VT, AF, TF, false, CSAs...>::Iterator Subvector<VT, AF, TF, false, CSAs...>::end()
{
...
template <typename VT // Type of the sparse vector
		  ...
		  ,
		  size_t... CSAs> // Compile time subvector arguments
inline typename Subvector<VT, AF, TF, false, CSAs...>::ConstIterator Subvector<VT, AF, TF, false, CSAs...>::end() const
{
	if (offset() + size() == vector_.size())
...
template <typename VT // Type of the sparse vector
		  ...
		  ,
		  size_t... CSAs> // Compile time subvector arguments
inline typename Subvector<VT, AF, TF, false, CSAs...>::ConstIterator Subvector<VT, AF, TF, false, CSAs...>::cend() const
{
	if (offset() + size() == vector_.size())
		return ConstIterator(vector_.cend(), offset());
	else
...
template <typename VT // Type of the sparse vector
		  ...
		  ,
		  size_t... CSAs> // Compile time subvector arguments
inline Subvector<VT, AF, TF, false, CSAs...> &Subvector<VT, AF, TF, false, CSAs...>::operator=(const Subvector &rhs)
{
	using mtrc::numeric::assign;
...
template <typename VT // Type of the sparse vector
		  ...
		  size_t... CSAs> // Compile time subvector arguments
inline
	typename Subvector<VT, AF, TF, false, CSAs...>::Iterator Subvector<VT, AF, TF, false, CSAs...>::erase(Iterator pos)
{
...
template <typename VT // Type of the sparse vector
		  ...
		  size_t... CSAs> // Compile time subvector arguments
inline
	typename Subvector<VT, AF, TF, false, CSAs...>::Iterator Subvector<VT, AF, TF, false, CSAs...>::find(size_t index)
{
...
inline Subvector<VT, AF, TF, false, CSAs...> &Subvector<VT, AF, TF, false, CSAs...>::scale(const Other &scalar)
{
