...
#ifndef METRIC_NUMERIC_MATH_VIEWS_COLUMNS_COLUMNSDATA_H
#define METRIC_NUMERIC_MATH_VIEWS_COLUMNS_COLUMNSDATA_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class ColumnsData<index_sequence<I, Is...>> {
  ...
  public:
	...
	/*!\name Constructors */
	//@{
	template <typename... RCAs> explicit inline ColumnsData(RCAs... args) noexcept;
...
template <size_t I // First column index
		  ,
		  size_t... Is> // Remaining column indices
constexpr typename ColumnsData<index_sequence<I, Is...>>::Indices ColumnsData<index_sequence<I, Is...>>::indices_;
#endif
/*! \endcond */
//*************************************************************************************************
...
{
	METRIC_NUMERIC_USER_ASSERT(i < columns(), "Invalid column access index");
	return indices_[i];
}
/*! \endcond */
//*************************************************************************************************
...
class ColumnsData<P> {
  ...
  public:
	...
	/*!\name Constructors */
	//@{
	template <typename... RCAs> inline ColumnsData(P p, size_t n, RCAs... args) noexcept;
...
template <typename P>		// Type of the index producer
template <typename... RCAs> // Optional column arguments
inline ColumnsData<P>::ColumnsData(P p, size_t n, RCAs... args) noexcept : p_(p), n_(n)
{
	MAYBE_UNUSED(args...);
}
/*! \endcond */
...
template <> class ColumnsData<> {
  ...
  public:
	...
	/*!\name Constructors */
	//@{
	template <typename T, typename... RCAs> inline ColumnsData(T *indices, size_t n, RCAs... args);
...
// \return A representation of the indices of the specified columns.
*/
inline decltype(auto) ColumnsData<>::idces() const noexcept { return mtrc::numeric::as_const(indices_); }
/*! \endcond */
//*************************************************************************************************
...
// \return The number of columns.
*/
inline size_t ColumnsData<>::columns() const noexcept { return indices_.size(); }
/*! \endcond */
//*************************************************************************************************
...
constexpr bool compareIndices(const ColumnsData<CRAs1...> &lhs, const ColumnsData<CRAs2...> &rhs) noexcept
{
