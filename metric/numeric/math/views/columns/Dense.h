...
#ifndef METRIC_NUMERIC_MATH_VIEWS_COLUMNS_DENSE_H
#define METRIC_NUMERIC_MATH_VIEWS_COLUMNS_DENSE_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
#include <metric/numeric/math/views/columns/ColumnsData.h>
...
class Columns<MT, true, true, SF, CCAs...> : public View<DenseMatrix<Columns<MT, true, true, SF, CCAs...>, true>>,
  ...
  public:
	...
	/*!\name Constructors */
	//@{
	template <typename... RCAs> explicit inline Columns(MT &matrix, RCAs... args);
	...
	template <typename MT2, bool SO2> inline Columns &operator=(const Matrix<MT2, SO2> &rhs);

	template <typename MT2, bool SO2>
	inline auto operator+=(const Matrix<MT2, SO2> &rhs) -> DisableIf_t<EnforceEvaluation_v<MT, MT2>, Columns &>;

	template <typename MT2, bool SO2>
	inline auto operator+=(const Matrix<MT2, SO2> &rhs) -> EnableIf_t<EnforceEvaluation_v<MT, MT2>, Columns &>;
  ...
  private:
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_COLUMNS_TYPE(MT);
...
template <typename MT // Type of the dense matrix
		  ...
		  typename... CCAs> // Compile time column arguments
inline
	typename Columns<MT, true, true, SF, CCAs...>::Reference Columns<MT, true, true, SF, CCAs...>::operator()(size_t i,
																											  size_t j)
{
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CCAs> // Compile time column arguments
inline typename Columns<MT, true, true, SF, CCAs...>::Reference Columns<MT, true, true, SF, CCAs...>::at(size_t i,
																										 size_t j)
{
	if (i >= rows()) {
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CCAs> // Compile time column arguments
inline typename Columns<MT, true, true, SF, CCAs...>::Pointer Columns<MT, true, true, SF, CCAs...>::data() noexcept
{
...
template <typename MT // Type of the dense matrix
		  ...
		  typename... CCAs> // Compile time column arguments
inline
	typename Columns<MT, true, true, SF, CCAs...>::Pointer Columns<MT, true, true, SF, CCAs...>::data(size_t j) noexcept
{
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CCAs> // Compile time column arguments
inline typename Columns<MT, true, true, SF, CCAs...>::Iterator Columns<MT, true, true, SF, CCAs...>::begin(size_t j)
{
	METRIC_NUMERIC_USER_ASSERT(j < columns(), "Invalid column access index");
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CCAs> // Compile time column arguments
inline typename Columns<MT, true, true, SF, CCAs...>::Iterator Columns<MT, true, true, SF, CCAs...>::end(size_t j)
{
	METRIC_NUMERIC_USER_ASSERT(j < columns(), "Invalid column access index");
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CCAs> // Compile time column arguments
inline Columns<MT, true, true, SF, CCAs...> &Columns<MT, true, true, SF, CCAs...>::operator=(const ElementType &rhs)
{
	for (size_t j = 0UL; j < columns(); ++j) {
...
Columns<MT, true, true, SF, CCAs...>::operator=(initializer_list<initializer_list<ElementType>> list)
{
	...
	if (list.size() != rows()) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Invalid assignment to column selection");
	}
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CCAs> // Compile time column arguments
inline Columns<MT, true, true, SF, CCAs...> &Columns<MT, true, true, SF, CCAs...>::operator=(const Columns &rhs)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_SYMMETRIC_MATRIX_TYPE(MT);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_HERMITIAN_MATRIX_TYPE(MT);
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CCAs> // Compile time column arguments
inline Columns<MT, true, true, SF, CCAs...> &Columns<MT, true, true, SF, CCAs...>::transpose()
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_SYMMETRIC_MATRIX_TYPE(MT);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_HERMITIAN_MATRIX_TYPE(MT);
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CCAs> // Compile time column arguments
inline Columns<MT, true, true, SF, CCAs...> &Columns<MT, true, true, SF, CCAs...>::ctranspose()
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_SYMMETRIC_MATRIX_TYPE(MT);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_HERMITIAN_MATRIX_TYPE(MT);
...
inline Columns<MT, true, true, SF, CCAs...> &Columns<MT, true, true, SF, CCAs...>::scale(const Other &scalar)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_SYMMETRIC_MATRIX_TYPE(MT);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_HERMITIAN_MATRIX_TYPE(MT);
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CCAs> // Compile time column arguments
template <typename MT2		// Data type of the other dense column selection
		  ,
		  bool SO2 // Storage order of the other dense column selection
		  ,
		  bool SF2 // Symmetry flag of the other dense column selection
		  ,
		  typename... CCAs2> // Compile time column arguments of the other dense column selection
inline bool
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CCAs> // Compile time column arguments
METRIC_NUMERIC_ALWAYS_INLINE typename Columns<MT, true, true, SF, CCAs...>::SIMDType
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CCAs> // Compile time column arguments
METRIC_NUMERIC_ALWAYS_INLINE void Columns<MT, true, true, SF, CCAs...>::store(size_t i, size_t j,
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CCAs> // Compile time column arguments
METRIC_NUMERIC_ALWAYS_INLINE void Columns<MT, true, true, SF, CCAs...>::storea(size_t i, size_t j,
																			   const SIMDType &value) noexcept
{
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CCAs> // Compile time column arguments
METRIC_NUMERIC_ALWAYS_INLINE void Columns<MT, true, true, SF, CCAs...>::storeu(size_t i, size_t j,
																			   const SIMDType &value) noexcept
{
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CCAs> // Compile time column arguments
METRIC_NUMERIC_ALWAYS_INLINE void Columns<MT, true, true, SF, CCAs...>::stream(size_t i, size_t j,
																			   const SIMDType &value) noexcept
{
...
inline void Columns<MT, true, true, SF, CCAs...>::assign(const DenseMatrix<MT2, false> &rhs)
{
	...
	if (rows() < block && columns() < block) {
		...
		METRIC_NUMERIC_INTERNAL_ASSERT(ipos <= (*rhs).rows(), "Invalid end calculation");
	...
	-> EnableIf_t<VectorizedAddAssign_v<MT2>>
{
	...
	for (size_t j = 0UL; j < columns(); ++j) {
		const size_t ibegin((IsLower_v<MT2>) ? (prevMultiple((IsStrictlyLower_v<MT2> ? j + 1UL : j), SIMDSIZE))
											 : (0UL));
		const size_t iend((IsUpper_v<MT2>) ? (IsStrictlyUpper_v<MT2> ? j : j + 1UL) : (rows()));
...
class Columns<MT, false, true, false, CCAs...>
	: public View<DenseMatrix<Columns<MT, false, true, false, CCAs...>, true>>, private ColumnsData<CCAs...> {
  private:
	//**Type definitions****************************************************************************
	using DataType = ColumnsData<CCAs...>;				//!< The type of the ColumnsData base class.
	using Operand = If_t<IsExpression_v<MT>, MT, MT &>; //!< Composite data type of the dense matrix expression.
  ...
  public:
	...
	class ColumnsIterator {
	  public:
		...
		*/
		inline DifferenceType operator-(const ColumnsIterator &rhs) const noexcept { return row_ - rhs.row_; }
		//*******************************************************************************************
...
template <typename MT // Type of the dense matrix
		  ...
		  typename... CCAs> // Compile time column arguments
inline
	typename Columns<MT, false, true, false, CCAs...>::Reference Columns<MT, false, true, false, CCAs...>::at(size_t i,
																											  size_t j)
{
	if (i >= rows()) {
		METRIC_NUMERIC_THROW_OUT_OF_RANGE("Invalid row access index");
...
template <typename MT // Type of the dense matrix
		  ...
		  typename... CCAs> // Compile time column arguments
inline
	typename Columns<MT, false, true, false, CCAs...>::Pointer Columns<MT, false, true, false, CCAs...>::data() noexcept
{
	return matrix_.data() + idx(0UL);
}
/*! \endcond */
...
template <typename MT // Type of the dense matrix
		  ...
		  typename... CCAs> // Compile time column arguments
inline
	typename Columns<MT, false, true, false, CCAs...>::Iterator Columns<MT, false, true, false, CCAs...>::end(size_t j)
{
	METRIC_NUMERIC_USER_ASSERT(j < columns(), "Invalid column access index");
...
template <typename MT // Type of the dense matrix
		  ,
		  typename... CCAs> // Compile time column arguments
inline Columns<MT, false, true, false, CCAs...> &Columns<MT, false, true, false, CCAs...>::operator=(const Columns &rhs)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_SYMMETRIC_MATRIX_TYPE(MT);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_HERMITIAN_MATRIX_TYPE(MT);
...
template <typename MT // Type of the dense matrix
		  ,
		  typename... CCAs> // Compile time column arguments
inline Columns<MT, false, true, false, CCAs...> &Columns<MT, false, true, false, CCAs...>::transpose()
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_SYMMETRIC_MATRIX_TYPE(MT);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_HERMITIAN_MATRIX_TYPE(MT);
...
template <typename MT // Type of the dense matrix
		  ,
		  typename... CCAs> // Compile time column arguments
inline Columns<MT, false, true, false, CCAs...> &Columns<MT, false, true, false, CCAs...>::ctranspose()
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_SYMMETRIC_MATRIX_TYPE(MT);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_HERMITIAN_MATRIX_TYPE(MT);
...
template <typename MT // Type of the dense matrix
		  ...
		  typename... CCAs> // Compile time column arguments
template <typename Other>	// Data type of the scalar value
inline Columns<MT, false, true, false, CCAs...> &Columns<MT, false, true, false, CCAs...>::scale(const Other &scalar)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_SYMMETRIC_MATRIX_TYPE(MT);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_HERMITIAN_MATRIX_TYPE(MT);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_UNITRIANGULAR_MATRIX_TYPE(MT);
...
template <typename MT // Type of the dense matrix
		  ,
		  typename... CCAs> // Compile time column arguments
class Columns<MT, false, true, true, CCAs...> : public View<DenseMatrix<Columns<MT, false, true, true, CCAs...>, true>>,
												private ColumnsData<CCAs...> {
  private:
	//**Type definitions****************************************************************************
	using DataType = ColumnsData<CCAs...>;				//!< The type of the ColumnsData base class.
...
template <typename MT // Type of the dense matrix
		  ,
		  typename... CCAs> // Compile time column arguments
inline typename Columns<MT, false, true, true, CCAs...>::Reference Columns<MT, false, true, true, CCAs...>::at(size_t i,
																											   size_t j)
{
	if (i >= rows()) {
		METRIC_NUMERIC_THROW_OUT_OF_RANGE("Invalid row access index");
...
template <typename MT // Type of the dense matrix
		  ...
		  typename... CCAs> // Compile time column arguments
inline
	typename Columns<MT, false, true, true, CCAs...>::Pointer Columns<MT, false, true, true, CCAs...>::data() noexcept
{
	return matrix_.data(idx(0UL));
}
/*! \endcond */
...
template <typename MT // Type of the dense matrix
		  ...
		  typename... CCAs> // Compile time column arguments
inline
	typename Columns<MT, false, true, true, CCAs...>::Iterator Columns<MT, false, true, true, CCAs...>::begin(size_t j)
{
	METRIC_NUMERIC_USER_ASSERT(j < columns(), "Invalid column access index");
	return matrix_.begin(idx(j));
}
...
template <typename MT // Type of the dense matrix
		  ,
		  typename... CCAs> // Compile time column arguments
inline typename Columns<MT, false, true, true, CCAs...>::Iterator Columns<MT, false, true, true, CCAs...>::end(size_t j)
{
	METRIC_NUMERIC_USER_ASSERT(j < columns(), "Invalid column access index");
	return matrix_.end(idx(j));
}
...
template <typename MT // Type of the dense matrix
		  ,
		  typename... CCAs> // Compile time column arguments
METRIC_NUMERIC_ALWAYS_INLINE typename Columns<MT, false, true, true, CCAs...>::SIMDType
