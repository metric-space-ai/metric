...
#ifndef METRIC_NUMERIC_MATH_VIEWS_COLUMNS_COLUMNS_H
#define METRIC_NUMERIC_MATH_VIEWS_COLUMNS_COLUMNS_H
//=================================================================================================
//
...
// included via the header files
   ...
   // or
   #include <metric/numeric/math/Columns.h>
   \endcode

// and forward declared via the header file

   \code
   #include <metric/numeric/Forward.h>
   \endcode
...
// indices:
   ...
   \code
   mtrc::numeric::DynamicMatrix<double,mtrc::numeric::columnMajor> A( 18UL, 9UL );
...
// specifier:
   ...
   \code
   using MatrixType = mtrc::numeric::DynamicMatrix<int>;

   using ColumnsType1 = decltype( mtrc::numeric::columns<3UL,0UL,4UL,8UL>( std::declval<MatrixType>() ) );
   using ColumnsType2 = mtrc::numeric::ColumnsExprTrait<MatrixType,3UL,0UL,4UL,8UL>::Type;
   \endcode
...
// following example demonstrates this in detail:
   ...
   \code
   mtrc::numeric::DynamicMatrix<double,mtrc::numeric::columnMajor> A;
   mtrc::numeric::DynamicMatrix<double,mtrc::numeric::rowMajor> B;
   mtrc::numeric::CompressedMatrix<double,mtrc::numeric::columnMajor> C;
   // ... Resizing and initialization
...
// iterator to immutable elements is returned:
   ...
   \code
   mtrc::numeric::DynamicMatrix<int,mtrc::numeric::columnMajor> A( 512UL, 256UL );
   // ... Resizing and initialization
   ...
   \code
   mtrc::numeric::CompressedMatrix<int,mtrc::numeric::columnMajor> A( 512UL, 256UL );
   // ... Resizing and initialization
...
// functions. The following example demonstrates all options:
   ...
   \code
   mtrc::numeric::CompressedMatrix<double,mtrc::numeric::columnMajor> A( 512UL, 256UL );  // Non-initialized matrix
of size 512x256
...
// such as resizing and swapping:
   ...
   \code
   mtrc::numeric::DynamicMatrix<int,mtrc::numeric::columnMajor> A( 42UL, 42UL );
   // ... Resizing and initialization
...
// sparse matrices with fitting element types:
   ...
   \code
   mtrc::numeric::DynamicMatrix<double,mtrc::numeric::columnMajor> D1, D2, D3;
   mtrc::numeric::CompressedMatrix<double,mtrc::numeric::columnMajor> S1, S2;

   mtrc::numeric::CompressedVector<double,mtrc::numeric::columnVector> a, b;
...
// matrix. For instance:
   ...
   \code
   mtrc::numeric::DynamicMatrix<int,mtrc::numeric::rowMajor> A( 64UL, 32UL );
   // ... Resizing and initialization
...
// order:
   ...
   mtrc::numeric::DynamicMatrix<double,mtrc::numeric::rowMajor> A( 128UL, 128UL );
   mtrc::numeric::DynamicMatrix<double,mtrc::numeric::rowMajor> B( 128UL, 128UL );
   // ... Resizing and initialization

   // The computation of the 15th, 30th, and 45th column of the multiplication between A and B ...
   mtrc::numeric::DynamicMatrix<double,mtrc::numeric::columnMajor> x = columns( A * B, { 15UL, 30UL, 45UL } );

   // ... is essentially the same as the following computation, which multiplies
   // A with the 15th, 30th, and 45th column of the row-major matrix B.
   mtrc::numeric::DynamicMatrix<double,mtrc::numeric::columnMajor> x = A * column( B, { 15UL, 30UL, 45UL } );
   \endcode

// Although Metric numeric performs the resulting matrix/matrix multiplication as efficiently as possible
