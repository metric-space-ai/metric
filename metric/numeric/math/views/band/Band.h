...
#ifndef METRIC_NUMERIC_MATH_VIEWS_BAND_BAND_H
#define METRIC_NUMERIC_MATH_VIEWS_BAND_BAND_H
//=================================================================================================
//
...
// function. It can be included via the header files
   ...
   // or
   #include <metric/numeric/math/Band.h>
   \endcode
...
// specifier:
   ...
   using BandType = decltype( mtrc::numeric::band<1L>( std::declval<MatrixType>() ) );
   \endcode
...
// column vectors, but this setting can be changed via the \c METRIC_NUMERIC_DEFAULT_TRANSPOSE_FLAG switch
...
// via the \c DiagonalExprTrait class template:
   ...
   using DiagonalType1 = decltype( mtrc::numeric::diagonal( std::declval<MatrixType>() ) );
   using DiagonalType2 = mtrc::numeric::DiagonalExprTrait<MatrixType>::Type;
   \endcode
...
// example shows this by means of a dense diagonal view:
   ...
   \code
   mtrc::numeric::DynamicMatrix<int,mtrc::numeric::rowMajor> A( 42UL, 42UL );
   mtrc::numeric::DynamicMatrix<int,mtrc::numeric::rowMajor> B( 42UL, 42UL );
   // ... Resizing and initialization
...
// fitting element types:
   ...
   mtrc::numeric::DynamicMatrix<double,mtrc::numeric::rowMajor> A( 4UL, 2UL );  // Non-initialized 4x2 matrix
   mtrc::numeric::DynamicMatrix<double,mtrc::numeric::rowMajor> B( 2UL, 4UL );  // Non-initialized 2x4 matrix
