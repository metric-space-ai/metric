...
#ifndef METRIC_NUMERIC_MATH_VIEWS_BAND_DENSE_H
#define METRIC_NUMERIC_MATH_VIEWS_BAND_DENSE_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class Band<MT, TF, true, false, CBAs...> : public View<DenseVector<Band<MT, TF, true, false, CBAs...>, TF>>,
	  ...
	  public:
		...
		*/
		inline ReferenceType operator[](size_t index) const
		{
			...
			const IteratorType pos(IsRowMajorMatrix_v<MatrixType> ? matrix_->begin(row_ + index) + column_ + index
		...
		*/
		inline DifferenceType operator-(const BandIterator &rhs) const noexcept { return row_ - rhs.row_; }
		//*******************************************************************************************
...
template <typename MT // Type of the dense matrix
		  ...
		  ptrdiff_t... CBAs> // Compile time band arguments
inline
	typename Band<MT, TF, true, false, CBAs...>::Reference Band<MT, TF, true, false, CBAs...>::operator[](size_t index)
{
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  ptrdiff_t... CBAs> // Compile time band arguments
inline typename Band<MT, TF, true, false, CBAs...>::Reference Band<MT, TF, true, false, CBAs...>::at(size_t index)
{
	if (index >= size()) {
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  ptrdiff_t... CBAs> // Compile time band arguments
inline typename Band<MT, TF, true, false, CBAs...>::Pointer Band<MT, TF, true, false, CBAs...>::data() noexcept
{
...
template <typename MT // Type of the dense matrix
		  ...
		  ptrdiff_t... CBAs> // Compile time band arguments
inline
	typename Band<MT, TF, true, false, CBAs...>::ConstPointer Band<MT, TF, true, false, CBAs...>::data() const noexcept
{
	if (IsRowMajorMatrix_v<MT>)
		return matrix_.data() + row() * matrix_.spacing() + column();
	else
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  ptrdiff_t... CBAs> // Compile time band arguments
inline typename Band<MT, TF, true, false, CBAs...>::Iterator Band<MT, TF, true, false, CBAs...>::begin()
{
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  ptrdiff_t... CBAs> // Compile time band arguments
inline typename Band<MT, TF, true, false, CBAs...>::ConstIterator Band<MT, TF, true, false, CBAs...>::begin() const
{
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  ptrdiff_t... CBAs> // Compile time band arguments
inline typename Band<MT, TF, true, false, CBAs...>::ConstIterator Band<MT, TF, true, false, CBAs...>::cbegin() const
{
	return ConstIterator(matrix_, row(), column());
}
/*! \endcond */
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  ptrdiff_t... CBAs> // Compile time band arguments
inline typename Band<MT, TF, true, false, CBAs...>::Iterator Band<MT, TF, true, false, CBAs...>::end()
{
	const size_t n(size());
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  ptrdiff_t... CBAs> // Compile time band arguments
inline typename Band<MT, TF, true, false, CBAs...>::ConstIterator Band<MT, TF, true, false, CBAs...>::end() const
{
	const size_t n(size());
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  ptrdiff_t... CBAs> // Compile time band arguments
inline typename Band<MT, TF, true, false, CBAs...>::ConstIterator Band<MT, TF, true, false, CBAs...>::cend() const
{
	const size_t n(size());
	return ConstIterator(matrix_, row() + n, column() + n);
}
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  ptrdiff_t... CBAs> // Compile time band arguments
inline Band<MT, TF, true, false, CBAs...> &Band<MT, TF, true, false, CBAs...>::operator=(const ElementType &rhs)
{
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  ptrdiff_t... CBAs> // Compile time band arguments
inline Band<MT, TF, true, false, CBAs...> &Band<MT, TF, true, false, CBAs...>::operator=(const Band &rhs)
{
	if (&rhs == this)
		return *this;

	if (size() != rhs.size()) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Band sizes do not match");
	}
...
inline Band<MT, TF, true, false, CBAs...> &Band<MT, TF, true, false, CBAs...>::operator=(const Vector<VT, TF> &rhs)
{
...
inline Band<MT, TF, true, false, CBAs...> &Band<MT, TF, true, false, CBAs...>::scale(const Other &scalar)
{
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  ptrdiff_t... CBAs> // Compile time band arguments
template <typename MT2		 // Matrix type of the other dense band
		  ,
		  ptrdiff_t... CBAs2> // Compile time band arguments of the other dense band
inline bool
...
class Band<MT, TF, true, true, CBAs...>
	: public View<DenseVector<Band<MT, TF, true, true, CBAs...>, TF>>, private BandData<CBAs...>, private Computation {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	//! Data type for composite expression templates.
	using CompositeType =
		If_t<RequiresEvaluation_v<LeftOperand> || RequiresEvaluation_v<RightOperand>, const ResultType, const Band &>;
	...
	*/
	constexpr bool isAligned() const noexcept { return false; }
	//**********************************************************************************************
