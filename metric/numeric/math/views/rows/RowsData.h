...
#ifndef METRIC_NUMERIC_MATH_VIEWS_ROWS_ROWSDATA_H
#define METRIC_NUMERIC_MATH_VIEWS_ROWS_ROWSDATA_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class RowsData<index_sequence<I, Is...>> {
  ...
  public:
	...
	/*!\name Constructors */
	//@{
	template <typename... RRAs> explicit inline RowsData(RRAs... args) noexcept;
...
template <size_t I // First row index
		  ,
		  size_t... Is> // Remaining row indices
constexpr typename RowsData<index_sequence<I, Is...>>::Indices RowsData<index_sequence<I, Is...>>::indices_;
#endif
/*! \endcond */
//*************************************************************************************************
...
class RowsData<P> {
  ...
  public:
	...
	/*!\name Constructors */
	//@{
	template <typename... RRAs> inline RowsData(P p, size_t n, RRAs... args) noexcept;
...
template <typename P>		// Type of the index producer
template <typename... RRAs> // Optional row arguments
inline RowsData<P>::RowsData(P p, size_t n, RRAs... args) noexcept : p_(p), n_(n)
{
	MAYBE_UNUSED(args...);
}
/*! \endcond */
...
template <> class RowsData<> {
  ...
  public:
	...
	/*!\name Constructors */
	//@{
	template <typename T, typename... RRAs> inline RowsData(T *indices, size_t n, RRAs... args);
...
// \return A representation of the indices of the specified rows.
*/
inline decltype(auto) RowsData<>::idces() const noexcept { return mtrc::numeric::as_const(indices_); }
/*! \endcond */
//*************************************************************************************************
...
// \return The number of rows.
*/
inline size_t RowsData<>::rows() const noexcept { return indices_.size(); }
/*! \endcond */
//*************************************************************************************************
...
constexpr bool compareIndices(const RowsData<CRAs1...> &lhs, const RowsData<CRAs2...> &rhs) noexcept
{
