...
#ifndef METRIC_NUMERIC_MATH_VIEWS_ROWS_ROWS_H
#define METRIC_NUMERIC_MATH_VIEWS_ROWS_ROWS_H
//=================================================================================================
//
...
// via the header files
   ...
   // or
   #include <metric/numeric/math/Rows.h>
   \endcode
...
// indices:
   ...
   \code
   mtrc::numeric::DynamicMatrix<double,mtrc::numeric::rowMajor> A( 9UL, 18UL );
...
// specifier:
   ...
   using RowsType = decltype( mtrc::numeric::rows<3UL,0UL,4UL,8UL>( std::declval<MatrixType>() ) );
   \endcode
...
// demonstrates this in detail:
   ...
   \code
   mtrc::numeric::DynamicMatrix<double,mtrc::numeric::rowMajor> A;
   mtrc::numeric::DynamicMatrix<double,mtrc::numeric::columnMajor> B;
   mtrc::numeric::CompressedMatrix<double,mtrc::numeric::rowMajor> C;
   // ... Resizing and initialization
...
// immutable elements is returned:
   ...
   \code
   mtrc::numeric::DynamicMatrix<int,mtrc::numeric::rowMajor> A( 256UL, 512UL );
   // ... Resizing and initialization
   ...
   \code
   mtrc::numeric::CompressedMatrix<int,mtrc::numeric::rowMajor> A( 256UL, 512UL );
   // ... Resizing and initialization
...
// functions. The following example demonstrates all options:
   ...
   \code
   mtrc::numeric::CompressedMatrix<double,mtrc::numeric::rowMajor> A( 256UL, 512UL );  // Non-initialized matrix of
size 256x512
...
// sparse matrices with fitting element types:
   ...
   \code
   mtrc::numeric::DynamicMatrix<double,mtrc::numeric::rowMajor> D1, D2, D3;
   mtrc::numeric::CompressedMatrix<double,mtrc::numeric::rowMajor> S1, S2;
...
// Therefore care has to be taken in the choice of the most suitable storage order:
   ...
   mtrc::numeric::DynamicMatrix<double,mtrc::numeric::rowMajor> x = rows( A * B, { 15UL, 30UL, 45UL } );

   // ... is essentially the same as the following computation, which multiplies
   // the 15th, 30th, and 45th row of the column-major matrix A with B.
   mtrc::numeric::DynamicMatrix<double,mtrc::numeric::rowMajor> x = rows( A, { 15UL, 30UL, 45UL } ) * B;
   \endcode
