...
#ifndef METRIC_NUMERIC_MATH_VIEWS_ROWS_DENSE_H
#define METRIC_NUMERIC_MATH_VIEWS_ROWS_DENSE_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
#include <metric/numeric/math/views/rows/RowsData.h>
...
class Rows<MT, true, true, SF, CRAs...> : public View<DenseMatrix<Rows<MT, true, true, SF, CRAs...>, false>>,
  ...
  public:
	...
	/*!\name Constructors */
	//@{
	template <typename... RRAs> explicit inline Rows(MT &matrix, RRAs... args);
	...
	template <typename MT2, bool SO2> inline Rows &operator=(const Matrix<MT2, SO2> &rhs);

	template <typename MT2, bool SO2>
	inline auto operator+=(const Matrix<MT2, SO2> &rhs) -> DisableIf_t<EnforceEvaluation_v<MT, MT2>, Rows &>;

	template <typename MT2, bool SO2>
	inline auto operator+=(const Matrix<MT2, SO2> &rhs) -> EnableIf_t<EnforceEvaluation_v<MT, MT2>, Rows &>;
  ...
  private:
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_ROWS_TYPE(MT);
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, true, true, SF, CRAs...>::Reference Rows<MT, true, true, SF, CRAs...>::operator()(size_t i,
																										   size_t j)
{
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, true, true, SF, CRAs...>::Reference Rows<MT, true, true, SF, CRAs...>::at(size_t i, size_t j)
{
	if (i >= rows()) {
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, true, true, SF, CRAs...>::ConstReference Rows<MT, true, true, SF, CRAs...>::at(size_t i,
																										size_t j) const
{
	if (i >= rows()) {
		METRIC_NUMERIC_THROW_OUT_OF_RANGE("Invalid row access index");
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, true, true, SF, CRAs...>::Pointer Rows<MT, true, true, SF, CRAs...>::data() noexcept
{
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, true, true, SF, CRAs...>::ConstPointer Rows<MT, true, true, SF, CRAs...>::data() const noexcept
{
	return matrix_.data(idx(0UL));
}
/*! \endcond */
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, true, true, SF, CRAs...>::Pointer Rows<MT, true, true, SF, CRAs...>::data(size_t i) noexcept
{
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, true, true, SF, CRAs...>::Iterator Rows<MT, true, true, SF, CRAs...>::begin(size_t i)
{
	METRIC_NUMERIC_USER_ASSERT(i < rows(), "Invalid row access index");
...
template <typename MT // Type of the dense matrix
		  ...
		  typename... CRAs> // Compile time row arguments
inline
	typename Rows<MT, true, true, SF, CRAs...>::ConstIterator Rows<MT, true, true, SF, CRAs...>::begin(size_t i) const
{
	METRIC_NUMERIC_USER_ASSERT(i < rows(), "Invalid row access index");
...
template <typename MT // Type of the dense matrix
		  ...
		  typename... CRAs> // Compile time row arguments
inline
	typename Rows<MT, true, true, SF, CRAs...>::ConstIterator Rows<MT, true, true, SF, CRAs...>::cbegin(size_t i) const
{
	METRIC_NUMERIC_USER_ASSERT(i < rows(), "Invalid row access index");
	return matrix_.cbegin(idx(i));
}
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, true, true, SF, CRAs...>::Iterator Rows<MT, true, true, SF, CRAs...>::end(size_t i)
{
	METRIC_NUMERIC_USER_ASSERT(i < rows(), "Invalid row access index");
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, true, true, SF, CRAs...>::ConstIterator Rows<MT, true, true, SF, CRAs...>::end(size_t i) const
{
	METRIC_NUMERIC_USER_ASSERT(i < rows(), "Invalid row access index");
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, true, true, SF, CRAs...>::ConstIterator Rows<MT, true, true, SF, CRAs...>::cend(size_t i) const
{
	METRIC_NUMERIC_USER_ASSERT(i < rows(), "Invalid row access index");
	return matrix_.cend(idx(i));
}
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CRAs> // Compile time row arguments
inline Rows<MT, true, true, SF, CRAs...> &Rows<MT, true, true, SF, CRAs...>::operator=(const ElementType &rhs)
{
	for (size_t i = 0UL; i < rows(); ++i) {
...
Rows<MT, true, true, SF, CRAs...>::operator=(initializer_list<initializer_list<ElementType>> list)
{
	...
	if (list.size() != rows()) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Invalid assignment to row selection");
	}
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CRAs> // Compile time row arguments
inline Rows<MT, true, true, SF, CRAs...> &Rows<MT, true, true, SF, CRAs...>::operator=(const Rows &rhs)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_SYMMETRIC_MATRIX_TYPE(MT);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_HERMITIAN_MATRIX_TYPE(MT);
...
inline Rows<MT, true, true, SF, CRAs...> &Rows<MT, true, true, SF, CRAs...>::operator=(const Matrix<MT2, SO2> &rhs)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_SYMMETRIC_MATRIX_TYPE(MT);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_HERMITIAN_MATRIX_TYPE(MT);
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CRAs> // Compile time row arguments
inline Rows<MT, true, true, SF, CRAs...> &Rows<MT, true, true, SF, CRAs...>::transpose()
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_SYMMETRIC_MATRIX_TYPE(MT);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_HERMITIAN_MATRIX_TYPE(MT);

	if (rows() != columns()) {
		METRIC_NUMERIC_THROW_LOGIC_ERROR("Invalid transpose of a non-quadratic matrix");
	}
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CRAs> // Compile time row arguments
inline Rows<MT, true, true, SF, CRAs...> &Rows<MT, true, true, SF, CRAs...>::ctranspose()
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_SYMMETRIC_MATRIX_TYPE(MT);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_HERMITIAN_MATRIX_TYPE(MT);
...
inline Rows<MT, true, true, SF, CRAs...> &Rows<MT, true, true, SF, CRAs...>::scale(const Other &scalar)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_SYMMETRIC_MATRIX_TYPE(MT);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_HERMITIAN_MATRIX_TYPE(MT);
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CRAs> // Compile time row arguments
template <typename MT2		// Data type of the other dense row selection
		  ,
		  bool SO2 // Storage order of the other dense row selection
		  ,
		  bool SF2 // Symmetry flag of the other dense row selection
		  ,
		  typename... CRAs2> // Compile time row arguments of the other dense row selection
inline bool Rows<MT, true, true, SF, CRAs...>::canAlias(const Rows<MT2, SO2, true, SF2, CRAs2...> *alias) const noexcept
{
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CRAs> // Compile time row arguments
METRIC_NUMERIC_ALWAYS_INLINE typename Rows<MT, true, true, SF, CRAs...>::SIMDType
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CRAs> // Compile time row arguments
METRIC_NUMERIC_ALWAYS_INLINE void Rows<MT, true, true, SF, CRAs...>::store(size_t i, size_t j,
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CRAs> // Compile time row arguments
METRIC_NUMERIC_ALWAYS_INLINE void Rows<MT, true, true, SF, CRAs...>::storea(size_t i, size_t j,
																			const SIMDType &value) noexcept
{
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CRAs> // Compile time row arguments
METRIC_NUMERIC_ALWAYS_INLINE void Rows<MT, true, true, SF, CRAs...>::storeu(size_t i, size_t j,
																			const SIMDType &value) noexcept
{
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  typename... CRAs> // Compile time row arguments
METRIC_NUMERIC_ALWAYS_INLINE void Rows<MT, true, true, SF, CRAs...>::stream(size_t i, size_t j,
																			const SIMDType &value) noexcept
{
...
inline void Rows<MT, true, true, SF, CRAs...>::assign(const DenseMatrix<MT2, true> &rhs)
{
	...
	if (rows() < block && columns() < block) {
		...
		METRIC_NUMERIC_INTERNAL_ASSERT(jpos <= (*rhs).columns(), "Invalid end calculation");
...
template <typename MT // Type of the dense matrix
		  ,
		  typename... CRAs> // Compile time row arguments
class Rows<MT, false, true, false, CRAs...> : public View<DenseMatrix<Rows<MT, false, true, false, CRAs...>, false>>,
											  private RowsData<CRAs...> {
  private:
	//**Type definitions****************************************************************************
	using DataType = RowsData<CRAs...>;					//!< The type of the RowsData base class.
  ...
  public:
	...
	class RowsIterator {
	  public:
		...
		*/
		inline DifferenceType operator-(const RowsIterator &rhs) const noexcept { return column_ - rhs.column_; }
		//*******************************************************************************************
...
template <typename MT // Type of the dense matrix
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, false, true, false, CRAs...>::Reference Rows<MT, false, true, false, CRAs...>::at(size_t i,
																										   size_t j)
{
	if (i >= rows()) {
		METRIC_NUMERIC_THROW_OUT_OF_RANGE("Invalid row access index");
...
template <typename MT // Type of the dense matrix
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, false, true, false, CRAs...>::Pointer Rows<MT, false, true, false, CRAs...>::data() noexcept
{
	return matrix_.data() + idx(0UL);
}
/*! \endcond */
...
template <typename MT // Type of the dense matrix
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, false, true, false, CRAs...>::Iterator Rows<MT, false, true, false, CRAs...>::begin(size_t i)
{
	METRIC_NUMERIC_USER_ASSERT(i < rows(), "Invalid row access index");
...
template <typename MT // Type of the dense matrix
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, false, true, false, CRAs...>::Iterator Rows<MT, false, true, false, CRAs...>::end(size_t i)
{
	METRIC_NUMERIC_USER_ASSERT(i < rows(), "Invalid row access index");
...
template <typename MT // Type of the dense matrix
		  ,
		  typename... CRAs> // Compile time row arguments
inline Rows<MT, false, true, false, CRAs...> &Rows<MT, false, true, false, CRAs...>::operator=(const ElementType &rhs)
{
	for (size_t i = 0UL; i < rows(); ++i) {
		row(matrix_, idx(i), unchecked) = rhs;
	}
...
template <typename MT // Type of the dense matrix
		  ,
		  typename... CRAs> // Compile time row arguments
inline Rows<MT, false, true, false, CRAs...> &Rows<MT, false, true, false, CRAs...>::operator=(const Rows &rhs)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_SYMMETRIC_MATRIX_TYPE(MT);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_HERMITIAN_MATRIX_TYPE(MT);
...
template <typename MT // Type of the dense matrix
		  ,
		  typename... CRAs> // Compile time row arguments
inline Rows<MT, false, true, false, CRAs...> &Rows<MT, false, true, false, CRAs...>::transpose()
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_SYMMETRIC_MATRIX_TYPE(MT);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_HERMITIAN_MATRIX_TYPE(MT);
...
template <typename MT // Type of the dense matrix
		  ,
		  typename... CRAs> // Compile time row arguments
inline Rows<MT, false, true, false, CRAs...> &Rows<MT, false, true, false, CRAs...>::ctranspose()
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_SYMMETRIC_MATRIX_TYPE(MT);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_HERMITIAN_MATRIX_TYPE(MT);
...
template <typename MT // Type of the dense matrix
		  ...
		  typename... CRAs> // Compile time row arguments
template <typename Other>	// Data type of the scalar value
inline Rows<MT, false, true, false, CRAs...> &Rows<MT, false, true, false, CRAs...>::scale(const Other &scalar)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_SYMMETRIC_MATRIX_TYPE(MT);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_HERMITIAN_MATRIX_TYPE(MT);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_UNITRIANGULAR_MATRIX_TYPE(MT);
...
template <typename MT // Type of the dense matrix
		  ,
		  typename... CRAs> // Compile time row arguments
class Rows<MT, false, true, true, CRAs...> : public View<DenseMatrix<Rows<MT, false, true, true, CRAs...>, false>>,
											 private RowsData<CRAs...> {
  private:
	//**Type definitions****************************************************************************
	using DataType = RowsData<CRAs...>;					//!< The type of the RowsData base class.
...
template <typename MT // Type of the dense matrix
		  ...
		  typename... CRAs> // Compile time row arguments
inline
	typename Rows<MT, false, true, true, CRAs...>::Reference Rows<MT, false, true, true, CRAs...>::operator()(size_t i,
																											  size_t j)
{
	METRIC_NUMERIC_USER_ASSERT(i < rows(), "Invalid row access index");
	METRIC_NUMERIC_USER_ASSERT(j < columns(), "Invalid column access index");
...
template <typename MT // Type of the dense matrix
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, false, true, true, CRAs...>::Reference Rows<MT, false, true, true, CRAs...>::at(size_t i,
																										 size_t j)
{
	if (i >= rows()) {
		METRIC_NUMERIC_THROW_OUT_OF_RANGE("Invalid row access index");
...
template <typename MT // Type of the dense matrix
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, false, true, true, CRAs...>::Pointer Rows<MT, false, true, true, CRAs...>::data() noexcept
{
	return matrix_.data(idx(0UL));
}
/*! \endcond */
...
template <typename MT // Type of the dense matrix
		  ...
		  typename... CRAs> // Compile time row arguments
inline
	typename Rows<MT, false, true, true, CRAs...>::Pointer Rows<MT, false, true, true, CRAs...>::data(size_t i) noexcept
{
	return matrix_.data(idx(i));
}
/*! \endcond */
...
template <typename MT // Type of the dense matrix
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, false, true, true, CRAs...>::Iterator Rows<MT, false, true, true, CRAs...>::begin(size_t i)
{
	METRIC_NUMERIC_USER_ASSERT(i < rows(), "Invalid row access index");
	return matrix_.begin(idx(i));
}
...
template <typename MT // Type of the dense matrix
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, false, true, true, CRAs...>::Iterator Rows<MT, false, true, true, CRAs...>::end(size_t i)
{
	METRIC_NUMERIC_USER_ASSERT(i < rows(), "Invalid row access index");
	return matrix_.end(idx(i));
}
...
template <typename MT // Type of the dense matrix
		  ,
		  typename... CRAs> // Compile time row arguments
inline Rows<MT, false, true, true, CRAs...> &Rows<MT, false, true, true, CRAs...>::operator=(const ElementType &rhs)
{
	for (size_t i = 0UL; i < rows(); ++i) {
...
template <typename MT // Type of the dense matrix
		  ,
		  typename... CRAs> // Compile time row arguments
METRIC_NUMERIC_ALWAYS_INLINE typename Rows<MT, false, true, true, CRAs...>::SIMDType
