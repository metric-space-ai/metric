...
#ifndef METRIC_NUMERIC_MATH_VIEWS_ROWS_SPARSE_H
#define METRIC_NUMERIC_MATH_VIEWS_ROWS_SPARSE_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class Rows<MT, true, false, SF, CRAs...> : public View<SparseMatrix<Rows<MT, true, false, SF, CRAs...>, false>>,
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, true, false, SF, CRAs...>::Reference Rows<MT, true, false, SF, CRAs...>::operator()(size_t i,
																											 size_t j)
{
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, true, false, SF, CRAs...>::Reference Rows<MT, true, false, SF, CRAs...>::at(size_t i, size_t j)
{
	if (i >= rows()) {
...
template <typename MT // Type of the sparse matrix
		  ...
		  typename... CRAs> // Compile time row arguments
inline
	typename Rows<MT, true, false, SF, CRAs...>::ConstReference Rows<MT, true, false, SF, CRAs...>::at(size_t i,
																									   size_t j) const
{
	if (i >= rows()) {
		METRIC_NUMERIC_THROW_OUT_OF_RANGE("Invalid row access index");
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, true, false, SF, CRAs...>::Iterator Rows<MT, true, false, SF, CRAs...>::begin(size_t i)
{
	METRIC_NUMERIC_USER_ASSERT(i < rows(), "Invalid row access index");
...
template <typename MT // Type of the sparse matrix
		  ...
		  typename... CRAs> // Compile time row arguments
inline
	typename Rows<MT, true, false, SF, CRAs...>::ConstIterator Rows<MT, true, false, SF, CRAs...>::begin(size_t i) const
{
	METRIC_NUMERIC_USER_ASSERT(i < rows(), "Invalid row access index");
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, true, false, SF, CRAs...>::Iterator Rows<MT, true, false, SF, CRAs...>::end(size_t i)
{
	METRIC_NUMERIC_USER_ASSERT(i < rows(), "Invalid row access index");
...
template <typename MT // Type of the sparse matrix
		  ...
		  typename... CRAs> // Compile time row arguments
inline
	typename Rows<MT, true, false, SF, CRAs...>::ConstIterator Rows<MT, true, false, SF, CRAs...>::end(size_t i) const
{
	METRIC_NUMERIC_USER_ASSERT(i < rows(), "Invalid row access index");
...
template <typename MT // Type of the sparse matrix
		  ...
		  typename... CRAs> // Compile time row arguments
inline
	typename Rows<MT, true, false, SF, CRAs...>::ConstIterator Rows<MT, true, false, SF, CRAs...>::cend(size_t i) const
{
	METRIC_NUMERIC_USER_ASSERT(i < rows(), "Invalid row access index");
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  typename... CRAs> // Compile time row arguments
inline Rows<MT, true, false, SF, CRAs...> &Rows<MT, true, false, SF, CRAs...>::operator=(const Rows &rhs)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_SYMMETRIC_MATRIX_TYPE(MT);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_HERMITIAN_MATRIX_TYPE(MT);

	METRIC_NUMERIC_CONSTRAINT_MUST_BE_SPARSE_MATRIX_TYPE(ResultType);
...
inline Rows<MT, true, false, SF, CRAs...> &Rows<MT, true, false, SF, CRAs...>::operator=(const Matrix<MT2, SO> &rhs)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_SYMMETRIC_MATRIX_TYPE(MT);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_HERMITIAN_MATRIX_TYPE(MT);
...
inline size_t Rows<MT, true, false, SF, CRAs...>::extendCapacity(size_t i) const noexcept
{
	...
	METRIC_NUMERIC_INTERNAL_ASSERT(nonzeros > capacity(i), "Invalid capacity value");
...
// efficient way to add new elements to a sparse row selection:
   ...
   \code
   mtrc::numeric::CompressedMatrix<double,mtrc::numeric::rowMajor> A( 42, 54 );
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, true, false, SF, CRAs...>::Iterator Rows<MT, true, false, SF, CRAs...>::erase(size_t i,
																									   Iterator pos)
{
	METRIC_NUMERIC_USER_ASSERT(i < rows(), "Invalid row access index");
...
template <typename MT // Type of the sparse matrix
		  ...
		  typename... CRAs> // Compile time row arguments
inline
	typename Rows<MT, true, false, SF, CRAs...>::Iterator Rows<MT, true, false, SF, CRAs...>::find(size_t i, size_t j)
{
...
template <typename MT // Type of the sparse matrix
		  ...
		  typename... CRAs> // Compile time row arguments
inline
	typename Rows<MT, true, false, SF, CRAs...>::ConstIterator Rows<MT, true, false, SF, CRAs...>::find(size_t i,
																										size_t j) const
{
	return matrix_.find(idx(i), j);
}
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, true, false, SF, CRAs...>::Iterator Rows<MT, true, false, SF, CRAs...>::lowerBound(size_t i,
																											size_t j)
{
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, true, false, SF, CRAs...>::Iterator Rows<MT, true, false, SF, CRAs...>::upperBound(size_t i,
																											size_t j)
{
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  typename... CRAs> // Compile time row arguments
inline Rows<MT, true, false, SF, CRAs...> &Rows<MT, true, false, SF, CRAs...>::transpose()
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_SYMMETRIC_MATRIX_TYPE(MT);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_HERMITIAN_MATRIX_TYPE(MT);
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  typename... CRAs> // Compile time row arguments
inline Rows<MT, true, false, SF, CRAs...> &Rows<MT, true, false, SF, CRAs...>::ctranspose()
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_SYMMETRIC_MATRIX_TYPE(MT);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_HERMITIAN_MATRIX_TYPE(MT);
...
inline Rows<MT, true, false, SF, CRAs...> &Rows<MT, true, false, SF, CRAs...>::scale(const Other &scalar)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_SYMMETRIC_MATRIX_TYPE(MT);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_HERMITIAN_MATRIX_TYPE(MT);
...
inline void Rows<MT, true, false, SF, CRAs...>::schurAssign(const Matrix<MT2, SO> &rhs)
{
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_SPARSE_MATRIX_TYPE(SchurType);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(SchurType);
...
template <typename MT // Type of the sparse matrix
		  ,
		  typename... CRAs> // Compile time row arguments
class Rows<MT, false, false, false, CRAs...> : public View<SparseMatrix<Rows<MT, false, false, false, CRAs...>, false>>,
											   private RowsData<CRAs...> {
  private:
	//**Type definitions****************************************************************************
	using DataType = RowsData<CRAs...>;					//!< The type of the RowsData base class.
  ...
  public:
	...
	class RowsElement : private SparseElement {
	  public:
		//**Constructor******************************************************************************
		...
		*/
		inline const RowsElement *operator->() const { return this; }
		//*******************************************************************************************
...
template <typename MT // Type of the sparse matrix
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, false, false, false, CRAs...>::Reference Rows<MT, false, false, false, CRAs...>::at(size_t i,
																											 size_t j)
{
	if (i >= rows()) {
		METRIC_NUMERIC_THROW_OUT_OF_RANGE("Invalid row access index");
...
template <typename MT // Type of the sparse matrix
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, false, false, false, CRAs...>::Iterator Rows<MT, false, false, false, CRAs...>::begin(size_t i)
{
	METRIC_NUMERIC_USER_ASSERT(i < rows(), "Invalid row access index");
...
template <typename MT // Type of the sparse matrix
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, false, false, false, CRAs...>::Iterator Rows<MT, false, false, false, CRAs...>::end(size_t i)
{
	METRIC_NUMERIC_USER_ASSERT(i < rows(), "Invalid row access index");
...
template <typename MT // Type of the sparse matrix
		  ,
		  typename... CRAs> // Compile time row arguments
inline Rows<MT, false, false, false, CRAs...> &Rows<MT, false, false, false, CRAs...>::operator=(const Rows &rhs)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_SYMMETRIC_MATRIX_TYPE(MT);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_HERMITIAN_MATRIX_TYPE(MT);
...
inline void Rows<MT, false, false, false, CRAs...>::reset(size_t i)
{
	...
	const size_t jbegin((IsUpper_v<MT>) ? ((IsUniUpper_v<MT> || IsStrictlyUpper_v<MT>) ? (index + 1UL) : (index))
										: (0UL));
	const size_t jend((IsLower_v<MT>) ? ((IsUniLower_v<MT> || IsStrictlyLower_v<MT>) ? (index) : (index + 1UL))
									  : (columns()));
...
// efficient way to add new elements to a sparse row selection:
   ...
   \code
   mtrc::numeric::CompressedMatrix<double,mtrc::numeric::columnMajor> A( 42, 54 );
   auto B = rows( A, { 10, 16, 4, 3 } );
...
template <typename MT // Type of the sparse matrix
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, false, false, false, CRAs...>::Iterator Rows<MT, false, false, false, CRAs...>::find(size_t i,
																											  size_t j)
{
	const size_t index(idx(i));
...
template <typename MT // Type of the sparse matrix
		  ,
		  typename... CRAs> // Compile time row arguments
inline Rows<MT, false, false, false, CRAs...> &Rows<MT, false, false, false, CRAs...>::transpose()
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_SYMMETRIC_MATRIX_TYPE(MT);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_HERMITIAN_MATRIX_TYPE(MT);
...
template <typename MT // Type of the sparse matrix
		  ,
		  typename... CRAs> // Compile time row arguments
inline Rows<MT, false, false, false, CRAs...> &Rows<MT, false, false, false, CRAs...>::ctranspose()
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_SYMMETRIC_MATRIX_TYPE(MT);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_HERMITIAN_MATRIX_TYPE(MT);
...
template <typename MT // Type of the sparse matrix
		  ...
		  typename... CRAs> // Compile time row arguments
template <typename Other>	// Data type of the scalar value
inline Rows<MT, false, false, false, CRAs...> &Rows<MT, false, false, false, CRAs...>::scale(const Other &scalar)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_SYMMETRIC_MATRIX_TYPE(MT);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_HERMITIAN_MATRIX_TYPE(MT);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_UNITRIANGULAR_MATRIX_TYPE(MT);
	...
	for (size_t i = 0UL; i < rows(); ++i) {
		...
		for (ConstIterator_t<MT2> element = (*rhs).begin(i); element != (*rhs).end(i); ++element) {
			...
			if (!isDefault<strict>(value))
				...
				matrix_.erase(index, element->index());
		}
	}
}
/*! \endcond */
	...
	for (size_t j = 0UL; j < columns(); ++j) {
		for (ConstIterator_t<MT2> element = (*rhs).begin(j); element != (*rhs).end(j); ++element) {
			...
			if (!isDefault<strict>(value))
				...
				matrix_.erase(idx(element->index()), j);
		}
	}
}
/*! \endcond */
...
template <typename MT // Type of the sparse matrix
		  ,
		  typename... CRAs> // Compile time row arguments
class Rows<MT, false, false, true, CRAs...> : public View<SparseMatrix<Rows<MT, false, false, true, CRAs...>, false>>,
											  private RowsData<CRAs...> {
  private:
	//**Type definitions****************************************************************************
	using DataType = RowsData<CRAs...>;					//!< The type of the RowsData base class.
...
template <typename MT // Type of the sparse matrix
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, false, false, true, CRAs...>::Reference Rows<MT, false, false, true, CRAs...>::at(size_t i,
																										   size_t j)
{
	if (i >= rows()) {
		METRIC_NUMERIC_THROW_OUT_OF_RANGE("Invalid row access index");
...
template <typename MT // Type of the sparse matrix
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, false, false, true, CRAs...>::Iterator Rows<MT, false, false, true, CRAs...>::begin(size_t i)
{
	METRIC_NUMERIC_USER_ASSERT(i < rows(), "Invalid row access index");
...
template <typename MT // Type of the sparse matrix
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, false, false, true, CRAs...>::Iterator Rows<MT, false, false, true, CRAs...>::end(size_t i)
{
	METRIC_NUMERIC_USER_ASSERT(i < rows(), "Invalid row access index");
...
// efficient way to add new elements to a sparse row selection:
   ...
   \code
   mtrc::numeric::SymmetricMatrix< mtrc::numeric::CompressedMatrix<double,mtrc::numeric::columnMajor> > A( 42 );
   auto B = rows( A, { 10, 16, 4, 3 } );
...
template <typename MT // Type of the sparse matrix
		  ...
		  typename... CRAs> // Compile time row arguments
inline
	typename Rows<MT, false, false, true, CRAs...>::Iterator Rows<MT, false, false, true, CRAs...>::erase(size_t i,
																										  Iterator pos)
{
	METRIC_NUMERIC_USER_ASSERT(i < rows(), "Invalid row access index");
...
template <typename MT // Type of the sparse matrix
		  ,
		  typename... CRAs> // Compile time row arguments
inline typename Rows<MT, false, false, true, CRAs...>::Iterator Rows<MT, false, false, true, CRAs...>::find(size_t i,
																											size_t j)
{
...
template <typename MT // Type of the sparse matrix
		  ...
		  typename... CRAs> // Compile time row arguments
inline
	typename Rows<MT, false, false, true, CRAs...>::Iterator Rows<MT, false, false, true, CRAs...>::lowerBound(size_t i,
																											   size_t j)
{
...
template <typename MT // Type of the sparse matrix
		  ...
		  typename... CRAs> // Compile time row arguments
inline
	typename Rows<MT, false, false, true, CRAs...>::Iterator Rows<MT, false, false, true, CRAs...>::upperBound(size_t i,
																											   size_t j)
{
