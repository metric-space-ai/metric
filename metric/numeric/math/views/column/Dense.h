...
#ifndef METRIC_NUMERIC_MATH_VIEWS_COLUMN_DENSE_H
#define METRIC_NUMERIC_MATH_VIEWS_COLUMN_DENSE_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class Column<MT, true, true, SF, CCAs...> : public View<DenseVector<Column<MT, true, true, SF, CCAs...>, false>>,
  ...
  public:
	...
	/*!\name Constructors */
	//@{
	template <typename... RCAs> explicit inline Column(MT &matrix, RCAs... args);
  ...
  public:
	...
	template <typename VT> inline auto assign(const DenseVector<VT, false> &rhs) -> DisableIf_t<VectorizedAssign_v<VT>>;

	template <typename VT> inline auto assign(const DenseVector<VT, false> &rhs) -> EnableIf_t<VectorizedAssign_v<VT>>;
...
// providing the optional \a mtrc::numeric::unchecked argument.
*/
template <typename MT // Type of the dense matrix
		  ,
		  bool SF // Symmetry flag
	  ...
	  matrix_(matrix) // The matrix containing the column
{
	if (isChecked(args...)) {
		...
		METRIC_NUMERIC_USER_ASSERT(column() < matrix_.columns(), "Invalid column access index");
	}
}
/*! \endcond */
//*************************************************************************************************
...
{
	METRIC_NUMERIC_USER_ASSERT(index < size(), "Invalid column access index");
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  size_t... CCAs> // Compile time column arguments
inline typename Column<MT, true, true, SF, CCAs...>::Reference Column<MT, true, true, SF, CCAs...>::at(size_t index)
{
	if (index >= size()) {
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  size_t... CCAs> // Compile time column arguments
inline typename Column<MT, true, true, SF, CCAs...>::Pointer Column<MT, true, true, SF, CCAs...>::data() noexcept
{
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  size_t... CCAs> // Compile time column arguments
inline typename Column<MT, true, true, SF, CCAs...>::Iterator Column<MT, true, true, SF, CCAs...>::begin()
{
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  size_t... CCAs> // Compile time column arguments
inline typename Column<MT, true, true, SF, CCAs...>::ConstIterator Column<MT, true, true, SF, CCAs...>::begin() const
{
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  size_t... CCAs> // Compile time column arguments
inline typename Column<MT, true, true, SF, CCAs...>::ConstIterator Column<MT, true, true, SF, CCAs...>::cbegin() const
{
	return matrix_.cbegin(column());
}
/*! \endcond */
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  size_t... CCAs> // Compile time column arguments
inline typename Column<MT, true, true, SF, CCAs...>::Iterator Column<MT, true, true, SF, CCAs...>::end()
{
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  size_t... CCAs> // Compile time column arguments
inline typename Column<MT, true, true, SF, CCAs...>::ConstIterator Column<MT, true, true, SF, CCAs...>::end() const
{
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  size_t... CCAs> // Compile time column arguments
inline typename Column<MT, true, true, SF, CCAs...>::ConstIterator Column<MT, true, true, SF, CCAs...>::cend() const
{
	return matrix_.cend(column());
}
/*! \endcond */
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  size_t... CCAs> // Compile time column arguments
inline Column<MT, true, true, SF, CCAs...> &Column<MT, true, true, SF, CCAs...>::operator=(const ElementType &rhs)
{
	decltype(auto) left(derestrict(matrix_));

	const size_t ibegin((IsLower_v<MT>) ? ((IsUniLower_v<MT> || IsStrictlyLower_v<MT>) ? (column() + 1UL) : (column()))
										: (0UL));
	const size_t iend((IsUpper_v<MT>) ? ((IsUniUpper_v<MT> || IsStrictlyUpper_v<MT>) ? (column()) : (column() + 1UL))
									  : (size()));
...
{
	if (list.size() > size()) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Invalid assignment to column");
	}
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  size_t... CCAs> // Compile time column arguments
inline Column<MT, true, true, SF, CCAs...> &Column<MT, true, true, SF, CCAs...>::operator=(const Column &rhs)
{
	if (&rhs == this)
		return *this;

	if (size() != rhs.size()) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Column sizes do not match");
	}
...
inline Column<MT, true, true, SF, CCAs...> &Column<MT, true, true, SF, CCAs...>::operator=(const Vector<VT, false> &rhs)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_COLUMN_VECTOR_TYPE(ResultType_t<VT>);
...
Column<MT, true, true, SF, CCAs...>::operator%=(const Vector<VT, false> &rhs)
{
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_COLUMN_VECTOR_TYPE(CrossType);
...
inline Column<MT, true, true, SF, CCAs...> &Column<MT, true, true, SF, CCAs...>::scale(const Other &scalar)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_UNITRIANGULAR_MATRIX_TYPE(MT);

	const size_t ibegin((IsLower_v<MT>) ? ((IsStrictlyLower_v<MT>) ? (column() + 1UL) : (column())) : (0UL));
	const size_t iend((IsUpper_v<MT>) ? ((IsStrictlyUpper_v<MT>) ? (column()) : (column() + 1UL)) : (size()));
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  size_t... CCAs> // Compile time column arguments
template <typename MT2	  // Data type of the other dense column
		  ,
		  bool SO2 // Storage order of the other dense column
		  ,
		  bool SF2 // Symmetry flag of the other dense column
		  ,
		  size_t... CCAs2> // Compile time column arguments of the other dense column
inline bool
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  size_t... CCAs> // Compile time column arguments
METRIC_NUMERIC_ALWAYS_INLINE typename Column<MT, true, true, SF, CCAs...>::SIMDType
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  size_t... CCAs> // Compile time column arguments
METRIC_NUMERIC_ALWAYS_INLINE void Column<MT, true, true, SF, CCAs...>::store(size_t index,
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  size_t... CCAs> // Compile time column arguments
METRIC_NUMERIC_ALWAYS_INLINE void Column<MT, true, true, SF, CCAs...>::storea(size_t index,
																			  const SIMDType &value) noexcept
{
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  size_t... CCAs> // Compile time column arguments
METRIC_NUMERIC_ALWAYS_INLINE void Column<MT, true, true, SF, CCAs...>::storeu(size_t index,
																			  const SIMDType &value) noexcept
{
...
template <typename MT // Type of the dense matrix
		  ...
		  ,
		  size_t... CCAs> // Compile time column arguments
METRIC_NUMERIC_ALWAYS_INLINE void Column<MT, true, true, SF, CCAs...>::stream(size_t index,
																			  const SIMDType &value) noexcept
{
...
class Column<MT, false, true, false, CCAs...>
	: public View<DenseVector<Column<MT, false, true, false, CCAs...>, false>>, private ColumnData<CCAs...> {
  private:
	//**Type definitions****************************************************************************
	using DataType = ColumnData<CCAs...>;				//!< The type of the ColumnData base class.
	using Operand = If_t<IsExpression_v<MT>, MT, MT &>; //!< Composite data type of the dense matrix expression.
	...
	class ColumnIterator {
	  public:
		...
		*/
		...
		{
			METRIC_NUMERIC_USER_ASSERT(row_ + index < matrix_->rows(), "Invalid access index detected");
		...
		*/
		inline DifferenceType operator-(const ColumnIterator &rhs) const noexcept { return row_ - rhs.row_; }
		//*******************************************************************************************
...
template <typename MT // Type of the dense matrix
		  ...
		  size_t... CCAs> // Compile time column arguments
inline
	typename Column<MT, false, true, false, CCAs...>::Pointer Column<MT, false, true, false, CCAs...>::data() noexcept
{
	return matrix_.data() + column();
}
/*! \endcond */
...
template <typename MT // Type of the dense matrix
		  ,
		  size_t... CCAs> // Compile time column arguments
inline typename Column<MT, false, true, false, CCAs...>::Iterator Column<MT, false, true, false, CCAs...>::begin()
{
...
template <typename MT // Type of the dense matrix
		  ,
		  size_t... CCAs> // Compile time column arguments
inline typename Column<MT, false, true, false, CCAs...>::Iterator Column<MT, false, true, false, CCAs...>::end()
{
...
template <typename MT // Type of the dense matrix
		  ...
		  size_t... CCAs> // Compile time column arguments
inline
	typename Column<MT, false, true, false, CCAs...>::ConstIterator Column<MT, false, true, false, CCAs...>::end() const
{
...
template <typename MT // Type of the dense matrix
		  ,
		  size_t... CCAs> // Compile time column arguments
inline Column<MT, false, true, false, CCAs...> &Column<MT, false, true, false, CCAs...>::operator=(const Column &rhs)
{
	if (&rhs == this)
		return *this;
...
template <typename MT // Type of the dense matrix
		  ...
		  size_t... CCAs> // Compile time column arguments
template <typename Other> // Data type of the scalar value
inline Column<MT, false, true, false, CCAs...> &Column<MT, false, true, false, CCAs...>::scale(const Other &scalar)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_UNITRIANGULAR_MATRIX_TYPE(MT);
...
template <typename MT // Type of the dense matrix
		  ,
		  size_t... CCAs> // Compile time column arguments
class Column<MT, false, true, true, CCAs...> : public View<DenseVector<Column<MT, false, true, true, CCAs...>, false>>,
											   private ColumnData<CCAs...> {
  private:
	//**Type definitions****************************************************************************
	using DataType = ColumnData<CCAs...>;				//!< The type of the ColumnData base class.
...
template <typename MT // Type of the dense matrix
		  ...
		  size_t... CCAs> // Compile time column arguments
inline
	typename Column<MT, false, true, true, CCAs...>::Reference Column<MT, false, true, true, CCAs...>::at(size_t index)
{
	if (index >= size()) {
		METRIC_NUMERIC_THROW_OUT_OF_RANGE("Invalid column access index");
	}
...
template <typename MT // Type of the dense matrix
		  ,
		  size_t... CCAs> // Compile time column arguments
inline typename Column<MT, false, true, true, CCAs...>::Pointer Column<MT, false, true, true, CCAs...>::data() noexcept
{
	return matrix_.data(column());
}
/*! \endcond */
...
template <typename MT // Type of the dense matrix
		  ,
		  size_t... CCAs> // Compile time column arguments
inline typename Column<MT, false, true, true, CCAs...>::Iterator Column<MT, false, true, true, CCAs...>::begin()
{
	return matrix_.begin(column());
}
/*! \endcond */
...
template <typename MT // Type of the dense matrix
		  ...
		  size_t... CCAs> // Compile time column arguments
inline
	typename Column<MT, false, true, true, CCAs...>::ConstIterator Column<MT, false, true, true, CCAs...>::begin() const
{
	return matrix_.cbegin(column());
}
/*! \endcond */
...
template <typename MT // Type of the dense matrix
		  ,
		  size_t... CCAs> // Compile time column arguments
inline typename Column<MT, false, true, true, CCAs...>::Iterator Column<MT, false, true, true, CCAs...>::end()
{
	return matrix_.end(column());
}
/*! \endcond */
...
template <typename MT // Type of the dense matrix
		  ...
		  size_t... CCAs> // Compile time column arguments
inline
	typename Column<MT, false, true, true, CCAs...>::ConstIterator Column<MT, false, true, true, CCAs...>::end() const
{
	return matrix_.cend(column());
}
/*! \endcond */
...
template <typename MT // Type of the dense matrix
		  ...
		  size_t... CCAs> // Compile time column arguments
inline
	typename Column<MT, false, true, true, CCAs...>::ConstIterator Column<MT, false, true, true, CCAs...>::cend() const
{
	return matrix_.cend(column());
}
/*! \endcond */
...
template <typename MT // Type of the dense matrix
		  ,
		  size_t... CCAs> // Compile time column arguments
inline Column<MT, false, true, true, CCAs...> &Column<MT, false, true, true, CCAs...>::operator=(const ElementType &rhs)
{
	decltype(auto) left(derestrict(matrix_));

	const size_t jbegin((IsUpper_v<MT>) ? ((IsUniUpper_v<MT> || IsStrictlyUpper_v<MT>) ? (column() + 1UL) : (column()))
										: (0UL));
	const size_t jend((IsLower_v<MT>) ? ((IsUniLower_v<MT> || IsStrictlyLower_v<MT>) ? (column()) : (column() + 1UL))
									  : (size()));
...
template <typename MT // Type of the dense matrix
		  ,
		  size_t... CCAs> // Compile time column arguments
inline Column<MT, false, true, true, CCAs...> &Column<MT, false, true, true, CCAs...>::operator=(const Column &rhs)
{
	if (&rhs == this)
		return *this;
...
template <typename MT // Type of the dense matrix
		  ...
		  size_t... CCAs> // Compile time column arguments
template <typename Other> // Data type of the scalar value
inline Column<MT, false, true, true, CCAs...> &Column<MT, false, true, true, CCAs...>::scale(const Other &scalar)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_UNITRIANGULAR_MATRIX_TYPE(MT);

	const size_t jbegin((IsUpper_v<MT>) ? ((IsStrictlyUpper_v<MT>) ? (column() + 1UL) : (column())) : (0UL));
	const size_t jend((IsLower_v<MT>) ? ((IsStrictlyLower_v<MT>) ? (column()) : (column() + 1UL)) : (size()));
...
template <typename MT // Type of the dense matrix
		  ,
		  size_t... CCAs> // Compile time column arguments
METRIC_NUMERIC_ALWAYS_INLINE typename Column<MT, false, true, true, CCAs...>::SIMDType
...
template <typename MT // Type of the dense matrix
		  ,
		  size_t... CCAs> // Compile time column arguments
METRIC_NUMERIC_ALWAYS_INLINE void Column<MT, false, true, true, CCAs...>::store(size_t index,
																				const SIMDType &value) noexcept
{
...
template <typename MT // Type of the dense matrix
		  ,
		  size_t... CCAs> // Compile time column arguments
METRIC_NUMERIC_ALWAYS_INLINE void Column<MT, false, true, true, CCAs...>::storea(size_t index,
																				 const SIMDType &value) noexcept
{
...
template <typename MT // Type of the dense matrix
		  ,
		  size_t... CCAs> // Compile time column arguments
METRIC_NUMERIC_ALWAYS_INLINE void Column<MT, false, true, true, CCAs...>::storeu(size_t index,
																				 const SIMDType &value) noexcept
{
...
template <typename MT // Type of the dense matrix
		  ,
		  size_t... CCAs> // Compile time column arguments
METRIC_NUMERIC_ALWAYS_INLINE void Column<MT, false, true, true, CCAs...>::stream(size_t index,
																				 const SIMDType &value) noexcept
{
