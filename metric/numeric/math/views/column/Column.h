...
#ifndef METRIC_NUMERIC_MATH_VIEWS_COLUMN_COLUMN_H
#define METRIC_NUMERIC_MATH_VIEWS_COLUMN_COLUMN_H
//=================================================================================================
//
...
// function. It can be included via the header files
   ...
   // or
   #include <metric/numeric/math/Column.h>
   \endcode
...
// compile time arguments. If the type is required, it can be determined via \c decltype specifier:
   ...
   using ColumnType = decltype( mtrc::numeric::column<1UL>( std::declval<MatrixType>() ) );
   \endcode
...
// of an assignment. The following example demonstrates this in detail:
   ...
   \code
   mtrc::numeric::DynamicVector<double,mtrc::numeric::columnVector> x;
   mtrc::numeric::CompressedVector<double,mtrc::numeric::columnVector> y;
   mtrc::numeric::DynamicMatrix<double,mtrc::numeric::columnMajor> A, B;
   mtrc::numeric::CompressedMatrix<double,mtrc::numeric::columnMajor> C, D;
   // ... Resizing and initialization
...
// columns an iterator to immutable elements is returned:
   ...
   \code
   mtrc::numeric::DynamicMatrix<int,mtrc::numeric::columnMajor> A( 128UL, 256UL );
   // ... Resizing and initialization
   ...
   \code
   mtrc::numeric::CompressedMatrix<int,mtrc::numeric::columnMajor> A( 128UL, 256UL );
   // ... Resizing and initialization
...
// The following example demonstrates all options:
   ...
   \code
   mtrc::numeric::CompressedMatrix<double,mtrc::numeric::columnMajor> A( 100UL, 10UL );  // Non-initialized 100x10
matrix
...
// fitting element types:
   ...
   \code
   mtrc::numeric::DynamicVector<double,mtrc::numeric::columnVector> a( 2UL, 2.0 ), b;
   mtrc::numeric::CompressedVector<double,mtrc::numeric::columnVector> c( 2UL );
   c[1] = 3.0;

   mtrc::numeric::DynamicMatrix<double,mtrc::numeric::columnMajor> A( 2UL, 4UL );  // Non-initialized 2x4 matrix
...
// elements. Therefore care has to be taken in the choice of the most suitable storage order:
   ...
   mtrc::numeric::DynamicVector<double,mtrc::numeric::columnVector> x = column( A * B, 15UL );

   // ... is essentially the same as the following computation, which multiplies
   // A with the 15th column of the row-major matrix B.
   mtrc::numeric::DynamicVector<double,mtrc::numeric::columnVector> x = A * column( B, 15UL );
   \endcode

// Although Metric numeric performs the resulting matrix/vector multiplication as efficiently as possible
