...
#ifndef METRIC_NUMERIC_MATH_VIEWS_COLUMN_SPARSE_H
#define METRIC_NUMERIC_MATH_VIEWS_COLUMN_SPARSE_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class Column<MT, true, false, SF, CCAs...> : public View<SparseVector<Column<MT, true, false, SF, CCAs...>, false>>,
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  size_t... CCAs> // Compile time column arguments
inline typename Column<MT, true, false, SF, CCAs...>::Reference Column<MT, true, false, SF, CCAs...>::at(size_t index)
{
	if (index >= size()) {
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  size_t... CCAs> // Compile time column arguments
inline typename Column<MT, true, false, SF, CCAs...>::Iterator Column<MT, true, false, SF, CCAs...>::begin()
{
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  size_t... CCAs> // Compile time column arguments
inline typename Column<MT, true, false, SF, CCAs...>::ConstIterator Column<MT, true, false, SF, CCAs...>::begin() const
{
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  size_t... CCAs> // Compile time column arguments
inline typename Column<MT, true, false, SF, CCAs...>::ConstIterator Column<MT, true, false, SF, CCAs...>::cbegin() const
{
	return matrix_.cbegin(column());
}
/*! \endcond */
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  size_t... CCAs> // Compile time column arguments
inline typename Column<MT, true, false, SF, CCAs...>::Iterator Column<MT, true, false, SF, CCAs...>::end()
{
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  size_t... CCAs> // Compile time column arguments
inline typename Column<MT, true, false, SF, CCAs...>::ConstIterator Column<MT, true, false, SF, CCAs...>::end() const
{
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  size_t... CCAs> // Compile time column arguments
inline typename Column<MT, true, false, SF, CCAs...>::ConstIterator Column<MT, true, false, SF, CCAs...>::cend() const
{
	return matrix_.cend(column());
}
/*! \endcond */
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  size_t... CCAs> // Compile time column arguments
inline Column<MT, true, false, SF, CCAs...> &Column<MT, true, false, SF, CCAs...>::operator=(const Column &rhs)
{
	using mtrc::numeric::assign;
...
Column<MT, true, false, SF, CCAs...>::operator+=(const DenseVector<VT, false> &rhs)
{
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_COLUMN_VECTOR_TYPE(AddType);
...
Column<MT, true, false, SF, CCAs...>::operator-=(const DenseVector<VT, false> &rhs)
{
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_COLUMN_VECTOR_TYPE(SubType);
...
Column<MT, true, false, SF, CCAs...>::operator*=(const Vector<VT, false> &rhs)
{
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_COLUMN_VECTOR_TYPE(MultType);
...
Column<MT, true, false, SF, CCAs...>::operator/=(const DenseVector<VT, false> &rhs)
{
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_COLUMN_VECTOR_TYPE(DivType);
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  size_t... CCAs> // Compile time column arguments
inline typename Column<MT, true, false, SF, CCAs...>::Iterator Column<MT, true, false, SF, CCAs...>::erase(Iterator pos)
{
...
template <typename MT // Type of the sparse matrix
		  ...
		  size_t... CCAs> // Compile time column arguments
inline
	typename Column<MT, true, false, SF, CCAs...>::Iterator Column<MT, true, false, SF, CCAs...>::erase(Iterator first,
																										Iterator last)
{
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  size_t... CCAs> // Compile time column arguments
inline typename Column<MT, true, false, SF, CCAs...>::Iterator Column<MT, true, false, SF, CCAs...>::find(size_t index)
{
...
inline Column<MT, true, false, SF, CCAs...> &Column<MT, true, false, SF, CCAs...>::scale(const Other &scalar)
{
...
class Column<MT, false, false, false, CCAs...>
	: public View<SparseVector<Column<MT, false, false, false, CCAs...>, false>>, private ColumnData<CCAs...> {
  private:
	//**Type definitions****************************************************************************
	using DataType = ColumnData<CCAs...>;				//!< The type of the ColumnData base class.
	using Operand = If_t<IsExpression_v<MT>, MT, MT &>; //!< Composite data type of the dense matrix expression.
  ...
  public:
	...
	class ColumnElement : private SparseElement {
	  public:
		...
		*/
		inline const ColumnElement *operator->() const { return this; }
		//*******************************************************************************************
		...
		*/
		inline size_t index() const { return row_; }
		//*******************************************************************************************
	...
	class ColumnIterator {
	  public:
		...
		*/
		inline ReferenceType operator*() const { return ReferenceType(pos_, row_); }
		//*******************************************************************************************
		...
		// \return Reference to the sparse vector element at the current iterator position.
		*/
		inline PointerType operator->() const { return PointerType(pos_, row_); }
		//*******************************************************************************************
...
template <typename MT // Type of the sparse matrix
		  ,
		  size_t... CCAs> // Compile time column arguments
inline typename Column<MT, false, false, false, CCAs...>::Iterator Column<MT, false, false, false, CCAs...>::begin()
{
...
template <typename MT // Type of the sparse matrix
		  ,
		  size_t... CCAs> // Compile time column arguments
inline typename Column<MT, false, false, false, CCAs...>::Iterator Column<MT, false, false, false, CCAs...>::end()
{
...
template <typename MT // Type of the sparse matrix
		  ,
		  size_t... CCAs> // Compile time column arguments
inline Column<MT, false, false, false, CCAs...> &Column<MT, false, false, false, CCAs...>::operator=(const Column &rhs)
{
	using mtrc::numeric::assign;
...
template <typename MT // Type of the sparse matrix
		  ...
		  size_t... CCAs> // Compile time column arguments
template <typename Other> // Data type of the scalar value
inline Column<MT, false, false, false, CCAs...> &Column<MT, false, false, false, CCAs...>::scale(const Other &scalar)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_UNITRIANGULAR_MATRIX_TYPE(MT);
...
class Column<MT, false, false, true, CCAs...>
	: public View<SparseVector<Column<MT, false, false, true, CCAs...>, false>>, private ColumnData<CCAs...> {
  private:
	//**Type definitions****************************************************************************
	using DataType = ColumnData<CCAs...>;				//!< The type of the ColumnData base class.
	using Operand = If_t<IsExpression_v<MT>, MT, MT &>; //!< Composite data type of the dense matrix expression.
...
template <typename MT // Type of the sparse matrix
		  ,
		  size_t... CCAs> // Compile time column arguments
inline typename Column<MT, false, false, true, CCAs...>::Iterator Column<MT, false, false, true, CCAs...>::begin()
{
	return matrix_.begin(column());
}
/*! \endcond */
...
template <typename MT // Type of the sparse matrix
		  ,
		  size_t... CCAs> // Compile time column arguments
inline typename Column<MT, false, false, true, CCAs...>::Iterator Column<MT, false, false, true, CCAs...>::end()
{
	return matrix_.end(column());
}
/*! \endcond */
...
template <typename MT // Type of the sparse matrix
		  ...
		  size_t... CCAs> // Compile time column arguments
inline
	typename Column<MT, false, false, true, CCAs...>::ConstIterator Column<MT, false, false, true, CCAs...>::end() const
{
	return matrix_.cend(column());
}
/*! \endcond */
...
template <typename MT // Type of the sparse matrix
		  ,
		  size_t... CCAs> // Compile time column arguments
inline Column<MT, false, false, true, CCAs...> &Column<MT, false, false, true, CCAs...>::operator=(const Column &rhs)
{
	using mtrc::numeric::assign;
...
template <typename MT // Type of the sparse matrix
		  ...
		  size_t... CCAs> // Compile time column arguments
template <typename Other> // Data type of the scalar value
inline Column<MT, false, false, true, CCAs...> &Column<MT, false, false, true, CCAs...>::scale(const Other &scalar)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_UNITRIANGULAR_MATRIX_TYPE(MT);
