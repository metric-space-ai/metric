...
#ifndef METRIC_NUMERIC_MATH_VIEWS_SUBMATRIX_SPARSE_H
#define METRIC_NUMERIC_MATH_VIEWS_SUBMATRIX_SPARSE_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class Submatrix<MT, AF, false, false, CSAs...>
	: public View<SparseMatrix<Submatrix<MT, AF, false, false, CSAs...>, false>>, private SubmatrixData<CSAs...> {
  private:
	//**Type definitions****************************************************************************
  ...
  public:
	...
	class SubmatrixElement : private SparseElement {
	  public:
		...
		*/
		inline const SubmatrixElement *operator->() const { return this; }
		//*******************************************************************************************
		...
		*/
		inline size_t index() const { return pos_->index() - offset_; }
		//*******************************************************************************************
	...
	class SubmatrixIterator {
	  public:
		...
		*/
		inline ReferenceType operator*() const { return ReferenceType(pos_, offset_); }
		//*******************************************************************************************
		...
		*/
		inline PointerType operator->() const { return PointerType(pos_, offset_); }
		//*******************************************************************************************
		...
		*/
		inline DifferenceType operator-(const SubmatrixIterator &rhs) const { return pos_ - rhs.pos_; }
		//*******************************************************************************************
...
template <typename MT // Type of the sparse matrix
		  ...
		  size_t... CSAs> // Compile time submatrix arguments
inline
	typename Submatrix<MT, AF, false, false, CSAs...>::Reference Submatrix<MT, AF, false, false, CSAs...>::at(size_t i,
																											  size_t j)
{
	if (i >= rows()) {
...
{
	METRIC_NUMERIC_USER_ASSERT(i < rows(), "Invalid sparse submatrix row access index");
...
template <typename MT // Type of the sparse matrix
		  ...
		  size_t... CSAs> // Compile time submatrix arguments
inline
	typename Submatrix<MT, AF, false, false, CSAs...>::Iterator Submatrix<MT, AF, false, false, CSAs...>::end(size_t i)
{
	METRIC_NUMERIC_USER_ASSERT(i < rows(), "Invalid sparse submatrix row access index");
...
template <typename MT // Type of the sparse matrix
		  ...
		  size_t... CSAs> // Compile time submatrix arguments
inline
	typename Submatrix<MT, AF, false, false, CSAs...>::Iterator Submatrix<MT, AF, false, false, CSAs...>::find(size_t i,
																											   size_t j)
{
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  size_t... CSAs> // Compile time submatrix arguments
inline Submatrix<MT, AF, false, false, CSAs...> &Submatrix<MT, AF, false, false, CSAs...>::transpose()
{
	using mtrc::numeric::assign;
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  size_t... CSAs> // Compile time submatrix arguments
inline Submatrix<MT, AF, false, false, CSAs...> &Submatrix<MT, AF, false, false, CSAs...>::ctranspose()
{
	using mtrc::numeric::assign;
...
inline Submatrix<MT, AF, false, false, CSAs...> &Submatrix<MT, AF, false, false, CSAs...>::scale(const Other &scalar)
{
...
class Submatrix<MT, AF, true, false, CSAs...>
	: public View<SparseMatrix<Submatrix<MT, AF, true, false, CSAs...>, true>>, private SubmatrixData<CSAs...> {
  private:
	//**Type definitions****************************************************************************
	using DataType = SubmatrixData<CSAs...>;			//!< The type of the SubmatrixData base class.
	using Operand = If_t<IsExpression_v<MT>, MT, MT &>; //!< Composite data type of the matrix expression.
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  size_t... CSAs> // Compile time submatrix arguments
inline typename Submatrix<MT, AF, true, false, CSAs...>::Reference Submatrix<MT, AF, true, false, CSAs...>::at(size_t i,
																											   size_t j)
{
	if (i >= rows()) {
		METRIC_NUMERIC_THROW_OUT_OF_RANGE("Invalid row access index");
...
template <typename MT // Type of the sparse matrix
		  ...
		  size_t... CSAs> // Compile time submatrix arguments
inline
	typename Submatrix<MT, AF, true, false, CSAs...>::Iterator Submatrix<MT, AF, true, false, CSAs...>::begin(size_t j)
{
	METRIC_NUMERIC_USER_ASSERT(j < columns(), "Invalid sparse submatrix column access index");
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  size_t... CSAs> // Compile time submatrix arguments
inline typename Submatrix<MT, AF, true, false, CSAs...>::Iterator Submatrix<MT, AF, true, false, CSAs...>::end(size_t j)
{
	METRIC_NUMERIC_USER_ASSERT(j < columns(), "Invalid sparse submatrix column access index");
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  size_t... CSAs> // Compile time submatrix arguments
inline Submatrix<MT, AF, true, false, CSAs...> &Submatrix<MT, AF, true, false, CSAs...>::operator=(const Submatrix &rhs)
{
	using mtrc::numeric::assign;
...
template <typename MT // Type of the sparse matrix
		  ...
		  size_t... CSAs> // Compile time submatrix arguments
inline
	typename Submatrix<MT, AF, true, false, CSAs...>::Iterator Submatrix<MT, AF, true, false, CSAs...>::find(size_t i,
																											 size_t j)
{
	const Iterator_t<MT> pos(matrix_.find(row() + i, column() + j));
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  size_t... CSAs> // Compile time submatrix arguments
inline Submatrix<MT, AF, true, false, CSAs...> &Submatrix<MT, AF, true, false, CSAs...>::transpose()
{
	using mtrc::numeric::assign;
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  size_t... CSAs> // Compile time submatrix arguments
inline Submatrix<MT, AF, true, false, CSAs...> &Submatrix<MT, AF, true, false, CSAs...>::ctranspose()
{
	using mtrc::numeric::assign;
...
template <typename MT // Type of the sparse matrix
		  ...
		  size_t... CSAs> // Compile time submatrix arguments
template <typename Other> // Data type of the scalar value
inline Submatrix<MT, AF, true, false, CSAs...> &Submatrix<MT, AF, true, false, CSAs...>::scale(const Other &scalar)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_UNITRIANGULAR_MATRIX_TYPE(MT);
