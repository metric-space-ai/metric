...
#ifndef METRIC_NUMERIC_MATH_VIEWS_SUBMATRIX_SUBMATRIX_H
#define METRIC_NUMERIC_MATH_VIEWS_SUBMATRIX_SUBMATRIX_H
//=================================================================================================
//
...
// function. It can be included via the header files
   ...
   // or
   #include <metric/numeric/math/Submatrix.h>
   \endcode
...
// specifier:
   ...
   using SubmatrixType = decltype( mtrc::numeric::submatrix<3UL,0UL,4UL,8UL>( std::declval<MatrixType>() ) );
   \endcode
...
// considered to be unaligned. This can be made explicit by the mtrc::numeric::unaligned flag:
...
// explicitly specifying the mtrc::numeric::aligned flag:
...
// the mtrc::numeric::aligned flag is specified during setup, an aligned submatrix is created:
