...
#ifndef METRIC_NUMERIC_MATH_VIEWS_ROW_ROW_H
#define METRIC_NUMERIC_MATH_VIEWS_ROW_ROW_H
//=================================================================================================
//
...
// It can be included via the header files
   ...
   // or
   #include <metric/numeric/math/Row.h>
   \endcode
...
// time arguments. If the type is required, it can be determined via \c decltype specifier:
   ...
   using RowType = decltype( mtrc::numeric::row<1UL>( std::declval<MatrixType>() ) );
   \endcode
...
// The following example demonstrates this in detail:
   ...
   \code
   mtrc::numeric::DynamicVector<double,mtrc::numeric::rowVector> x;
   mtrc::numeric::CompressedVector<double,mtrc::numeric::rowVector> y;
   mtrc::numeric::DynamicMatrix<double,mtrc::numeric::rowMajor> A, B;
   mtrc::numeric::CompressedMatrix<double,mtrc::numeric::rowMajor> C, D;
   // ... Resizing and initialization
...
// rows an iterator to immutable elements is returned:
   ...
   \code
   mtrc::numeric::DynamicMatrix<int,mtrc::numeric::rowMajor> A( 128UL, 256UL );
   // ... Resizing and initialization
   ...
   \code
   mtrc::numeric::CompressedMatrix<int,mtrc::numeric::rowMajor> A( 128UL, 256UL );
   // ... Resizing and initialization
...
// The following example demonstrates all options:
   ...
   \code
   mtrc::numeric::CompressedMatrix<double,mtrc::numeric::rowMajor> A( 10UL, 100UL );  // Non-initialized 10x100
matrix
...
// resizing and swapping. The following example shows this by means of a dense row view:
   ...
   \code
   mtrc::numeric::DynamicMatrix<int,mtrc::numeric::rowMajor> A( 42UL, 42UL );
   // ... Resizing and initialization
...
// fitting element types:
   ...
   \code
   mtrc::numeric::DynamicVector<double,mtrc::numeric::rowVector> a( 2UL, 2.0 ), b;
   mtrc::numeric::CompressedVector<double,mtrc::numeric::rowVector> c( 2UL );
   c[1] = 3.0;

   mtrc::numeric::DynamicMatrix<double,mtrc::numeric::rowMajor> A( 4UL, 2UL );  // Non-initialized 4x2 matrix
...
// instance:
   ...
   \code
   mtrc::numeric::DynamicMatrix<int,mtrc::numeric::columnMajor> A( 64UL, 32UL );
   // ... Resizing and initialization
...
// elements. Therefore care has to be taken in the choice of the most suitable storage order:
   ...
   mtrc::numeric::DynamicMatrix<double,mtrc::numeric::columnMajor> A( 128UL, 128UL );
   mtrc::numeric::DynamicMatrix<double,mtrc::numeric::columnMajor> B( 128UL, 128UL );
   // ... Resizing and initialization

   // The computation of the 15th row of the multiplication between A and B ...
   mtrc::numeric::DynamicVector<double,mtrc::numeric::rowVector> x = row( A * B, 15UL );

   // ... is essentially the same as the following computation, which multiplies
   // the 15th row of the column-major matrix A with B.
   mtrc::numeric::DynamicVector<double,mtrc::numeric::rowVector> x = row( A, 15UL ) * B;
   \endcode

// Although Metric numeric performs the resulting vector/matrix multiplication as efficiently as possible
