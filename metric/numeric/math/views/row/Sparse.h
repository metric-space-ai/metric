...
#ifndef METRIC_NUMERIC_MATH_VIEWS_ROW_SPARSE_H
#define METRIC_NUMERIC_MATH_VIEWS_ROW_SPARSE_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class Row<MT, true, false, SF, CRAs...> : public View<SparseVector<Row<MT, true, false, SF, CRAs...>, true>>,
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  size_t... CRAs> // Compile time row arguments
inline typename Row<MT, true, false, SF, CRAs...>::Reference Row<MT, true, false, SF, CRAs...>::operator[](size_t index)
{
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  size_t... CRAs> // Compile time row arguments
inline typename Row<MT, true, false, SF, CRAs...>::Reference Row<MT, true, false, SF, CRAs...>::at(size_t index)
{
	if (index >= size()) {
...
template <typename MT // Type of the sparse matrix
		  ...
		  size_t... CRAs> // Compile time row arguments
inline
	typename Row<MT, true, false, SF, CRAs...>::ConstReference Row<MT, true, false, SF, CRAs...>::at(size_t index) const
{
	if (index >= size()) {
		METRIC_NUMERIC_THROW_OUT_OF_RANGE("Invalid row access index");
	}
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  size_t... CRAs> // Compile time row arguments
inline typename Row<MT, true, false, SF, CRAs...>::Iterator Row<MT, true, false, SF, CRAs...>::begin()
{
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  size_t... CRAs> // Compile time row arguments
inline typename Row<MT, true, false, SF, CRAs...>::ConstIterator Row<MT, true, false, SF, CRAs...>::begin() const
{
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  size_t... CRAs> // Compile time row arguments
inline typename Row<MT, true, false, SF, CRAs...>::ConstIterator Row<MT, true, false, SF, CRAs...>::cbegin() const
{
	return matrix_.cbegin(row());
}
/*! \endcond */
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  size_t... CRAs> // Compile time row arguments
inline typename Row<MT, true, false, SF, CRAs...>::Iterator Row<MT, true, false, SF, CRAs...>::end()
{
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  size_t... CRAs> // Compile time row arguments
inline typename Row<MT, true, false, SF, CRAs...>::ConstIterator Row<MT, true, false, SF, CRAs...>::end() const
{
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  size_t... CRAs> // Compile time row arguments
inline typename Row<MT, true, false, SF, CRAs...>::ConstIterator Row<MT, true, false, SF, CRAs...>::cend() const
{
	return matrix_.cend(row());
}
/*! \endcond */
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  size_t... CRAs> // Compile time row arguments
inline Row<MT, true, false, SF, CRAs...> &Row<MT, true, false, SF, CRAs...>::operator=(const Row &rhs)
{
	using mtrc::numeric::assign;
...
inline Row<MT, true, false, SF, CRAs...> &Row<MT, true, false, SF, CRAs...>::operator=(const DenseVector<VT, true> &rhs)
{
	using mtrc::numeric::assign;

	METRIC_NUMERIC_CONSTRAINT_MUST_BE_DENSE_VECTOR_TYPE(ResultType_t<VT>);
...
Row<MT, true, false, SF, CRAs...>::operator=(const SparseVector<VT, true> &rhs)
{
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_SPARSE_VECTOR_TYPE(ResultType_t<VT>);
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_ROW_VECTOR_TYPE(ResultType_t<VT>);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(ResultType_t<VT>);
...
Row<MT, true, false, SF, CRAs...>::operator+=(const DenseVector<VT, true> &rhs)
{
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_ROW_VECTOR_TYPE(AddType);
...
Row<MT, true, false, SF, CRAs...>::operator+=(const SparseVector<VT, true> &rhs)
{
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_SPARSE_VECTOR_TYPE(AddType);
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_ROW_VECTOR_TYPE(AddType);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(AddType);
...
Row<MT, true, false, SF, CRAs...>::operator-=(const DenseVector<VT, true> &rhs)
{
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_ROW_VECTOR_TYPE(SubType);
...
Row<MT, true, false, SF, CRAs...>::operator-=(const SparseVector<VT, true> &rhs)
{
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_SPARSE_VECTOR_TYPE(SubType);
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_ROW_VECTOR_TYPE(SubType);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(SubType);
...
inline Row<MT, true, false, SF, CRAs...> &Row<MT, true, false, SF, CRAs...>::operator*=(const Vector<VT, true> &rhs)
{
	using mtrc::numeric::assign;
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_ROW_VECTOR_TYPE(MultType);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(MultType);
...
Row<MT, true, false, SF, CRAs...>::operator/=(const DenseVector<VT, true> &rhs)
{
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_SPARSE_VECTOR_TYPE(DivType);
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_ROW_VECTOR_TYPE(DivType);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(DivType);
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  size_t... CRAs> // Compile time row arguments
inline typename Row<MT, true, false, SF, CRAs...>::Iterator Row<MT, true, false, SF, CRAs...>::erase(Iterator pos)
{
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  size_t... CRAs> // Compile time row arguments
inline typename Row<MT, true, false, SF, CRAs...>::Iterator Row<MT, true, false, SF, CRAs...>::erase(Iterator first,
																									 Iterator last)
{
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  size_t... CRAs> // Compile time row arguments
inline typename Row<MT, true, false, SF, CRAs...>::Iterator Row<MT, true, false, SF, CRAs...>::find(size_t index)
{
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  size_t... CRAs> // Compile time row arguments
inline typename Row<MT, true, false, SF, CRAs...>::Iterator Row<MT, true, false, SF, CRAs...>::lowerBound(size_t index)
{
...
template <typename MT // Type of the sparse matrix
		  ...
		  ,
		  size_t... CRAs> // Compile time row arguments
inline typename Row<MT, true, false, SF, CRAs...>::Iterator Row<MT, true, false, SF, CRAs...>::upperBound(size_t index)
{
...
inline Row<MT, true, false, SF, CRAs...> &Row<MT, true, false, SF, CRAs...>::scale(const Other &scalar)
{
...
template <typename MT // Type of the sparse matrix
		  ,
		  size_t... CRAs> // Compile time row arguments
class Row<MT, false, false, false, CRAs...> : public View<SparseVector<Row<MT, false, false, false, CRAs...>, true>>,
											  private RowData<CRAs...> {
  private:
	//**Type definitions****************************************************************************
	using DataType = RowData<CRAs...>;					//!< The type of the RowData base class.
  ...
  public:
	...
	class RowElement : private SparseElement {
	  public:
		...
		*/
		inline const RowElement *operator->() const { return this; }
		//*******************************************************************************************
		...
		*/
		inline decltype(auto) value() const { return pos_->value(); }
		//*******************************************************************************************
		...
		*/
		inline size_t index() const { return column_; }
		//*******************************************************************************************
	...
	class RowIterator {
	  public:
		...
		*/
		...
		{
			METRIC_NUMERIC_INTERNAL_ASSERT(matrix.find(row, column) == pos, "Invalid initial iterator position");
		}
		//*******************************************************************************************
		...
		*/
		inline ReferenceType operator*() const { return ReferenceType(pos_, column_); }
		//*******************************************************************************************
		...
		// \return Reference to the sparse vector element at the current iterator position.
		*/
		inline PointerType operator->() const { return PointerType(pos_, column_); }
		//*******************************************************************************************
...
template <typename MT // Type of the sparse matrix
		  ,
		  size_t... CRAs> // Compile time row arguments
inline typename Row<MT, false, false, false, CRAs...>::Reference Row<MT, false, false, false, CRAs...>::at(size_t index)
{
	if (index >= size()) {
		METRIC_NUMERIC_THROW_OUT_OF_RANGE("Invalid row access index");
	}
...
template <typename MT // Type of the sparse matrix
		  ,
		  size_t... CRAs> // Compile time row arguments
inline typename Row<MT, false, false, false, CRAs...>::Iterator Row<MT, false, false, false, CRAs...>::begin()
{
...
template <typename MT // Type of the sparse matrix
		  ...
		  size_t... CRAs> // Compile time row arguments
inline
	typename Row<MT, false, false, false, CRAs...>::ConstIterator Row<MT, false, false, false, CRAs...>::begin() const
{
...
template <typename MT // Type of the sparse matrix
		  ...
		  size_t... CRAs> // Compile time row arguments
inline
	typename Row<MT, false, false, false, CRAs...>::ConstIterator Row<MT, false, false, false, CRAs...>::cbegin() const
{
	return ConstIterator(matrix_, row(), 0UL);
}
/*! \endcond */
...
template <typename MT // Type of the sparse matrix
		  ,
		  size_t... CRAs> // Compile time row arguments
inline typename Row<MT, false, false, false, CRAs...>::Iterator Row<MT, false, false, false, CRAs...>::end()
{
...
template <typename MT // Type of the sparse matrix
		  ,
		  size_t... CRAs> // Compile time row arguments
inline typename Row<MT, false, false, false, CRAs...>::ConstIterator Row<MT, false, false, false, CRAs...>::end() const
{
...
template <typename MT // Type of the sparse matrix
		  ,
		  size_t... CRAs> // Compile time row arguments
inline typename Row<MT, false, false, false, CRAs...>::ConstIterator Row<MT, false, false, false, CRAs...>::cend() const
{
	return ConstIterator(matrix_, row(), size());
}
/*! \endcond */
...
template <typename MT // Type of the sparse matrix
		  ,
		  size_t... CRAs> // Compile time row arguments
inline Row<MT, false, false, false, CRAs...> &Row<MT, false, false, false, CRAs...>::operator=(const Row &rhs)
{
	using mtrc::numeric::assign;
...
template <typename MT // Type of the sparse matrix
		  ...
		  size_t... CRAs> // Compile time row arguments
inline
	typename Row<MT, false, false, false, CRAs...>::Iterator Row<MT, false, false, false, CRAs...>::erase(Iterator pos)
{
...
template <typename MT // Type of the sparse matrix
		  ...
		  size_t... CRAs> // Compile time row arguments
inline
	typename Row<MT, false, false, false, CRAs...>::Iterator Row<MT, false, false, false, CRAs...>::find(size_t index)
{
...
template <typename MT // Type of the sparse matrix
		  ...
		  size_t... CRAs> // Compile time row arguments
template <typename Other> // Data type of the scalar value
inline Row<MT, false, false, false, CRAs...> &Row<MT, false, false, false, CRAs...>::scale(const Other &scalar)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_UNITRIANGULAR_MATRIX_TYPE(MT);
...
template <typename MT // Type of the sparse matrix
		  ,
		  size_t... CRAs> // Compile time row arguments
class Row<MT, false, false, true, CRAs...> : public View<SparseVector<Row<MT, false, false, true, CRAs...>, true>>,
											 private RowData<CRAs...> {
  private:
	//**Type definitions****************************************************************************
	using DataType = RowData<CRAs...>;					//!< The type of the RowData base class.
...
template <typename MT // Type of the sparse matrix
		  ,
		  size_t... CRAs> // Compile time row arguments
inline typename Row<MT, false, false, true, CRAs...>::Reference Row<MT, false, false, true, CRAs...>::at(size_t index)
{
	if (index >= size()) {
		METRIC_NUMERIC_THROW_OUT_OF_RANGE("Invalid row access index");
	}
...
template <typename MT // Type of the sparse matrix
		  ,
		  size_t... CRAs> // Compile time row arguments
inline typename Row<MT, false, false, true, CRAs...>::Iterator Row<MT, false, false, true, CRAs...>::begin()
{
	return matrix_.begin(row());
}
/*! \endcond */
...
template <typename MT // Type of the sparse matrix
		  ,
		  size_t... CRAs> // Compile time row arguments
inline typename Row<MT, false, false, true, CRAs...>::ConstIterator Row<MT, false, false, true, CRAs...>::begin() const
{
	return matrix_.cbegin(row());
}
/*! \endcond */
...
template <typename MT // Type of the sparse matrix
		  ,
		  size_t... CRAs> // Compile time row arguments
inline typename Row<MT, false, false, true, CRAs...>::ConstIterator Row<MT, false, false, true, CRAs...>::cbegin() const
{
	return matrix_.cbegin(row());
}
/*! \endcond */
...
template <typename MT // Type of the sparse matrix
		  ,
		  size_t... CRAs> // Compile time row arguments
inline typename Row<MT, false, false, true, CRAs...>::Iterator Row<MT, false, false, true, CRAs...>::end()
{
	return matrix_.end(row());
}
/*! \endcond */
...
template <typename MT // Type of the sparse matrix
		  ,
		  size_t... CRAs> // Compile time row arguments
inline typename Row<MT, false, false, true, CRAs...>::ConstIterator Row<MT, false, false, true, CRAs...>::end() const
{
	return matrix_.cend(row());
}
/*! \endcond */
...
template <typename MT // Type of the sparse matrix
		  ,
		  size_t... CRAs> // Compile time row arguments
inline typename Row<MT, false, false, true, CRAs...>::ConstIterator Row<MT, false, false, true, CRAs...>::cend() const
{
	return matrix_.cend(row());
}
/*! \endcond */
...
template <typename MT // Type of the sparse matrix
		  ,
		  size_t... CRAs> // Compile time row arguments
inline Row<MT, false, false, true, CRAs...> &Row<MT, false, false, true, CRAs...>::operator=(const Row &rhs)
{
	using mtrc::numeric::assign;
...
template <typename MT // Type of the sparse matrix
		  ,
		  size_t... CRAs> // Compile time row arguments
inline typename Row<MT, false, false, true, CRAs...>::Iterator Row<MT, false, false, true, CRAs...>::erase(Iterator pos)
{
	return matrix_.erase(row(), pos);
}
/*! \endcond */
...
template <typename MT // Type of the sparse matrix
		  ...
		  size_t... CRAs> // Compile time row arguments
inline
	typename Row<MT, false, false, true, CRAs...>::Iterator Row<MT, false, false, true, CRAs...>::erase(Iterator first,
																										Iterator last)
{
	return matrix_.erase(row(), first, last);
}
...
// that are smaller than a certain threshold value:
   ...
   \code
   mtrc::numeric::SymmetricMatrix< mtrc::numeric::CompressedMatrix<double,mtrc::numeric::columnMajor> > A;
   // ... Resizing and initialization
...
template <typename MT // Type of the sparse matrix
		  ,
		  size_t... CRAs> // Compile time row arguments
inline typename Row<MT, false, false, true, CRAs...>::Iterator Row<MT, false, false, true, CRAs...>::find(size_t index)
{
...
template <typename MT // Type of the sparse matrix
		  ...
		  size_t... CRAs> // Compile time row arguments
template <typename Other> // Data type of the scalar value
inline Row<MT, false, false, true, CRAs...> &Row<MT, false, false, true, CRAs...>::scale(const Other &scalar)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_UNITRIANGULAR_MATRIX_TYPE(MT);
