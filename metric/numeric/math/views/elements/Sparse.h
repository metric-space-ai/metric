...
#ifndef METRIC_NUMERIC_MATH_VIEWS_ELEMENTS_SPARSE_H
#define METRIC_NUMERIC_MATH_VIEWS_ELEMENTS_SPARSE_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
#include <metric/numeric/math/views/elements/ElementsData.h>
...
class Elements<VT, TF, false, CEAs...> : public View<SparseVector<Elements<VT, TF, false, CEAs...>, TF>>,
  ...
  public:
	...
	class ElementsElement : private SparseElement {
	  public:
		//**Constructor******************************************************************************
		...
		*/
		inline const ElementsElement *operator->() const { return this; }
		//*******************************************************************************************
	...
	class ElementsIterator {
	  public:
		...
		*/
		inline ReferenceType operator*() const { return ReferenceType(pos_, index_); }
		//*******************************************************************************************
		...
		*/
		inline PointerType operator->() const { return PointerType(pos_, index_); }
		//*******************************************************************************************
		...
		*/
		inline bool operator==(const ElementsIterator &rhs) const { return index_ == rhs.index_; }
		//*******************************************************************************************
	...
	/*!\name Constructors */
	//@{
	template <typename... REAs> explicit inline Elements(VT &vector, REAs... args);
  ...
  private:
	...
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_ELEMENTS_TYPE(VT);
...
template <typename VT // Type of the sparse vector
		  ...
		  ,
		  typename... CEAs> // Compile time element arguments
inline typename Elements<VT, TF, false, CEAs...>::Reference Elements<VT, TF, false, CEAs...>::operator[](size_t index)
{
	METRIC_NUMERIC_USER_ASSERT(index < size(), "Invalid element access index");
...
template <typename VT // Type of the sparse vector
		  ...
		  ,
		  typename... CEAs> // Compile time element arguments
inline typename Elements<VT, TF, false, CEAs...>::Reference Elements<VT, TF, false, CEAs...>::at(size_t index)
{
	if (index >= size()) {
		METRIC_NUMERIC_THROW_OUT_OF_RANGE("Invalid element access index");
	}
	return (*this)[index];
}
/*! \endcond */
...
template <typename VT // Type of the sparse vector
		  ...
		  typename... CEAs> // Compile time element arguments
inline
	typename Elements<VT, TF, false, CEAs...>::ConstReference Elements<VT, TF, false, CEAs...>::at(size_t index) const
{
	if (index >= size()) {
		METRIC_NUMERIC_THROW_OUT_OF_RANGE("Invalid element access index");
	}
...
template <typename VT // Type of the sparse vector
		  ...
		  ,
		  typename... CEAs> // Compile time element arguments
inline typename Elements<VT, TF, false, CEAs...>::Iterator Elements<VT, TF, false, CEAs...>::begin()
{
...
template <typename VT // Type of the sparse vector
		  ...
		  ,
		  typename... CEAs> // Compile time element arguments
inline typename Elements<VT, TF, false, CEAs...>::ConstIterator Elements<VT, TF, false, CEAs...>::begin() const
{
...
template <typename VT // Type of the sparse vector
		  ...
		  ,
		  typename... CEAs> // Compile time element arguments
inline typename Elements<VT, TF, false, CEAs...>::ConstIterator Elements<VT, TF, false, CEAs...>::cbegin() const
{
	return ConstIterator(this, 0UL);
}
/*! \endcond */
...
template <typename VT // Type of the sparse vector
		  ...
		  ,
		  typename... CEAs> // Compile time element arguments
inline typename Elements<VT, TF, false, CEAs...>::Iterator Elements<VT, TF, false, CEAs...>::end()
{
...
template <typename VT // Type of the sparse vector
		  ...
		  ,
		  typename... CEAs> // Compile time element arguments
inline typename Elements<VT, TF, false, CEAs...>::ConstIterator Elements<VT, TF, false, CEAs...>::end() const
{
...
template <typename VT // Type of the sparse vector
		  ...
		  ,
		  typename... CEAs> // Compile time element arguments
inline typename Elements<VT, TF, false, CEAs...>::ConstIterator Elements<VT, TF, false, CEAs...>::cend() const
{
	return ConstIterator(this, size());
}
/*! \endcond */
...
template <typename VT // Type of the sparse vector
		  ...
		  ,
		  typename... CEAs> // Compile time element arguments
inline Elements<VT, TF, false, CEAs...> &Elements<VT, TF, false, CEAs...>::operator=(initializer_list<ElementType> list)
{
	using mtrc::numeric::assign;

	if (list.size() > size()) {
		METRIC_NUMERIC_THROW_INVALID_ARGUMENT("Invalid assignment to elements");
	}
...
template <typename VT // Type of the sparse vector
		  ...
		  ,
		  typename... CEAs> // Compile time element arguments
inline Elements<VT, TF, false, CEAs...> &Elements<VT, TF, false, CEAs...>::operator=(const Elements &rhs)
{
	using mtrc::numeric::assign;
...
inline Elements<VT, TF, false, CEAs...> &Elements<VT, TF, false, CEAs...>::operator=(const Vector<VT2, TF> &rhs)
{
	using mtrc::numeric::assign;
...
inline Elements<VT, TF, false, CEAs...> &Elements<VT, TF, false, CEAs...>::operator/=(const DenseVector<VT2, TF> &rhs)
{
	using mtrc::numeric::assign;

	METRIC_NUMERIC_CONSTRAINT_MUST_BE_SPARSE_VECTOR_TYPE(ResultType);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(ResultType);
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_DENSE_VECTOR_TYPE(ResultType_t<VT2>);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(ResultType_t<VT2>);
...
template <typename VT // Type of the sparse vector
		  ...
		  typename... CEAs> // Compile time element arguments
inline
	typename Elements<VT, TF, false, CEAs...>::Iterator Elements<VT, TF, false, CEAs...>::set(size_t index,
...
template <typename VT // Type of the sparse vector
		  ...
		  ,
		  typename... CEAs> // Compile time element arguments
inline typename Elements<VT, TF, false, CEAs...>::Iterator Elements<VT, TF, false, CEAs...>::erase(Iterator pos)
{
...
template <typename VT // Type of the sparse vector
		  ...
		  ,
		  typename... CEAs> // Compile time element arguments
inline typename Elements<VT, TF, false, CEAs...>::Iterator Elements<VT, TF, false, CEAs...>::erase(Iterator first,
																								   Iterator last)
{
...
// all elements that are smaller than a certain threshold value:
   ...
   \code
   mtrc::numeric::CompressedVector<double,mtrc::numeric::rowVector> a;
...
template <typename VT // Type of the sparse vector
		  ...
		  ,
		  typename... CEAs> // Compile time element arguments
inline typename Elements<VT, TF, false, CEAs...>::Iterator Elements<VT, TF, false, CEAs...>::find(size_t index)
{
...
template <typename VT // Type of the sparse vector
		  ...
		  typename... CEAs> // Compile time element arguments
inline
	typename Elements<VT, TF, false, CEAs...>::ConstIterator Elements<VT, TF, false, CEAs...>::find(size_t index) const
{
...
template <typename VT // Type of the sparse vector
		  ...
		  ,
		  typename... CEAs> // Compile time element arguments
inline typename Elements<VT, TF, false, CEAs...>::Iterator Elements<VT, TF, false, CEAs...>::lowerBound(size_t index)
{
...
template <typename VT // Type of the sparse vector
		  ...
		  ,
		  typename... CEAs> // Compile time element arguments
inline typename Elements<VT, TF, false, CEAs...>::Iterator Elements<VT, TF, false, CEAs...>::upperBound(size_t index)
{
	while ((++index) < size()) {
		const Iterator_t<VT> pos(vector_.find(idx(index)));
		if (pos != vector_.end())
...
inline Elements<VT, TF, false, CEAs...> &Elements<VT, TF, false, CEAs...>::scale(const Other &scalar)
{
