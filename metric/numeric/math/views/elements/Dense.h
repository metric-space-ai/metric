...
#ifndef METRIC_NUMERIC_MATH_VIEWS_ELEMENTS_DENSE_H
#define METRIC_NUMERIC_MATH_VIEWS_ELEMENTS_DENSE_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
class Elements<VT, TF, true, CEAs...> : public View<DenseVector<Elements<VT, TF, true, CEAs...>, TF>>,
  ...
  public:
	...
	class ElementsIterator {
	  public:
		...
		*/
		inline DifferenceType operator-(const ElementsIterator &rhs) const { return index_ - rhs.index_; }
		//*******************************************************************************************
...
template <typename VT // Type of the dense vector
		  ...
		  ,
		  typename... CEAs> // Compile time element arguments
inline typename Elements<VT, TF, true, CEAs...>::Reference Elements<VT, TF, true, CEAs...>::operator[](size_t index)
{
...
template <typename VT // Type of the dense vector
		  ...
		  ,
		  typename... CEAs> // Compile time element arguments
inline typename Elements<VT, TF, true, CEAs...>::Reference Elements<VT, TF, true, CEAs...>::at(size_t index)
{
	if (index >= size()) {
...
template <typename VT // Type of the dense vector
		  ...
		  ,
		  typename... CEAs> // Compile time element arguments
inline typename Elements<VT, TF, true, CEAs...>::ConstReference Elements<VT, TF, true, CEAs...>::at(size_t index) const
{
	if (index >= size()) {
		METRIC_NUMERIC_THROW_OUT_OF_RANGE("Invalid element access index");
	}
...
template <typename VT // Type of the dense vector
		  ...
		  ,
		  typename... CEAs> // Compile time element arguments
inline typename Elements<VT, TF, true, CEAs...>::Pointer Elements<VT, TF, true, CEAs...>::data() noexcept
{
...
template <typename VT // Type of the dense vector
		  ...
		  ,
		  typename... CEAs> // Compile time element arguments
inline typename Elements<VT, TF, true, CEAs...>::ConstPointer Elements<VT, TF, true, CEAs...>::data() const noexcept
{
	return vector_.data() + idx(0UL);
}
/*! \endcond */
...
template <typename VT // Type of the dense vector
		  ...
		  ,
		  typename... CEAs> // Compile time element arguments
inline typename Elements<VT, TF, true, CEAs...>::Iterator Elements<VT, TF, true, CEAs...>::begin()
{
...
template <typename VT // Type of the dense vector
		  ...
		  ,
		  typename... CEAs> // Compile time element arguments
inline typename Elements<VT, TF, true, CEAs...>::ConstIterator Elements<VT, TF, true, CEAs...>::begin() const
{
...
template <typename VT // Type of the dense vector
		  ...
		  ,
		  typename... CEAs> // Compile time element arguments
inline typename Elements<VT, TF, true, CEAs...>::ConstIterator Elements<VT, TF, true, CEAs...>::cbegin() const
{
	return ConstIterator(this, 0UL);
}
/*! \endcond */
...
template <typename VT // Type of the dense vector
		  ...
		  ,
		  typename... CEAs> // Compile time element arguments
inline typename Elements<VT, TF, true, CEAs...>::Iterator Elements<VT, TF, true, CEAs...>::end()
{
...
template <typename VT // Type of the dense vector
		  ...
		  ,
		  typename... CEAs> // Compile time element arguments
inline typename Elements<VT, TF, true, CEAs...>::ConstIterator Elements<VT, TF, true, CEAs...>::end() const
{
...
template <typename VT // Type of the dense vector
		  ...
		  ,
		  typename... CEAs> // Compile time element arguments
inline typename Elements<VT, TF, true, CEAs...>::ConstIterator Elements<VT, TF, true, CEAs...>::cend() const
{
	return ConstIterator(this, size());
}
/*! \endcond */
...
template <typename VT // Type of the dense vector
		  ...
		  ,
		  typename... CEAs> // Compile time element arguments
inline Elements<VT, TF, true, CEAs...> &Elements<VT, TF, true, CEAs...>::operator=(const ElementType &rhs)
{
...
template <typename VT // Type of the dense vector
		  ...
		  ,
		  typename... CEAs> // Compile time element arguments
inline Elements<VT, TF, true, CEAs...> &Elements<VT, TF, true, CEAs...>::operator=(initializer_list<ElementType> list)
{
	if (list.size() > size()) {
...
template <typename VT // Type of the dense vector
		  ...
		  ,
		  typename... CEAs> // Compile time element arguments
inline Elements<VT, TF, true, CEAs...> &Elements<VT, TF, true, CEAs...>::operator=(const Elements &rhs)
{
...
inline Elements<VT, TF, true, CEAs...> &Elements<VT, TF, true, CEAs...>::operator=(const Vector<VT2, TF> &rhs)
{
...
inline Elements<VT, TF, true, CEAs...> &Elements<VT, TF, true, CEAs...>::operator/=(const DenseVector<VT2, TF> &rhs)
{
	METRIC_NUMERIC_CONSTRAINT_MUST_BE_VECTOR_WITH_TRANSPOSE_FLAG(ResultType_t<VT2>, TF);
	METRIC_NUMERIC_CONSTRAINT_MUST_NOT_REQUIRE_EVALUATION(ResultType_t<VT2>);
...
inline Elements<VT, TF, true, CEAs...> &Elements<VT, TF, true, CEAs...>::scale(const Other &scalar)
{
	for (size_t i = 0UL; i < size(); ++i)
