...
#ifndef METRIC_NUMERIC_MATH_VIEWS_ELEMENTS_ELEMENTSDATA_H
#define METRIC_NUMERIC_MATH_VIEWS_ELEMENTS_ELEMENTSDATA_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
#include <metric/numeric/util/AsConst.h>
...
class ElementsData<index_sequence<I, Is...>> {
  ...
  public:
	...
	/*!\name Constructors */
	//@{
	template <typename... REAs> explicit inline ElementsData(REAs... args) noexcept;
...
//*************************************************************************************************
/*! \cond METRIC_NUMERIC_INTERNAL */
#if METRIC_NUMERIC_CPP14_MODE
// Definition and initialization of the static member variables
template <size_t I // First element index
		  ,
		  size_t... Is> // Remaining element indices
constexpr typename ElementsData<index_sequence<I, Is...>>::Indices ElementsData<index_sequence<I, Is...>>::indices_;
#endif
/*! \endcond */
//*************************************************************************************************
...
{
	METRIC_NUMERIC_USER_ASSERT(i < size(), "Invalid element access index");
	return indices_[i];
}
/*! \endcond */
//*************************************************************************************************
...
class ElementsData<P> {
  ...
  public:
	...
	/*!\name Constructors */
	//@{
	template <typename... REAs> inline ElementsData(P p, size_t n, REAs... args) noexcept;
...
template <typename P>		// Type of the index producer
template <typename... REAs> // Optional element arguments
inline ElementsData<P>::ElementsData(P p, size_t n, REAs... args) noexcept : p_(p), n_(n)
{
	MAYBE_UNUSED(args...);
}
/*! \endcond */
...
template <> class ElementsData<> {
  ...
  public:
	...
	/*!\name Constructors */
	//@{
	template <typename T, typename... REAs> inline ElementsData(T *indices, size_t n, REAs... args);
...
// \return A representation of the indices of the specified elements.
*/
inline decltype(auto) ElementsData<>::idces() const noexcept { return mtrc::numeric::as_const(indices_); }
/*! \endcond */
//*************************************************************************************************
...
// \return The index of the specified element.
//
// This function only performs an index check in case METRIC_NUMERIC_USER_ASSERT() is active.
*/
...
// \return The number of elements.
*/
inline size_t ElementsData<>::size() const noexcept { return indices_.size(); }
/*! \endcond */
//*************************************************************************************************
...
constexpr bool compareIndices(const ElementsData<CEAs1...> &lhs, const ElementsData<CEAs2...> &rhs) noexcept
{
