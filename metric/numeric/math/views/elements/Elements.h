...
#ifndef METRIC_NUMERIC_MATH_VIEWS_ELEMENTS_ELEMENTS_H
#define METRIC_NUMERIC_MATH_VIEWS_ELEMENTS_ELEMENTS_H
//=================================================================================================
//
...
// be included via the header files
   ...
   // or
   #include <metric/numeric/math/Elements.h>
   \endcode
...
// indices:
   ...
   \code
   mtrc::numeric::DynamicVector<double,mtrc::numeric::rowVector> x{ 1, 2, 3, 4, 5, 6, 7, 8, 9 };
...
// specifier:
   ...
   using ElementsType = decltype( mtrc::numeric::elements<4UL,12UL>( std::declval<VectorType>() ) );
   \endcode
...
// left-hand side of an assignment leads to undefined behavior:
   ...
   \code
   mtrc::numeric::DynamicVector<int,mtrc::numeric::rowVector> a{ 1, 2, 3 };
   mtrc::numeric::DynamicVector<int,mtrc::numeric::rowVector> b{ 1, 2, 3, 4 };
