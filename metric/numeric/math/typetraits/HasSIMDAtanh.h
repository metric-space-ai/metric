...
#ifndef METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDATANH_H
#define METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDATANH_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
using HasSIMDAtanhHelper = BoolConstant<(IsFloat_v<T> || IsDouble_v<T>) &&
...
// The following example assumes that the Intel SVML is available:
   ...
   \code
   mtrc::numeric::HasSIMDAtanh< float >::value         // Evaluates to 1
   mtrc::numeric::HasSIMDAtanh< double >::Type         // Results in TrueType
   mtrc::numeric::HasSIMDAtanh< const double >         // Is derived from TrueType
   mtrc::numeric::HasSIMDAtanh< unsigned int >::value  // Evaluates to 0
   mtrc::numeric::HasSIMDAtanh< long double >::Type    // Results in FalseType
   mtrc::numeric::HasSIMDAtanh< complex<double> >      // Is derived from FalseType
   \endcode
*/
template <typename T> // Type of the operand
struct HasSIMDAtanh : public BoolConstant<HasSIMDAtanhHelper<RemoveCVRef_t<T>>::value> {};
//*************************************************************************************************
...
// two statements are identical:
   ...
   \code
   constexpr bool value1 = mtrc::numeric::HasSIMDAtanh<T>::value;
   constexpr bool value2 = mtrc::numeric::HasSIMDAtanh_v<T>;
   \endcode
*/
template <typename T> // Type of the operand
