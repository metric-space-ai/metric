...
#ifndef METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDLOG10_H
#define METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDLOG10_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
using HasSIMDLog10Helper = BoolConstant<(IsFloat_v<T> || IsDouble_v<T>) &&
...
// following example assumes that the Intel SVML is available:
   ...
   \code
   mtrc::numeric::HasSIMDLog10< float >::value         // Evaluates to 1
   mtrc::numeric::HasSIMDLog10< double >::Type         // Results in TrueType
   mtrc::numeric::HasSIMDLog10< const double >         // Is derived from TrueType
   mtrc::numeric::HasSIMDLog10< unsigned int >::value  // Evaluates to 0
   mtrc::numeric::HasSIMDLog10< long double >::Type    // Results in FalseType
   mtrc::numeric::HasSIMDLog10< complex<double> >      // Is derived from FalseType
   \endcode
*/
template <typename T> // Type of the operand
struct HasSIMDLog10 : public BoolConstant<HasSIMDLog10Helper<RemoveCVRef_t<T>>::value> {};
//*************************************************************************************************
...
// two statements are identical:
   ...
   \code
   constexpr bool value1 = mtrc::numeric::HasSIMDLog10<T>::value;
   constexpr bool value2 = mtrc::numeric::HasSIMDLog10_v<T>;
   \endcode
*/
template <typename T> // Type of the operand
