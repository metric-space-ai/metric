...
#ifndef METRIC_NUMERIC_MATH_TYPETRAITS_ISDECLSTRLOWEXPR_H
#define METRIC_NUMERIC_MATH_TYPETRAITS_ISDECLSTRLOWEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
*/
template <typename MT> TrueType isDeclStrLowExpr_backend(const volatile DeclStrLowExpr<MT> *);
...
*/
template <typename T> struct IsDeclStrLowExpr : public decltype(isDeclStrLowExpr_backend(std::declval<T *>())){};
//*************************************************************************************************
...
// \ingroup math_type_traits
*/
template <typename T> struct IsDeclStrLowExpr<T &> : public FalseType {};
/*! \endcond */
//*************************************************************************************************
...
// following two statements are identical:
   ...
   \code
   constexpr bool value1 = mtrc::numeric::IsDeclStrLowExpr<T>::value;
   constexpr bool value2 = mtrc::numeric::IsDeclStrLowExpr_v<T>;
   \endcode
*/
template <typename T> constexpr bool IsDeclStrLowExpr_v = IsDeclStrLowExpr<T>::value;
//*************************************************************************************************
