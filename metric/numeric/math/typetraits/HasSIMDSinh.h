...
#ifndef METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDSINH_H
#define METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDSINH_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
using HasSIMDSinhHelper = BoolConstant<(IsFloat_v<T> || IsDouble_v<T>) &&
...
// following example assumes that the Intel SVML is available:
   ...
   \code
   mtrc::numeric::HasSIMDSinh< float >::value         // Evaluates to 1
   mtrc::numeric::HasSIMDSinh< double >::Type         // Results in TrueType
   mtrc::numeric::HasSIMDSinh< const double >         // Is derived from TrueType
   mtrc::numeric::HasSIMDSinh< unsigned int >::value  // Evaluates to 0
   mtrc::numeric::HasSIMDSinh< long double >::Type    // Results in FalseType
   mtrc::numeric::HasSIMDSinh< complex<double> >      // Is derived from FalseType
   \endcode
*/
template <typename T> // Type of the operand
struct HasSIMDSinh : public BoolConstant<HasSIMDSinhHelper<RemoveCVRef_t<T>>::value> {};
//*************************************************************************************************
...
// two statements are identical:
   ...
   \code
   constexpr bool value1 = mtrc::numeric::HasSIMDSinh<T>::value;
   constexpr bool value2 = mtrc::numeric::HasSIMDSinh_v<T>;
   \endcode
*/
template <typename T> // Type of the operand
