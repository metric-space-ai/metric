...
#ifndef METRIC_NUMERIC_MATH_TYPETRAITS_ISVECVECKRONEXPR_H
#define METRIC_NUMERIC_MATH_TYPETRAITS_ISVECVECKRONEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
*/
template <typename MT> TrueType isVecVecKronExpr_backend(const volatile VecVecKronExpr<MT> *);
...
*/
template <typename T> struct IsVecVecKronExpr : public decltype(isVecVecKronExpr_backend(std::declval<T *>())){};
//*************************************************************************************************
...
// \ingroup math_type_traits
*/
template <typename T> struct IsVecVecKronExpr<T &> : public FalseType {};
/*! \endcond */
//*************************************************************************************************
...
// following two statements are identical:
   ...
   \code
   constexpr bool value1 = mtrc::numeric::IsVecVecKronExpr<T>::value;
   constexpr bool value2 = mtrc::numeric::IsVecVecKronExpr_v<T>;
   \endcode
*/
template <typename T> constexpr bool IsVecVecKronExpr_v = IsVecVecKronExpr<T>::value;
//*************************************************************************************************
