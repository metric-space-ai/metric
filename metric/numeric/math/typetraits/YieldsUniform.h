...
#ifndef METRIC_NUMERIC_MATH_TYPETRAITS_YIELDSUNIFORM_H
#define METRIC_NUMERIC_MATH_TYPETRAITS_YIELDSUNIFORM_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
// \a FalseType.
*/
template <typename OP, typename T, typename... Ts> struct YieldsUniform : public FalseType {};
//*************************************************************************************************
...
struct YieldsUniform<const OP, T, Ts...> : public YieldsUniform<OP, T, Ts...> {};
/*! \endcond */
//*************************************************************************************************
...
*/
template <typename OP, typename T, typename... Ts>
struct YieldsUniform<volatile OP, T, Ts...> : public YieldsUniform<OP, T, Ts...> {};
/*! \endcond */
//*************************************************************************************************
...
*/
template <typename OP, typename T, typename... Ts>
struct YieldsUniform<const volatile OP, T, Ts...> : public YieldsUniform<OP, T, Ts...> {};
/*! \endcond */
//*************************************************************************************************
...
// the vector or matrix type \a T the following two statements are identical:
   ...
   \code
   constexpr bool value1 = mtrc::numeric::YieldsUniform<OP,T>::value;
   constexpr bool value2 = mtrc::numeric::YieldsUniform_v<OP,T>;
   \endcode
*/
template <typename OP, typename T, typename... Ts> constexpr bool YieldsUniform_v = YieldsUniform<OP, T, Ts...>::value;
//*************************************************************************************************
