...
#ifndef METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDLGAMMA_H
#define METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDLGAMMA_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
using HasSIMDLGammaHelper = BoolConstant<(IsFloat_v<T> || IsDouble_v<T>) &&
...
// example assumes that the Intel SVML is available:
   ...
   \code
   mtrc::numeric::HasSIMDLGamma< float >::value         // Evaluates to 1
   mtrc::numeric::HasSIMDLGamma< double >::Type         // Results in TrueType
   mtrc::numeric::HasSIMDLGamma< const double >         // Is derived from TrueType
   mtrc::numeric::HasSIMDLGamma< unsigned int >::value  // Evaluates to 0
   mtrc::numeric::HasSIMDLGamma< long double >::Type    // Results in FalseType
   mtrc::numeric::HasSIMDLGamma< complex<double> >      // Is derived from FalseType
   \endcode
*/
template <typename T> // Type of the operand
struct HasSIMDLGamma : public BoolConstant<HasSIMDLGammaHelper<RemoveCVRef_t<T>>::value> {};
//*************************************************************************************************
...
// two statements are identical:
   ...
   \code
   constexpr bool value1 = mtrc::numeric::HasSIMDLGamma<T>::value;
   constexpr bool value2 = mtrc::numeric::HasSIMDLGamma_v<T>;
   \endcode
*/
template <typename T> // Type of the operand
