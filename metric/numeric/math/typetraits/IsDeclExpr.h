...
#ifndef METRIC_NUMERIC_MATH_TYPETRAITS_ISDECLEXPR_H
#define METRIC_NUMERIC_MATH_TYPETRAITS_ISDECLEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
*/
template <typename U> TrueType isDeclExpr_backend(const volatile DeclExpr<U> *);
...
*/
template <typename T> struct IsDeclExpr : public decltype(isDeclExpr_backend(std::declval<T *>())){};
//*************************************************************************************************
...
// \ingroup math_type_traits
*/
template <typename T> struct IsDeclExpr<T &> : public FalseType {};
/*! \endcond */
//*************************************************************************************************
...
// two statements are identical:
   ...
   \code
   constexpr bool value1 = mtrc::numeric::IsDeclExpr<T>::value;
   constexpr bool value2 = mtrc::numeric::IsDeclExpr_v<T>;
   \endcode
*/
template <typename T> constexpr bool IsDeclExpr_v = IsDeclExpr<T>::value;
//*************************************************************************************************
