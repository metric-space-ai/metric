...
#ifndef METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDCOSH_H
#define METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDCOSH_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
using HasSIMDCoshHelper = BoolConstant<(IsFloat_v<T> || IsDouble_v<T>) &&
...
// following example assumes that the Intel SVML is available:
   ...
   \code
   mtrc::numeric::HasSIMDCosh< float >::value         // Evaluates to 1
   mtrc::numeric::HasSIMDCosh< double >::Type         // Results in TrueType
   mtrc::numeric::HasSIMDCosh< const double >         // Is derived from TrueType
   mtrc::numeric::HasSIMDCosh< unsigned int >::value  // Evaluates to 0
   mtrc::numeric::HasSIMDCosh< long double >::Type    // Results in FalseType
   mtrc::numeric::HasSIMDCosh< complex<double> >      // Is derived from FalseType
   \endcode
*/
template <typename T> // Type of the operand
struct HasSIMDCosh : public BoolConstant<HasSIMDCoshHelper<RemoveCVRef_t<T>>::value> {};
//*************************************************************************************************
...
// two statements are identical:
   ...
   \code
   constexpr bool value1 = mtrc::numeric::HasSIMDCosh<T>::value;
   constexpr bool value2 = mtrc::numeric::HasSIMDCosh_v<T>;
   \endcode
*/
template <typename T> // Type of the operand
