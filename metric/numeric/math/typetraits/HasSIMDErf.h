...
#ifndef METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDERF_H
#define METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDERF_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
using HasSIMDErfHelper = BoolConstant<(IsFloat_v<T> || IsDouble_v<T>) &&
...
// The following example assumes that the Intel SVML is available:
   ...
   \code
   mtrc::numeric::HasSIMDErf< float >::value         // Evaluates to 1
   mtrc::numeric::HasSIMDErf< double >::Type         // Results in TrueType
   mtrc::numeric::HasSIMDErf< const double >         // Is derived from TrueType
   mtrc::numeric::HasSIMDErf< unsigned int >::value  // Evaluates to 0
   mtrc::numeric::HasSIMDErf< long double >::Type    // Results in FalseType
   mtrc::numeric::HasSIMDErf< complex<double> >      // Is derived from FalseType
   \endcode
*/
template <typename T> // Type of the operand
struct HasSIMDErf : public BoolConstant<HasSIMDErfHelper<RemoveCVRef_t<T>>::value> {};
//*************************************************************************************************
...
// two statements are identical:
   ...
   \code
   constexpr bool value1 = mtrc::numeric::HasSIMDErf<T>::value;
   constexpr bool value2 = mtrc::numeric::HasSIMDErf_v<T>;
   \endcode
*/
template <typename T> // Type of the operand
