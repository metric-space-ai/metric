...
#ifndef METRIC_NUMERIC_MATH_TYPETRAITS_ISDECLUNILOWEXPR_H
#define METRIC_NUMERIC_MATH_TYPETRAITS_ISDECLUNILOWEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
*/
template <typename MT> TrueType isDeclUniLowExpr_backend(const volatile DeclUniLowExpr<MT> *);
...
*/
template <typename T> struct IsDeclUniLowExpr : public decltype(isDeclUniLowExpr_backend(std::declval<T *>())){};
//*************************************************************************************************
...
// \ingroup math_type_traits
*/
template <typename T> struct IsDeclUniLowExpr<T &> : public FalseType {};
/*! \endcond */
//*************************************************************************************************
...
// following two statements are identical:
   ...
   \code
   constexpr bool value1 = mtrc::numeric::IsDeclUniLowExpr<T>::value;
   constexpr bool value2 = mtrc::numeric::IsDeclUniLowExpr_v<T>;
   \endcode
*/
template <typename T> constexpr bool IsDeclUniLowExpr_v = IsDeclUniLowExpr<T>::value;
//*************************************************************************************************
