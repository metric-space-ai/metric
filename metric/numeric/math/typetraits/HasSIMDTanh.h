...
#ifndef METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDTANH_H
#define METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDTANH_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
using HasSIMDTanhHelper = BoolConstant<(IsFloat_v<T> || IsDouble_v<T>) &&
...
// following example assumes that the Intel SVML is available:
   ...
   \code
   mtrc::numeric::HasSIMDTanh< float >::value         // Evaluates to 1
   mtrc::numeric::HasSIMDTanh< double >::Type         // Results in TrueType
   mtrc::numeric::HasSIMDTanh< const double >         // Is derived from TrueType
   mtrc::numeric::HasSIMDTanh< unsigned int >::value  // Evaluates to 0
   mtrc::numeric::HasSIMDTanh< long double >::Type    // Results in FalseType
   mtrc::numeric::HasSIMDTanh< complex<double> >      // Is derived from FalseType
   \endcode
*/
template <typename T> // Type of the operand
struct HasSIMDTanh : public BoolConstant<HasSIMDTanhHelper<RemoveCVRef_t<T>>::value> {};
//*************************************************************************************************
...
// two statements are identical:
   ...
   \code
   constexpr bool value1 = mtrc::numeric::HasSIMDTanh<T>::value;
   constexpr bool value2 = mtrc::numeric::HasSIMDTanh_v<T>;
   \endcode
*/
template <typename T> // Type of the operand
