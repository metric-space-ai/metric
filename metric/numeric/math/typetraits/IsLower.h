...
#ifndef METRIC_NUMERIC_MATH_TYPETRAITS_ISLOWER_H
#define METRIC_NUMERIC_MATH_TYPETRAITS_ISLOWER_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
struct IsLowerHelper : public BoolConstant<IsUniLower_v<T> || IsStrictlyLower_v<T>> {};
...
// is set to \a false, \a Type is \a FalseType, and the class derives from \a FalseType.
   ...
   using LowerDynamicType       = mtrc::numeric::LowerMatrix<DynamicMatrixType>;
   ...
   mtrc::numeric::IsLower< const LowerDynamicType >::Type     // Results in TrueType
   mtrc::numeric::IsLower< volatile UniLowerCompressedType >  // Is derived from TrueType
   ...
   \endcode
*/
template <typename T> struct IsLower : public IsLowerHelper<T> {};
//*************************************************************************************************
...
// \ingroup math_type_traits
*/
template <typename T> struct IsLower<const T> : public IsLower<T> {};
/*! \endcond */
//*************************************************************************************************
...
// \ingroup math_type_traits
*/
template <typename T> struct IsLower<volatile T> : public IsLower<T> {};
/*! \endcond */
//*************************************************************************************************
...
// \ingroup math_type_traits
*/
template <typename T> struct IsLower<const volatile T> : public IsLower<T> {};
/*! \endcond */
//*************************************************************************************************
...
// two statements are identical:
   ...
   \code
   constexpr bool value1 = mtrc::numeric::IsLower<T>::value;
   constexpr bool value2 = mtrc::numeric::IsLower_v<T>;
   \endcode
*/
template <typename T> constexpr bool IsLower_v = IsLower<T>::value;
//*************************************************************************************************
