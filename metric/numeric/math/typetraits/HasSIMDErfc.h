...
#ifndef METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDERFC_H
#define METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDERFC_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
using HasSIMDErfcHelper = BoolConstant<(IsFloat_v<T> || IsDouble_v<T>) &&
...
// The following example assumes that the Intel SVML is available:
   ...
   \code
   mtrc::numeric::HasSIMDErfc< float >::value         // Evaluates to 1
   mtrc::numeric::HasSIMDErfc< double >::Type         // Results in TrueType
   mtrc::numeric::HasSIMDErfc< const double >         // Is derived from TrueType
   mtrc::numeric::HasSIMDErfc< unsigned int >::value  // Evaluates to 0
   mtrc::numeric::HasSIMDErfc< long double >::Type    // Results in FalseType
   mtrc::numeric::HasSIMDErfc< complex<double> >      // Is derived from FalseType
   \endcode
*/
template <typename T> // Type of the operand
struct HasSIMDErfc : public BoolConstant<HasSIMDErfcHelper<RemoveCVRef_t<T>>::value> {};
//*************************************************************************************************
...
// two statements are identical:
   ...
   \code
   constexpr bool value1 = mtrc::numeric::HasSIMDErfc<T>::value;
   constexpr bool value2 = mtrc::numeric::HasSIMDErfc_v<T>;
   \endcode
*/
template <typename T> // Type of the operand
