...
#ifndef METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDEXP_H
#define METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDEXP_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
using HasSIMDExpHelper = BoolConstant<(IsFloat_v<T> || IsDouble_v<T>) &&
...
// example assumes that the Intel SVML is available:
   ...
   \code
   mtrc::numeric::HasSIMDExp< float >::value         // Evaluates to 1
   mtrc::numeric::HasSIMDExp< double >::Type         // Results in TrueType
   mtrc::numeric::HasSIMDExp< const double >         // Is derived from TrueType
   mtrc::numeric::HasSIMDExp< unsigned int >::value  // Evaluates to 0
   mtrc::numeric::HasSIMDExp< long double >::Type    // Results in FalseType
   mtrc::numeric::HasSIMDExp< complex<double> >      // Is derived from FalseType
   \endcode
*/
template <typename T> // Type of the operand
struct HasSIMDExp : public BoolConstant<HasSIMDExpHelper<RemoveCVRef_t<T>>::value> {};
//*************************************************************************************************
...
// two statements are identical:
   ...
   \code
   constexpr bool value1 = mtrc::numeric::HasSIMDExp<T>::value;
   constexpr bool value2 = mtrc::numeric::HasSIMDExp_v<T>;
   \endcode
*/
template <typename T> // Type of the operand
