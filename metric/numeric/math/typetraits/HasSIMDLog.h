...
#ifndef METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDLOG_H
#define METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDLOG_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
using HasSIMDLogHelper = BoolConstant<(IsFloat_v<T> || IsDouble_v<T>) &&
...
// following example assumes that the Intel SVML is available:
   ...
   \code
   mtrc::numeric::HasSIMDLog< float >::value         // Evaluates to 1
   mtrc::numeric::HasSIMDLog< double >::Type         // Results in TrueType
   mtrc::numeric::HasSIMDLog< const double >         // Is derived from TrueType
   mtrc::numeric::HasSIMDLog< unsigned int >::value  // Evaluates to 0
   mtrc::numeric::HasSIMDLog< long double >::Type    // Results in FalseType
   mtrc::numeric::HasSIMDLog< complex<double> >      // Is derived from FalseType
   \endcode
*/
template <typename T> // Type of the operand
struct HasSIMDLog : public BoolConstant<HasSIMDLogHelper<RemoveCVRef_t<T>>::value> {};
//*************************************************************************************************
...
// two statements are identical:
   ...
   \code
   constexpr bool value1 = mtrc::numeric::HasSIMDLog<T>::value;
   constexpr bool value2 = mtrc::numeric::HasSIMDLog_v<T>;
   \endcode
*/
template <typename T> // Type of the operand
