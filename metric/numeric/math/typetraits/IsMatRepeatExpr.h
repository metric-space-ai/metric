...
#ifndef METRIC_NUMERIC_MATH_TYPETRAITS_ISMATREPEATEXPR_H
#define METRIC_NUMERIC_MATH_TYPETRAITS_ISMATREPEATEXPR_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
*/
template <typename VT> TrueType isMatRepeatExpr_backend(const volatile MatRepeatExpr<VT> *);
...
// \a FalseType.
*/
template <typename T> struct IsMatRepeatExpr : public decltype(isMatRepeatExpr_backend(std::declval<T *>())){};
//*************************************************************************************************
...
// \ingroup math_type_traits
*/
template <typename T> struct IsMatRepeatExpr<T &> : public FalseType {};
/*! \endcond */
//*************************************************************************************************
...
// two statements are identical:
   ...
   \code
   constexpr bool value1 = mtrc::numeric::IsMatRepeatExpr<T>::value;
   constexpr bool value2 = mtrc::numeric::IsMatRepeatExpr_v<T>;
   \endcode
*/
template <typename T> constexpr bool IsMatRepeatExpr_v = IsMatRepeatExpr<T>::value;
//*************************************************************************************************
