...
#ifndef METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDSIN_H
#define METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDSIN_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
using HasSIMDSinHelper = BoolConstant<(IsFloat_v<T> || IsDouble_v<T>) &&
...
// example assumes that the Intel SVML is available:
   ...
   \code
   mtrc::numeric::HasSIMDSin< float >::value         // Evaluates to 1
   mtrc::numeric::HasSIMDSin< double >::Type         // Results in TrueType
   mtrc::numeric::HasSIMDSin< const double >         // Is derived from TrueType
   mtrc::numeric::HasSIMDSin< unsigned int >::value  // Evaluates to 0
   mtrc::numeric::HasSIMDSin< long double >::Type    // Results in FalseType
   mtrc::numeric::HasSIMDSin< complex<double> >      // Is derived from FalseType
   \endcode
*/
template <typename T> // Type of the operand
struct HasSIMDSin : public BoolConstant<HasSIMDSinHelper<RemoveCVRef_t<T>>::value> {};
//*************************************************************************************************
...
// two statements are identical:
   ...
   \code
   constexpr bool value1 = mtrc::numeric::HasSIMDSin<T>::value;
   constexpr bool value2 = mtrc::numeric::HasSIMDSin_v<T>;
   \endcode
*/
template <typename T> // Type of the operand
