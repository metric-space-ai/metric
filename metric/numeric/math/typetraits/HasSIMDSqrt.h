...
#ifndef METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDSQRT_H
#define METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDSQRT_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
using HasSIMDSqrtHelper =
	BoolConstant<(IsFloat_v<T> && (bool(METRIC_NUMERIC_SSE_MODE) || bool(METRIC_NUMERIC_AVX_MODE) ||
								   bool(METRIC_NUMERIC_MIC_MODE) || bool(METRIC_NUMERIC_AVX512F_MODE))) ||
				 (IsDouble_v<T> && (bool(METRIC_NUMERIC_SSE2_MODE) || bool(METRIC_NUMERIC_AVX_MODE) ||
									bool(METRIC_NUMERIC_MIC_MODE) || bool(METRIC_NUMERIC_AVX512F_MODE)))>;
/*! \endcond */
//*************************************************************************************************
...
// following example assumes that AVX is available:
   ...
   \code
   mtrc::numeric::HasSIMDSqrt< float >::value         // Evaluates to 1
   mtrc::numeric::HasSIMDSqrt< double >::Type         // Results in TrueType
   mtrc::numeric::HasSIMDSqrt< const double >         // Is derived from TrueType
   mtrc::numeric::HasSIMDSqrt< unsigned int >::value  // Evaluates to 0
   mtrc::numeric::HasSIMDSqrt< long double >::Type    // Results in FalseType
   mtrc::numeric::HasSIMDSqrt< complex<double> >      // Is derived from FalseType
   \endcode
*/
template <typename T> // Type of the operand
struct HasSIMDSqrt : public BoolConstant<HasSIMDSqrtHelper<RemoveCVRef_t<T>>::value> {};
//*************************************************************************************************
...
// two statements are identical:
   ...
   \code
   constexpr bool value1 = mtrc::numeric::HasSIMDSqrt<T>::value;
   constexpr bool value2 = mtrc::numeric::HasSIMDSqrt_v<T>;
   \endcode
*/
template <typename T> // Type of the operand
