...
#ifndef METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDSIGN_H
#define METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDSIGN_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
using HasSIMDSignHelper = BoolConstant<
	...
	((IsFloat_v<T> || IsDouble_v<T>) &&
	 ...
	 (bool(METRIC_NUMERIC_SSE4_MODE) || bool(METRIC_NUMERIC_AVX_MODE) || bool(METRIC_NUMERIC_MIC_MODE) ||
...
// example assumes that AVX is available:
   ...
   \code
   mtrc::numeric::HasSIMDSign< int >::value           // Evaluates to 1
   mtrc::numeric::HasSIMDSign< float >::Type          // Results in TrueType
   mtrc::numeric::HasSIMDSign< double >               // Is derived from TrueType
   mtrc::numeric::HasSIMDSign< unsigned int >::value  // Evaluates to 0
   mtrc::numeric::HasSIMDSign< long double >::Type    // Results in FalseType
   mtrc::numeric::HasSIMDSign< complex<float> >       // Is derived from FalseType
   \endcode
*/
template <typename T> // Type of the operand
struct HasSIMDSign : public BoolConstant<HasSIMDSignHelper<RemoveCVRef_t<T>>::value> {};
//*************************************************************************************************
...
// two statements are identical:
   ...
   \code
   constexpr bool value1 = mtrc::numeric::HasSIMDSign<T>::value;
   constexpr bool value2 = mtrc::numeric::HasSIMDSign_v<T>;
   \endcode
*/
template <typename T> // Type of the operand
