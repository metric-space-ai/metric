...
#ifndef METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDASINH_H
#define METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDASINH_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
using HasSIMDAsinhHelper = BoolConstant<(IsFloat_v<T> || IsDouble_v<T>) &&
...
// following example assumes that the Intel SVML is available:
   ...
   \code
   mtrc::numeric::HasSIMDAsinh< float >::value         // Evaluates to 1
   mtrc::numeric::HasSIMDAsinh< double >::Type         // Results in TrueType
   mtrc::numeric::HasSIMDAsinh< const double >         // Is derived from TrueType
   mtrc::numeric::HasSIMDAsinh< unsigned int >::value  // Evaluates to 0
   mtrc::numeric::HasSIMDAsinh< long double >::Type    // Results in FalseType
   mtrc::numeric::HasSIMDAsinh< complex<double> >      // Is derived from FalseType
   \endcode
*/
template <typename T> // Type of the operand
struct HasSIMDAsinh : public BoolConstant<HasSIMDAsinhHelper<RemoveCVRef_t<T>>::value> {};
//*************************************************************************************************
...
// two statements are identical:
   ...
   \code
   constexpr bool value1 = mtrc::numeric::HasSIMDAsinh<T>::value;
   constexpr bool value2 = mtrc::numeric::HasSIMDAsinh_v<T>;
   \endcode
*/
template <typename T> // Type of the operand
