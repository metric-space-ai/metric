...
#ifndef METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDEXP2_H
#define METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDEXP2_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
using HasSIMDExp2Helper = BoolConstant<(IsFloat_v<T> || IsDouble_v<T>) &&
...
// example assumes that the Intel SVML is available:
   ...
   \code
   mtrc::numeric::HasSIMDExp2< float >::value         // Evaluates to 1
   mtrc::numeric::HasSIMDExp2< double >::Type         // Results in TrueType
   mtrc::numeric::HasSIMDExp2< const double >         // Is derived from TrueType
   mtrc::numeric::HasSIMDExp2< unsigned int >::value  // Evaluates to 0
   mtrc::numeric::HasSIMDExp2< long double >::Type    // Results in FalseType
   mtrc::numeric::HasSIMDExp2< complex<double> >      // Is derived from FalseType
   \endcode
*/
template <typename T> // Type of the operand
struct HasSIMDExp2 : public BoolConstant<HasSIMDExp2Helper<RemoveCVRef_t<T>>::value> {};
//*************************************************************************************************
...
// two statements are identical:
   ...
   \code
   constexpr bool value1 = mtrc::numeric::HasSIMDExp2<T>::value;
   constexpr bool value2 = mtrc::numeric::HasSIMDExp2_v<T>;
   \endcode
*/
template <typename T> // Type of the operand
