...
#ifndef METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDTAN_H
#define METRIC_NUMERIC_MATH_TYPETRAITS_HASSIMDTAN_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
using HasSIMDTanHelper = BoolConstant<(IsFloat_v<T> || IsDouble_v<T>) &&
...
// example assumes that the Intel SVML is available:
   ...
   \code
   mtrc::numeric::HasSIMDTan< float >::value         // Evaluates to 1
   mtrc::numeric::HasSIMDTan< double >::Type         // Results in TrueType
   mtrc::numeric::HasSIMDTan< const double >         // Is derived from TrueType
   mtrc::numeric::HasSIMDTan< unsigned int >::value  // Evaluates to 0
   mtrc::numeric::HasSIMDTan< long double >::Type    // Results in FalseType
   mtrc::numeric::HasSIMDTan< complex<double> >      // Is derived from FalseType
   \endcode
*/
template <typename T> // Type of the operand
struct HasSIMDTan : public BoolConstant<HasSIMDTanHelper<RemoveCVRef_t<T>>::value> {};
//*************************************************************************************************
...
// two statements are identical:
   ...
   \code
   constexpr bool value1 = mtrc::numeric::HasSIMDTan<T>::value;
   constexpr bool value2 = mtrc::numeric::HasSIMDTan_v<T>;
   \endcode
*/
template <typename T> // Type of the operand
