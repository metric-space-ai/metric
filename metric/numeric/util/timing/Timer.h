...
#ifndef METRIC_NUMERIC_UTIL_TIMING_TIMER_H
#define METRIC_NUMERIC_UTIL_TIMING_TIMER_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
inline Timer<TP>::Timer()
	: counter_(0), start_(0.0), end_(0.0), time_(0.0), min_(std::numeric_limits<double>::max()), max_(0.0), last_(0.0)
{
