...
#ifndef METRIC_NUMERIC_UTIL_INTEGRALCONSTANT_H
#define METRIC_NUMERIC_UTIL_INTEGRALCONSTANT_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
// \a ValueType.
   ...
   \endcode
*/
template <typename T, T N> struct IntegralConstant : public std::integral_constant<T, N> {
	//**********************************************************************************************
...
// definition \a ValueType.
   ...
   \endcode
*/
template <bool B> using Bool_t = IntegralConstant<bool, B>;
//*************************************************************************************************
...
// definition \a ValueType.
   ...
   \endcode
*/
template <char N> using Char_t = IntegralConstant<char, N>;
//*************************************************************************************************
...
// definition \a ValueType.
   ...
   \endcode
*/
template <int N> using Int_t = IntegralConstant<int, N>;
//*************************************************************************************************
...
// definition \a ValueType.
   ...
   \endcode
*/
template <long N> using Long_t = IntegralConstant<long, N>;
//*************************************************************************************************
...
// the nested type definition \a ValueType.
   ...
   \endcode
*/
template <ptrdiff_t N> using Ptrdiff_t = IntegralConstant<ptrdiff_t, N>;
//*************************************************************************************************
...
// \a ValueType.
   ...
   \endcode
*/
template <size_t N> using Size_t = IntegralConstant<size_t, N>;
//*************************************************************************************************
...
*/
template <bool B> constexpr BoolConstant<!B> operator!(BoolConstant<B>) noexcept { return BoolConstant<!B>(); }
//*************************************************************************************************
...
*/
template <bool B1, bool B2> constexpr BoolConstant<B1 && B2> operator&&(BoolConstant<B1>, BoolConstant<B2>) noexcept
{
