...
#ifndef METRIC_NUMERIC_UTIL_CONSTRAINTS_FLOAT_H
#define METRIC_NUMERIC_UTIL_CONSTRAINTS_FLOAT_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
// is created.
*/
#define METRIC_NUMERIC_CONSTRAINT_MUST_BE_FLOAT_TYPE(T)                                                                \
	static_assert(::mtrc::numeric::IsFloat_v<T>, "Non-float type detected")
//*************************************************************************************************
...
// created.
*/
#define METRIC_NUMERIC_CONSTRAINT_MUST_NOT_BE_FLOAT_TYPE(T)                                                            \
	static_assert(!::mtrc::numeric::IsFloat_v<T>, "Float type detected")
//*************************************************************************************************
