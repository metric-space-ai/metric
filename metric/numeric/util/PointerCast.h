...
#ifndef METRIC_NUMERIC_UTIL_POINTERCAST_H
#define METRIC_NUMERIC_UTIL_POINTERCAST_H
...
// for pointer types.
   ...
   \endcode
*/
template <typename To, typename From> inline To *static_pointer_cast(From *ptr) { return static_cast<To *>(ptr); }
//*************************************************************************************************
...
// type conversion doesn't succeed.
   ...
   \endcode
*/
template <typename To, typename From> inline To *dynamic_pointer_cast(From *ptr) { return dynamic_cast<To *>(ptr); }
//*************************************************************************************************
...
// for pointer types.
   ...
   \endcode
*/
template <typename To, typename From> inline To *const_pointer_cast(From *ptr) { return const_cast<To *>(ptr); }
//*************************************************************************************************
