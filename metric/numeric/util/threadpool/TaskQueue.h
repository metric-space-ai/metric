...
#ifndef METRIC_NUMERIC_UTIL_THREADPOOL_TASKQUEUE_H
#define METRIC_NUMERIC_UTIL_THREADPOOL_TASKQUEUE_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
 ...
 */
inline TaskQueue::TaskQueue() : tasks_() // FIFO container for the contained tasks
{
}
//*************************************************************************************************
...
*/
inline TaskQueue::SizeType TaskQueue::maxSize() const { return tasks_.max_size(); }
//*************************************************************************************************
...
*/
inline TaskQueue::SizeType TaskQueue::size() const { return tasks_.size(); }
//*************************************************************************************************
...
*/
inline bool TaskQueue::isEmpty() const { return tasks_.empty(); }
//*************************************************************************************************
...
*/
inline void TaskQueue::push(Task task) { tasks_.push_back(task); }
//*************************************************************************************************
...
// \return void
*/
inline void TaskQueue::clear() { tasks_.clear(); }
//*************************************************************************************************
...
*/
inline void TaskQueue::swap(TaskQueue &tq) noexcept { tasks_.swap(tq.tasks_); }
//*************************************************************************************************
...
// \exception no-throw guarantee.
*/
inline void swap(TaskQueue &a, TaskQueue &b) noexcept { a.swap(b); }
//*************************************************************************************************
