...
#ifndef METRIC_NUMERIC_UTIL_MPL_PLUS_H
#define METRIC_NUMERIC_UTIL_MPL_PLUS_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
// nested member \a value, the resulting type is available via the nested type \a ValueType.
   ...
   \code
   mtrc::numeric::Plus_t< Int_t<3> , Int_t<2>  >::value      // Results in 5
   mtrc::numeric::Plus_t< Long_t<3>, Int_t<2>  >::ValueType  // Results in long
   mtrc::numeric::Plus_t< Int_t<3> , Long_t<2> >::ValueType  // Results in long
   \endcode
*/
