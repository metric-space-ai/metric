...
#ifndef METRIC_NUMERIC_UTIL_MPL_MAX_H
#define METRIC_NUMERIC_UTIL_MPL_MAX_H
//*************************************************************************************************
// Includes
//*************************************************************************************************
...
// nested type \a ValueType.
   ...
   \code
   mtrc::numeric::Max_t< Int_t<3> , Int_t<2>  >::value      // Results in 3
   mtrc::numeric::Max_t< Long_t<3>, Int_t<2>  >::ValueType  // Results in long
   mtrc::numeric::Max_t< Int_t<3> , Long_t<2> >::ValueType  // Results in int
   \endcode
*/
