...
template <typename Space> class GraphTopology {
  public:
	...
	{
		return mtrc::position_of_record_id(ids_, id, "record id is outside the graph topology");
	}
	...
	{
		representation_diagnostics result{representation_kind::graph_topology, exactness::approximate,
										  materialization::topology, update_mode::snapshot};
