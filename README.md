...
|VOI normalized                                                                                                                                          |Python  |f = distance.VOI_normalized(k=3, logbase=2)                           |result = f(dataA, dataB)     |defaults: k=3, logbase=2                              |
|                                                                                                                                                        |C++     |auto f = metric::VOI_normalized<double>();                            |auto result = f(dataA, dataB)|defaults: k=3, p=25, logbase=2                        |
|VOI                                                                                                                                                     |C++     |auto f = metric::VOI<double>();                                       |auto result = f(dataA, dataB)|defaults: k=3, p=25, logbase=2                        |
|mutualInformation                                                                                                                                       |C++     |not needed                                                            |auto result = metric::mutualInformation(dataA, dataB) |defaults: k=3, metric=metric::Chebyshev<Container>(), logbase=2
