...
template <typename ValueType> void register_wrapper_TWED(py::module &m)
{
	using Metric = mtrc::TWED<ValueType>;
...
void export_metric_TWED(py::module &m) { register_wrapper_TWED<double>(m); }
