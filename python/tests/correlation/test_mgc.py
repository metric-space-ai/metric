try:
    ...
    import pytest
    pytest.skip("MGC requires the FULL Python build", allow_module_level=True)
from metric.distance import Euclidean, Manhattan, P_norm
import numpy
import pytest


a1 = numpy.float64([[-1.08661677587398], [-1.00699896410939], [-0.814135753976830],
...
b1 = numpy.float64([[2.70625143351230], [1.41259513494005], [0.666086793692617],
