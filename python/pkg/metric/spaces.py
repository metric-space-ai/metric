...
class FiniteMetricSpace:
    ...
    def __getstate__(self):
        """Pickle the records, ids, metadata and settings (not the rebuildable
        caches or native handles).
        ...
        is raised so a user knows to use a named metric or re-attach the metric
        after loading, rather than getting an opaque pickling failure.
        """
        ...
        # Rebuildable / non-portable: dropped on pickle, recomputed lazily on load.
    ...
    def __setstate__(self, state):
        ...
        # Re-seed the caches that __getstate__ dropped.
        self._lazy_distances = {}
        self._distances = None
