...
| UCR process curves | Review pending | Native `metric.visual.v1`, 737 records, 576 source-relation records, 1 relation, render OK, grammar OK | `visual/examples/process-curve-external-hero/index.html` | `examples/engine/process_curve_external_visual_export.cpp` | `docs/examples/assets/process-curve-external/metric.visual.json` |
