...
- C++ engine intent helpers and strategies: `metric::find_neighbors`, `metric::find_groups`, `metric::find_representatives`, `metric::describe_structure`, `metric::compare`, `metric::correlate`, LAPACK-backed `metric::reduce`, `metric::strategies::brute_force`, `matrix_cache`, `cover_tree`, `knn_graph`, `k_medoids`, `dbscan`, `farthest_first`, `mgc`, and `pcfa`
