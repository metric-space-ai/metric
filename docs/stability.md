...
- C++ engine clustering operator: `metric::ClusteringResult` and `metric::operators::kmedoids`
...
- initial C++ engine clustering operator under `metric/operators/clustering.hpp`
