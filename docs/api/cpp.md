...
The graph construction, diagnostics, symmetrization, and out-degree pruning helpers are available through the dedicated `<metric/operators/sparsify.hpp>` header as well as the compatibility `<metric/operators.hpp>` aggregate.
